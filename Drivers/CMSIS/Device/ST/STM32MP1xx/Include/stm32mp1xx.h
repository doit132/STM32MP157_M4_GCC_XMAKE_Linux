...
/* Uncomment the line below according to the target STM32MP1 device used in your
  ...
  */
	...
	#define __STM32MP1xx_CMSIS_VERSION                                                         \
		((__CMSIS_DEVICE_VERSION_MAIN << 24) | (__CMSIS_DEVICE_HAL_VERSION_SUB1 << 16) |   \
		 (__CMSIS_DEVICE_HAL_VERSION_SUB2 << 8) | (__CMSIS_DEVICE_HAL_VERSION_RC))
	 ...
	 */
	#if defined(CORE_CM4)
		#if defined(STM32MP15xx) /* keep for backward compatibility STM32MP15xx =          \
					    STM32MP157Cxx */
