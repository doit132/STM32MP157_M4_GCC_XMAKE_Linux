...
ErrorStatus LL_I2C_DeInit(I2C_TypeDef *I2Cx)
{
	...
	if (I2Cx == I2C1) {
		...
		/* Force reset of I2C clock */
		LL_APB5_GRP1_ForceReset(LL_APB5_GRP1_PERIPH_I2C4);

		/* Release reset of I2C clock */
		LL_APB5_GRP1_ReleaseReset(LL_APB5_GRP1_PERIPH_I2C4);
	} else if (I2Cx == I2C5) {
		/* Force reset of I2C clock */
		...
		/* Force reset of I2C clock */
		LL_APB5_GRP1_ForceReset(LL_APB5_GRP1_PERIPH_I2C6);

		/* Release reset of I2C clock */
		LL_APB5_GRP1_ReleaseReset(LL_APB5_GRP1_PERIPH_I2C6);
	} else {
		status = ERROR;
	}
