 ...
 ===============================================================================
    ...
    [..] Internal/external clock and PLL configuration
	 ...
	 (#) PLL , The RCC features four independent PLLs (clocked by HSI , HSE or CSI),
	     featuring three different output clocks and able  to work either in integer, Fractional
or Spread Sprectum mode.
	   ...
	   (++) PLL3, which is used to provide clock to the MCU sub-system and to generate the
kernel clock for peripherals.
	 ...
	 (#) LSECSS (LSE Clock security system), once enabled and if a LSE clock failure occurs
	     ...
	     (++) A failure event is generated (rcc_lsecss_fail). This event is connected to the
TAMP block, allowing to wake up from Standby, and allowing the protection of backup registers and
BKPSRAM
    ...
    [..] Sub-system clock configuration
	 ...
	 (#) The MPUDIV divider located into RCC MPU Clock Divider Register (RCC_MPCKDIVR) can be
used to adjust dynamically the clock for the MPU.

	 (#) The AXIDIV divider located into RCC AXI Clock Divider Register (RCC_AXIDIVR) can be
used to adjust dynamically the clock for the AXI matrix. The value of this divider also impacts the
clock frequency of AHB5, AHB6, APB4 and APB5.

	 (#) The APB4DIV divider located into RCC APB4 Clock Divider Register (RCC_APB4DIVR) can be
used to adjust dynamically the clock for the APB4 bridge.
	 ...
	 (#) The APB1DIV divider located into RCC APB1 Clock Divider Register (RCC_APB1DIVR), can be
used to adjust dynamically the clock for the APB1 bridge. Similar implementation is available for
	     APB2 and APB3.
...
HAL_StatusTypeDef HAL_RCC_DeInit(void)
{
	...
	CLEAR_BIT(RCC->PLL2CR, RCC_PLL2CR_DIVPEN | RCC_PLL2CR_DIVQEN | RCC_PLL2CR_DIVREN);
	...
	CLEAR_BIT(RCC->PLL3CR, RCC_PLL3CR_DIVPEN | RCC_PLL3CR_DIVQEN | RCC_PLL3CR_DIVREN);
	...
	CLEAR_BIT(RCC->PLL4CR, RCC_PLL4CR_DIVPEN | RCC_PLL4CR_DIVQEN | RCC_PLL4CR_DIVREN);
	...
	WRITE_REG(RCC->OCENCLRR, RCC_OCENCLRR_HSIKERON | RCC_OCENCLRR_CSION |
					 RCC_OCENCLRR_CSIKERON | RCC_OCENCLRR_DIGBYP |
					 RCC_OCENCLRR_HSEON | RCC_OCENCLRR_HSEKERON |
					 RCC_OCENCLRR_HSEBYP);
	...
	CLEAR_BIT(RCC->MP_CIER,
		  (RCC_MP_CIER_LSIRDYIE | RCC_MP_CIER_LSERDYIE | RCC_MP_CIER_HSIRDYIE |
		   RCC_MP_CIER_HSERDYIE | RCC_MP_CIER_CSIRDYIE | RCC_MP_CIER_PLL1DYIE |
		   RCC_MP_CIER_PLL2DYIE | RCC_MP_CIER_PLL3DYIE | RCC_MP_CIER_PLL4DYIE |
		   RCC_MP_CIER_LSECSSIE | RCC_MP_CIER_WKUPIE));

	/* Clear all RCC MPU interrupt flags */
	SET_BIT(RCC->MP_CIFR, (RCC_MP_CIFR_LSIRDYF | RCC_MP_CIFR_LSERDYF | RCC_MP_CIFR_HSIRDYF |
			       RCC_MP_CIFR_HSERDYF | RCC_MP_CIFR_CSIRDYF | RCC_MP_CIFR_PLL1DYF |
			       RCC_MP_CIFR_PLL2DYF | RCC_MP_CIFR_PLL3DYF | RCC_MP_CIFR_PLL4DYF |
			       RCC_MP_CIFR_LSECSSF | RCC_MP_CIFR_WKUPF));

	/* Clear all RCC MPU Reset Flags */
	SET_BIT(RCC->MP_RSTSCLRR,
		(RCC_MP_RSTSCLRR_MPUP1RSTF | RCC_MP_RSTSCLRR_MPUP0RSTF |
		 RCC_MP_RSTSCLRR_CSTDBYRSTF | RCC_MP_RSTSCLRR_STDBYRSTF |
		 RCC_MP_RSTSCLRR_IWDG2RSTF | RCC_MP_RSTSCLRR_IWDG1RSTF | RCC_MP_RSTSCLRR_MCSYSRSTF |
		 RCC_MP_RSTSCLRR_MPSYSRSTF | RCC_MP_RSTSCLRR_VCORERSTF | RCC_MP_RSTSCLRR_HCSSRSTF |
		 RCC_MP_RSTSCLRR_PADRSTF | RCC_MP_RSTSCLRR_BORRSTF | RCC_MP_RSTSCLRR_PORRSTF));
	#endif

	#ifdef CORE_CM4
	/* Reset RCC Clock Source Interrupt Enable Register */
	CLEAR_BIT(RCC->MC_CIER,
		  (RCC_MC_CIER_LSIRDYIE | RCC_MC_CIER_LSERDYIE | RCC_MC_CIER_HSIRDYIE |
		   RCC_MC_CIER_HSERDYIE | RCC_MC_CIER_CSIRDYIE | RCC_MC_CIER_PLL1DYIE |
		   RCC_MC_CIER_PLL2DYIE | RCC_MC_CIER_PLL3DYIE | RCC_MC_CIER_PLL4DYIE |
		   RCC_MC_CIER_LSECSSIE | RCC_MC_CIER_WKUPIE));

	/* Clear all RCC MCU interrupt flags */
	SET_BIT(RCC->MC_CIFR, (RCC_MC_CIFR_LSIRDYF | RCC_MC_CIFR_LSERDYF | RCC_MC_CIFR_HSIRDYF |
			       RCC_MC_CIFR_HSERDYF | RCC_MC_CIFR_CSIRDYF | RCC_MC_CIFR_PLL1DYF |
			       RCC_MC_CIFR_PLL2DYF | RCC_MC_CIFR_PLL3DYF | RCC_MC_CIFR_PLL4DYF |
			       RCC_MC_CIFR_LSECSSF | RCC_MC_CIFR_WKUPF));

	/* Clear all RCC MCU Reset Flags */
	SET_BIT(RCC->MC_RSTSCLRR, RCC_MC_RSTSCLRR_WWDG1RSTF | RCC_MC_RSTSCLRR_IWDG2RSTF |
					  RCC_MC_RSTSCLRR_IWDG1RSTF | RCC_MC_RSTSCLRR_MCSYSRSTF |
					  RCC_MC_RSTSCLRR_MPSYSRSTF | RCC_MC_RSTSCLRR_MCURSTF |
					  RCC_MC_RSTSCLRR_VCORERSTF | RCC_MC_RSTSCLRR_HCSSRSTF |
					  RCC_MC_RSTSCLRR_PADRSTF | RCC_MC_RSTSCLRR_BORRSTF |
					  RCC_MC_RSTSCLRR_PORRSTF);
	#endif
	...
	if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_CSI) ==
		...
		if (IS_CSI_IN_USE()) {
			...
			/* Otherwise, just the calibration is allowed */
				...
				/* Adjusts the Internal High Speed oscillator (CSI) calibration
				 * value.*/
	...
	if ((pll1->PLLState) != RCC_PLL_NONE) {
		...
		if (!__IS_PLL1_IN_USE()) /* If not used then */
		{
			if ((pll1->PLLState) == RCC_PLL_ON) {
				...
				__HAL_RCC_PLL1CLKOUT_DISABLE(RCC_PLL1_DIVP | RCC_PLL1_DIVQ |
							     RCC_PLL1_DIVR);
				...
				If the User wants to change the PLL parameters he must disable the
				concerned PLL (PLLxON=0) and wait for the PLLxRDY flag to be at 0.
				The PLL configuration below can be done at any time:
				-Enable/Disable of output clock dividers (DIVPxEN, DIVQxEN &
				DIVRxEN) -Fractional Division Enable (PLLxFRACNEN) -Fractional
				Division factor (FRACNx)*/
				...
				/* In integer or clock spreading mode the application shall ensure
				 * that a 0 is loaded into the SDM */
				...
				__HAL_RCC_PLL1CLKOUT_ENABLE(RCC_PLL1_DIVP | RCC_PLL1_DIVQ |
							    RCC_PLL1_DIVR);
			} else {
				/*Disable the post-dividers*/
				__HAL_RCC_PLL1CLKOUT_DISABLE(RCC_PLL1_DIVP | RCC_PLL1_DIVQ |
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef *RCC_OscInitStruct)
{
	...
	RCC_OscInitStruct->OscillatorType = RCC_OSCILLATORTYPE_HSE | RCC_OSCILLATORTYPE_HSI |
					    RCC_OSCILLATORTYPE_CSI | RCC_OSCILLATORTYPE_LSE |
					    RCC_OSCILLATORTYPE_LSI;
	...
	RCC_OscInitStruct->PLL.PLLM =
		(uint32_t)((RCC->PLL1CFGR1 & RCC_PLL1CFGR1_DIVM1) >> RCC_PLL1CFGR1_DIVM1_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLN =
		(uint32_t)((RCC->PLL1CFGR1 & RCC_PLL1CFGR1_DIVN) >> RCC_PLL1CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLR =
		(uint32_t)((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVR) >> RCC_PLL1CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLP =
		(uint32_t)((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVP) >> RCC_PLL1CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLQ =
		(uint32_t)((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVQ) >> RCC_PLL1CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLFRACV =
		(uint32_t)((RCC->PLL1FRACR & RCC_PLL1FRACR_FRACV) >> RCC_PLL1FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL.INC_STEP =
		(uint32_t)((RCC->PLL1CSGR & RCC_PLL1CSGR_INC_STEP) >> RCC_PLL1CSGR_INC_STEP_Pos);
	...
	RCC_OscInitStruct->PLL2.PLLM =
		(uint32_t)((RCC->PLL2CFGR1 & RCC_PLL2CFGR1_DIVM2) >> RCC_PLL2CFGR1_DIVM2_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLN =
		(uint32_t)((RCC->PLL2CFGR1 & RCC_PLL2CFGR1_DIVN) >> RCC_PLL2CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLR =
		(uint32_t)((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVR) >> RCC_PLL2CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLP =
		(uint32_t)((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVP) >> RCC_PLL2CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLQ =
		(uint32_t)((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVQ) >> RCC_PLL2CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLFRACV =
		(uint32_t)((RCC->PLL2FRACR & RCC_PLL2FRACR_FRACV) >> RCC_PLL2FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL2.INC_STEP =
		(uint32_t)((RCC->PLL2CSGR & RCC_PLL2CSGR_INC_STEP) >> RCC_PLL2CSGR_INC_STEP_Pos);
	...
	RCC_OscInitStruct->PLL3.PLLM =
		(uint32_t)((RCC->PLL3CFGR1 & RCC_PLL3CFGR1_DIVM3) >> RCC_PLL3CFGR1_DIVM3_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLN =
		(uint32_t)((RCC->PLL3CFGR1 & RCC_PLL3CFGR1_DIVN) >> RCC_PLL3CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLR =
		(uint32_t)((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVR) >> RCC_PLL3CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLP =
		(uint32_t)((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVP) >> RCC_PLL3CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLQ =
		(uint32_t)((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVQ) >> RCC_PLL3CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLRGE = (uint32_t)(RCC->PLL3CFGR1 & RCC_PLL3CFGR1_IFRGE);
	RCC_OscInitStruct->PLL3.PLLFRACV =
		(uint32_t)((RCC->PLL3FRACR & RCC_PLL3FRACR_FRACV) >> RCC_PLL3FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL3.INC_STEP =
		(uint32_t)((RCC->PLL3CSGR & RCC_PLL3CSGR_INC_STEP) >> RCC_PLL3CSGR_INC_STEP_Pos);
	...
	RCC_OscInitStruct->PLL4.PLLM =
		(uint32_t)((RCC->PLL4CFGR1 & RCC_PLL4CFGR1_DIVM4) >> RCC_PLL4CFGR1_DIVM4_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLN =
		(uint32_t)((RCC->PLL4CFGR1 & RCC_PLL4CFGR1_DIVN) >> RCC_PLL4CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLR =
		(uint32_t)((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVR) >> RCC_PLL4CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLP =
		(uint32_t)((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVP) >> RCC_PLL4CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLQ =
		(uint32_t)((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVQ) >> RCC_PLL4CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLRGE = (uint32_t)(RCC->PLL4CFGR1 & RCC_PLL4CFGR1_IFRGE);
	RCC_OscInitStruct->PLL4.PLLFRACV =
		(uint32_t)((RCC->PLL4FRACR & RCC_PLL4FRACR_FRACV) >> RCC_PLL4FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL4.INC_STEP =
		(uint32_t)((RCC->PLL4CSGR & RCC_PLL4CSGR_INC_STEP) >> RCC_PLL4CSGR_INC_STEP_Pos);
}
...
void HAL_RCC_GetClockConfig(RCC_ClkInitTypeDef *RCC_ClkInitStruct, uint32_t *pFLatency)
{
	...
	RCC_ClkInitStruct->ClockType = RCC_CLOCKTYPE_MPU | RCC_CLOCKTYPE_ACLK | RCC_CLOCKTYPE_HCLK |
...
/**
 * @brief  Returns the PLL1 clock frequencies :PLL1_P_Frequency,PLL1_R_Frequency and
 * PLL1_Q_Frequency
 * @note   The PLL1 clock frequencies computed by this function is not the real
 *         frequency in the chip. It is calculated based on the predefined
 *         constant and the selected clock source:
 * @note     The function returns values based on HSE_VALUE or HSI_VALUE Value multiplied/divided by
 * the PLL factors.
 * @note   This function can be used by the user application to compute the
 *         baud-rate for the communication peripherals or configure other parameters.
 *
 * @note   Each time PLL1CLK changes, this function must be called to update the
 *         right PLL1CLK value. Otherwise, any configuration based on this function will be
 * incorrect.
...
__weak void HAL_RCC_GetPLL1ClockFreq(PLL1_ClocksTypeDef *PLL1_Clocks)
{
	...
	fracn1 = (float)(pll1fracen *
			 ((RCC->PLL1FRACR & RCC_PLL1FRACR_FRACV) >> RCC_PLL1FRACR_FRACV_Pos));
	...
	PLL1_Clocks->PLL1_P_Frequency =
		(uint32_t)(pll1vco / ((float)(((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVP) >>
					       RCC_PLL1CFGR2_DIVP_Pos) +
					      1U)));
	PLL1_Clocks->PLL1_Q_Frequency =
		(uint32_t)(pll1vco / ((float)(((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVQ) >>
					       RCC_PLL1CFGR2_DIVQ_Pos) +
					      1U)));
	PLL1_Clocks->PLL1_R_Frequency =
		(uint32_t)(pll1vco / ((float)(((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVR) >>
					       RCC_PLL1CFGR2_DIVR_Pos) +
					      1U)));
}

/**
 * @brief  Returns the PLL2 clock frequencies :PLL2_P_Frequency,PLL2_R_Frequency and
 * PLL2_Q_Frequency
 ...
 *         right PLL2CLK value. Otherwise, any configuration based on this function will be
 * incorrect.
...
__weak void HAL_RCC_GetPLL2ClockFreq(PLL2_ClocksTypeDef *PLL2_Clocks)
{
	...
	PLL2_Clocks->PLL2_P_Frequency =
		(uint32_t)(pll2vco / ((float)(((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVP) >>
					       RCC_PLL2CFGR2_DIVP_Pos) +
					      1U)));
	PLL2_Clocks->PLL2_Q_Frequency =
		(uint32_t)(pll2vco / ((float)(((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVQ) >>
					       RCC_PLL2CFGR2_DIVQ_Pos) +
					      1U)));
	PLL2_Clocks->PLL2_R_Frequency =
		(uint32_t)(pll2vco / ((float)(((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVR) >>
					       RCC_PLL2CFGR2_DIVR_Pos) +
					      1U)));
}

/**
 * @brief  Returns the PLL3 clock frequencies :PLL3_P_Frequency,PLL3_R_Frequency and
 * PLL3_Q_Frequency
 * @note   The PLL3 clock frequencies computed by this function is not the real
 *         frequency in the chip. It is calculated based on the predefined
 *         constant and the selected clock source:
 * @note     The function returns values based on HSE_VALUE, HSI_VALUE or CSI Value
 * multiplied/divided by the PLL factors.
 * @note   This function can be used by the user application to compute the
 *         baud-rate for the communication peripherals or configure other parameters.
 *
 * @note   Each time PLL3CLK changes, this function must be called to update the
 *         right PLL3CLK value. Otherwise, any configuration based on this function will be
 * incorrect.
...
__weak void HAL_RCC_GetPLL3ClockFreq(PLL3_ClocksTypeDef *PLL3_Clocks)
{
	...
	PLL3_Clocks->PLL3_P_Frequency =
		(uint32_t)(pll3vco / ((float)(((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVP) >>
					       RCC_PLL3CFGR2_DIVP_Pos) +
					      1U)));
	PLL3_Clocks->PLL3_Q_Frequency =
		(uint32_t)(pll3vco / ((float)(((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVQ) >>
...
/**
 * @brief  Returns the PLL4 clock frequencies :PLL4_P_Frequency,PLL4_R_Frequency and
 * PLL4_Q_Frequency
 ...
 *         right PLL4CLK value. Otherwise, any configuration based on this function will be
 * incorrect.
...
__weak void HAL_RCC_GetPLL4ClockFreq(PLL4_ClocksTypeDef *PLL4_Clocks)
{
	...
	fracn1 = (float)(pll4fracen *
			 ((RCC->PLL4FRACR & RCC_PLL4FRACR_FRACV) >> RCC_PLL4FRACR_FRACV_Pos));
	...
	PLL4_Clocks->PLL4_P_Frequency =
		(uint32_t)(pll4vco / ((float)(((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVP) >>
					       RCC_PLL4CFGR2_DIVP_Pos) +
					      1U)));
	PLL4_Clocks->PLL4_Q_Frequency =
		(uint32_t)(pll4vco / ((float)(((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVQ) >>
					       RCC_PLL4CFGR2_DIVQ_Pos) +
					      1U)));
	PLL4_Clocks->PLL4_R_Frequency =
		(uint32_t)(pll4vco / ((float)(((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVR) >>
					       RCC_PLL4CFGR2_DIVR_Pos) +
					      1U)));
}
 ...
 *         right MLHCLK value. Otherwise, any configuration based on this function will be
 * incorrect.
 * @retval HCLK4 frequency
 */
