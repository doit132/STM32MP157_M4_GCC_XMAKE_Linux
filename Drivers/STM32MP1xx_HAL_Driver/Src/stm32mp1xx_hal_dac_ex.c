  ...
  ******************************************************************************
  ...
  ==============================================================================
    [..]
	  ...
	  HAL_DACEx_DualSetValue() to set digital value to converted simultaneously in Channel 1 and
 Channel 2.
 ...
 *            @arg DAC_LFSRUNMASK_BITS1_0: Unmask DAC channel LFSR bit[1:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS2_0: Unmask DAC channel LFSR bit[2:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS3_0: Unmask DAC channel LFSR bit[3:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS4_0: Unmask DAC channel LFSR bit[4:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS5_0: Unmask DAC channel LFSR bit[5:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS6_0: Unmask DAC channel LFSR bit[6:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS7_0: Unmask DAC channel LFSR bit[7:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS8_0: Unmask DAC channel LFSR bit[8:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS9_0: Unmask DAC channel LFSR bit[9:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS10_0: Unmask DAC channel LFSR bit[10:0] for noise wave
 * generation
 *            @arg DAC_LFSRUNMASK_BITS11_0: Unmask DAC channel LFSR bit[11:0] for noise wave
 * generation
 * @retval HAL status
 */
	...
	if (hdac->State == HAL_DAC_STATE_BUSY) {
		...
		*(__IO uint32_t *)tmp = 0x0800;
		...
		while (delta != 0U) {
			...
			MODIFY_REG(hdac->Instance->CCR, (DAC_CCR_OTRIM1 << Channel),
				   (trimmingvalue << Channel));
