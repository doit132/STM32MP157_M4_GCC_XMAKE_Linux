...
#define IS_LL_UTILS_APB2_DIV(__VALUE__)                                                            \
	(((__VALUE__) == LL_RCC_APB2_DIV_1) || ((__VALUE__) == LL_RCC_APB2_DIV_2) ||               \
	 ((__VALUE__) == LL_RCC_APB2_DIV_4) || ((__VALUE__) == LL_RCC_APB2_DIV_8) ||               \
	 ((__VALUE__) == LL_RCC_APB2_DIV_16))

#define IS_LL_UTILS_APB3_DIV(__VALUE__)                                                            \
	(((__VALUE__) == LL_RCC_APB3_DIV_1) || ((__VALUE__) == LL_RCC_APB3_DIV_2) ||               \
	 ((__VALUE__) == LL_RCC_APB3_DIV_4) || ((__VALUE__) == LL_RCC_APB3_DIV_8) ||               \
	 ((__VALUE__) == LL_RCC_APB3_DIV_16))

#define IS_LL_UTILS_APB4_DIV(__VALUE__)                                                            \
	(((__VALUE__) == LL_RCC_APB4_DIV_1) || ((__VALUE__) == LL_RCC_APB4_DIV_2) ||               \
	 ((__VALUE__) == LL_RCC_APB4_DIV_4) || ((__VALUE__) == LL_RCC_APB4_DIV_8) ||               \
	 ((__VALUE__) == LL_RCC_APB4_DIV_16))

#define IS_LL_UTILS_APB5_DIV(__VALUE__)                                                            \
	(((__VALUE__) == LL_RCC_APB5_DIV_1) || ((__VALUE__) == LL_RCC_APB5_DIV_2) ||               \
	 ((__VALUE__) == LL_RCC_APB5_DIV_4) || ((__VALUE__) == LL_RCC_APB5_DIV_8) ||               \
...
#define IS_LL_UTILS_PLLVCO_INPUT(__VALUE__, __TYPE__)                                              \
	((((__TYPE__) == UTILS_PLL_1600_TYPE) && (UTILS_PLL1600_INPUT_MIN <= (__VALUE__)) &&       \
	  ((__VALUE__) <= UTILS_PLL1600_INPUT_MAX)) ||                                             \
	 (((__TYPE__) == UTILS_PLL_800_TYPE) && (UTILS_PLL800_INPUT_MIN <= (__VALUE__)) &&         \
	  ((__VALUE__) <= UTILS_PLL800_INPUT_MAX)))

#define IS_LL_UTILS_PLLVCO_OUTPUT(__VALUE__, __TYPE__)                                             \
	((((__TYPE__) == UTILS_PLL_1600_TYPE) && (UTILS_PLL1600_OUTPUT_MIN <= (__VALUE__)) &&      \
	  ((__VALUE__) <= UTILS_PLL1600_OUTPUT_MAX)) ||                                            \
	 (((__TYPE__) == UTILS_PLL_800_TYPE) && (UTILS_PLL800_OUTPUT_MIN <= (__VALUE__)) &&        \
	  ((__VALUE__) <= UTILS_PLL800_OUTPUT_MAX)))

#define IS_LL_UTILS_HSE_BYPASS(__STATE__)                                                          \
	(((__STATE__) == LL_UTILS_HSEBYPASS_ON) || ((__STATE__) == LL_UTILS_HSEBYPASSDIG_ON) ||    \
...
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency,
					    LL_UTILS_PLLTypeDef *UTILS_PLLStruct);
static void UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_Frequency,
					 ...
					 LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
	...
	vcooutput_freq = (LL_RCC_CalcPLLClockFreq(HSEFrequency, UTILS_PLLsInitStruct->PLL1.PLLM,
						  UTILS_PLLsInitStruct->PLL1.PLLN,
						  UTILS_PLLsInitStruct->PLL1.PLLFRACV, 1U) *
			  2U);
	assert_param(IS_LL_UTILS_PLLVCO_OUTPUT(vcooutput_freq, UTILS_PLL_1600_TYPE));

	vcooutput_freq = (LL_RCC_CalcPLLClockFreq(HSEFrequency, UTILS_PLLsInitStruct->PLL2.PLLM,
						  UTILS_PLLsInitStruct->PLL2.PLLN,
						  UTILS_PLLsInitStruct->PLL2.PLLFRACV, 1U) *
			  2U);
	assert_param(IS_LL_UTILS_PLLVCO_OUTPUT(vcooutput_freq, UTILS_PLL_1600_TYPE));

	vcooutput_freq = LL_RCC_CalcPLLClockFreq(HSEFrequency, UTILS_PLLsInitStruct->PLL3.PLLM,
						 UTILS_PLLsInitStruct->PLL3.PLLN,
						 UTILS_PLLsInitStruct->PLL3.PLLFRACV, 1U);
	assert_param(IS_LL_UTILS_PLLVCO_OUTPUT(vcooutput_freq, UTILS_PLL_800_TYPE));

	vcooutput_freq = LL_RCC_CalcPLLClockFreq(HSEFrequency, UTILS_PLLsInitStruct->PLL4.PLLM,
						 UTILS_PLLsInitStruct->PLL4.PLLN,
						 UTILS_PLLsInitStruct->PLL4.PLLFRACV, 1U);
	assert_param(IS_LL_UTILS_PLLVCO_OUTPUT(vcooutput_freq, UTILS_PLL_800_TYPE));
#endif /* USE_FULL_ASSERT */
					    ...
					    LL_UTILS_PLLTypeDef *UTILS_PLLStruct)
{
	...
	pllfreq = LL_RCC_CalcPLLClockFreq(PLL_InputFrequency, UTILS_PLLStruct->PLLM,
					  UTILS_PLLStruct->PLLN, UTILS_PLLStruct->PLLFRACV,
 ...
 * @retval None
 */
static void UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_CoreFrequency,
					   LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
