 ...
 */
	 ...
	 */
		...
		#define IS_LL_RCC_I2C_CLKSOURCE(__VALUE__)                                         \
			(((__VALUE__) == LL_RCC_I2C12_CLKSOURCE) ||                                \
		...
		#define IS_LL_RCC_SPI_CLKSOURCE(__VALUE__)                                         \
			(((__VALUE__) == LL_RCC_SPI1_CLKSOURCE) ||                                 \
		...
		#define IS_LL_RCC_SDMMC_CLKSOURCE(__VALUE__)                                       \
			(((__VALUE__) == LL_RCC_SDMMC12_CLKSOURCE) ||                              \
		...
		#define IS_LL_RCC_SPDIFRX_CLKSOURCE(__VALUE__)                                     \
			(((__VALUE__) == LL_RCC_SPDIFRX_CLKSOURCE))

		#define IS_LL_RCC_CEC_CLKSOURCE(__VALUE__) (((__VALUE__) == LL_RCC_CEC_CLKSOURCE))

		#define IS_LL_RCC_USBPHY_CLKSOURCE(__VALUE__)                                      \
			(((__VALUE__) == LL_RCC_USBPHY_CLKSOURCE))

		#define IS_LL_RCC_USBO_CLKSOURCE(__VALUE__) (((__VALUE__) == LL_RCC_USBO_CLKSOURCE))

		#define IS_LL_RCC_RNG_CLKSOURCE(__VALUE__)                                         \
			(((__VALUE__) == LL_RCC_RNG1_CLKSOURCE) ||                                 \
			 ((__VALUE__) == LL_RCC_RNG2_CLKSOURCE))

		#define IS_LL_RCC_CKPER_CLKSOURCE(__VALUE__)                                       \
			(((__VALUE__) == LL_RCC_CKPER_CLKSOURCE))

		#define IS_LL_RCC_STGEN_CLKSOURCE(__VALUE__)                                       \
			(((__VALUE__) == LL_RCC_STGEN_CLKSOURCE))

		#if defined(DSI)
			#define IS_LL_RCC_DSI_CLKSOURCE(__VALUE__)                                 \
				(((__VALUE__) == LL_RCC_DSI_CLKSOURCE))
		#endif /*DSI*/
		...
		#define IS_LL_RCC_DFSDM_CLKSOURCE(__VALUE__)                                       \
			(((__VALUE__) == LL_RCC_DFSDM_CLKSOURCE))

		#define IS_LL_RCC_TIMGPRES(__VALUE__)                                              \
			(((__VALUE__) == LL_RCC_TIMG1PRES) || ((__VALUE__) == LL_RCC_TIMG2PRES))
...
void LL_RCC_GetPLL1ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
	...
	if (m != 0U) {
		if (LL_RCC_PLL1P_IsEnabled() != 0U) {
			PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL1_GetP());
		}
	}
}
...
void LL_RCC_GetPLL2ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
	...
	if (m != 0U) {
		if (LL_RCC_PLL2P_IsEnabled() != 0U) {
			PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL2_GetP());
		}

		if (LL_RCC_PLL2Q_IsEnabled() != 0U) {
			PLL_Clocks->PLL_Q_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL2_GetQ());
		}

		if (LL_RCC_PLL2R_IsEnabled() != 0U) {
			PLL_Clocks->PLL_R_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL2_GetR());
		}
	}
}
...
void LL_RCC_GetPLL3ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
	...
	if (m != 0U) {
		if (LL_RCC_PLL3P_IsEnabled() != 0U) {
			PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL3_GetP());
		}

		if (LL_RCC_PLL3Q_IsEnabled() != 0U) {
			PLL_Clocks->PLL_Q_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL3_GetQ());
		}

		if (LL_RCC_PLL3R_IsEnabled() != 0U) {
			PLL_Clocks->PLL_R_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL3_GetR());
		}
	}
}
...
void LL_RCC_GetPLL4ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
	...
	/* Fout4_ck = ((HSE_VALUE, CSI_VALUE, EXTERNAL_CLOCK_VALUE or HSI_VALUE/HSIDIV) / PLLM) *
	 * (PLLN + (FRACV/(2^13))) Where Fout4_ck is the PLL4 frequency before PQR post-dividers
	...
	if (m != 0U) {
		if (LL_RCC_PLL4P_IsEnabled() != 0U) {
			PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL4_GetP());
		}

		if (LL_RCC_PLL4Q_IsEnabled() != 0U) {
			PLL_Clocks->PLL_Q_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL4_GetQ());
		}

		if (LL_RCC_PLL4R_IsEnabled() != 0U) {
			PLL_Clocks->PLL_R_Frequency = LL_RCC_CalcPLLClockFreq(
				pllinputfreq, m, n, fracv, LL_RCC_PLL4_GetR());
		}
	}
}
...
uint32_t LL_RCC_GetI2CClockFreq(uint32_t I2CxSource)
{
	...
	case LL_RCC_I2C35_CLKSOURCE_PCLK1:
		i2c_frequency =
			RCC_GetPCLK1ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMCUSSClockFreq()));
		break;
	...
	case LL_RCC_I2C46_CLKSOURCE_PCLK5:
		i2c_frequency =
			RCC_GetPCLK5ClockFreq(RCC_GetACLKClockFreq(RCC_GetAXISSClockFreq()));
		break;
...
uint32_t LL_RCC_GetSPIClockFreq(uint32_t SPIxSource)
{
	...
	case LL_RCC_SPI45_CLKSOURCE_PCLK2:
		spi_frequency =
			RCC_GetPCLK2ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMCUSSClockFreq()));
		break;
...
uint32_t LL_RCC_GetQSPIClockFreq(uint32_t QSPIxSource)
{
	...
	case LL_RCC_QSPI_CLKSOURCE_ACLK:
		qspi_frequency =
			RCC_GetACLKClockFreq(RCC_GetACLKClockFreq(RCC_GetAXISSClockFreq()));
		break;
...
uint32_t LL_RCC_GetLPTIMClockFreq(uint32_t LPTIMxSource)
{
	...
	case LL_RCC_LPTIM45_CLKSOURCE_PCLK3:
		lptim_frequency =
			RCC_GetPCLK3ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMCUSSClockFreq()));
		break;
