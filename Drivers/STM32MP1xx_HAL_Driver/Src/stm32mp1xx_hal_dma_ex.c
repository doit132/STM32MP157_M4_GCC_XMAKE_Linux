/**
  ...
  ******************************************************************************
  ...
  HAL_DMA_MUX_IRQHandler should be called with, as parameter, the appropriate DMA handle as many as
  used DMAs in the user project (exception done if a given DMA is not using the DMAMUX SYNC block
...
@verbatim
 ...
 ===============================================================================
    [..]  This section provides functions allowing to:
      ...
      (+) Configure the DMA_MUX Request Generator Block using HAL_DMAEx_ConfigMuxRequestGenerator
function.
      (+) Functions HAL_DMAEx_EnableMuxRequestGenerator and HAL_DMAEx_DisableMuxRequestGenerator can
					  ...
					  HAL_DMA_MuxSyncConfigTypeDef *pSyncConfig)
{
	...
	if (hdma->State == HAL_DMA_STATE_READY) {
		...
		/* Set the new synchronization parameters (and keep the request ID filled during the
		 * Init)*/
...
void HAL_DMAEx_MUX_IRQHandler(DMA_HandleTypeDef *hdma)
{
	...
	if (hdma->DMAmuxRequestGen != 0) {
		/* if using a DMAMUX request generator block Check for DMAMUX request generator
		 * overrun */
