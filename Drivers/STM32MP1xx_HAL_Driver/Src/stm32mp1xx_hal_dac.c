/**
  ...
  ******************************************************************************
  ...
  ==============================================================================
    ...
    The 2 converters (i.e. channel1 & channel2) can be used independently or simultaneously (dual
 mode):
    ...
    Digital to Analog conversion can be triggered by:
      ...
      (#) Timers TRGO: LPTIM1,LPTIM2
	  (DAC_TRIGGER_LP1_OUT,DAC_TRIGGER_LP2_OUT)
 ...
 HAL_DACEx_ConvHalfCpltCallbackCh2() function is executed and user can add his own code by
 customization of function pointer HAL_DAC_ConvHalfCpltCallbackCh1() or
 HAL_DACEx_ConvHalfCpltCallbackCh2().
       (+) At The end of data transfer HAL_DAC_ConvCpltCallbackCh1()or
 HAL_DACEx_ConvHalfCpltCallbackCh2() function is executed and user can add his own code by
 customization of function pointer HAL_DAC_ConvCpltCallbackCh1() or
 HAL_DACEx_ConvHalfCpltCallbackCh2().
       (+) In case of transfer Error, HAL_DAC_ErrorCallbackCh1() function is executed and user can
	    add his own code by customization of function pointer HAL_DAC_ErrorCallbackCh1.
       (+) In case of DMA underrun, DAC interruption triggers and execute internal function
 HAL_DAC_IRQHandler. HAL_DAC_DMAUnderrunCallbackCh1()or HAL_DACEx_DMAUnderrunCallbackCh2() function
					...
					uint32_t Channel)
{
	...
	/* Sample on old configuration */
	{
		...
		/* RefreshTime */
		hdac->Instance->SHRR = (sConfig->DAC_SampleAndHoldConfig.DAC_RefreshTime)
				       << Channel;
	}
	...
	tmpreg1 &= ~(((uint32_t)(DAC_CR_MAMP1 | DAC_CR_WAVE1 | DAC_CR_TSEL1 | DAC_CR_TEN1))
		     << Channel);
...
uint32_t HAL_DAC_GetError(DAC_HandleTypeDef *hdac)
{
	 ...
	 * @}
	 */
	/** @addtogroup DAC_Exported_Functions_Group5 Register Callback
	 * @{
	 */
	#if (USE_HAL_DAC_REGISTER_CALLBACKS == 1)
/**
