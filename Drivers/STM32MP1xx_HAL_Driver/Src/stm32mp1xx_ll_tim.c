 ...
 */
		...
		defined(TIM12) | defined(TIM13) | defined(TIM14) | defined(TIM15) ||               \
		...
		#define IS_LL_TIM_BREAK_AFMODE(__VALUE__)                                          \
			(((__VALUE__) == LL_TIM_BREAK_AFMODE_INPUT) ||                             \
		...
		#define IS_LL_TIM_BREAK2_AFMODE(__VALUE__)                                         \
			(((__VALUE__) == LL_TIM_BREAK2_AFMODE_INPUT) ||                            \
 ...
 * @param  TIMx Timer Instance
 * @param  TIM_InitStruct pointer to a @ref LL_TIM_InitTypeDef structure (TIMx time base unit
 * configuration data structure)
 * @retval An ErrorStatus enumeration value:
 *          - SUCCESS: TIMx registers are de-initialized
 ...
 * @param  TIM_OC_InitStruct pointer to a @ref LL_TIM_OC_InitTypeDef structure (the output channel
 * configuration data structure)
 * @retval None
 */
 ...
 * @param  TIM_OC_InitStruct pointer to a @ref LL_TIM_OC_InitTypeDef structure (TIMx output channel
 * configuration data structure)
 * @retval An ErrorStatus enumeration value:
 ...
 *         structure to their default values.
 * @param  TIM_ICInitStruct pointer to a @ref LL_TIM_IC_InitTypeDef structure (the input channel
 * configuration data structure)
 * @retval None
 */
 ...
 *         @arg @ref LL_TIM_CHANNEL_CH3
 *         @arg @ref LL_TIM_CHANNEL_CH4
 * @param  TIM_IC_InitStruct pointer to a @ref LL_TIM_IC_InitTypeDef structure (TIMx input channel
 * configuration data structure)
 * @retval An ErrorStatus enumeration value:
 *          - SUCCESS: TIMx output channel is initialized
 *          - ERROR: TIMx output channel is not initialized
 ...
 * @param  TIM_EncoderInitStruct pointer to a @ref LL_TIM_ENCODER_InitTypeDef structure (encoder
 ...
 * @param  TIMx Timer Instance
 * @param  TIM_EncoderInitStruct pointer to a @ref LL_TIM_ENCODER_InitTypeDef structure (TIMx
 ...
 *         structure to their default values.
 * @param  TIM_HallSensorInitStruct pointer to a @ref LL_TIM_HALLSENSOR_InitTypeDef structure (HALL
...
/**
  ...
  * @param  TIMx Timer Instance
  * @param  TIM_HallSensorInitStruct pointer to a @ref LL_TIM_HALLSENSOR_InitTypeDef structure (TIMx
  HALL sensor interface configuration data structure)
  * @retval An ErrorStatus enumeration value:
  *          - SUCCESS: TIMx registers are de-initialized
  *          - ERROR: not applicable
  */
				   ...
				   LL_TIM_HALLSENSOR_InitTypeDef *TIM_HallSensorInitStruct)
{
	...
	tmpccmr1 &=
		(uint32_t) ~(TIM_CCMR1_OC2M | TIM_CCMR1_OC2FE | TIM_CCMR1_OC2PE | TIM_CCMR1_OC2CE);
 ...
 *         to their default values.
 * @param  TIM_BDTRInitStruct pointer to a @ref LL_TIM_BDTR_InitTypeDef structure (Break and Dead
...
static ErrorStatus IC4Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
	...
	#endif /* TIM1 || TIM2 || TIM3 || TIM4 || TIM5 || TIM6 || TIM7 || TIM8 || TIM12 || TIM13   \
