...
#ifndef STM32MP1xx_HAL_USART_H
#define STM32MP1xx_HAL_USART_H
...
typedef struct {
	...
	uint32_t WordLength; /*!< Specifies the number of data bits transmitted or received in a
				frame. This parameter can be a value of @ref USARTEx_Word_Length. */
	...
	uint32_t CLKLastBit; /*!< Specifies whether the clock pulse corresponding to the last
...
typedef enum {
	...
	USART_CLOCKSOURCE_PCLK5 = 0x02U,    /*!< PCLK5 clock source  (only used by UART1) */
	USART_CLOCKSOURCE_PLL3Q = 0x04U,    /*!< PLL3Q clock source  (only used by UART1) */
	USART_CLOCKSOURCE_PLL4Q = 0x08U,    /*!< PLL4Q clock source  */
	USART_CLOCKSOURCE_HSI = 0x10U,	    /*!< HSI clock source    */
	USART_CLOCKSOURCE_CSI = 0x20U,	    /*!< CSI clock source    */
	USART_CLOCKSOURCE_HSE = 0x40U,	    /*!< HSE clock source    */
...
typedef struct __USART_HandleTypeDef {
	...
	uint32_t FifoMode; /*!< Specifies if the FIFO mode will be used. This parameter can be a
			      value of @ref USARTEx_FIFO_mode. */

	void (*RxISR)(
		struct __USART_HandleTypeDef *husart); /*!< Function pointer on Rx IRQ handler  */

	void (*TxISR)(
		struct __USART_HandleTypeDef *husart); /*!< Function pointer on Tx IRQ handler  */
	...
	void (*TxHalfCpltCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Tx Half Complete Callback */
	void (*TxCpltCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Tx Complete Callback */
	void (*RxHalfCpltCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Rx Half Complete Callback */
	void (*RxCpltCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Rx Complete Callback */
	void (*TxRxCpltCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Tx Rx Complete Callback */
	void (*ErrorCallback)(struct __USART_HandleTypeDef *husart); /*!< USART Error Callback */
	void (*AbortCpltCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Abort Complete Callback */
	void (*RxFifoFullCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Rx Fifo Full Callback */
	void (*TxFifoEmptyCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Tx Fifo Empty Callback */

	void (*MspInitCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Msp Init callback */
	void (*MspDeInitCallback)(
		struct __USART_HandleTypeDef *husart); /*!< USART Msp DeInit callback */
 ...
 */
typedef void (*pUSART_CallbackTypeDef)(
	USART_HandleTypeDef *husart); /*!< pointer to an USART callback function */
...
#define USART_STOPBITS_1_5                                                                         \
	(USART_CR2_STOP_0 | USART_CR2_STOP_1) /*!< USART frame with 1.5 stop bits */
...
#define USART_LASTBIT_DISABLE                                                                      \
	0x00000000U /*!< USART frame last data bit clock pulse not output to SCLK pin */
#define USART_LASTBIT_ENABLE                                                                       \
	USART_CR2_LBCL /*!< USART frame last data bit clock pulse output to SCLK pin     */
/**
 * @}
 */
...
#define __HAL_USART_CLEAR_IDLEFLAG(__HANDLE__)                                                     \
	__HAL_USART_CLEAR_FLAG((__HANDLE__), USART_CLEAR_IDLEF)

/** @brief  Clear the USART TX FIFO empty clear flag.
 * @param  __HANDLE__ specifies the USART Handle.
 * @retval None
 */
#define __HAL_USART_CLEAR_TXFECF(__HANDLE__)                                                       \
	__HAL_USART_CLEAR_FLAG((__HANDLE__), USART_CLEAR_TXFECF)
...
#define __HAL_USART_GET_IT(__HANDLE__, __INTERRUPT__)                                              \
	((((__HANDLE__)->Instance->ISR &                                                           \
	   (0x01U << (((__INTERRUPT__)&USART_ISR_MASK) >> USART_ISR_POS))) != 0U)                  \
		 ? SET                                                                             \
		 : RESET)
...
#define __HAL_USART_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                                       \
	((((((((uint8_t)(__INTERRUPT__)) >> 0x05U) == 0x01U)                                       \
	   ...
	   (0x01U << (((uint16_t)(__INTERRUPT__)) & USART_IT_MASK))) != 0U)                        \
		 ? SET                                                                             \
		 : RESET)
 ...
 * @retval None
 */
#define __HAL_USART_CLEAR_IT(__HANDLE__, __IT_CLEAR__)                                             \
 ...
 * @retval None
 */
#define __HAL_USART_SEND_REQ(__HANDLE__, __REQ__)                                                  \
...
#define USART_DIV_SAMPLING8(__PCLK__, __BAUD__, __CLOCKPRESCALER__)                                \
	(((((__PCLK__) / USART_GET_DIV_FACTOR(__CLOCKPRESCALER__)) * 2U) + ((__BAUD__) / 2U)) /    \
	 (__BAUD__))
	...
	do {                                                                                       \
		if ((__HANDLE__)->Instance == USART1) {                                            \
			...
			case RCC_USART1CLKSOURCE_PLL4:                                             \
				(__CLOCKSOURCE__) = USART_CLOCKSOURCE_PLL4Q;                       \
				break;                                                             \
			case RCC_USART1CLKSOURCE_HSE:                                              \
				(__CLOCKSOURCE__) = USART_CLOCKSOURCE_HSE;                         \
				break;                                                             \
			default:                                                                   \
...
#define IS_USART_STOPBITS(__STOPBITS__)                                                            \
	(((__STOPBITS__) == USART_STOPBITS_0_5) || ((__STOPBITS__) == USART_STOPBITS_1) ||         \
	 ((__STOPBITS__) == USART_STOPBITS_1_5) || ((__STOPBITS__) == USART_STOPBITS_2))
...
#define IS_USART_PARITY(__PARITY__)                                                                \
	(((__PARITY__) == USART_PARITY_NONE) || ((__PARITY__) == USART_PARITY_EVEN) ||             \
 ...
 */
#define IS_USART_POLARITY(__CPOL__)                                                                \
	(((__CPOL__) == USART_POLARITY_LOW) || ((__CPOL__) == USART_POLARITY_HIGH))
 ...
 */
#define IS_USART_PHASE(__CPHA__)                                                                   \
	(((__CPHA__) == USART_PHASE_1EDGE) || ((__CPHA__) == USART_PHASE_2EDGE))
...
#include "stm32mp1xx_hal_usart_ex.h"
