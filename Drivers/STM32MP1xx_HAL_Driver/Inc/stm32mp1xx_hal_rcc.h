...
typedef struct {
	...
	uint32_t PLLN; /*!< PLLN: Multiplication factor for PLL VCO output clock
			    ...
			    Integer mode:     25 and 100 for PLL1600 (PLL1 and PLL2), 25 and 200 for
			  PLL800 Fractional mode:  4 and 512 (PLL1600 and PLL800) */
	...
	uint32_t PLLRGE; /*!< PLLRGE: PLL input frequency range for PLL3 and PLL4
			      This parameter must be a value of @ref RCC_PLL3_IF_Range and
			    RCC_PLL4_IF_Range */
...
/**
 * @brief  RCC Internal/External Oscillator (HSE, HSI, CSI, LSE and LSI) configuration structure
 * definition
 */
typedef struct {
	...
	uint32_t
		HSIDivValue; /*!< The HSI Division value.
...
#define IS_RCC_CLOCKTYPETYPE(CLOCK)                                                                \
	(((CLOCK) == RCC_CLOCKTYPE_NONE) || (((CLOCK)&RCC_CLOCKTYPE_MPU) == RCC_CLOCKTYPE_MPU) ||  \
...
#define RCC_HSI_DIV8                                                                               \
	(RCC_HSICFGR_HSIDIV_0 | RCC_HSICFGR_HSIDIV_1) /* Division by 8, ck_hsi(_ker) =  8 MHz*/

#define IS_RCC_HSIDIV(DIV)                                                                         \
	(((DIV) == RCC_HSI_DIV1) || ((DIV) == RCC_HSI_DIV2) || ((DIV) == RCC_HSI_DIV4) ||          \
	 ((DIV) == RCC_HSI_DIV8))
/**
 * @}
 */
...
#define IS_RCC_MCO2SOURCE(SOURCE)                                                                  \
	(((SOURCE) == RCC_MCO2SOURCE_MPU) || ((SOURCE) == RCC_MCO2SOURCE_AXI) ||                   \
...
#define RCC_MCODIV_16                                                                              \
	(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_2 | RCC_MCO1CFGR_MCO1DIV_1 |                \
	 RCC_MCO1CFGR_MCO1DIV_0)

#define IS_RCC_MCODIV(DIV)                                                                         \
	(((DIV) == RCC_MCODIV_1) || ((DIV) == RCC_MCODIV_2) || ((DIV) == RCC_MCODIV_3) ||          \
	 ((DIV) == RCC_MCODIV_4) || ((DIV) == RCC_MCODIV_5) || ((DIV) == RCC_MCODIV_6) ||          \
	 ((DIV) == RCC_MCODIV_7) || ((DIV) == RCC_MCODIV_8) || ((DIV) == RCC_MCODIV_9) ||          \
	 ((DIV) == RCC_MCODIV_10) || ((DIV) == RCC_MCODIV_11) || ((DIV) == RCC_MCODIV_12) ||       \
	 ((DIV) == RCC_MCODIV_13) || ((DIV) == RCC_MCODIV_14) || ((DIV) == RCC_MCODIV_15) ||       \
	 ((DIV) == RCC_MCODIV_16))
/**
 * @}
 */
...
#define IS_RCC_MPUSOURCE(SOURCE)                                                                   \
	(((SOURCE) == RCC_MPUSOURCE_HSI) || ((SOURCE) == RCC_MPUSOURCE_HSE) ||                     \
	 ((SOURCE) == RCC_MPUSOURCE_PLL1) || ((SOURCE) == RCC_MPUSOURCE_MPUDIV))
/**
 * @}
 */
...
#define IS_RCC_AXISSOURCE(SOURCE)                                                                  \
	(((SOURCE) == RCC_AXISSOURCE_HSI) || ((SOURCE) == RCC_AXISSOURCE_HSE) ||                   \
	 ((SOURCE) == RCC_AXISSOURCE_PLL2) || ((SOURCE) == RCC_AXISSOURCE_OFF))
/**
 * @}
 */
...
#define IS_RCC_MCUSSOURCE(SOURCE)                                                                  \
	(((SOURCE) == RCC_MCUSSOURCE_HSI) || ((SOURCE) == RCC_MCUSSOURCE_HSE) ||                   \
	 ((SOURCE) == RCC_MCUSSOURCE_CSI) || ((SOURCE) == RCC_MCUSSOURCE_PLL3))
/**
 * @}
 */
...
#define IS_RCC_MPUDIV(DIVIDER)                                                                     \
	(((DIVIDER) == RCC_MPU_DIV2) || ((DIVIDER) == RCC_MPU_DIV4) ||                             \
	 ((DIVIDER) == RCC_MPU_DIV8) || ((DIVIDER) == RCC_MPU_DIV16))
/**
 * @}
 */
...
#define IS_RCC_AXIDIV(DIVIDER)                                                                     \
	(((DIVIDER) == RCC_AXI_DIV1) || ((DIVIDER) == RCC_AXI_DIV2) ||                             \
	 ((DIVIDER) == RCC_AXI_DIV3) || ((DIVIDER) == RCC_AXI_DIV4))
/**
 * @}
 */
...
#define IS_RCC_APB4DIV(DIVIDER)                                                                    \
	(((DIVIDER) == RCC_APB4_DIV1) || ((DIVIDER) == RCC_APB4_DIV2) ||                           \
	 ((DIVIDER) == RCC_APB4_DIV4) || ((DIVIDER) == RCC_APB4_DIV8) ||                           \
...
#define IS_RCC_APB5DIV(DIVIDER)                                                                    \
	(((DIVIDER) == RCC_APB5_DIV1) || ((DIVIDER) == RCC_APB5_DIV2) ||                           \
	 ((DIVIDER) == RCC_APB5_DIV4) || ((DIVIDER) == RCC_APB5_DIV8) ||                           \
...
#define IS_RCC_MCUDIV(DIVIDER)                                                                     \
	(((DIVIDER) == RCC_MCU_DIV1) || ((DIVIDER) == RCC_MCU_DIV2) ||                             \
	 ((DIVIDER) == RCC_MCU_DIV4) || ((DIVIDER) == RCC_MCU_DIV8) ||                             \
	 ((DIVIDER) == RCC_MCU_DIV16) || ((DIVIDER) == RCC_MCU_DIV32) ||                           \
	 ((DIVIDER) == RCC_MCU_DIV64) || ((DIVIDER) == RCC_MCU_DIV128) ||                          \
	 ((DIVIDER) == RCC_MCU_DIV256) || ((DIVIDER) == RCC_MCU_DIV512))
/**
 * @}
 */
...
#define IS_RCC_APB1DIV(DIVIDER)                                                                    \
	(((DIVIDER) == RCC_APB1_DIV1) || ((DIVIDER) == RCC_APB1_DIV2) ||                           \
	 ((DIVIDER) == RCC_APB1_DIV4) || ((DIVIDER) == RCC_APB1_DIV8) ||                           \
...
#define IS_RCC_APB2DIV(DIVIDER)                                                                    \
	(((DIVIDER) == RCC_APB2_DIV1) || ((DIVIDER) == RCC_APB2_DIV2) ||                           \
	 ((DIVIDER) == RCC_APB2_DIV4) || ((DIVIDER) == RCC_APB2_DIV8) ||                           \
...
#define IS_RCC_APB3DIV(DIVIDER)                                                                    \
	(((DIVIDER) == RCC_APB3_DIV1) || ((DIVIDER) == RCC_APB3_DIV2) ||                           \
	 ((DIVIDER) == RCC_APB3_DIV4) || ((DIVIDER) == RCC_APB3_DIV8) ||                           \
...
#define IS_RCC_PLLMODE(MODE)                                                                       \
	(((MODE) == RCC_PLL_FRACTIONAL) || ((MODE) == RCC_PLL_INTEGER) ||                          \
...
#define IS_RCC_SSCG_MODE(MODE)                                                                     \
	(((MODE) == RCC_SSCG_CENTER_SPREAD) || ((MODE) == RCC_SSCG_DOWN_SPREAD))
/**
 * @}
 */
...
#define IS_RCC_MOD_PER(ADJ)    ((RCC_MOD_PER_MIN <= (ADJ)) && ((ADJ) <= RCC_MOD_PER_MAX))
/**
 * @}
 */
...
#define IS_RCC_INC_STEP(ADJ)   ((RCC_INC_STEP_MIN <= (ADJ)) && ((ADJ) <= RCC_INC_STEP_MAX))
/**
 * @}
 */
...
#define IS_RCC_RPDFN_DIS(STATE)                                                                    \
	(((STATE) == RCC_RPDFN_DIS_DISABLED) || ((STATE) == RCC_RPDFN_DIS_ENABLED))
/**
 * @}
 */
...
#define IS_RCC_TPDFN_DIS(STATE)                                                                    \
	(((STATE) == RCC_TPDFN_DIS_DISABLED) || ((STATE) == RCC_TPDFN_DIS_ENABLED))
/**
 * @}
 */
...
#define IS_RCC_PLL12SOURCE(SOURCE)                                                                 \
	(((SOURCE) == RCC_PLL12SOURCE_HSI) || ((SOURCE) == RCC_PLL12SOURCE_HSE) ||                 \
...
#define IS_RCC_PLL3SOURCE(SOURCE)                                                                  \
	(((SOURCE) == RCC_PLL3SOURCE_HSI) || ((SOURCE) == RCC_PLL3SOURCE_HSE) ||                   \
	 ((SOURCE) == RCC_PLL3SOURCE_CSI) || ((SOURCE) == RCC_PLL3SOURCE_OFF))
...
#define IS_RCC_PLL4SOURCE(SOURCE)                                                                  \
	(((SOURCE) == RCC_PLL4SOURCE_HSI) || ((SOURCE) == RCC_PLL4SOURCE_HSE) ||                   \
	 ((SOURCE) == RCC_PLL4SOURCE_CSI) || ((SOURCE) == RCC_PLL4SOURCE_I2S_CKIN))
/**
 * @}
 */
...
#define IS_RCC_PLL1CLOCKOUT_VALUE(VALUE)                                                           \
	(((VALUE) == RCC_PLL1_DIVP) || ((VALUE) == RCC_PLL1_DIVQ) || ((VALUE) == RCC_PLL1_DIVR))
/**
 * @}
 */
...
#define IS_RCC_PLL2CLOCKOUT_VALUE(VALUE)                                                           \
	(((VALUE) == RCC_PLL2CR_DIVPEN) || ((VALUE) == RCC_PLL2CR_DIVQEN) ||                       \
...
#define IS_RCC_PLL3CLOCKOUT_VALUE(VALUE)                                                           \
	(((VALUE) == RCC_PLL3_DIVP) || ((VALUE) == RCC_PLL3_DIVQ) || ((VALUE) == RCC_PLL3_DIVR))
/**
 * @}
 */
...
#define IS_RCC_PLL4CLOCKOUT_VALUE(VALUE)                                                           \
	(((VALUE) == RCC_PLL4_DIVP) || ((VALUE) == RCC_PLL4_DIVQ) || ((VALUE) == RCC_PLL4_DIVR))
...
#define RCC_RTCCLKSOURCE_HSE_DIV                                                                   \
	(RCC_BDCR_RTCSRC_1 |                                                                       \
	 RCC_BDCR_RTCSRC_0) /* HSE clock divided by RTCDIV value is used as RTC clock*/

#define IS_RCC_RTCCLKSOURCE(SOURCE)                                                                \
	(((SOURCE) == RCC_RTCCLKSOURCE_OFF) || ((SOURCE) == RCC_RTCCLKSOURCE_LSE) ||               \
...
#define RCC_FLAG_AXISSRCRDY                                                                        \
	((RCC->ASSCKSELR & RCC_ASSCKSELR_AXISSRCRDY) == RCC_ASSCKSELR_AXISSRCRDY)

/* Flags in the MSSCKSELR register */
#define RCC_FLAG_MCUSSRCRDY                                                                        \
	((RCC->MSSCKSELR & RCC_MSSCKSELR_MCUSSRCRDY) == RCC_MSSCKSELR_MCUSSRCRDY)

/* Flags in the RCK12SELR register */
#define RCC_FLAG_PLL12SRCRDY                                                                       \
	((RCC->RCK12SELR & RCC_RCK12SELR_PLL12SRCRDY) == RCC_RCK12SELR_PLL12SRCRDY)
...
#define RCC_FLAG_TIMG1PRERDY                                                                       \
	((RCC->TIMG1PRER & RCC_TIMG1PRER_TIMG1PRERDY) == RCC_TIMG1PRER_TIMG1PRERDY)

/* Flags in the TIMG2PRER register */
#define RCC_FLAG_TIMG2PRERDY                                                                       \
...
#define RCC_FLAG_DDRPHYCSRCRDY                                                                     \
	((RCC->DDRCKSELR & RCC_DDRCKSELR_DDRPHYCSRCRDY) == RCC_DDRCKSELR_DDRPHYCSRCRDY)
...
#define RCC_FLAG_LSIRDY ((RCC->RDLSICR & RCC_RDLSICR_LSIRDY) == RCC_RDLSICR_LSIRDY)
	...
	#define RCC_FLAG_PORRST                                                                    \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_PORRSTF) == RCC_MP_RSTSCLRR_PORRSTF)
	#define RCC_FLAG_BORRST                                                                    \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_BORRSTF) == RCC_MP_RSTSCLRR_BORRSTF)
	#define RCC_FLAG_PADRST                                                                    \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_PADRSTF) == RCC_MP_RSTSCLRR_PADRSTF)
	#define RCC_FLAG_HCSSRST                                                                   \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_HCSSRSTF) == RCC_MP_RSTSCLRR_HCSSRSTF)
	#define RCC_FLAG_VCORERST                                                                  \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_VCORERSTF) == RCC_MP_RSTSCLRR_VCORERSTF)
	#define RCC_FLAG_MPSYSRSTF                                                                 \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_MPSYSRSTF) == RCC_MP_RSTSCLRR_MPSYSRSTF)
	#define RCC_FLAG_MCSYSRSTF                                                                 \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_MCSYSRSTF) == RCC_MP_RSTSCLRR_MCSYSRSTF)
	#define RCC_FLAG_IWDG1RST                                                                  \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_IWDG1RSTF) == RCC_MP_RSTSCLRR_IWDG1RSTF)
	#define RCC_FLAG_IWDG2RST                                                                  \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_IWDG2RSTF) == RCC_MP_RSTSCLRR_IWDG2RSTF)
	#define RCC_FLAG_STDBYRSTF                                                                 \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_STDBYRSTF) == RCC_MP_RSTSCLRR_STDBYRSTF)
	#define RCC_FLAG_CSTDBYRSTF                                                                \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_CSTDBYRSTF) == RCC_MP_RSTSCLRR_CSTDBYRSTF)
	#define RCC_FLAG_MPUP0RSTF                                                                 \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_MPUP0RSTF) == RCC_MP_RSTSCLRR_MPUP0RSTF)
	#define RCC_FLAG_MPUP1RSTF                                                                 \
		((RCC->MP_RSTSCLRR & RCC_MP_RSTSCLRR_MPUP1RSTF) == RCC_MP_RSTSCLRR_MPUP1RSTF)
#elif defined(CORE_CM4)
	/* Flags in the RCC_MC_RSTSCLRR */
	#define RCC_MASK_ALL_RESET_FLAGS (0x000007FFU)
	#define RCC_FLAG_PORRST                                                                    \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_PORRSTF) == RCC_MC_RSTSCLRR_PORRSTF)
	#define RCC_FLAG_BORRST                                                                    \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_BORRSTF) == RCC_MC_RSTSCLRR_BORRSTF)
	#define RCC_FLAG_PADRST                                                                    \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_PADRSTF) == RCC_MC_RSTSCLRR_PADRSTF)
	#define RCC_FLAG_HCSSRST                                                                   \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_HCSSRSTF) == RCC_MC_RSTSCLRR_HCSSRSTF)
	#define RCC_FLAG_VCORERST                                                                  \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_VCORERSTF) == RCC_MC_RSTSCLRR_VCORERSTF)
	#define RCC_FLAG_MCURST                                                                    \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_MCURSTF) == RCC_MC_RSTSCLRR_MCURSTF)
	#define RCC_FLAG_MPSYSRST                                                                  \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_MPSYSRSTF) == RCC_MC_RSTSCLRR_MPSYSRSTF)
	#define RCC_FLAG_MCSYSRST                                                                  \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_MCSYSRSTF) == RCC_MC_RSTSCLRR_MCSYSRSTF)
	#define RCC_FLAG_IWDG1RST                                                                  \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_IWDG1RSTF) == RCC_MC_RSTSCLRR_IWDG1RSTF)
	#define RCC_FLAG_IWDG2RST                                                                  \
		((RCC->MC_RSTSCLRR & RCC_MC_RSTSCLRR_IWDG2RSTF) == RCC_MC_RSTSCLRR_IWDG2RSTF)
...
#define IS_RCC_LSEDRIVE(VALUE)                                                                     \
	(((VALUE) == RCC_LSEDRIVE_LOW) || ((VALUE) == RCC_LSEDRIVE_MEDIUMLOW) ||                   \
...
#define RCC_IT_ALL                                                                                 \
	(RCC_IT_LSIRDY | RCC_IT_LSERDY | RCC_IT_HSIRDY | RCC_IT_HSERDY | RCC_IT_CSIRDY |           \
	 RCC_IT_PLLRDY | RCC_IT_PLL2RDY | RCC_IT_PLL3RDY | RCC_IT_PLL4RDY | RCC_IT_LSECSS |        \
	 RCC_IT_WKUP)

#define IS_RCC_IT(VALUE)                                                                           \
	(((VALUE) == RCC_IT_LSIRDY) || ((VALUE) == RCC_IT_LSERDY) || ((VALUE) == RCC_IT_HSIRDY) || \
	 ((VALUE) == RCC_IT_HSERDY) || ((VALUE) == RCC_IT_CSIRDY) || ((VALUE) == RCC_IT_PLLRDY) || \
	 ((VALUE) == RCC_IT_PLL2RDY) || ((VALUE) == RCC_IT_PLL3RDY) ||                             \
	 ((VALUE) == RCC_IT_PLL4RDY) || ((VALUE) == RCC_IT_LSECSS) || ((VALUE) == RCC_IT_WKUP))
...
#define __HAL_RCC_MDMA_RELEASE_RESET()	  (RCC->TZAHB6RSTCLRR = RCC_TZAHB6RSTCLRR_MDMARST)
	...
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_ENABLE()                                               \
			(RCC->MP_AHB5ENSETR = RCC_MP_AHB5ENSETR_CRYP1EN)
	#endif
	...
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_DISABLE()                                              \
	...
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_ENABLE()                                               \
			(RCC->MP_AHB3ENSETR = RCC_MP_AHB3ENSETR_CRYP2EN)
	#endif
	...
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_DISABLE()                                              \
			(RCC->MP_AHB3ENCLRR = RCC_MP_AHB3ENCLRR_CRYP2EN)
	#endif
	...
	#define __HAL_RCC_TIM2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM2LPEN)
	#define __HAL_RCC_TIM3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM3LPEN)
	#define __HAL_RCC_TIM4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM4LPEN)
	#define __HAL_RCC_TIM5_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM5LPEN)
	#define __HAL_RCC_TIM6_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM6LPEN)
	#define __HAL_RCC_TIM7_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM7LPEN)
	#define __HAL_RCC_TIM12_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM12LPEN)
	#define __HAL_RCC_TIM13_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM13LPEN)
	#define __HAL_RCC_TIM14_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_TIM14LPEN)
	#define __HAL_RCC_LPTIM1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_LPTIM1LPEN)
	#define __HAL_RCC_SPI2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_SPI2LPEN)
	#define __HAL_RCC_SPI3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_SPI3LPEN)
	#define __HAL_RCC_USART2_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_USART2LPEN)
	#define __HAL_RCC_USART3_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_USART3LPEN)
	#define __HAL_RCC_UART4_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_UART4LPEN)
	...
	#define __HAL_RCC_UART7_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_UART7LPEN)
	#define __HAL_RCC_UART8_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_UART8LPEN)
	#define __HAL_RCC_I2C1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_I2C1LPEN)
	#define __HAL_RCC_I2C2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_I2C2LPEN)
	#define __HAL_RCC_I2C3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_I2C3LPEN)
	#define __HAL_RCC_I2C5_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_I2C5LPEN)
	#define __HAL_RCC_SPDIFRX_CLK_SLEEP_ENABLE()                                               \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_SPDIFLPEN)
	#define __HAL_RCC_CEC_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_CECLPEN)
	#define __HAL_RCC_DAC12_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_DAC12LPEN)
	#define __HAL_RCC_MDIOS_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB1LPENSETR = RCC_MP_APB1LPENSETR_MDIOSLPEN)

	#define __HAL_RCC_TIM2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_TIM2LPEN)
	#define __HAL_RCC_TIM3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_TIM3LPEN)
	...
	#define __HAL_RCC_TIM5_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_TIM5LPEN)
	...
	#define __HAL_RCC_TIM7_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_TIM7LPEN)
	...
	#define __HAL_RCC_TIM13_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_TIM13LPEN)
	#define __HAL_RCC_TIM14_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_TIM14LPEN)
	#define __HAL_RCC_LPTIM1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_LPTIM1LPEN)
	#define __HAL_RCC_SPI2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_SPI2LPEN)
	#define __HAL_RCC_SPI3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_SPI3LPEN)
	#define __HAL_RCC_USART2_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_USART2LPEN)
	...
	#define __HAL_RCC_UART4_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_UART4LPEN)
	#define __HAL_RCC_UART5_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_UART5LPEN)
	#define __HAL_RCC_UART7_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_UART7LPEN)
	...
	#define __HAL_RCC_I2C1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_I2C1LPEN)
	#define __HAL_RCC_I2C2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_I2C2LPEN)
	#define __HAL_RCC_I2C3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_I2C3LPEN)
	#define __HAL_RCC_I2C5_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_I2C5LPEN)
	#define __HAL_RCC_SPDIFRX_CLK_SLEEP_DISABLE()                                              \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_SPDIFLPEN)
	#define __HAL_RCC_CEC_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_CECLPEN)
	#define __HAL_RCC_DAC12_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_DAC12LPEN)
	#define __HAL_RCC_MDIOS_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB1LPENCLRR = RCC_MP_APB1LPENCLRR_MDIOSLPEN)
	...
	#define __HAL_RCC_TIM1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_TIM1LPEN)
	#define __HAL_RCC_TIM8_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_TIM8LPEN)
	#define __HAL_RCC_TIM15_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_TIM15LPEN)
	#define __HAL_RCC_TIM16_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_TIM16LPEN)
	#define __HAL_RCC_TIM17_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_TIM17LPEN)
	#define __HAL_RCC_SPI1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_SPI1LPEN)
	#define __HAL_RCC_SPI4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_SPI4LPEN)
	#define __HAL_RCC_SPI5_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_SPI5LPEN)
	#define __HAL_RCC_USART6_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_USART6LPEN)
	#define __HAL_RCC_SAI1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_SAI1LPEN)
	#define __HAL_RCC_SAI2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_SAI2LPEN)
	#define __HAL_RCC_SAI3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_SAI3LPEN)
	#define __HAL_RCC_DFSDM1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_DFSDMLPEN)
	#define __HAL_RCC_ADFSDM1_CLK_SLEEP_ENABLE()                                               \
		(RCC->MP_APB2LPENSETR = RCC_MP_APB2LPENSETR_ADFSDMLPEN)
	...
	#define __HAL_RCC_TIM1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_TIM1LPEN)
	#define __HAL_RCC_TIM8_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_TIM8LPEN)
	#define __HAL_RCC_TIM15_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_TIM15LPEN)
	#define __HAL_RCC_TIM16_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_TIM16LPEN)
	#define __HAL_RCC_TIM17_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_TIM17LPEN)
	#define __HAL_RCC_SPI1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_SPI1LPEN)
	#define __HAL_RCC_SPI4_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_SPI4LPEN)
	#define __HAL_RCC_SPI5_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_SPI5LPEN)
	#define __HAL_RCC_USART6_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_USART6LPEN)
	#define __HAL_RCC_SAI1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_SAI1LPEN)
	#define __HAL_RCC_SAI2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_SAI2LPEN)
	#define __HAL_RCC_SAI3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_SAI3LPEN)
	#define __HAL_RCC_DFSDM1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_DFSDMLPEN)
	#define __HAL_RCC_ADFSDM1_CLK_SLEEP_DISABLE()                                              \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_ADFSDMLPEN)
	#define __HAL_RCC_FDCAN_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB2LPENCLRR = RCC_MP_APB2LPENCLRR_FDCANLPEN)
	...
	#define __HAL_RCC_LPTIM2_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB3LPENSETR = RCC_MP_APB3LPENSETR_LPTIM2LPEN)
	#define __HAL_RCC_LPTIM3_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB3LPENSETR = RCC_MP_APB3LPENSETR_LPTIM3LPEN)
	#define __HAL_RCC_LPTIM4_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB3LPENSETR = RCC_MP_APB3LPENSETR_LPTIM4LPEN)
	#define __HAL_RCC_LPTIM5_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB3LPENSETR = RCC_MP_APB3LPENSETR_LPTIM5LPEN)
	#define __HAL_RCC_SAI4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB3LPENSETR = RCC_MP_APB3LPENSETR_SAI4LPEN)
	...
	#define __HAL_RCC_VREF_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB3LPENSETR = RCC_MP_APB3LPENSETR_VREFLPEN)
	#define __HAL_RCC_DTS_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MP_APB3LPENSETR = RCC_MP_APB3LPENSETR_DTSLPEN)

	#define __HAL_RCC_LPTIM2_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_LPTIM2LPEN)
	#define __HAL_RCC_LPTIM3_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_LPTIM3LPEN)
	#define __HAL_RCC_LPTIM4_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_LPTIM4LPEN)
	#define __HAL_RCC_LPTIM5_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_LPTIM5LPEN)
	#define __HAL_RCC_SAI4_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_SAI4LPEN)
	#define __HAL_RCC_SYSCFG_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_SYSCFGLPEN)
	#define __HAL_RCC_VREF_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_VREFLPEN)
	#define __HAL_RCC_DTS_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MP_APB3LPENCLRR = RCC_MP_APB3LPENCLRR_DTSLPEN)
	...
	#define __HAL_RCC_LTDC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB4LPENSETR = RCC_MP_APB4LPENSETR_LTDCLPEN)
	#define __HAL_RCC_DSI_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MP_APB4LPENSETR = RCC_MP_APB4LPENSETR_DSILPEN)
	#define __HAL_RCC_DDRPERFM_CLK_SLEEP_ENABLE()                                              \
		(RCC->MP_APB4LPENSETR = RCC_MP_APB4LPENSETR_DDRPERFMLPEN)
	#define __HAL_RCC_IWDG2APB_CLK_SLEEP_ENABLE()                                              \
		(RCC->MP_APB4LPENSETR = RCC_MP_APB4LPENSETR_IWDG2APBLPEN)
	#define __HAL_RCC_USBPHY_CLK_SLEEP_ENABLE()                                                \
	...
	#define __HAL_RCC_STGENRO_CLK_STOP_ENABLE()                                                \
		(RCC->MP_APB4LPENSETR = RCC_MP_APB4LPENSETR_STGENROSTPEN)

	#define __HAL_RCC_LTDC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_LTDCLPEN)
	#define __HAL_RCC_DSI_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_DSILPEN)
	#define __HAL_RCC_DDRPERFM_CLK_SLEEP_DISABLE()                                             \
		(RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_DDRPERFMLPEN)
	#define __HAL_RCC_IWDG2APB_CLK_SLEEP_DISABLE()                                             \
		(RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_IWDG2APBLPEN)
	#define __HAL_RCC_USBPHY_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_USBPHYLPEN)
	#define __HAL_RCC_STGENRO_CLK_SLEEP_DISABLE()                                              \
		(RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_STGENROLPEN)
	#define __HAL_RCC_STGENRO_CLK_STOP_DISABLE()                                               \
		(RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_STGENROSTPEN)
	...
	#define __HAL_RCC_SPI6_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_SPI6LPEN)
	#define __HAL_RCC_I2C4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_I2C4LPEN)
	#define __HAL_RCC_I2C6_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_I2C6LPEN)
	#define __HAL_RCC_USART1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_USART1LPEN)
	#define __HAL_RCC_RTCAPB_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_RTCAPBLPEN)
	#define __HAL_RCC_TZC1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_TZC1LPEN)
	#define __HAL_RCC_TZC2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_TZC2LPEN)
	#define __HAL_RCC_TZPC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_TZPCLPEN)
	#define __HAL_RCC_BSEC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_BSECLPEN)
	#define __HAL_RCC_STGEN_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_STGENLPEN)

	#define __HAL_RCC_SPI6_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_SPI6LPEN)
	#define __HAL_RCC_I2C4_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_I2C4LPEN)
	#define __HAL_RCC_I2C6_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_I2C6LPEN)
	#define __HAL_RCC_USART1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_USART1LPEN)
	#define __HAL_RCC_RTCAPB_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_RTCAPBLPEN)
	#define __HAL_RCC_TZC1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_TZC1LPEN)
	#define __HAL_RCC_TZC2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_TZC2LPEN)
	#define __HAL_RCC_TZPC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_TZPCLPEN)
	#define __HAL_RCC_BSEC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENSETR_BSECLPEN)
	#define __HAL_RCC_STGEN_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENSETR_STGENLPEN)
	 ...
	 * @note   By default, all peripheral clocks are enabled during CSLEEP mode.
	 */
	#define __HAL_RCC_GPIOZ_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB5LPENSETR = RCC_MP_AHB5LPENSETR_GPIOZLPEN)
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_SLEEP_ENABLE()                                         \
			(RCC->MP_AHB5LPENSETR = RCC_MP_AHB5LPENSETR_CRYP1LPEN)
	#endif
	#define __HAL_RCC_HASH1_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB5LPENSETR = RCC_MP_AHB5LPENSETR_HASH1LPEN)
	#define __HAL_RCC_RNG1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB5LPENSETR = RCC_MP_AHB5LPENSETR_RNG1LPEN)
	...
	#define __HAL_RCC_GPIOZ_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB5LPENCLRR = RCC_MP_AHB5LPENCLRR_GPIOZLPEN)
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_SLEEP_DISABLE()                                        \
			(RCC->MP_AHB5LPENCLRR = RCC_MP_AHB5LPENCLRR_CRYP1LPEN)
	#endif
	#define __HAL_RCC_HASH1_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB5LPENCLRR = RCC_MP_AHB5LPENCLRR_HASH1LPEN)
	#define __HAL_RCC_RNG1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB5LPENCLRR = RCC_MP_AHB5LPENCLRR_RNG1LPEN)
	#define __HAL_RCC_BKPSRAM_CLK_SLEEP_DISABLE()                                              \
		(RCC->MP_AHB5LPENCLRR = RCC_MP_AHB5LPENCLRR_BKPSRAMLPEN)
	 ...
	 * @note   By default, all peripheral clocks are enabled during CSLEEP mode.
	 */
	#define __HAL_RCC_MDMA_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_MDMALPEN)
	#define __HAL_RCC_GPU_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_GPULPEN)
	#define __HAL_RCC_ETH1CK_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_ETHCKLPEN)
	#define __HAL_RCC_ETH1TX_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_ETHTXLPEN)
	#define __HAL_RCC_ETH1RX_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_ETHRXLPEN)
	#define __HAL_RCC_ETH1MAC_CLK_SLEEP_ENABLE()                                               \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_ETHMACLPEN)
	...
	#define __HAL_RCC_SDMMC1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_SDMMC1LPEN)
	#define __HAL_RCC_SDMMC2_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_SDMMC2LPEN)
	#define __HAL_RCC_CRC1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_CRC1LPEN)
	#define __HAL_RCC_USBH_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB6LPENSETR = RCC_MP_AHB6LPENSETR_USBHLPEN)

	#define __HAL_RCC_MDMA_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_MDMALPEN)
	#define __HAL_RCC_GPU_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_GPULPEN)
	#define __HAL_RCC_ETH1CK_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_ETHCKLPEN)
	#define __HAL_RCC_ETH1TX_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_ETHTXLPEN)
	#define __HAL_RCC_ETH1RX_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_ETHRXLPEN)
	#define __HAL_RCC_ETH1MAC_CLK_SLEEP_DISABLE()                                              \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_ETHMACLPEN)
	#define __HAL_RCC_FMC_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_FMCLPEN)
	#define __HAL_RCC_QSPI_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_QSPILPEN)
	#define __HAL_RCC_SDMMC1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_SDMMC1LPEN)
	#define __HAL_RCC_SDMMC2_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_SDMMC2LPEN)
	#define __HAL_RCC_CRC1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB6LPENCLRR = RCC_MP_AHB6LPENCLRR_CRC1LPEN)
	#define __HAL_RCC_USBH_CLK_SLEEP_DISABLE()                                                 \
	...
	#define __HAL_RCC_DMA1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB2LPENSETR = RCC_MP_AHB2LPENSETR_DMA1LPEN)
	#define __HAL_RCC_DMA2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB2LPENSETR = RCC_MP_AHB2LPENSETR_DMA2LPEN)
	#define __HAL_RCC_DMAMUX_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AHB2LPENSETR = RCC_MP_AHB2LPENSETR_DMAMUXLPEN)
	#define __HAL_RCC_ADC12_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB2LPENSETR = RCC_MP_AHB2LPENSETR_ADC12LPEN)
	#define __HAL_RCC_USBO_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB2LPENSETR = RCC_MP_AHB2LPENSETR_USBOLPEN)
	#define __HAL_RCC_SDMMC3_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AHB2LPENSETR = RCC_MP_AHB2LPENSETR_SDMMC3LPEN)

	#define __HAL_RCC_DMA1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB2LPENCLRR = RCC_MP_AHB2LPENCLRR_DMA1LPEN)
	#define __HAL_RCC_DMA2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB2LPENCLRR = RCC_MP_AHB2LPENCLRR_DMA2LPEN)
	#define __HAL_RCC_DMAMUX_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AHB2LPENCLRR = RCC_MP_AHB2LPENCLRR_DMAMUXLPEN)
	#define __HAL_RCC_ADC12_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB2LPENCLRR = RCC_MP_AHB2LPENCLRR_ADC12LPEN)
	#define __HAL_RCC_USBO_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB2LPENCLRR = RCC_MP_AHB2LPENCLRR_USBOLPEN)
	#define __HAL_RCC_SDMMC3_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AHB2LPENCLRR = RCC_MP_AHB2LPENCLRR_SDMMC3LPEN)
	...
	#define __HAL_RCC_DCMI_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB3LPENSETR = RCC_MP_AHB3LPENSETR_DCMILPEN)
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_SLEEP_ENABLE()                                         \
			(RCC->MP_AHB3LPENSETR = RCC_MP_AHB3LPENSETR_CRYP2LPEN)
	#endif
	#define __HAL_RCC_HASH2_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB3LPENSETR = RCC_MP_AHB3LPENSETR_HASH2LPEN)
	#define __HAL_RCC_RNG2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB3LPENSETR = RCC_MP_AHB3LPENSETR_RNG2LPEN)
	#define __HAL_RCC_CRC2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB3LPENSETR = RCC_MP_AHB3LPENSETR_CRC2LPEN)
	#define __HAL_RCC_HSEM_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB3LPENSETR = RCC_MP_AHB3LPENSETR_HSEMLPEN)
	#define __HAL_RCC_IPCC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MP_AHB3LPENSETR = RCC_MP_AHB3LPENSETR_IPCCLPEN)

	#define __HAL_RCC_DCMI_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB3LPENCLRR = RCC_MP_AHB3LPENCLRR_DCMILPEN)
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_SLEEP_DISABLE()                                        \
			(RCC->MP_AHB3LPENCLRR = RCC_MP_AHB3LPENCLRR_CRYP2LPEN)
	#endif
	#define __HAL_RCC_HASH2_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB3LPENCLRR = RCC_MP_AHB3LPENCLRR_HASH2LPEN)
	#define __HAL_RCC_RNG2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB3LPENCLRR = RCC_MP_AHB3LPENCLRR_RNG2LPEN)
	#define __HAL_RCC_CRC2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB3LPENCLRR = RCC_MP_AHB3LPENCLRR_CRC2LPEN)
	#define __HAL_RCC_HSEM_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB3LPENCLRR = RCC_MP_AHB3LPENCLRR_HSEMLPEN)
	#define __HAL_RCC_IPCC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MP_AHB3LPENCLRR = RCC_MP_AHB3LPENCLRR_IPCCLPEN)
	...
	#define __HAL_RCC_GPIOB_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOBLPEN)
	#define __HAL_RCC_GPIOC_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOCLPEN)
	#define __HAL_RCC_GPIOD_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIODLPEN)
	#define __HAL_RCC_GPIOE_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOELPEN)
	#define __HAL_RCC_GPIOF_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOFLPEN)
	#define __HAL_RCC_GPIOG_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOGLPEN)
	#define __HAL_RCC_GPIOH_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOHLPEN)
	#define __HAL_RCC_GPIOI_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOILPEN)
	#define __HAL_RCC_GPIOJ_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MP_AHB4LPENSETR = RCC_MP_AHB4LPENSETR_GPIOJLPEN)
	...
	#define __HAL_RCC_GPIOA_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOALPEN)
	#define __HAL_RCC_GPIOB_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOBLPEN)
	#define __HAL_RCC_GPIOC_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOCLPEN)
	#define __HAL_RCC_GPIOD_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIODLPEN)
	#define __HAL_RCC_GPIOE_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOELPEN)
	#define __HAL_RCC_GPIOF_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOFLPEN)
	#define __HAL_RCC_GPIOG_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOGLPEN)
	#define __HAL_RCC_GPIOH_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOHLPEN)
	#define __HAL_RCC_GPIOI_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOILPEN)
	...
	#define __HAL_RCC_GPIOK_CLK_SLEEP_DISABLE()                                                \
		(RCC->MP_AHB4LPENCLRR = RCC_MP_AHB4LPENCLRR_GPIOKLPEN)
	 ...
	 * @note   By default, all peripheral clocks are enabled during CSLEEP mode.
	 */
	#define __HAL_RCC_SYSRAM_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_AXIMLPENSETR = RCC_MP_AXIMLPENSETR_SYSRAMLPEN)

	#define __HAL_RCC_SYSRAM_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_AXIMLPENCLRR = RCC_MP_AXIMLPENCLRR_SYSRAMLPEN)
	 ...
	 * @note   By default, all peripheral clocks are enabled during CSLEEP mode.
	 */
	#define __HAL_RCC_RETRAM_CLK_SLEEP_ENABLE()                                                \
		(RCC->MP_MLAHBLPENSETR = RCC_MP_MLAHBLPENSETR_RETRAMLPEN)

	#define __HAL_RCC_RETRAM_CLK_SLEEP_DISABLE()                                               \
		(RCC->MP_MLAHBLPENCLRR = RCC_MP_MLAHBLPENCLRR_RETRAMLPEN)
	...
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_ENABLE()                                               \
			(RCC->MC_AHB5ENSETR = RCC_MC_AHB5ENSETR_CRYP1EN)
	#endif
	...
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_DISABLE()                                              \
			(RCC->MC_AHB5ENCLRR = RCC_MC_AHB5ENCLRR_CRYP1EN)
	#endif
	...
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_ENABLE()                                               \
			(RCC->MC_AHB3ENSETR = RCC_MC_AHB3ENSETR_CRYP2EN)
	#endif
	...
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_DISABLE()                                              \
			(RCC->MC_AHB3ENCLRR = RCC_MC_AHB3ENCLRR_CRYP2EN)
	#endif
	 ...
	 */
	#define __HAL_RCC_TIM2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM2LPEN)
	#define __HAL_RCC_TIM3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM3LPEN)
	#define __HAL_RCC_TIM4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM4LPEN)
	#define __HAL_RCC_TIM5_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM5LPEN)
	#define __HAL_RCC_TIM6_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM6LPEN)
	#define __HAL_RCC_TIM7_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM7LPEN)
	#define __HAL_RCC_TIM12_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM12LPEN)
	#define __HAL_RCC_TIM13_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM13LPEN)
	#define __HAL_RCC_TIM14_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_TIM14LPEN)
	#define __HAL_RCC_LPTIM1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_LPTIM1LPEN)
	#define __HAL_RCC_SPI2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_SPI2LPEN)
	#define __HAL_RCC_SPI3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_SPI3LPEN)
	#define __HAL_RCC_USART2_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_USART2LPEN)
	#define __HAL_RCC_USART3_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_USART3LPEN)
	#define __HAL_RCC_UART4_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_UART4LPEN)
	#define __HAL_RCC_UART5_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_UART5LPEN)
	#define __HAL_RCC_UART7_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_UART7LPEN)
	#define __HAL_RCC_UART8_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_UART8LPEN)
	#define __HAL_RCC_I2C1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_I2C1LPEN)
	#define __HAL_RCC_I2C2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_I2C2LPEN)
	#define __HAL_RCC_I2C3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_I2C3LPEN)
	#define __HAL_RCC_I2C5_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_I2C5LPEN)
	#define __HAL_RCC_SPDIFRX_CLK_SLEEP_ENABLE()                                               \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_SPDIFLPEN)
	#define __HAL_RCC_CEC_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_CECLPEN)
	#define __HAL_RCC_WWDG1_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_WWDG1LPEN)
	#define __HAL_RCC_DAC12_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_DAC12LPEN)
	#define __HAL_RCC_MDIOS_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB1LPENSETR = RCC_MC_APB1LPENSETR_MDIOSLPEN)

	#define __HAL_RCC_TIM2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM2LPEN)
	#define __HAL_RCC_TIM3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM3LPEN)
	#define __HAL_RCC_TIM4_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM4LPEN)
	#define __HAL_RCC_TIM5_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM5LPEN)
	#define __HAL_RCC_TIM6_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM6LPEN)
	#define __HAL_RCC_TIM7_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM7LPEN)
	#define __HAL_RCC_TIM12_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM12LPEN)
	#define __HAL_RCC_TIM13_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM13LPEN)
	#define __HAL_RCC_TIM14_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_TIM14LPEN)
	#define __HAL_RCC_LPTIM1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_LPTIM1LPEN)
	#define __HAL_RCC_SPI2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_SPI2LPEN)
	#define __HAL_RCC_SPI3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_SPI3LPEN)
	#define __HAL_RCC_USART2_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_USART2LPEN)
	#define __HAL_RCC_USART3_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_USART3LPEN)
	#define __HAL_RCC_UART4_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_UART4LPEN)
	#define __HAL_RCC_UART5_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_UART5LPEN)
	#define __HAL_RCC_UART7_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_UART7LPEN)
	#define __HAL_RCC_UART8_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_UART8LPEN)
	#define __HAL_RCC_I2C1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_I2C1LPEN)
	#define __HAL_RCC_I2C2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_I2C2LPEN)
	#define __HAL_RCC_I2C3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_I2C3LPEN)
	#define __HAL_RCC_I2C5_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_I2C5LPEN)
	#define __HAL_RCC_SPDIFRX_CLK_SLEEP_DISABLE()                                              \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_SPDIFLPEN)
	#define __HAL_RCC_CEC_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_CECLPEN)
	#define __HAL_RCC_WWDG1_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_WWDG1LPEN)
	#define __HAL_RCC_DAC12_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_DAC12LPEN)
	#define __HAL_RCC_MDIOS_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB1LPENCLRR = RCC_MC_APB1LPENCLRR_MDIOSLPEN)
	 ...
	 */
	#define __HAL_RCC_TIM1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_TIM1LPEN)
	#define __HAL_RCC_TIM8_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_TIM8LPEN)
	#define __HAL_RCC_TIM15_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_TIM15LPEN)
	#define __HAL_RCC_TIM16_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_TIM16LPEN)
	#define __HAL_RCC_TIM17_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_TIM17LPEN)
	#define __HAL_RCC_SPI1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_SPI1LPEN)
	#define __HAL_RCC_SPI4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_SPI4LPEN)
	#define __HAL_RCC_SPI5_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_SPI5LPEN)
	#define __HAL_RCC_USART6_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_USART6LPEN)
	#define __HAL_RCC_SAI1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_SAI1LPEN)
	#define __HAL_RCC_SAI2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_SAI2LPEN)
	#define __HAL_RCC_SAI3_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_SAI3LPEN)
	#define __HAL_RCC_DFSDM1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_DFSDMLPEN)
	#define __HAL_RCC_ADFSDM1_CLK_SLEEP_ENABLE()                                               \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_ADFSDMLPEN)
	#define __HAL_RCC_FDCAN_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB2LPENSETR = RCC_MC_APB2LPENSETR_FDCANLPEN)

	#define __HAL_RCC_TIM1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_TIM1LPEN)
	#define __HAL_RCC_TIM8_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_TIM8LPEN)
	#define __HAL_RCC_TIM15_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_TIM15LPEN)
	#define __HAL_RCC_TIM16_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_TIM16LPEN)
	#define __HAL_RCC_TIM17_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_TIM17LPEN)
	#define __HAL_RCC_SPI1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_SPI1LPEN)
	#define __HAL_RCC_SPI4_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_SPI4LPEN)
	#define __HAL_RCC_SPI5_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_SPI5LPEN)
	#define __HAL_RCC_USART6_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_USART6LPEN)
	#define __HAL_RCC_SAI1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_SAI1LPEN)
	#define __HAL_RCC_SAI2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_SAI2LPEN)
	#define __HAL_RCC_SAI3_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_SAI3LPEN)
	#define __HAL_RCC_DFSDM1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_DFSDMLPEN)
	#define __HAL_RCC_ADFSDM1_CLK_SLEEP_DISABLE()                                              \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_ADFSDMLPEN)
	#define __HAL_RCC_FDCAN_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB2LPENCLRR = RCC_MC_APB2LPENCLRR_FDCANLPEN)
	 ...
	 */
	#define __HAL_RCC_LPTIM2_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_LPTIM2LPEN)
	#define __HAL_RCC_LPTIM3_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_LPTIM3LPEN)
	#define __HAL_RCC_LPTIM4_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_LPTIM4LPEN)
	#define __HAL_RCC_LPTIM5_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_LPTIM5LPEN)
	#define __HAL_RCC_SAI4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_SAI4LPEN)
	#define __HAL_RCC_SYSCFG_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_SYSCFGLPEN)
	#define __HAL_RCC_VREF_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_VREFLPEN)
	#define __HAL_RCC_DTS_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MC_APB3LPENSETR = RCC_MC_APB3LPENSETR_DTSLPEN)

	#define __HAL_RCC_LPTIM2_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_LPTIM2LPEN)
	#define __HAL_RCC_LPTIM3_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_LPTIM3LPEN)
	#define __HAL_RCC_LPTIM4_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_LPTIM4LPEN)
	#define __HAL_RCC_LPTIM5_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_LPTIM5LPEN)
	#define __HAL_RCC_SAI4_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_SAI4LPEN)
	#define __HAL_RCC_SYSCFG_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_SYSCFGLPEN)
	#define __HAL_RCC_VREF_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_VREFLPEN)
	#define __HAL_RCC_DTS_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MC_APB3LPENCLRR = RCC_MC_APB3LPENCLRR_DTSLPEN)
	 ...
	 */
	#define __HAL_RCC_LTDC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB4LPENSETR = RCC_MC_APB4LPENSETR_LTDCLPEN)
	#define __HAL_RCC_DSI_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MC_APB4LPENSETR = RCC_MC_APB4LPENSETR_DSILPEN)
	#define __HAL_RCC_DDRPERFM_CLK_SLEEP_ENABLE()                                              \
		(RCC->MC_APB4LPENSETR = RCC_MC_APB4LPENSETR_DDRPERFMLPEN)
	#define __HAL_RCC_USBPHY_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB4LPENSETR = RCC_MC_APB4LPENSETR_USBPHYLPEN)
	#define __HAL_RCC_STGENRO_CLK_SLEEP_ENABLE()                                               \
		(RCC->MC_APB4LPENSETR = RCC_MC_APB4LPENSETR_STGENROLPEN)
	#define __HAL_RCC_STGENRO_CLK_STOP_ENABLE()                                                \
		(RCC->MC_APB4LPENSETR = RCC_MC_APB4LPENSETR_STGENROSTPEN)

	#define __HAL_RCC_LTDC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB4LPENCLRR = RCC_MC_APB4LPENCLRR_LTDCLPEN)
	#define __HAL_RCC_DSI_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MC_APB4LPENCLRR = RCC_MC_APB4LPENCLRR_DSILPEN)
	#define __HAL_RCC_DDRPERFM_CLK_SLEEP_DISABLE()                                             \
		(RCC->MC_APB4LPENCLRR = RCC_MC_APB4LPENCLRR_DDRPERFMLPEN)
	#define __HAL_RCC_USBPHY_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB4LPENCLRR = RCC_MC_APB4LPENCLRR_USBPHYLPEN)
	#define __HAL_RCC_STGENRO_CLK_SLEEP_DISABLE()                                              \
		(RCC->MC_APB4LPENCLRR = RCC_MC_APB4LPENCLRR_STGENROLPEN)
	#define __HAL_RCC_STGENRO_CLK_STOP_DISABLE()                                               \
		(RCC->MC_APB4LPENCLRR = RCC_MC_APB4LPENCLRR_STGENROSTPEN)
	 ...
	 */
	#define __HAL_RCC_SPI6_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_SPI6LPEN)
	#define __HAL_RCC_I2C4_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_I2C4LPEN)
	#define __HAL_RCC_I2C6_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_I2C6LPEN)
	#define __HAL_RCC_USART1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_USART1LPEN)
	#define __HAL_RCC_RTCAPB_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_RTCAPBLPEN)
	#define __HAL_RCC_TZC1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_TZC1LPEN)
	#define __HAL_RCC_TZC2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_TZC2LPEN)
	#define __HAL_RCC_TZPC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_TZPCLPEN)
	#define __HAL_RCC_BSEC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_BSECLPEN)
	#define __HAL_RCC_STGEN_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_APB5LPENSETR = RCC_MC_APB5LPENSETR_STGENLPEN)

	#define __HAL_RCC_SPI6_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_SPI6LPEN)
	#define __HAL_RCC_I2C4_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_I2C4LPEN)
	#define __HAL_RCC_I2C6_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_I2C6LPEN)
	#define __HAL_RCC_USART1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_USART1LPEN)
	#define __HAL_RCC_RTCAPB_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_RTCAPBLPEN)
	#define __HAL_RCC_TZC1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_TZC1LPEN)
	#define __HAL_RCC_TZC2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_TZC2LPEN)
	#define __HAL_RCC_TZPC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENCLRR_TZPCLPEN)
	#define __HAL_RCC_BSEC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENSETR_BSECLPEN)
	#define __HAL_RCC_STGEN_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_APB5LPENCLRR = RCC_MC_APB5LPENSETR_STGENLPEN)
	 ...
	 */
	#define __HAL_RCC_GPIOZ_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB5LPENSETR = RCC_MC_AHB5LPENSETR_GPIOZLPEN)
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_SLEEP_ENABLE()                                         \
			(RCC->MC_AHB5LPENSETR = RCC_MC_AHB5LPENSETR_CRYP1LPEN)
	#endif
	#define __HAL_RCC_HASH1_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB5LPENSETR = RCC_MC_AHB5LPENSETR_HASH1LPEN)
	#define __HAL_RCC_RNG1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB5LPENSETR = RCC_MC_AHB5LPENSETR_RNG1LPEN)
	#define __HAL_RCC_BKPSRAM_CLK_SLEEP_ENABLE()                                               \
		(RCC->MC_AHB5LPENSETR = RCC_MC_AHB5LPENSETR_BKPSRAMLPEN)

	#define __HAL_RCC_GPIOZ_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB5LPENCLRR = RCC_MC_AHB5LPENCLRR_GPIOZLPEN)
	#if defined(CRYP1)
		#define __HAL_RCC_CRYP1_CLK_SLEEP_DISABLE()                                        \
			(RCC->MC_AHB5LPENCLRR = RCC_MC_AHB5LPENCLRR_CRYP1LPEN)
	#endif
	#define __HAL_RCC_HASH1_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB5LPENCLRR = RCC_MC_AHB5LPENCLRR_HASH1LPEN)
	#define __HAL_RCC_RNG1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB5LPENCLRR = RCC_MC_AHB5LPENCLRR_RNG1LPEN)
	#define __HAL_RCC_BKPSRAM_CLK_SLEEP_DISABLE()                                              \
		(RCC->MC_AHB5LPENCLRR = RCC_MC_AHB5LPENCLRR_BKPSRAMLPEN)
	 ...
	 */
	#define __HAL_RCC_MDMA_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_MDMALPEN)
	#define __HAL_RCC_GPU_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_GPULPEN)
	#define __HAL_RCC_ETH1CK_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_ETHCKLPEN)
	#define __HAL_RCC_ETH1TX_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_ETHTXLPEN)
	#define __HAL_RCC_ETH1RX_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_ETHRXLPEN)
	#define __HAL_RCC_ETH1MAC_CLK_SLEEP_ENABLE()                                               \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_ETHMACLPEN)
	#define __HAL_RCC_FMC_CLK_SLEEP_ENABLE()                                                   \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_FMCLPEN)
	#define __HAL_RCC_QSPI_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_QSPILPEN)
	#define __HAL_RCC_SDMMC1_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_SDMMC1LPEN)
	#define __HAL_RCC_SDMMC2_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_SDMMC2LPEN)
	#define __HAL_RCC_CRC1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_CRC1LPEN)
	#define __HAL_RCC_USBH_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_USBHLPEN)

	#define __HAL_RCC_MDMA_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_MDMALPEN)
	#define __HAL_RCC_GPU_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_GPULPEN)
	#define __HAL_RCC_ETH1CK_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_ETHCKLPEN)
	#define __HAL_RCC_ETH1TX_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_ETHTXLPEN)
	#define __HAL_RCC_ETH1RX_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_ETHRXLPEN)
	#define __HAL_RCC_ETH1MAC_CLK_SLEEP_DISABLE()                                              \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_ETHMACLPEN)
	#define __HAL_RCC_FMC_CLK_SLEEP_DISABLE()                                                  \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_FMCLPEN)
	#define __HAL_RCC_QSPI_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_QSPILPEN)
	#define __HAL_RCC_SDMMC1_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_SDMMC1LPEN)
	#define __HAL_RCC_SDMMC2_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_SDMMC2LPEN)
	#define __HAL_RCC_CRC1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_CRC1LPEN)
	#define __HAL_RCC_USBH_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB6LPENCLRR = RCC_MC_AHB6LPENCLRR_USBHLPEN)
	 ...
	 */
	#define __HAL_RCC_DMA1_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB2LPENSETR = RCC_MC_AHB2LPENSETR_DMA1LPEN)
	#define __HAL_RCC_DMA2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB2LPENSETR = RCC_MC_AHB2LPENSETR_DMA2LPEN)
	#define __HAL_RCC_DMAMUX_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AHB2LPENSETR = RCC_MC_AHB2LPENSETR_DMAMUXLPEN)
	#define __HAL_RCC_ADC12_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB2LPENSETR = RCC_MC_AHB2LPENSETR_ADC12LPEN)
	#define __HAL_RCC_USBO_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB2LPENSETR = RCC_MC_AHB2LPENSETR_USBOLPEN)
	#define __HAL_RCC_SDMMC3_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AHB2LPENSETR = RCC_MC_AHB2LPENSETR_SDMMC3LPEN)

	#define __HAL_RCC_DMA1_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB2LPENCLRR = RCC_MC_AHB2LPENCLRR_DMA1LPEN)
	#define __HAL_RCC_DMA2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB2LPENCLRR = RCC_MC_AHB2LPENCLRR_DMA2LPEN)
	#define __HAL_RCC_DMAMUX_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AHB2LPENCLRR = RCC_MC_AHB2LPENCLRR_DMAMUXLPEN)
	#define __HAL_RCC_ADC12_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB2LPENCLRR = RCC_MC_AHB2LPENCLRR_ADC12LPEN)
	#define __HAL_RCC_USBO_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB2LPENCLRR = RCC_MC_AHB2LPENCLRR_USBOLPEN)
	#define __HAL_RCC_SDMMC3_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AHB2LPENCLRR = RCC_MC_AHB2LPENCLRR_SDMMC3LPEN)
	 ...
	 */
	#define __HAL_RCC_DCMI_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB3LPENSETR = RCC_MC_AHB3LPENSETR_DCMILPEN)
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_SLEEP_ENABLE()                                         \
			(RCC->MC_AHB3LPENSETR = RCC_MC_AHB3LPENSETR_CRYP2LPEN)
	#endif
	#define __HAL_RCC_HASH2_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB3LPENSETR = RCC_MC_AHB3LPENSETR_HASH2LPEN)
	#define __HAL_RCC_RNG2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB3LPENSETR = RCC_MC_AHB3LPENSETR_RNG2LPEN)
	#define __HAL_RCC_CRC2_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB3LPENSETR = RCC_MC_AHB3LPENSETR_CRC2LPEN)
	#define __HAL_RCC_HSEM_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB3LPENSETR = RCC_MC_AHB3LPENSETR_HSEMLPEN)
	#define __HAL_RCC_IPCC_CLK_SLEEP_ENABLE()                                                  \
		(RCC->MC_AHB3LPENSETR = RCC_MC_AHB3LPENSETR_IPCCLPEN)

	#define __HAL_RCC_DCMI_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB3LPENCLRR = RCC_MC_AHB3LPENCLRR_DCMILPEN)
	#if defined(CRYP2)
		#define __HAL_RCC_CRYP2_CLK_SLEEP_DISABLE()                                        \
			(RCC->MC_AHB3LPENCLRR = RCC_MC_AHB3LPENCLRR_CRYP2LPEN)
	#endif
	#define __HAL_RCC_HASH2_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB3LPENCLRR = RCC_MC_AHB3LPENCLRR_HASH2LPEN)
	#define __HAL_RCC_RNG2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB3LPENCLRR = RCC_MC_AHB3LPENCLRR_RNG2LPEN)
	#define __HAL_RCC_CRC2_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB3LPENCLRR = RCC_MC_AHB3LPENCLRR_CRC2LPEN)
	#define __HAL_RCC_HSEM_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB3LPENCLRR = RCC_MC_AHB3LPENCLRR_HSEMLPEN)
	#define __HAL_RCC_IPCC_CLK_SLEEP_DISABLE()                                                 \
		(RCC->MC_AHB3LPENCLRR = RCC_MC_AHB3LPENCLRR_IPCCLPEN)
	 ...
	 */
	#define __HAL_RCC_GPIOA_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOALPEN)
	#define __HAL_RCC_GPIOB_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOBLPEN)
	#define __HAL_RCC_GPIOC_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOCLPEN)
	#define __HAL_RCC_GPIOD_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIODLPEN)
	#define __HAL_RCC_GPIOE_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOELPEN)
	#define __HAL_RCC_GPIOF_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOFLPEN)
	#define __HAL_RCC_GPIOG_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOGLPEN)
	#define __HAL_RCC_GPIOH_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOHLPEN)
	#define __HAL_RCC_GPIOI_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOILPEN)
	#define __HAL_RCC_GPIOJ_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOJLPEN)
	#define __HAL_RCC_GPIOK_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_AHB4LPENSETR = RCC_MC_AHB4LPENSETR_GPIOKLPEN)

	#define __HAL_RCC_GPIOA_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOALPEN)
	#define __HAL_RCC_GPIOB_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOBLPEN)
	#define __HAL_RCC_GPIOC_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOCLPEN)
	#define __HAL_RCC_GPIOD_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIODLPEN)
	#define __HAL_RCC_GPIOE_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOELPEN)
	#define __HAL_RCC_GPIOF_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOFLPEN)
	#define __HAL_RCC_GPIOG_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOGLPEN)
	#define __HAL_RCC_GPIOH_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOHLPEN)
	#define __HAL_RCC_GPIOI_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOILPEN)
	#define __HAL_RCC_GPIOJ_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOJLPEN)
	#define __HAL_RCC_GPIOK_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_AHB4LPENCLRR = RCC_MC_AHB4LPENCLRR_GPIOKLPEN)
	 ...
	 */
	#define __HAL_RCC_SYSRAM_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_AXIMLPENSETR = RCC_MC_AXIMLPENSETR_SYSRAMLPEN)

	#define __HAL_RCC_SYSRAM_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_AXIMLPENCLRR = RCC_MC_AXIMLPENCLRR_SYSRAMLPEN)
	 ...
	 */
	#define __HAL_RCC_RETRAM_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_MLAHBLPENSETR = RCC_MC_MLAHBLPENSETR_RETRAMLPEN)
	#define __HAL_RCC_SRAM1_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_MLAHBLPENSETR = RCC_MC_MLAHBLPENSETR_SRAM1LPEN)
	#define __HAL_RCC_SRAM2_CLK_SLEEP_ENABLE()                                                 \
		(RCC->MC_MLAHBLPENSETR = RCC_MC_MLAHBLPENSETR_SRAM2LPEN)
	#define __HAL_RCC_SRAM34_CLK_SLEEP_ENABLE()                                                \
		(RCC->MC_MLAHBLPENSETR = RCC_MC_MLAHBLPENSETR_SRAM34LPEN)

	#define __HAL_RCC_RETRAM_CLK_SLEEP_DISABLE()                                               \
		(RCC->MC_MLAHBLPENCLRR = RCC_MC_MLAHBLPENCLRR_RETRAMLPEN)
	#define __HAL_RCC_SRAM1_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_MLAHBLPENCLRR = RCC_MC_MLAHBLPENCLRR_SRAM1LPEN)
	#define __HAL_RCC_SRAM2_CLK_SLEEP_DISABLE()                                                \
		(RCC->MC_MLAHBLPENCLRR = RCC_MC_MLAHBLPENCLRR_SRAM2LPEN)
	#define __HAL_RCC_SRAM34_CLK_SLEEP_DISABLE()                                               \
	 ...
	 *         power consumption.
	 * @note   It is possible to control the gating of clocks coming from PADs ETH_RX_CLK and
	 * ETH_TX_CLK in CSTOP and STOP modes via the ETHSTPEN bit
	 */
	#define __HAL_RCC_ETH1CK_CLK_STOP_ENABLE()                                                 \
		(RCC->MC_AHB6LPENSETR = RCC_MC_AHB6LPENSETR_ETHSTPEN)

	#define __HAL_RCC_ETH1CK_CLK_STOP_DISABLE()                                                \
		(RCC->MC_AHB6LPENSETR) = (RCC_MC_AHB6LPENCLRR_ETHSTPEN)
...
#define IS_HSE_IN_USE()                                                                            \
	((((__HAL_RCC_GET_MPU_SOURCE() == RCC_MPUSOURCE_HSE) &&                                    \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_MPUSRCRDY)) ||                                              \
	  ((__HAL_RCC_GET_AXIS_SOURCE() == RCC_AXISSOURCE_HSE) &&                                  \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_AXISSRCRDY)) ||                                             \
	  ((__HAL_RCC_GET_MCU_SOURCE() == RCC_MCUSSOURCE_HSE) &&                                   \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_MCUSSRCRDY)) ||                                             \
                                                                                                   \
	  ((__HAL_RCC_GET_PLL12_SOURCE() == RCC_PLL12SOURCE_HSE) &&                                \
	   (__HAL_RCC_GET_FLAG(RCC_FLAG_PLL1RDY) || __HAL_RCC_GET_FLAG(RCC_FLAG_PLL2RDY))) ||      \
                                                                                                   \
	  ((__HAL_RCC_GET_PLL3_SOURCE() == RCC_PLL3SOURCE_HSE) &&                                  \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_PLL3RDY)) ||                                                \
                                                                                                   \
	  ((__HAL_RCC_GET_PLL4_SOURCE() == RCC_PLL4SOURCE_HSE) &&                                  \
...
#define IS_HSI_IN_USE()                                                                            \
	((((__HAL_RCC_GET_MPU_SOURCE() == RCC_MPUSOURCE_HSI) &&                                    \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_MPUSRCRDY)) ||                                              \
	  ((__HAL_RCC_GET_AXIS_SOURCE() == RCC_AXISSOURCE_HSI) &&                                  \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_AXISSRCRDY)) ||                                             \
	  ((__HAL_RCC_GET_MCU_SOURCE() == RCC_MCUSSOURCE_HSI) &&                                   \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_MCUSSRCRDY)) ||                                             \
                                                                                                   \
...
#define IS_CSI_IN_USE()                                                                            \
	((((__HAL_RCC_GET_PLL3_SOURCE() == RCC_PLL3SOURCE_CSI) &&                                  \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_PLL3RDY)) ||                                                \
	  ((__HAL_RCC_GET_MCU_SOURCE() == RCC_MCUSSOURCE_CSI) &&                                   \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_MCUSSRCRDY)) ||                                             \
                                                                                                   \
	  ((__HAL_RCC_GET_PLL4_SOURCE() == RCC_PLL4SOURCE_CSI) &&                                  \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_PLL4RDY)))                                                  \
		 ? 1                                                                               \
		 : 0)

/** @brief Macros to test if PLLx are used on the Core and buses clock generation system (MPU, MCU
 * or AXIS blocks)
...
#define __IS_PLL1_IN_USE()                                                                         \
	((((__HAL_RCC_GET_MPU_SOURCE() == RCC_MPUSOURCE_PLL1) &&                                   \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_MPUSRCRDY)) ||                                              \
	  ((__HAL_RCC_GET_MPU_SOURCE() == RCC_MPUSOURCE_MPUDIV) &&                                 \
	   __HAL_RCC_GET_FLAG(RCC_FLAG_MPUSRCRDY)))                                                \
		 ? 1                                                                               \
		 : 0)

#define __IS_PLL2_IN_USE()                                                                         \
	(((__HAL_RCC_GET_AXIS_SOURCE() == RCC_AXISSOURCE_PLL2) &&                                  \
	  __HAL_RCC_GET_FLAG(RCC_FLAG_AXISSRCRDY))                                                 \
		 ? 1                                                                               \
		 : 0)

#define __IS_PLL3_IN_USE()                                                                         \
	(((__HAL_RCC_GET_MCU_SOURCE() == RCC_MCUSSOURCE_PLL3) &&                                   \
	  __HAL_RCC_GET_FLAG(RCC_FLAG_MCUSSRCRDY))                                                 \
		 ? 1                                                                               \
		 : 0)
...
#define __HAL_RCC_HSI_DIV(__RCC_HSIDIV__)                                                          \
	do {                                                                                       \
		MODIFY_REG(RCC->HSICFGR, RCC_HSICFGR_HSIDIV, (__RCC_HSIDIV__));                    \
	} while (0)
...
#define __HAL_RCC_MRD_CONFIG(__DURATION__)                                                         \
	do {                                                                                       \
		MODIFY_REG(RCC->RDLSICR, RCC_RDLSICR_MRD,                                          \
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LSEDRIVE_LOW: LSE oscillator low drive capability (default after backup
 * domain reset)
 ...
 *         of the following:
 *             - RCC_LSEDRIVE_LOW: LSE oscillator low drive capability (default after backup domain
 * reset)
 ...
 * @note   Enabling/disabling  Those Clocks outputs can be disabled anytime  without the need to
 * stop the PLL, with the exception of ck_pll_p  cannot be stopped if used as MPU Clock
...
#define __HAL_RCC_PLL1CLKOUT_ENABLE(__RCC_PLL1ClockOut__)                                          \
	SET_BIT(RCC->PLL1CR, (__RCC_PLL1ClockOut__))

#define __HAL_RCC_PLL1CLKOUT_DISABLE(__RCC_PLL1ClockOut__)                                         \
	CLEAR_BIT(RCC->PLL1CR, (__RCC_PLL1ClockOut__))

/**
 * @brief  Enables or disables Fractional Part Of The Multiplication Factor of PLL1 VCO
 * @note   Enabling/disabling  Fractional Part can be done anytime  without the need to stop the
 * PLL1
 * @retval None
 */
...
#define __HAL_RCC_PLL12_SOURCE(__RCC_PLL12SOURCE__)                                                \
	do {                                                                                       \
		MODIFY_REG(RCC->RCK12SELR, RCC_RCK12SELR_PLL12SRC, (__RCC_PLL12SOURCE__));         \
	} while (0)
...
#define __HAL_RCC_PLL1_CONFIG(__PLLM1__, __PLLN1__, __PLLP1__, __PLLQ1__, __PLLR1__)               \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL1CFGR1, (RCC_PLL1CFGR1_DIVN | RCC_PLL1CFGR1_DIVM1),             \
			   (((__PLLN1__)-1U) | (((__PLLM1__)-1U) << 16U)));                        \
		MODIFY_REG(RCC->PLL1CFGR2,                                                         \
			   (RCC_PLL1CFGR2_DIVP | RCC_PLL1CFGR2_DIVQ | RCC_PLL1CFGR2_DIVR),         \
			   (((__PLLP1__)-1U) | (((__PLLQ1__)-1U) << 8U) |                          \
			    (((__PLLR1__)-1U) << 16U)));                                           \
	} while (0)
...
/** @brief  Macro to config the PLL1 Clock Spreading Generator
  ...
  * @retval None
  */
#define __HAL_RCC_PLL1CSGCONFIG(__RCC_PLL1_MOD_PER__, __RCC_PLL1_TPDFN_DIS__,                      \
				__RCC_PLL1_RPDFN_DIS__, __RCC_PLL1_SSCG_MODE__,                    \
				__RCC_PLL1_INC_STEP__)                                             \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL1CSGR,                                                          \
			   (RCC_PLL1CSGR_MOD_PER | RCC_PLL1CSGR_TPDFN_DIS |                        \
			    RCC_PLL1CSGR_RPDFN_DIS | RCC_PLL1CSGR_SSCG_MODE |                      \
			    RCC_PLL1CSGR_INC_STEP),                                                \
			   ((__RCC_PLL1_MOD_PER__) | (__RCC_PLL1_TPDFN_DIS__) |                    \
			    (__RCC_PLL1_RPDFN_DIS__) | (__RCC_PLL1_SSCG_MODE__) |                  \
			    ((__RCC_PLL1_INC_STEP__) << RCC_PLL1CSGR_INC_STEP_Pos)));              \
	} while (0)
...
#define __HAL_RCC_PLL2CLKOUT_ENABLE(__RCC_PLL2ClockOut__)                                          \
	SET_BIT(RCC->PLL2CR, (__RCC_PLL2ClockOut__))

#define __HAL_RCC_PLL2CLKOUT_DISABLE(__RCC_PLL2ClockOut__)                                         \
	CLEAR_BIT(RCC->PLL2CR, (__RCC_PLL2ClockOut__))
...
#define __HAL_RCC_PLL2_CONFIG(__PLLM2__, __PLLN2__, __PLLP2__, __PLLQ2__, __PLLR2__)               \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL2CFGR1, (RCC_PLL2CFGR1_DIVN | RCC_PLL2CFGR1_DIVM2),             \
			   (((__PLLN2__)-1U) | (((__PLLM2__)-1U) << 16U)));                        \
		MODIFY_REG(RCC->PLL2CFGR2,                                                         \
			   (RCC_PLL2CFGR2_DIVP | RCC_PLL2CFGR2_DIVQ | RCC_PLL2CFGR2_DIVR),         \
			   (((__PLLP2__)-1U) | (((__PLLQ2__)-1U) << 8U) |                          \
			    (((__PLLR2__)-1U) << 16U)));                                           \
	} while (0)
...
/** @brief  Macro to config the PLL2 Clock Spreading Generator
  ...
  * @retval None
  */
#define __HAL_RCC_PLL2CSGCONFIG(__RCC_PLL2_MOD_PER__, __RCC_PLL2_TPDFN_DIS__,                      \
				__RCC_PLL2_RPDFN_DIS__, __RCC_PLL2_SSCG_MODE__,                    \
				__RCC_PLL2_INC_STEP__)                                             \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL2CSGR,                                                          \
			   (RCC_PLL2CSGR_MOD_PER | RCC_PLL2CSGR_TPDFN_DIS |                        \
			    RCC_PLL2CSGR_RPDFN_DIS | RCC_PLL2CSGR_SSCG_MODE |                      \
			    RCC_PLL2CSGR_INC_STEP),                                                \
			   ((__RCC_PLL2_MOD_PER__) | (__RCC_PLL2_TPDFN_DIS__) |                    \
			    (__RCC_PLL2_RPDFN_DIS__) | (__RCC_PLL2_SSCG_MODE__) |                  \
			    ((__RCC_PLL2_INC_STEP__) << RCC_PLL2CSGR_INC_STEP_Pos)));              \
	} while (0)
...
#define __HAL_RCC_PLL3CLKOUT_ENABLE(__RCC_PLL3ClockOut__)                                          \
	SET_BIT(RCC->PLL3CR, (__RCC_PLL3ClockOut__))

#define __HAL_RCC_PLL3CLKOUT_DISABLE(__RCC_PLL3ClockOut__)                                         \
	CLEAR_BIT(RCC->PLL3CR, (__RCC_PLL3ClockOut__))
...
/** @brief  Macro to config the PLL3 Clock Spreading Generator
  ...
  * @retval None
  */
#define __HAL_RCC_PLL3CSGCONFIG(__RCC_PLL3_MOD_PER__, __RCC_PLL3_TPDFN_DIS__,                      \
				__RCC_PLL3_RPDFN_DIS__, __RCC_PLL3_SSCG_MODE__,                    \
				__RCC_PLL3_INC_STEP__)                                             \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL3CSGR,                                                          \
			   (RCC_PLL3CSGR_MOD_PER | RCC_PLL3CSGR_TPDFN_DIS |                        \
			    RCC_PLL3CSGR_RPDFN_DIS | RCC_PLL3CSGR_SSCG_MODE |                      \
			    RCC_PLL3CSGR_INC_STEP),                                                \
			   ((__RCC_PLL3_MOD_PER__) | (__RCC_PLL3_TPDFN_DIS__) |                    \
			    (__RCC_PLL3_RPDFN_DIS__) | (__RCC_PLL3_SSCG_MODE__) |                  \
			    ((__RCC_PLL3_INC_STEP__) << RCC_PLL3CSGR_INC_STEP_Pos)));              \
	} while (0)
...
#define __HAL_RCC_PLL3_SOURCE(__RCC_PLL3SOURCE__)                                                  \
	do {                                                                                       \
		MODIFY_REG(RCC->RCK3SELR, RCC_RCK3SELR_PLL3SRC, (__RCC_PLL3SOURCE__));             \
	} while (0)
...
#define __HAL_RCC_PLL3_CONFIG(__PLLM3__, __PLLN3__, __PLLP3__, __PLLQ3__, __PLLR3__)               \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL3CFGR1, (RCC_PLL3CFGR1_DIVN | RCC_PLL3CFGR1_DIVM3),             \
			   (((__PLLN3__)-1U) | (((__PLLM3__)-1U) << 16U)));                        \
		MODIFY_REG(RCC->PLL3CFGR2,                                                         \
			   (RCC_PLL3CFGR2_DIVP | RCC_PLL3CFGR2_DIVQ | RCC_PLL3CFGR2_DIVR),         \
			   (((__PLLP3__)-1U) | (((__PLLQ3__)-1U) << 8U) |                          \
			    (((__PLLR3__)-1U) << 16U)));                                           \
	} while (0)
 ...
 * @retval None
 */
#define __HAL_RCC_PLL4CLKOUT_ENABLE(__RCC_PLL4ClockOut__)                                          \
	SET_BIT(RCC->PLL4CR, (__RCC_PLL4ClockOut__))

#define __HAL_RCC_PLL4CLKOUT_DISABLE(__RCC_PLL4ClockOut__)                                         \
	CLEAR_BIT(RCC->PLL4CR, (__RCC_PLL4ClockOut__))
...
/** @brief  Macro to config the PLL4 Clock Spreading Generator
  ...
  * @retval None
  */
#define __HAL_RCC_PLL4CSGCONFIG(__RCC_PLL4_MOD_PER__, __RCC_PLL4_TPDFN_DIS__,                      \
				__RCC_PLL4_RPDFN_DIS__, __RCC_PLL4_SSCG_MODE__,                    \
				__RCC_PLL4_INC_STEP__)                                             \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL4CSGR,                                                          \
			   (RCC_PLL4CSGR_MOD_PER | RCC_PLL4CSGR_TPDFN_DIS |                        \
			    RCC_PLL4CSGR_RPDFN_DIS | RCC_PLL4CSGR_SSCG_MODE |                      \
			    RCC_PLL4CSGR_INC_STEP),                                                \
			   ((__RCC_PLL4_MOD_PER__) | (__RCC_PLL4_TPDFN_DIS__) |                    \
			    (__RCC_PLL4_RPDFN_DIS__) | (__RCC_PLL4_SSCG_MODE__) |                  \
			    ((__RCC_PLL4_INC_STEP__) << RCC_PLL4CSGR_INC_STEP_Pos)));              \
	} while (0)
...
#define __HAL_RCC_PLL4_SOURCE(__RCC_PLL4SOURCE__)                                                  \
	do {                                                                                       \
		MODIFY_REG(RCC->RCK4SELR, RCC_RCK4SELR_PLL4SRC, (__RCC_PLL4SOURCE__));             \
	} while (0)
...
#define __HAL_RCC_PLL4_CONFIG(__PLLM4__, __PLLN4__, __PLLP4__, __PLLQ4__, __PLLR4__)               \
	do {                                                                                       \
		MODIFY_REG(RCC->PLL4CFGR1, (RCC_PLL4CFGR1_DIVN | RCC_PLL4CFGR1_DIVM4),             \
			   (((__PLLN4__)-1U) | (((__PLLM4__)-1U) << 16U)));                        \
		MODIFY_REG(RCC->PLL4CFGR2,                                                         \
			   (RCC_PLL4CFGR2_DIVP | RCC_PLL4CFGR2_DIVQ | RCC_PLL4CFGR2_DIVR),         \
			   (((__PLLP4__)-1U) | (((__PLLQ4__)-1U) << 8U) |                          \
			    (((__PLLR4__)-1U) << 16U)));                                           \
	} while (0)
...
#define __HAL_RCC_MCO1_CONFIGURE(__RCC_MCO1SOURCE__, __RCC_MCO1PRESCALER__)                        \
	do {                                                                                       \
		MODIFY_REG(RCC->MCO1CFGR, (RCC_MCO1CFGR_MCO1SEL | RCC_MCO1CFGR_MCO1DIV),           \
...
#define __HAL_RCC_MCO2_CONFIGURE(__RCC_MCO2SOURCE__, __RCC_MCO2PRESCALER__)                        \
	do {                                                                                       \
		MODIFY_REG(RCC->MCO2CFGR, (RCC_MCO2CFGR_MCO2SEL | RCC_MCO2CFGR_MCO2DIV),           \
...
#define __HAL_RCC_MPU_SOURCE(__RCC_MPUSOURCE__)                                                    \
	do {                                                                                       \
		MODIFY_REG(RCC->MPCKSELR, RCC_MPCKSELR_MPUSRC, (__RCC_MPUSOURCE__));               \
	} while (0)
...
#define __HAL_RCC_AXISS_SOURCE(__RCC_AXISSOURCE__)                                                 \
	do {                                                                                       \
		MODIFY_REG(RCC->ASSCKSELR, RCC_ASSCKSELR_AXISSRC, (__RCC_AXISSOURCE__));           \
	} while (0)
...
#define __HAL_RCC_MCU_SOURCE(__RCC_MCUSSOURCE__)                                                   \
	do {                                                                                       \
		MODIFY_REG(RCC->MSSCKSELR, RCC_MSSCKSELR_MCUSSRC, (__RCC_MCUSSOURCE__));           \
	} while (0)
 ...
 * @note   If TZEN = 1, this parameter can only be modified in secure mode
 * @note   Caution: The software has to set these bits correctly to ensure that the clock supplied
 * to the RTC is lower than 4 MHz.
...
#define __HAL_RCC_RTC_HSEDIV(__HSEDIV__)                                                           \
	do {                                                                                       \
		MODIFY_REG(RCC->RTCDIVR, RCC_RTCDIVR_RTCDIV, ((__HSEDIV__)-1U));                   \
	} while (0)

/** @brief  Macro to get the HSE division factor for RTC clock.
 * @retval The HSE division factor for RTC clock. The returned value can be a number between 1 and
 * 64 Eg.: 1:  HSE (default after reset) 2:  HSE/2 64: HSE/64
 */
 ...
 * @note   If TZEN = 1, this parameter can only be modified in secure mode.
 * @note   It is possible to change this division ratio on-the-fly. It impacts only the frequency of
 * MPU clock.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16 ck_mpuss cycles after
 * MPUDIV update.
 * @note   The application can check if the new division factor is taken into account by reading
 * back the MPUDIVRDY flag
 *
...
#define __HAL_RCC_MPU_DIV(__RCC_MPUDIV__)                                                          \
	do {                                                                                       \
		MODIFY_REG(RCC->MPCKDIVR, RCC_MPCKDIVR_MPUDIV, (__RCC_MPUDIV__));                  \
	} while (0)
 ...
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16 ck_axiss cycles after
 * AXIDIV update.
 * @note   The application can check if the new division factor is taken into account by reading
 * back the AXIDIVRDY flag
 *
...
#define __HAL_RCC_AXI_DIV(__RCC_AXIDIV__)                                                          \
	do {                                                                                       \
		MODIFY_REG(RCC->AXIDIVR, RCC_AXIDIVR_AXIDIV, (__RCC_AXIDIV__));                    \
	} while (0)
 ...
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16 ck_aclk cycles after
 * APB4DIV update.
 * @note   The application can check if the new division factor is taken into account by reading
 * back the APB4DIVRDY flag
 *
...
#define __HAL_RCC_APB4_DIV(__RCC_APB4DIV__)                                                        \
	do {                                                                                       \
		MODIFY_REG(RCC->APB4DIVR, RCC_APB4DIVR_APB4DIV, (__RCC_APB4DIV__));                \
	} while (0)
...
#define __HAL_RCC_APB5_DIV(__RCC_APB5DIV__)                                                        \
	do {                                                                                       \
		MODIFY_REG(RCC->APB5DIVR, RCC_APB5DIVR_APB5DIV, (__RCC_APB5DIV__));                \
	} while (0)
 ...
 * @note   If TZEN = 1, this parameter can only be modified in secure mode.
 * @note   Changing this division ratio has an impact on the frequency of MCU clock, and all bus
 * matrix clocks.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16 ck_mcuss cycles after
 * MCUDIV update.
 * @note   The application can check if the new division factor is taken into account by reading
 * back the MCUDIVRDY flag
 *
...
#define __HAL_RCC_MCU_DIV(__RCC_MCUDIV__)                                                          \
	do {                                                                                       \
		MODIFY_REG(RCC->MCUDIVR, RCC_MCUDIVR_MCUDIV, (__RCC_MCUDIV__));                    \
	} while (0)
 ...
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16 ck_hclk cycles after
 * APB1DIV update.
 * @note   The application can check if the new division factor is taken into account by reading
 * back the APB1DIVRDY flag
 *
...
#define __HAL_RCC_APB1_DIV(__RCC_APB1DIV__)                                                        \
	do {                                                                                       \
		MODIFY_REG(RCC->APB1DIVR, RCC_APB1DIVR_APB1DIV, (__RCC_APB1DIV__));                \
	} while (0)
...
#define __HAL_RCC_APB2_DIV(__RCC_APB2DIV__)                                                        \
	do {                                                                                       \
		MODIFY_REG(RCC->APB2DIVR, RCC_APB2DIVR_APB2DIV, (__RCC_APB2DIV__));                \
	} while (0)
...
#define __HAL_RCC_APB3_DIV(__RCC_APB3DIV__)                                                        \
	do {                                                                                       \
		MODIFY_REG(RCC->APB3DIVR, RCC_APB3DIVR_APB3DIV, (__RCC_APB3DIV__));                \
	} while (0)
 ...
 */
	...
	#define __HAL_RCC_GET_IT(__INTERRUPT__)                                                    \
		((RCC->MC_CIFR & (__INTERRUPT__)) == (__INTERRUPT__))
#endif /* CORE_CM4 */
#ifdef CORE_CA7
	#define __HAL_RCC_GET_IT(__INTERRUPT__)                                                    \
		((RCC->MP_CIFR & (__INTERRUPT__)) == (__INTERRUPT__))
#endif /* CORE_CA7 */
/**
 * @}
 */
