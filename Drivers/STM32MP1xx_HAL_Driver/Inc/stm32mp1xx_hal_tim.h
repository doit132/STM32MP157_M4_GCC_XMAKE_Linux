...
typedef struct {
	...
	uint32_t Break2Filter;	   /*!< TIM break2 input filter.
					This parameter can be a number between Min_Data = 0x0 and
				      Max_Data = 0xF */
	uint32_t
		Break2AFMode; /*!< Specifies the alternate function mode of the break2 input.
...
#define TIM_DMABURSTLENGTH_10TRANSFERS                                                             \
	0x00000900U /*!< The transfer is done to 10 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_11TRANSFERS                                                             \
	0x00000A00U /*!< The transfer is done to 11 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_12TRANSFERS                                                             \
	0x00000B00U /*!< The transfer is done to 12 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_13TRANSFERS                                                             \
	0x00000C00U /*!< The transfer is done to 13 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_14TRANSFERS                                                             \
	0x00000D00U /*!< The transfer is done to 14 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_15TRANSFERS                                                             \
	0x00000E00U /*!< The transfer is done to 15 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_16TRANSFERS                                                             \
	0x00000F00U /*!< The transfer is done to 16 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_17TRANSFERS                                                             \
	0x00001000U /*!< The transfer is done to 17 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_18TRANSFERS                                                             \
	0x00001100U /*!< The transfer is done to 18 registers starting trom TIMx_CR1 +             \
		       TIMx_DCR.DBA */
/**
 * @}
 */
...
#define TIM_BREAK_SYSTEM_PVD                                                                       \
	SYSCFG_CBR_PVDL /*!< Enables and locks the PVD connection with TIM1/8/15/16/17 Break Input \
			   and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_LOCKUP                                                                    \
	SYSCFG_CBR_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of    \
			  TIM1/8/15/16/17 */
/**
 * @}
 */
...
#define IS_TIM_DMA_BASE(__BASE__)                                                                  \
	(((__BASE__) == TIM_DMABASE_CR1) || ((__BASE__) == TIM_DMABASE_CR2) ||                     \
	 ...
	 ((__BASE__) == TIM_DMABASE_CCR6) || ((__BASE__) == TIM_DMABASE_TISEL))
...
#define IS_TIM_BREAK_SYSTEM(__CONFIG__)                                                            \
	(((__CONFIG__) == TIM_BREAK_SYSTEM_PVD) || ((__CONFIG__) == TIM_BREAK_SYSTEM_LOCKUP))
...
/* Non-Blocking mode: DMA */
HAL_StatusTypeDef HAL_TIM_PWM_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, uint32_t *pData,
					uint16_t Length);
