...
typedef struct {
	uint32_t DAC_SampleTime; /*!< Specifies the Sample time for the selected channel.
				    ...
				    DAC_SAMPLEANDHOLD_ENABLE. This parameter must be a number
				    between Min_Data = 0 and Max_Data = 1023 */

	uint32_t DAC_HoldTime; /*!< Specifies the hold time for the selected channel
				    This parameter applies when DAC_SampleAndHold is
				  DAC_SAMPLEANDHOLD_ENABLE. This parameter must be a number between
...
typedef struct {
	...
	uint32_t DAC_ConnectOnChipPeripheral; /*!< Specifies whether the DAC output is connected or
						 not to on chip peripheral . This parameter can be a
						 value of @ref DAC_ConnectOnChipPeripheral */
...
#define DAC_TRIGGER_NONE                                                                           \
	((uint32_t)0x00000000) /*!< Conversion is automatic once the DAC_DHRxxxx register has been \
				  loaded, and not by external trigger */
#define DAC_TRIGGER_SOFTWARE                                                                       \
	((uint32_t)(DAC_CR_TEN1)) /*!< Conversion started by software trigger for DAC channel */
#define DAC_TRIGGER_T1_TRGO                                                                        \
	((uint32_t)(DAC_CR_TSEL1_0 | DAC_CR_TEN1)) /*!< TIM1 TRGO selected as external conversion  \
						      trigger for DAC channel */
#define DAC_TRIGGER_T2_TRGO                                                                        \
	((uint32_t)(DAC_CR_TSEL1_1 | DAC_CR_TEN1)) /*!< TIM2 TRGO selected as external conversion  \
						      trigger for DAC channel */
#define DAC_TRIGGER_T4_TRGO                                                                        \
	((uint32_t)(DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                                              \
		    DAC_CR_TEN1)) /*!< TIM4 TRGO selected as external conversion trigger for DAC   \
				     channel */
#define DAC_TRIGGER_T5_TRGO                                                                        \
	((uint32_t)(DAC_CR_TSEL1_2 | DAC_CR_TEN1)) /*!< TIM5 TRGO selected as external conversion  \
						      trigger for DAC channel */
#define DAC_TRIGGER_T6_TRGO                                                                        \
	((uint32_t)(DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 |                                              \
		    DAC_CR_TEN1)) /*!< TIM6 TRGO selected as external conversion trigger for DAC   \
				     channel */
#define DAC_TRIGGER_T7_TRGO                                                                        \
	((uint32_t)(DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 |                                              \
		    DAC_CR_TEN1)) /*!< TIM7 TRGO selected as external conversion trigger for DAC   \
				     channel */
#define DAC_TRIGGER_T8_TRGO                                                                        \
	((uint32_t)(DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                             \
		    DAC_CR_TEN1)) /*!< TIM8 TRGO selected as external conversion trigger for DAC   \
				     channel */
#define DAC_TRIGGER_T15_TRGO                                                                       \
	((uint32_t)(DAC_CR_TSEL1_3 | DAC_CR_TEN1)) /*!< TIM15 TRGO selected as external conversion \
						      trigger for DAC channel */
#define DAC_TRIGGER_LP1_OUT                                                                        \
	((uint32_t)(DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                             \
		    DAC_CR_TEN1)) /*!< LP1 OUT TRGO selected as external conversion trigger for    \
				     DAC channel */
#define DAC_TRIGGER_LP2_OUT                                                                        \
	((uint32_t)(DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 |                                              \
		    DAC_CR_TEN1)) /*!< LP2 OUT TRGO selected as external conversion trigger for    \
				     DAC channel */
#define DAC_TRIGGER_EXT_IT9                                                                        \
	((uint32_t)(DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 |                             \
		    DAC_CR_TEN1)) /*!< EXTI Line9 event selected as external conversion trigger    \
				     for DAC channel */
/**
 * @}
 */
 ...
 * @{
 */
#define DAC_HIGH_FREQUENCY_INTERFACE_MODE_DISABLE                                                  \
	((uint32_t)0x00000000) /*!< High frequency interface mode disabled */
#define DAC_HIGH_FREQUENCY_INTERFACE_MODE_ABOVE_80MHZ                                              \
	((uint32_t)DAC_CR_HFSEL) /*!< High frequency interface mode enabled */
#define DAC_HIGH_FREQUENCY_INTERFACE_MODE_AUTOMATIC                                                \
	((uint32_t)0x00000002) /*!< High frequency interface mode automatic */
...
HAL_StatusTypeDef HAL_DAC_Start_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t *pData,
				    uint32_t Length, uint32_t Alignment);
HAL_StatusTypeDef HAL_DAC_Stop_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel);

void HAL_DAC_IRQHandler(DAC_HandleTypeDef *hdac);
HAL_StatusTypeDef HAL_DAC_SetValue(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Alignment,
				   uint32_t Data);
