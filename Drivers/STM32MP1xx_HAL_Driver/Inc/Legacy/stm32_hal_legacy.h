...
#define COMP_EXTI_LINE_COMP7_EVENT COMP_EXTI_LINE_COMP7
	...
	#define COMP_LPTIMCONNECTION_ENABLED                                                       \
		((uint32_t)0x00000003U) /*!< COMPX output generic naming: connected to LPTIM input \
					   1 for COMP1, LPTIM input 2 for COMP2 */
#endif
...
#define HAL_CRC_Input_Data_Reverse                                                                 \
	HAL_CRCEx_Input_Data_Reverse /*!< Aliased to HAL_CRCEx_Input_Data_Reverse for inter STM32  \
					series compatibility  */
#define HAL_CRC_Output_Data_Reverse                                                                \
	HAL_CRCEx_Output_Data_Reverse /*!< Aliased to HAL_CRCEx_Output_Data_Reverse for inter      \
...
#define RCC_MCOSOURCE_PLLCLK_DIV2  RCC_MCO1SOURCE_PLLCLK_DIV2
	...
	defined(STM32L5) || defined(STM32WL)
