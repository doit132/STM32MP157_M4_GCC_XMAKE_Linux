 ...
 */
	...
	defined(TIM6) || defined(TIM7) || defined(TIM8) ||                                         \
	defined(TIM12) | defined(TIM13) | defined(TIM14) | defined(TIM15) || defined(TIM16) ||     \
	defined(TIM17)
...
typedef struct {
	...
	uint32_t Autoreload; /*!< Specifies the auto reload value to be loaded into the active
				...
				Max_Data=0xFFFF. Some timer instances may support 32 bits counters.
				In that case this parameter must be a number between 0x0000 and
				0xFFFFFFFF.
	...
	uint32_t
		RepetitionCounter; /*!< Specifies the repetition counter value. Each time the RCR
				      ...
				      0x00 and Max_Data = 0xFF. Advanced timers: this parameter must
				      be a number between Min_Data = 0x0000 and Max_Data = 0xFFFF.

				       This feature can be modified afterwards using unitary
				      function @ref LL_TIM_SetRepetitionCounter().*/
} LL_TIM_InitTypeDef;
...
typedef struct {
	...
	uint32_t CompareValue; /*!< Specifies the Compare value to be loaded into the Capture
...
typedef struct {
	...
	uint32_t IC1Prescaler; /*!< Specifies the TI1 input prescaler value.
				    Prescaler must be set to get a maximum counter period longer
				  than the time interval between 2 consecutive changes on the Hall
				  inputs. This parameter can be a value of @ref TIM_LL_EC_ICPSC.
	...
	uint32_t CommutationDelay; /*!< Specifies the compare value to be loaded into the Capture
				      Compare Register. A positive pulse (TRGO event) is generated
				      with a programmable delay every time a change occurs on the
				      Hall inputs. This parameter can be a number between Min_Data =
				      0x0000 and Max_Data = 0xFFFF.

					This feature can be modified afterwards using unitary
				      function @ref LL_TIM_OC_SetCompareCH2().*/
...
typedef struct {
	...
	uint32_t LockLevel; /*!< Specifies the LOCK level parameters.
				 ...
				 @note The LOCK bits can be written only once after the reset. Once
			       the TIMx_BDTR register has been written, their content is frozen
	...
	uint8_t DeadTime; /*!< Specifies the delay time between the switching-off and the
			     ...
			     LL_TIM_OC_SetDeadTime()
			       ...
			       @note This bit-field can not be modified as long as LOCK level 1, 2
	...
	uint32_t BreakAFMode; /*!< Specifies the alternate function mode of the break input.
				 ...
				 @ref LL_TIM_ConfigBRK()
				  ...
				  @note Bidirectional break input is only supported by advanced
				 timers instances.
	...
	uint32_t AutomaticOutput; /*!< Specifies whether the TIM Automatic Output feature is enabled
				     or not. This parameter can be a value of @ref
				     TIM_LL_EC_AUTOMATICOUTPUT_ENABLE

				       This feature can be modified afterwards using unitary
				     functions @ref LL_TIM_EnableAutomaticOutput() or @ref
	...
	#define LL_TIM_UPDATESOURCE_REGULAR                                                        \
		0x00000000U /*!< Counter overflow/underflow, Setting the UG bit or Update          \
			       generation through the slave mode controller generates an update    \
			       request */
	...
	#define LL_TIM_OCMODE_FROZEN                                                               \
		0x00000000U /*!<The comparison between the output compare register TIMx_CCRy and   \
			       the counter TIMx_CNT has no effect on the output channel level */
	#define LL_TIM_OCMODE_ACTIVE   TIM_CCMR1_OC1M_0 /*!<OCyREF is forced high on compare match*/
	#define LL_TIM_OCMODE_INACTIVE TIM_CCMR1_OC1M_1 /*!<OCyREF is forced low on compare        \
							   match*/
	...
	#define LL_TIM_OCMODE_PWM1                                                                 \
		(TIM_CCMR1_OC1M_2 |                                                                \
		 TIM_CCMR1_OC1M_1) /*!<In upcounting, channel y is active as long as               \
				      TIMx_CNT<TIMx_CCRy else inactive.  In downcounting, channel  \
				      y is inactive as long as TIMx_CNT>TIMx_CCRy else active.*/
	#define LL_TIM_OCMODE_PWM2                                                                 \
		(TIM_CCMR1_OC1M_2 | TIM_CCMR1_OC1M_1 |                                             \
		 TIM_CCMR1_OC1M_0) /*!<In upcounting, channel y is inactive as long as             \
				      TIMx_CNT<TIMx_CCRy else active.  In downcounting, channel y  \
	...
	#define LL_TIM_OCMODE_ASSYMETRIC_PWM1                                                      \
		(TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1M_2) /*!<Asymmetric PWM mode   \
									    1*/
	...
	#define LL_TIM_ICPSC_DIV1                                                                  \
		0x00000000U /*!< No prescaler, capture is done each time an edge is detected on    \
			       the capture input */
	...
	#define LL_TIM_IC_POLARITY_BOTHEDGE                                                        \
		(TIM_CCER_CC1P |                                                                   \
		 TIM_CCER_CC1NP) /*!< The circuit is sensitive to both TIxFP1 rising and falling   \
				    edges, TIxFP1 is not inverted */
	/**
	 * @}
	 */
	...
	#define LL_TIM_ENCODERMODE_X4_TI12                                                         \
		(TIM_SMCR_SMS_1 |                                                                  \
		 TIM_SMCR_SMS_0) /*!< Quadrature encoder mode 3, x4 mode - Counter counts up/down  \
				    on both TI1FP1 and TI2FP2 edges depending on the level of the  \
				    other input */
	/**
	 * @}
	 */
	...
	#define LL_TIM_TRGO2_CC1F                                                                  \
		(TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< CC1 capture or a compare match is used as   \
						     trigger output 2 */
	...
	#define LL_TIM_TRGO2_OC4_RISINGFALLING                                                     \
		(TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1) /*!< OC4REF rising or falling edges are used as  \
						     trigger output 2 */
	...
	#define LL_TIM_TRGO2_OC4_RISING_OC6_RISING                                                 \
		(TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2) /*!< OC4REF or OC6REF rising edges are used as   \
						     trigger output 2 */
	#define LL_TIM_TRGO2_OC4_RISING_OC6_FALLING                                                \
		(TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 |                                                 \
		 TIM_CR2_MMS2_0) /*!< OC4REF rising or OC6REF falling edges are used as trigger    \
				    output 2 */
	...
	#define LL_TIM_TRGO2_OC5_RISING_OC6_FALLING                                                \
		(TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1 |                                \
		 TIM_CR2_MMS2_0) /*!< OC5REF rising or OC6REF falling edges are used as trigger    \
				    output 2 */
	/**
	 * @}
	 */
	...
	#define LL_TIM_SLAVEMODE_TRIGGER                                                           \
		(TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1) /*!< Trigger Mode - The counter starts at a      \
						     rising edge of the trigger TRGI */
	#define LL_TIM_SLAVEMODE_COMBINED_RESETTRIGGER                                             \
		TIM_SMCR_SMS_3 /*!< Combined reset + trigger mode - Rising edge of the selected    \
				  trigger input (TRGI)  reinitializes the counter, generates an    \
	...
	#define LL_TIM_TIM1_ETRSOURCE_ADC1_AWD1                                                    \
		(TIM1_AF1_ETRSEL_1 |                                                               \
		 TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to ADC1 analog watchdog 1 */
	#define LL_TIM_TIM1_ETRSOURCE_ADC1_AWD2                                                    \
		TIM1_AF1_ETRSEL_2 /*!< ETR input is connected to ADC1 analog watchdog 2 */
	#define LL_TIM_TIM1_ETRSOURCE_ADC1_AWD3                                                    \
		(TIM1_AF1_ETRSEL_2 |                                                               \
		 TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to ADC1 analog watchdog 3 */
	#define LL_TIM_TIM1_ETRSOURCE_ADC2_AWD1                                                    \
		(TIM1_AF1_ETRSEL_2 |                                                               \
		 TIM1_AF1_ETRSEL_1) /*!< ETR input is connected to ADC2 analog watchdog 1 */
	#define LL_TIM_TIM1_ETRSOURCE_ADC2_AWD2                                                    \
		(TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 |                                           \
		 TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to ADC2 analog watchdog 2 */
	#define LL_TIM_TIM1_ETRSOURCE_ADC2_AWD3                                                    \
		(TIM1_AF1_ETRSEL_3) /*!< ETR input is connected to ADC2 analog watchdog 3 */

	#define LL_TIM_TIM8_ETRSOURCE_GPIO 0x00000000U /*!< ETR input is connected to GPIO */
	#define LL_TIM_TIM8_ETRSOURCE_ADC1_AWD1                                                    \
		(TIM1_AF1_ETRSEL_1 |                                                               \
		 TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to ADC1 analog watchdog 1 */
	#define LL_TIM_TIM8_ETRSOURCE_ADC1_AWD2                                                    \
		TIM1_AF1_ETRSEL_2 /*!< ETR input is connected to ADC1 analog watchdog 2 */
	#define LL_TIM_TIM8_ETRSOURCE_ADC1_AWD3                                                    \
		(TIM1_AF1_ETRSEL_2 |                                                               \
		 TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to ADC1 analog watchdog 3 */
	...
	#define LL_TIM_TIM2_ETRSOURCE_RCC_LSE                                                      \
		(TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to RCC LSE */
	#define LL_TIM_TIM2_ETRSOURCE_SAI1_FSA                                                     \
		TIM1_AF1_ETRSEL_2 /*!< ETR input is connected to SAI1 FS_A */
	#define LL_TIM_TIM2_ETRSOURCE_SAI1_FSB                                                     \
		(TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to SAI1 FS_B   \
							 */
	#define LL_TIM_TIM2_ETRSOURCE_ETH_PPS                                                      \
		(TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1) /*!< ETR input is connected to ETH PPS */

	#define LL_TIM_TIM3_ETRSOURCE_GPIO 0x00000000U /*!< ETR input is connected to GPIO */
	#define LL_TIM_TIM3_ETRSOURCE_ETH_PPS                                                      \
		(TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1) /*!< ETR input is connected to ETH PPS */
	...
	#define LL_TIM_TIM5_ETRSOURCE_SAI2_FSA                                                     \
		TIM1_AF1_ETRSEL_0 /*!< ETR input is connected to SAI2 FS_A */
	#define LL_TIM_TIM5_ETRSOURCE_SAI2_FSB                                                     \
		TIM1_AF1_ETRSEL_1 /*!< ETR input is connected to SAI2 FS_B */
	#define LL_TIM_TIM5_ETRSOURCE_OTG_SOF                                                      \
		(TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to OTG SOF */
	/**
	 * @}
	 */
	...
	#define LL_TIM_BKIN_SOURCE_DF1BK                                                           \
		TIM1_AF1_BKDF1BK0E /*!< internal signal: DFSDM1 break output */
	/**
	 * @}
	 */
	...
	#define LL_TIM_DMABURST_BASEADDR_TISEL                                                     \
		(TIM_DCR_DBA_4 | TIM_DCR_DBA_3 |                                                   \
		 TIM_DCR_DBA_1) /*!< TIMx_TISEL register is the DMA base address for DMA burst */
	/**
	 * @}
	 */
	...
	#define LL_TIM_DMABURST_LENGTH_2TRANSFERS                                                  \
		TIM_DCR_DBL_0 /*!< Transfer is done to 2 registers starting from the DMA burst     \
				 base address */
	#define LL_TIM_DMABURST_LENGTH_3TRANSFERS                                                  \
		TIM_DCR_DBL_1 /*!< Transfer is done to 3 registers starting from the DMA burst     \
				 base address */
	...
	#define LL_TIM_DMABURST_LENGTH_5TRANSFERS                                                  \
		TIM_DCR_DBL_2 /*!< Transfer is done to 5 registers starting from the DMA burst     \
				 base address */
	...
	#define LL_TIM_DMABURST_LENGTH_9TRANSFERS                                                  \
		TIM_DCR_DBL_3 /*!< Transfer is done to 9 registers starting from the DMA burst     \
				 base address */
	#define LL_TIM_DMABURST_LENGTH_10TRANSFERS                                                 \
		(TIM_DCR_DBL_3 | TIM_DCR_DBL_0) /*!< Transfer is done to 10 registers starting     \
						   from the DMA burst base address */
	#define LL_TIM_DMABURST_LENGTH_11TRANSFERS                                                 \
		(TIM_DCR_DBL_3 | TIM_DCR_DBL_1) /*!< Transfer is done to 11 registers starting     \
						   from the DMA burst base address */
	...
	#define LL_TIM_DMABURST_LENGTH_13TRANSFERS                                                 \
		(TIM_DCR_DBL_3 | TIM_DCR_DBL_2) /*!< Transfer is done to 13 registers starting     \
						   from the DMA burst base address */
	...
	#define LL_TIM_DMABURST_LENGTH_17TRANSFERS                                                 \
		TIM_DCR_DBL_4 /*!< Transfer is done to 17 registers starting from the DMA burst    \
				 base address */
	#define LL_TIM_DMABURST_LENGTH_18TRANSFERS                                                 \
		(TIM_DCR_DBL_4 | TIM_DCR_DBL_0) /*!< Transfer is done to 18 registers starting     \
						   from the DMA burst base address */
	/**
	 * @}
	 */
	...
	#define LL_TIM_TIM5_TI1_RMP_FDCAN1_TMP                                                     \
		TIM_TISEL_TI1SEL_0 /*!< TIM5 input 1 is connected to FDCAN1_TMP */
	#define LL_TIM_TIM5_TI1_RMP_FDCAN1_RTP                                                     \
		TIM_TISEL_TI1SEL_1 /*!< TIM5 input 1 is connected to FDCAN1_RTP */
	...
	#define LL_TIM_TIM12_TI1_RMP_HSI_CAL_CK                                                    \
		TIM_TISEL_TI1SEL_0 /*!< TIM12 input 1 is connected to HSI_CAL_CK */
	#define LL_TIM_TIM12_TI1_RMP_CSI_CAL_CK                                                    \
		TIM_TISEL_TI1SEL_1 /*!< TIM12 input 1 is connected to CSI_CAL_CK */
	...
	#define LL_TIM_TIM15_TI1_RMP_TIM2_CH1                                                      \
		TIM_TISEL_TI1SEL_0 /*!< TIM15 input 1 is connected to TIM2_CH1 */
	#define LL_TIM_TIM15_TI1_RMP_TIM3_CH1                                                      \
		TIM_TISEL_TI1SEL_1 /*!< TIM15 input 1 is connected to TIM3_CH1 */
	#define LL_TIM_TIM15_TI1_RMP_TIM4_CH1                                                      \
		(TIM_TISEL_TI1SEL_0 |                                                              \
		 TIM_TISEL_TI1SEL_1) /*!< TIM15 input 1 is connected to TIM4_CH1 */
	#define LL_TIM_TIM15_TI1_RMP_RCC_LSE                                                       \
		TIM_TISEL_TI1SEL_2 /*!< TIM15 input 1 is connected to RCC_LSE  */
	#define LL_TIM_TIM15_TI1_RMP_RCC_CSI                                                       \
		(TIM_TISEL_TI1SEL_2 |                                                              \
		 TIM_TISEL_TI1SEL_0) /*!< TIM15 input 1 is connected to RCC_CSI  */
	#define LL_TIM_TIM15_TI1_RMP_RCC_MCO2                                                      \
		(TIM_TISEL_TI1SEL_2 |                                                              \
		 TIM_TISEL_TI1SEL_1) /*!< TIM15 input 1 is connected to RCC_MCO2 */
	#define LL_TIM_TIM15_TI1_RMP_HSI_CAL_CK                                                    \
		(TIM_TISEL_TI1SEL_2 | TIM_TISEL_TI1SEL_1 |                                         \
		 TIM_TISEL_TI1SEL_0) /*!< TIM15 input 1 is connected to HSI_CAL_CK */
	#define LL_TIM_TIM15_TI1_RMP_CSI_CAL_CK                                                    \
		TIM_TISEL_TI1SEL_3 /*!< TIM15 input 1 is connected to CSI_CAL_CK */
	#define LL_TIM_TIM15_TI2_RMP_GPIO 0x00000000U /*!< TIM15 input 2 is connected to GPIO */
	#define LL_TIM_TIM15_TI2_RMP_TIM2_CH2                                                      \
		TIM_TISEL_TI1SEL_0 /*!< TIM15 input 2 is connected to TIM2_CH2 */
	#define LL_TIM_TIM15_TI2_RMP_TIM3_CH2                                                      \
		TIM_TISEL_TI1SEL_1 /*!< TIM15 input 2 is connected to TIM3_CH2 */
	#define LL_TIM_TIM15_TI2_RMP_TIM4_CH2                                                      \
		(TIM_TISEL_TI1SEL_0 |                                                              \
		 TIM_TISEL_TI1SEL_1) /*!< TIM15 input 2 is connected to TIM4_CH2 */
	/**
	 * @}
	 */
	...
	#define LL_TIM_TIM16_TI1_RMP_RCC_LSI                                                       \
		TIM_TISEL_TI1SEL_0 /*!< TIM16 input 1 is connected to RCC_LSI */
	#define LL_TIM_TIM16_TI1_RMP_RCC_LSE                                                       \
		TIM_TISEL_TI1SEL_1 /*!< TIM16 input 1 is connected to RCC_LSE */
	#define LL_TIM_TIM16_TI1_RMP_WKUP_IT                                                       \
		(TIM_TISEL_TI1SEL_0 |                                                              \
		 TIM_TISEL_TI1SEL_1) /*!< TIM16 input 1 is connected to WKUP_IT */
	/**
	 * @}
	 */
	...
	#define LL_TIM_TIM17_TI1_RMP_SPDIFRX_FS                                                    \
		TIM_TISEL_TI1SEL_0 /*!< TIM17 input 1 is connected to SPDIF_FS */
	#define LL_TIM_TIM17_TI1_RMP_RCC_HSE_RTC                                                   \
		TIM_TISEL_TI1SEL_1 /*!< TIM17 input 1 is connected to RCC_HSE_RTC */
	#define LL_TIM_TIM17_TI1_RMP_RCC_MCO1                                                      \
		(TIM_TISEL_TI1SEL_0 |                                                              \
		 TIM_TISEL_TI1SEL_1) /*!< TIM17 input 1 is connected to RCC_MCO1 */
	/**
	 * @}
	 */
	...
	/**
	 * @brief  HELPER macro calculating the compare value required to achieve the required timer
					    ...
					    uint32_t Configuration)
{
	...
	register __IO uint32_t *pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->CCMR1) +
...
{
	register uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
	register const __IO uint32_t *pReg = (__IO uint32_t *)((
