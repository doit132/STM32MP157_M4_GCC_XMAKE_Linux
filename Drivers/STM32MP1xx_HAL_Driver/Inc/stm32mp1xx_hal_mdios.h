...
typedef struct {
	...
	/** @defgroup MDIOS_Input_Output_Registers_Definitions MDIOS Input Output Registers
	 * Definitions
	 * @{
	 */
	 ...
	 * @retval None.
	 */
	#define __HAL_MDIOS_WAKEUP_EXTID2_ENABLE_IT(__EXTI_LINE__)                                 \
		(EXTI_D2->IMR2 |= (__EXTI_LINE__))
	 ...
	 * @retval None
	 */
	#define __HAL_MDIOS_WAKEUP_EXTI_GENERATE_SWIT(__EXTI_LINE__)                               \
		(EXTI->SWIER2 |= (__EXTI_LINE__))
