 ...
 */
	...
	#define LL_PWR_MCU_MODE_STANDBY                                                            \
		PWR_MCUCR_PDDS /*!< Allow STANDBY mode when MCU enters to CSTOP */
	/**
	 * @}
	 */
	...
	#define LL_PWR_PVDLEVEL_7                                                                  \
		PWR_CR1_PLS_LEV7 /*!< External voltage level on PVD_IN pin, compared to internal   \
				    VREFINT level. */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_PWR_AVDLEVEL_0                                                                  \
		PWR_CR1_ALS_LEV0 /*!< Analog Voltage threshold detected by AVD 1.7 V */
	#define LL_PWR_AVDLEVEL_1                                                                  \
		PWR_CR1_ALS_LEV1 /*!< Analog Voltage threshold detected by AVD 2.1 V */
	#define LL_PWR_AVDLEVEL_2                                                                  \
		PWR_CR1_ALS_LEV2 /*!< Analog Voltage threshold detected by AVD 2.5 V */
	#define LL_PWR_AVDLEVEL_3                                                                  \
		PWR_CR1_ALS_LEV3 /*!< Analog Voltage threshold detected by AVD 2.8 V */
	...
	#define LL_PWR_BATT_CHARG_RESISTOR_5K                                                      \
		0x00000000U /*!< Charge VBAT through a 5 kO resistor  */
	#define LL_PWR_BATT_CHARGRESISTOR_1_5K                                                     \
		PWR_CR3_VBRS /*!< Charge VBAT through a 1.5 kO resistor  */
	/**
	 * @}
	 */
...
{
	return ((READ_BIT(PWR->WKUPCR, (WakeUpPin << PWR_WKUPCR_WKUPP_Pos)) ==
		 (WakeUpPin << PWR_WKUPCR_WKUPP_Pos))
			? 1UL
			: 0UL);
}
...
{
	register uint32_t regValue = READ_BIT(
		PWR->WKUPCR, (PWR_WKUPCR_WKUPPUPD1
			      << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin)) &
				  LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)));
