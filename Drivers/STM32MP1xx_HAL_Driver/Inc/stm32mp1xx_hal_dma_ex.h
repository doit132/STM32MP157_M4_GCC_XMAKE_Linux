...
typedef struct {
	uint32_t SyncSignalID; /*!< Specifies the synchronization signal gating the DMA request in
				  ...
				  DMAEx_MUX_SyncSignalID_selection */
	...
	uint32_t SyncPolarity; /*!< Specifies the polarity of the signal on which the DMA request is
				  ...
				  DMAEx_MUX_SyncPolarity_selection */
	...
	uint32_t
		RequestNumber; /*!< Specifies the number of DMA request that will be authorized
				  after a sync event. This parameters can be in the range 1 to 32 */
...
typedef struct {
	uint32_t SignalID; /*!< Specifies the ID of the signal used for DMAMUX request generator
			      ...
			      DMAEx_MUX_SignalGeneratorID_selection */

	uint32_t Polarity; /*!< Specifies the polarity of the signal on which the request is
			     generated. This parameter can be a value of @ref
			     DMAEx_MUX_RequestGeneneratorPolarity_selection */

	uint32_t
		RequestNumber; /*!< Specifies the number of DMA request that will be generated after
				  a signal event. This parameters can be in the range 1 to 32 */
...
#define HAL_DMAMUX1_SYNC_DMAMUX1_CH0_EVT                                                           \
	0U /*!< DMAMUX1 synchronization Signal is DMAMUX1 Channel0 Event */
#define HAL_DMAMUX1_SYNC_DMAMUX1_CH1_EVT                                                           \
	1U /*!< DMAMUX1 synchronization Signal is DMAMUX1 Channel1 Event */
#define HAL_DMAMUX1_SYNC_DMAMUX1_CH2_EVT                                                           \
	2U /*!< DMAMUX1 synchronization Signal is DMAMUX1 Channel2 Event */
#define HAL_DMAMUX1_SYNC_LPTIM1_OUT                                                                \
	3U /*!< DMAMUX1 synchronization Signal is LPTIM1 OUT             */
#define HAL_DMAMUX1_SYNC_LPTIM2_OUT                                                                \
	4U /*!< DMAMUX1 synchronization Signal is LPTIM2 OUT             */
#define HAL_DMAMUX1_SYNC_LPTIM3_OUT                                                                \
	5U			  /*!< DMAMUX1 synchronization Signal is LPTIM3 OUT             */
#define HAL_DMAMUX1_SYNC_EXTI0 6U /*!< DMAMUX1 synchronization Signal is EXTI0 IT               */
#define HAL_DMAMUX1_SYNC_TIM12_TRGO                                                                \
	7U /*!< DMAMUX1 synchronization Signal is TIM12 TRGO             */
...
#define HAL_DMAMUX1_REQ_GEN_TIM12_TRGO                                                             \
...
/** @defgroup DMAEx_MUX_RequestGeneneratorPolarity_selection DMAEx MUX RequestGeneneratorPolarity
 * selection
