 ...
 */
	...
	#define ADC_CALIB_FACTOR_OFFSET_REGOFFSET                                                  \
		(0x00000000UL) /* Register CALFACT defined as reference register */
	#define ADC_CALIB_FACTOR_LINEARITY_REGOFFSET                                               \
		(0x00000001UL) /* Register CALFACT2 offset vs register CALFACT */
	#define ADC_CALIB_FACTOR_REGOFFSET_MASK                                                    \
	...
	#define ADC_CALIB_MODE_BINARY_MASK                                                         \
		(ADC_CALIB_FACTOR_REGOFFSET_MASK) /* Mask to get binary value of calibration mode: \
						     0 for offset, 1 for linearity */
	...
	#define ADC_REG_RANK_1_SQRX_BITOFFSET_POS                                                  \
		(6UL) /* Equivalent to bitfield "ADC_SQR1_SQ1" position in register */
	...
	#define ADC_REG_RANK_5_SQRX_BITOFFSET_POS                                                  \
		(0UL) /* Equivalent to bitfield "ADC_SQR2_SQ5" position in register */
	#define ADC_REG_RANK_6_SQRX_BITOFFSET_POS                                                  \
		(6UL) /* Equivalent to bitfield "ADC_SQR2_SQ6" position in register */
	...
	#define ADC_REG_TRIG_EXTSEL_BITOFFSET_POS                                                  \
		(6UL) /* Equivalent to bitfield "ADC_CFGR_EXTSEL" position in register */
	#define ADC_REG_TRIG_EXTEN_BITOFFSET_POS                                                   \
		(10UL) /* Equivalent to bitfield "ADC_CFGR_EXTEN" position in register */
	...
	#define ADC_INJ_TRIG_EXTSEL_BITOFFSET_POS                                                  \
		(2UL) /* Equivalent to bitfield "ADC_JSQR_JEXTSEL" position in register */
	#define ADC_INJ_TRIG_EXTEN_BITOFFSET_POS                                                   \
		(6UL) /* Equivalent to bitfield "ADC_JSQR_JEXTEN" position in register */
	...
	#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS                                                \
		(26UL) /* Equivalent to bitfield "ADC_CHANNEL_ID_NUMBER_MASK" position in register \
			*/
	...
	#define ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0                                                 \
		(ADC_SQR2_SQ5) /* Equivalent to shift: (ADC_CHANNEL_NUMBER_MASK >> [Position of    \
				  bitfield "ADC_CHANNEL_NUMBER_MASK" in register]) */
	...
	#define ADC_CHANNEL_SMPx_BITOFFSET_POS                                                     \
		(20UL) /* Equivalent to bitfield "ADC_CHANNEL_SMPx_BITOFFSET_MASK" position in     \
			  register */
	...
	#define ADC_CHANNEL_0_SMP                                                                  \
		(ADC_SMPR1_REGOFFSET |                                                             \
		 ((0UL)                                                                            \
		  << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield   \
	...
	#define ADC_CHANNEL_19_SMP                                                                 \
		(ADC_SMPR2_REGOFFSET |                                                             \
		 ((27UL)                                                                           \
		  << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield   \
							 "ADC_SMPR2_SMP19" position in register */
	...
	#define ADC_SINGLEDIFF_CHANNEL_SHIFT_MASK                                                  \
		(ADC_CALFACT_CALFACT_S_4 |                                                         \
		 ADC_CALFACT_CALFACT_S_3) /* Bits chosen to perform of shift when single mode is   \
					     selected, shift value out of channels bits range. */
	#define ADC_SINGLEDIFF_CALIB_F_BIT_D_MASK                                                  \
		(0x00010000UL) /* Selection of 1 bit to discriminate differential mode: mask of    \
				  bit */
	...
	#define ADC_SINGLEDIFF_CALIB_F_BIT_D_SHIFT4                                                \
		(ADC_SINGLEDIFF_CALIB_F_BIT_D_POS -                                                \
		 4UL) /* Shift of bit ADC_SINGLEDIFF_CALIB_F_BIT_D to position to perform a shift  \
			 of 4 ranks */
	...
	#define ADC_CR_BITS_PROPERTY_RS                                                            \
		(ADC_CR_ADCAL | ADC_CR_JADSTP | ADC_CR_ADSTP | ADC_CR_JADSTART | ADC_CR_ADSTART |  \
		 ADC_CR_ADDIS | ADC_CR_ADEN) /* ADC register CR bits with HW property "rs":        \
						Software can read as well as set this bit. Writing \
						'0' has no effect on the bit value. */

	/* ADC internal channels related definitions */
	/* Internal voltage reference VrefInt */
	#define VREFINT_CAL_ADDR                                                                   \
		((uint16_t *)(0x5C005252UL)) /* Internal voltage reference, address of parameter   \
	...
	#define VREFINT_CAL_VREF                                                                   \
		(3300UL) /* Analog voltage reference (Vref+) value with which temperature sensor   \
			    has been calibrated in production (tolerance: +-10 mV) (unit: mV). */
	/* Temperature sensor */
	#define TEMPSENSOR_CAL1_ADDR                                                               \
		((uint16_t *)(0x5C00525CUL)) /* Internal temperature sensor, address of parameter  \
						TS_CAL1: On STM32MP1, temperature sensor ADC raw   \
						data acquired at temperature  30 DegC (tolerance:  \
						+-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
	#define TEMPSENSOR_CAL2_ADDR                                                               \
		((uint16_t *)(0x5C00525EUL)) /* Internal temperature sensor, address of parameter  \
						TS_CAL2: On STM32MP1, temperature sensor ADC raw   \
						data acquired at temperature 110 DegC (tolerance:  \
						+-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
	#define TEMPSENSOR_CAL1_TEMP                                                               \
		(30L) /* Internal temperature sensor, temperature at which temperature sensor has  \
			 been calibrated in production for data into TEMPSENSOR_CAL1_ADDR          \
			 (tolerance: +-5 DegC) (unit: DegC). */
	#define TEMPSENSOR_CAL2_TEMP                                                               \
		(110L) /* Internal temperature sensor, temperature at which temperature sensor has \
			  been calibrated in production for data into TEMPSENSOR_CAL2_ADDR         \
			  (tolerance: +-5 DegC) (unit: DegC). */
	#define TEMPSENSOR_CAL_VREFANALOG                                                          \
		(3300UL) /* Analog voltage reference (Vref+) voltage with which temperature sensor \
...
typedef struct {
	...
	uint32_t Multimode; /*!< Set ADC multimode configuration to operate in independent mode or
			       multimode (for devices with several ADC instances). This parameter
			       can be a value of @ref ADC_LL_EC_MULTI_MODE

				 This feature can be modified afterwards using unitary function @ref
			       LL_ADC_SetMultimode(). */

	uint32_t MultiDMATransfer; /*!< Set ADC dual ADC mode DMA transfer data format: Each DMA, 32
				      down to 10-bits or 8-bits resolution. This parameter can be a
				      value of @ref ADC_LL_EC_MULTI_DMA_TRANSFER

					This feature can be modified afterwards using unitary
				      function @ref LL_ADC_SetMultiDMATransfer(). */

	uint32_t MultiTwoSamplingDelay; /*!< Set ADC multimode delay between 2 sampling phases.
					     This parameter can be a value of @ref
					   ADC_LL_EC_MULTI_TWOSMP_DELAY

					     This feature can be modified afterwards using unitary
					   function @ref LL_ADC_SetMultiTwoSamplingDelay(). */
...
typedef struct {
	...
	uint32_t LeftBitShift; /*!< Configures the left shifting applied to the final result with or
				  without oversampling. This parameter can be a value of @ref
				  ADC_LL_EC_LEFT_BIT_SHIFT. */
 ...
 */
typedef struct {
	uint32_t TriggerSource; /*!< Set ADC group regular conversion trigger source: internal (SW
				   start) or from external peripheral (timer event, external
				   interrupt line). This parameter can be a value of @ref
				   ADC_LL_EC_REG_TRIGGER_SOURCE
				     @note On this STM32 series, setting trigger source to external
				   trigger also set trigger polarity to rising edge (default setting
				   for compatibility with some ADC on other STM32 families having
				   this setting set by HW default value). In case of need to modify
				   trigger edge, use function @ref LL_ADC_REG_SetTriggerEdge().
	...
	uint32_t SequencerDiscont; /*!< Set ADC group regular sequencer discontinuous mode: sequence
				      ...
				      number of ranks. This parameter can be a value of @ref
	...
	uint32_t ContinuousMode; /*!< Set ADC continuous conversion mode on ADC group regular,
				    ...
				    conversion per trigger) or in continuous mode (after the first
				    trigger, following conversions launched successively
				    automatically). This parameter can be a value of @ref
				    ADC_LL_EC_REG_CONTINUOUS_MODE Note: It is not possible to enable
				    both ADC group regular continuous mode and discontinuous mode.

				      This feature can be modified afterwards using unitary function
				    @ref LL_ADC_REG_SetContinuousMode(). */

	uint32_t DataTransferMode; /*!< Set ADC group regular conversion data transfer mode: no
				      transfer, transfer by DMA (Limited/Unlimited) or DFSDM. This
				      parameter can be a value of @ref
				      ADC_LL_EC_REG_DATA_TRANSFER_MODE

					This feature can be modified afterwards using unitary
				      function @ref LL_ADC_REG_SetDataTransferMode(). */
 ...
 */
typedef struct {
	uint32_t TriggerSource; /*!< Set ADC group injected conversion trigger source: internal (SW
				   start) or from external peripheral (timer event, external
				   interrupt line). This parameter can be a value of @ref
				   ...
				   for compatibility with some ADC on other STM32 families having
				   this setting set by HW default value). In case of need to modify
				   trigger edge, use function @ref LL_ADC_INJ_SetTriggerEdge().
	...
	uint32_t SequencerLength; /*!< Set ADC group injected sequencer length.
				     ...
				     ADC_LL_EC_INJ_SEQ_SCAN_LENGTH
				       ...
				       This feature can be modified afterwards using unitary
				     function @ref LL_ADC_INJ_SetSequencerLength(). */

	uint32_t SequencerDiscont; /*!< Set ADC group injected sequencer discontinuous mode:
				      sequence subdivided and scan conversions interrupted every
				      selected number of ranks. This parameter can be a value of
				      @ref ADC_LL_EC_INJ_SEQ_DISCONT_MODE
					@note This parameter has an effect only if group injected
				      sequencer is enabled (scan length of 2 ranks or more).

					This feature can be modified afterwards using unitary
				      function @ref LL_ADC_INJ_SetSequencerDiscont(). */

	uint32_t TrigAuto; /*!< Set ADC group injected conversion trigger: independent or from ADC
			      group regular. This parameter can be a value of @ref
			      ADC_LL_EC_INJ_TRIG_AUTO Note: This parameter must be set to set to
			      independent trigger if injected trigger source is set to an external
			      trigger.
	...
	#define LL_ADC_FLAG_AWD3 ADC_ISR_AWD3 /*!< ADC flag ADC analog watchdog 3 */
		...
		#define LL_ADC_FLAG_AWD1_MST                                                       \
			ADC_CSR_AWD1_MST /*!< ADC flag ADC multimode master analog watchdog 1 of   \
					    the ADC master */
		#define LL_ADC_FLAG_AWD1_SLV                                                       \
			ADC_CSR_AWD1_SLV /*!< ADC flag ADC multimode slave analog watchdog 1 of    \
					    the ADC slave */
		#define LL_ADC_FLAG_AWD2_MST                                                       \
			ADC_CSR_AWD2_MST /*!< ADC flag ADC multimode master analog watchdog 2 of   \
					    the ADC master */
		#define LL_ADC_FLAG_AWD2_SLV                                                       \
			ADC_CSR_AWD2_SLV /*!< ADC flag ADC multimode slave analog watchdog 2 of    \
					    the ADC slave */
		#define LL_ADC_FLAG_AWD3_MST                                                       \
			ADC_CSR_AWD3_MST /*!< ADC flag ADC multimode master analog watchdog 3 of   \
					    the ADC master */
		#define LL_ADC_FLAG_AWD3_SLV                                                       \
			ADC_CSR_AWD3_SLV /*!< ADC flag ADC multimode slave analog watchdog 3 of    \
					    the ADC slave */
	#endif				 /* ADC_MULTIMODE_SUPPORT */
	/**
	 * @}
	...
	#define LL_ADC_DMA_REG_REGULAR_DATA                                                        \
		...
		#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI                                          \
			(0x00000001UL) /* ADC group regular conversion data register               \
					  (corresponding to register CDR) to be used with ADC      \
					  configured in multimode (available on STM32 devices with \
					  several ADC instances). Without DMA transfer, register   \
					  accessed by LL function @ref                             \
	...
	#define LL_ADC_PATH_INTERNAL_TEMPSENSOR                                                    \
		(ADC_CCR_VSENSEEN) /*!< ADC measurement path to internal channel temperature       \
				      sensor */
	#define LL_ADC_PATH_INTERNAL_VBAT                                                          \
		(ADC_CCR_VBATEN) /*!< ADC measurement path to internal channel Vbat */
	#define LL_ADC_PATH_INTERNAL_VDDCORE                                                       \
		(ADC2_OR_VDDCOREEN) /*!< ADC measurement path to internal channel Vddcore */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_ADC_BOOST_MODE_DISABLE                                                          \
		(0x00000000UL) /*!< ADC boost mode disable: can be used when ADC clock < 20 MHz to \
				  save power at lower clock frequency */
	#define LL_ADC_BOOST_MODE_ENABLE                                                           \
		(ADC_CR_BOOST) /*!< ADC boost mode enable: must be used when ADC clock > 20 MHz.   \
				  Note: In multimode, boost setting of ADC slave is discarded are  \
				  applies setting of ADC master. */
	/**
	 * @}
	 */

	/** @defgroup ADC_LL_EC_CALIBRATION_OFFSET_LINEARITY  ADC instance - Calibration mode for
	 * offset and linearity
	 * @{
	 */
	#define LL_ADC_CALIB_OFFSET                                                                \
		(ADC_CALIB_FACTOR_OFFSET_REGOFFSET) /*!< Calibration of ADC offset. Duration of    \
						       calibration of offset duration: 1280 ADC    \
						       clock cycles. For devices with differential \
						       mode available: Calibration of offset is    \
						       specific to each of single-ended and        \
						       differential modes. */
	#define LL_ADC_CALIB_LINEARITY                                                             \
		(ADC_CALIB_FACTOR_LINEARITY_REGOFFSET) /*!< Calibration of ADC linearity. Duration \
							  of calibration of linearity: 15104 ADC   \
							  clock cycles. For devices with           \
							  differential mode available: Calibration \
							  of linearity is common to both           \
							  single-ended and differential modes. */
	#define LL_ADC_CALIB_OFFSET_LINEARITY                                                      \
		(ADC_CALIB_FACTOR_LINEARITY_REGOFFSET |                                            \
		 ADC_CR_ADCALLIN) /*!< Calibration of ADC offset and linearity. Duration of        \
				     calibration of offset and linearity: 16384 ADC clock cycles.  \
				     For devices with differential mode available: Calibration of  \
				     offset is specific to each of single-ended and differential   \
				     modes, calibration of linearity is common to both             \
				     single-ended and differential modes. */
	/**
	 * @}
	 */

	/** @defgroup ADC_LL_EC_CALIBRATION_LINEARITY_WORD  ADC instance - Calibration linearity
	 * words
	 * @{
	 */
	#define LL_ADC_CALIB_LINEARITY_WORD1                                                       \
		(ADC_CR_LINCALRDYW1) /*!< ADC calibration linearity word 1 */
	#define LL_ADC_CALIB_LINEARITY_WORD2                                                       \
		(ADC_CR_LINCALRDYW2) /*!< ADC calibration linearity word 2 */
	#define LL_ADC_CALIB_LINEARITY_WORD3                                                       \
		(ADC_CR_LINCALRDYW3) /*!< ADC calibration linearity word 3 */
	#define LL_ADC_CALIB_LINEARITY_WORD4                                                       \
		(ADC_CR_LINCALRDYW4) /*!< ADC calibration linearity word 4 */
	#define LL_ADC_CALIB_LINEARITY_WORD5                                                       \
		(ADC_CR_LINCALRDYW5) /*!< ADC calibration linearity word 5 */
	#define LL_ADC_CALIB_LINEARITY_WORD6                                                       \
		(ADC_CR_LINCALRDYW6) /*!< ADC calibration linearity word 6 */
	/**
	 * @}
	 */
	...
	#define LL_ADC_RESOLUTION_10B                                                              \
		(ADC_CFGR_RES_1 | ADC_CFGR_RES_0)     /*!< ADC resolution 10 bits */
	...
	#define LL_ADC_LEFT_BIT_SHIFT_NONE                                                         \
		(0x00000000UL) /*!< ADC no bit shift left applied on the final ADC convesion data  \
				*/
	#define LL_ADC_LEFT_BIT_SHIFT_1                                                            \
		(ADC_CFGR2_LSHIFT_0) /*!< ADC 1 bit shift left applied on the final ADC convesion  \
					data */
	...
	#define LL_ADC_LEFT_BIT_SHIFT_3                                                            \
		(ADC_CFGR2_LSHIFT_1 | ADC_CFGR2_LSHIFT_0) /*!< ADC 3 bits shift left applied on    \
							     the final ADC convesion data */
	...
	#define LL_ADC_LEFT_BIT_SHIFT_5                                                            \
		(ADC_CFGR2_LSHIFT_2 | ADC_CFGR2_LSHIFT_0) /*!< ADC 5 bits shift left applied on    \
							     the final ADC convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_6                                                            \
		(ADC_CFGR2_LSHIFT_2 | ADC_CFGR2_LSHIFT_1) /*!< ADC 6 bits shift left applied on    \
							     the final ADC convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_7                                                            \
		(ADC_CFGR2_LSHIFT_2 | ADC_CFGR2_LSHIFT_1 |                                         \
		 ADC_CFGR2_LSHIFT_0) /*!< ADC 7 bits shift left applied on the final ADC convesion \
					data */
	#define LL_ADC_LEFT_BIT_SHIFT_8                                                            \
		(ADC_CFGR2_LSHIFT_3) /*!< ADC 8 bits shift left applied on the final ADC convesion \
					data */
	#define LL_ADC_LEFT_BIT_SHIFT_9                                                            \
		(ADC_CFGR2_LSHIFT_3 | ADC_CFGR2_LSHIFT_0) /*!< ADC 9 bits shift left applied on    \
							     the final ADC convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_10                                                           \
		(ADC_CFGR2_LSHIFT_3 | ADC_CFGR2_LSHIFT_1) /*!< ADC 10 bits shift left applied on   \
							     the final ADC convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_11                                                           \
		(ADC_CFGR2_LSHIFT_3 | ADC_CFGR2_LSHIFT_1 |                                         \
		 ADC_CFGR2_LSHIFT_0) /*!< ADC 11 bits shift left applied on the final ADC          \
					convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_12                                                           \
		(ADC_CFGR2_LSHIFT_3 | ADC_CFGR2_LSHIFT_2) /*!< ADC 12 bits shift left applied on   \
							     the final ADC convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_13                                                           \
		(ADC_CFGR2_LSHIFT_3 | ADC_CFGR2_LSHIFT_2 |                                         \
		 ADC_CFGR2_LSHIFT_0) /*!< ADC 13 bits shift left applied on the final ADC          \
					convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_14                                                           \
		(ADC_CFGR2_LSHIFT_3 | ADC_CFGR2_LSHIFT_2 |                                         \
		 ADC_CFGR2_LSHIFT_1) /*!< ADC 14 bits shift left applied on the final ADC          \
					convesion data */
	#define LL_ADC_LEFT_BIT_SHIFT_15                                                           \
		(ADC_CFGR2_LSHIFT_3 | ADC_CFGR2_LSHIFT_2 | ADC_CFGR2_LSHIFT_1 |                    \
		 ADC_CFGR2_LSHIFT_0) /*!< ADC 15 bits shift left applied on the final ADC          \
					convesion data */
	/**
	 * @}
	 */
	...
	#define LL_ADC_LP_AUTOWAIT                                                                 \
		(ADC_CFGR_AUTDLY) /*!< ADC low power mode auto delay: Dynamic low power mode, ADC  \
				     conversions are performed only when necessary (when previous  \
				     ADC conversion data is read). See description with function   \
				     @ref LL_ADC_SetLowPowerMode(). */
	/**
	 * @}
	 */
	...
	#define LL_ADC_OFFSET_1                                                                    \
		ADC_OFR1_REGOFFSET /*!< ADC offset number 1: ADC channel and offset level to which \
				      the offset programmed will be applied (independently of      \
				      channel mapped on ADC group regular or group injected) */
	#define LL_ADC_OFFSET_2                                                                    \
		ADC_OFR2_REGOFFSET /*!< ADC offset number 2: ADC channel and offset level to which \
				      the offset programmed will be applied (independently of      \
				      channel mapped on ADC group regular or group injected) */
	#define LL_ADC_OFFSET_3                                                                    \
		ADC_OFR3_REGOFFSET /*!< ADC offset number 3: ADC channel and offset level to which \
				      the offset programmed will be applied (independently of      \
				      channel mapped on ADC group regular or group injected) */
	#define LL_ADC_OFFSET_4                                                                    \
		ADC_OFR4_REGOFFSET /*!< ADC offset number 4: ADC channel and offset level to which \
				      the offset programmed will be applied (independently of      \
				      channel mapped on ADC group regular or group injected) */
	/**
	 * @}
	...
	/** @defgroup ADC_LL_EC_OFFSET_SIGNED_SATURATION ADC instance - Offset signed saturation
	 * mode
	 * @{
	 */
	#define LL_ADC_OFFSET_SIGNED_SATURATION_DISABLE                                            \
		(0x00000000UL) /*!< ADC offset signed saturation is disabled (among ADC selected   \
				  offset number 1, 2, 3 or 4) */
	#define LL_ADC_OFFSET_SIGNED_SATURATION_ENABLE                                             \
		(ADC_OFR1_SSATE) /*!< ADC offset signed saturation is enabled (among ADC selected  \
				    offset number 1, 2, 3 or 4) */
	/**
	 * @}
	 */
	...
	#define LL_ADC_OFFSET_RSHIFT_DISABLE                                                       \
		(0x00000000UL) /*!< ADC offset right shift is disabled (among ADC selected offset  \
				  number 1, 2, 3 or 4) */
	#define LL_ADC_OFFSET_RSHIFT_ENABLE                                                        \
		(ADC_CFGR2_RSHIFT1) /*!< ADC offset right shif is enabled (among ADC selected      \
				       offset number 1, 2, 3 or 4) */
	/**
	 * @}
	 */
	...
	#define LL_ADC_CHANNEL_10                                                                  \
		(ADC_CHANNEL_10_NUMBER | ADC_CHANNEL_10_SMP |                                      \
		 ADC_CHANNEL_10_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN10 */
	#define LL_ADC_CHANNEL_11                                                                  \
		(ADC_CHANNEL_11_NUMBER | ADC_CHANNEL_11_SMP |                                      \
		 ADC_CHANNEL_11_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN11 */
	#define LL_ADC_CHANNEL_12                                                                  \
		(ADC_CHANNEL_12_NUMBER | ADC_CHANNEL_12_SMP |                                      \
		 ADC_CHANNEL_12_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN12 */
	#define LL_ADC_CHANNEL_13                                                                  \
		(ADC_CHANNEL_13_NUMBER | ADC_CHANNEL_13_SMP |                                      \
		 ADC_CHANNEL_13_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN13 */
	#define LL_ADC_CHANNEL_14                                                                  \
		(ADC_CHANNEL_14_NUMBER | ADC_CHANNEL_14_SMP |                                      \
		 ADC_CHANNEL_14_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN14 */
	#define LL_ADC_CHANNEL_15                                                                  \
		(ADC_CHANNEL_15_NUMBER | ADC_CHANNEL_15_SMP |                                      \
		 ADC_CHANNEL_15_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN15 */
	#define LL_ADC_CHANNEL_16                                                                  \
		(ADC_CHANNEL_16_NUMBER | ADC_CHANNEL_16_SMP |                                      \
		 ADC_CHANNEL_16_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN16 */
	#define LL_ADC_CHANNEL_17                                                                  \
		(ADC_CHANNEL_17_NUMBER | ADC_CHANNEL_17_SMP |                                      \
		 ADC_CHANNEL_17_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN17 */
	#define LL_ADC_CHANNEL_18                                                                  \
		(ADC_CHANNEL_18_NUMBER | ADC_CHANNEL_18_SMP |                                      \
		 ADC_CHANNEL_18_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN18 */
	#define LL_ADC_CHANNEL_19                                                                  \
		(ADC_CHANNEL_19_NUMBER | ADC_CHANNEL_19_SMP |                                      \
		 ADC_CHANNEL_19_BITFIELD) /*!< ADC external channel (channel connected to GPIO     \
					     pin) ADCx_IN19 */
	#define LL_ADC_CHANNEL_VREFINT                                                             \
		(LL_ADC_CHANNEL_13 |                                                               \
		 ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt:       \
						Internal voltage reference. On STM32MP1, ADC       \
						channel available only on ADC instance: ADC2. */
	#define LL_ADC_CHANNEL_VCORE                                                               \
		(LL_ADC_CHANNEL_14 |                                                               \
		 ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VddCore. On    \
						STM32MP1, ADC channel available only on ADC        \
						instance: ADC2. */
	#define LL_ADC_CHANNEL_TEMPSENSOR                                                          \
		(LL_ADC_CHANNEL_12 |                                                               \
		 ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Temperature    \
						sensor. On STM32MP1, ADC channel available only on \
						ADC instance: ADC2. */
	#define LL_ADC_CHANNEL_VBAT                                                                \
		(LL_ADC_CHANNEL_15 |                                                               \
		 ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/3: Vbat   \
						voltage through a divider ladder of factor 1/4 to  \
						have Vbat always below Vdda. On STM32MP1, ADC      \
						channel available only on ADC instance: ADC2. */
	#define LL_ADC_CHANNEL_DAC1CH1_ADC2                                                        \
		(LL_ADC_CHANNEL_16 |                                                               \
		 ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to DAC1 channel   \
						1, channel specific to ADC2 */
	#define LL_ADC_CHANNEL_DAC1CH2_ADC2                                                        \
		(LL_ADC_CHANNEL_17 |                                                               \
		 ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to DAC1 channel   \
						2, channel specific to ADC2 */
	/**
	 * @}
	 */
	...
	#define LL_ADC_REG_TRIG_EXT_TIM1_CH1                                                       \
		(ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from     \
						   external peripheral: TIM1 channel 1 event       \
	...
	#define LL_ADC_REG_TRIG_EXT_TIM1_CH2                                                       \
		(ADC_CFGR_EXTSEL_0 |                                                               \
		 ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from     \
						   external peripheral: TIM1 channel 2 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	#define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                                       \
		(ADC_CFGR_EXTSEL_1 |                                                               \
		 ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from     \
						   external peripheral: TIM1 channel 3 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                                       \
		(ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                           \
		 ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from     \
						   external peripheral: TIM2 channel 2 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	...
	#define LL_ADC_REG_TRIG_EXT_RISINGFALLING                                                  \
		(ADC_CFGR_EXTEN_1 |                                                                \
		 ADC_CFGR_EXTEN_0) /*!< ADC group regular conversion trigger polarity set to both  \
	...
	#define LL_ADC_REG_CONV_SINGLE                                                             \
		(0x00000000UL) /*!< ADC conversions are performed in single mode: one conversion   \
				  per trigger */
	#define LL_ADC_REG_CONV_CONTINUOUS                                                         \
		(ADC_CFGR_CONT) /*!< ADC conversions are performed in continuous mode: after the   \
	...
	/** @defgroup ADC_LL_EC_REG_DATA_TRANSFER_MODE  ADC group regular - Data transfer mode of
	 * ADC conversion data
	 * @{
	 */
	#define LL_ADC_REG_DR_TRANSFER                                                             \
		(0x00000000UL) /*!< ADC conversions are transferred to DR rigister */
	#define LL_ADC_REG_DMA_TRANSFER_LIMITED                                                    \
		(ADC_CFGR_DMNGT_0) /*!< ADC conversion data are transferred by DMA, in limited     \
				      mode (one shot mode): DMA transfer requests are stopped when \
				      number of DMA data transfers (number of ADC conversions) is  \
				      reached. This ADC mode is intended to be used with DMA mode  \
				      non-circular. */
	#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                                  \
		(ADC_CFGR_DMNGT_1 |                                                                \
		 ADC_CFGR_DMNGT_0) /*!< ADC conversion data are transferred by DMA, in unlimited   \
	...
	#define LL_ADC_REG_DFSDM_TRANSFER                                                          \
		(ADC_CFGR_DMNGT_1) /*!< ADC conversion data are transferred to DFSDM */
	/**
	 * @}
	 */
	...
	#define LL_ADC_REG_SEQ_SCAN_DISABLE                                                        \
		(0x00000000UL) /*!< ADC group regular sequencer disable (equivalent to sequencer   \
				  of 1 rank: ADC conversion on only 1 channel) */
	...
	#define LL_ADC_REG_SEQ_SCAN_ENABLE_4RANKS                                                  \
		(ADC_SQR1_L_1 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 4 ranks \
						 in the sequence */
	...
	#define LL_ADC_REG_SEQ_SCAN_ENABLE_6RANKS                                                  \
		(ADC_SQR1_L_2 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 6 ranks \
						 in the sequence */
	#define LL_ADC_REG_SEQ_SCAN_ENABLE_7RANKS                                                  \
		(ADC_SQR1_L_2 | ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 7 ranks \
						 in the sequence */
	...
	#define LL_ADC_REG_SEQ_SCAN_ENABLE_10RANKS                                                 \
		(ADC_SQR1_L_3 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 10      \
						 ranks in the sequence */
	#define LL_ADC_REG_SEQ_SCAN_ENABLE_11RANKS                                                 \
		(ADC_SQR1_L_3 | ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 11      \
						 ranks in the sequence */
	...
	#define LL_ADC_REG_SEQ_SCAN_ENABLE_13RANKS                                                 \
		(ADC_SQR1_L_3 | ADC_SQR1_L_2) /*!< ADC group regular sequencer enable with 13      \
						 ranks in the sequence */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                                       \
		(ADC_JSQR_JEXTSEL_0 |                                                              \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: TIM1 channel 4 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                       \
		(ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                         \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: TIM2 channel 1 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                                    \
		(ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |                                         \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: external interrupt         \
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4                                                       \
		(ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                    \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: TIM8 channel 4 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM3_CH3                                                       \
		(ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                    \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: TIM3 channel 3 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM3_CH1                                                       \
		(ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |                    \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: TIM3 channel 1 event       \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM15_TRGO                                                     \
		(ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |                    \
		 ...
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: TIM15 TRGO event. Trigger  \
						   edge set to rising edge (default setting). */
	#define LL_ADC_INJ_TRIG_EXT_LPTIM1_OUT                                                     \
		(ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_1 |                                         \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: LPTIM1 OUT event. Trigger  \
						   edge set to rising edge (default setting). */
	#define LL_ADC_INJ_TRIG_EXT_LPTIM2_OUT                                                     \
		(ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                    \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: LPTIM2 OUT event. Trigger  \
						   edge set to rising edge (default setting). */
	#define LL_ADC_INJ_TRIG_EXT_LPTIM3_OUT                                                     \
		(ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_2 |                                         \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from    \
						   external peripheral: LPTIM3 OUT event. 4 event  \
						   (capture compare: input capture or output       \
						   capture). Trigger edge set to rising edge       \
						   (default setting). */
	/**
	...
	#define LL_ADC_INJ_TRIG_EXT_RISING                                                         \
		(ADC_JSQR_JEXTEN_0) /*!< ADC group injected conversion trigger polarity set to     \
				       rising edge */
	#define LL_ADC_INJ_TRIG_EXT_FALLING                                                        \
		(ADC_JSQR_JEXTEN_1) /*!< ADC group injected conversion trigger polarity set to     \
				       falling edge */
	...
	#define LL_ADC_INJ_TRIG_INDEPENDENT                                                        \
		(0x00000000UL) /*!< ADC group injected conversion trigger independent. Setting     \
				  mandatory if ADC group injected injected trigger source is set   \
				  to an external trigger. */
	#define LL_ADC_INJ_TRIG_FROM_GRP_REGULAR                                                   \
		(ADC_CFGR_JAUTO) /*!< ADC group injected conversion trigger from ADC group         \
				    regular. Setting compliant only with group injected trigger    \
				    source set to SW start, without any further action on  ADC     \
				    group injected conversion start or stop: in this case, ADC     \
				    group injected is controlled only from ADC group regular. */
	/**
	 * @}
	 */
	...
	#define LL_ADC_INJ_QUEUE_2CONTEXTS_LAST_ACTIVE                                             \
		(0x00000000UL) /* Group injected sequence context queue is enabled and can contain \
				  up to 2 contexts. When all contexts have been processed, the     \
				  queue maintains the last context active perpetually. */
	#define LL_ADC_INJ_QUEUE_2CONTEXTS_END_EMPTY                                               \
		(ADC_CFGR_JQM) /* Group injected sequence context queue is enabled and can contain \
				  up to 2 contexts. When all contexts have been processed, the     \
				  queue is empty and injected group triggers are disabled. */
	#define LL_ADC_INJ_QUEUE_DISABLE                                                           \
		(ADC_CFGR_JQDIS) /* Group injected sequence context queue is disabled: only 1      \
				    sequence can be configured and is active perpetually. */
	/**
	 * @}
	 */
	...
	#define LL_ADC_INJ_SEQ_SCAN_DISABLE                                                        \
		(0x00000000UL) /*!< ADC group injected sequencer disable (equivalent to sequencer  \
				  of 1 rank: ADC conversion on only 1 channel) */
	...
	#define LL_ADC_INJ_SEQ_SCAN_ENABLE_4RANKS                                                  \
		(ADC_JSQR_JL_1 | ADC_JSQR_JL_0) /*!< ADC group injected sequencer enable with 4    \
						   ranks in the sequence */
	/**
	 * @}
	 */

	/** @defgroup ADC_LL_EC_INJ_SEQ_DISCONT_MODE  ADC group injected - Sequencer discontinuous
	 * mode
	 * @{
	 */
	...
	#define LL_ADC_INJ_SEQ_DISCONT_1RANK                                                       \
		(ADC_CFGR_JDISCEN) /*!< ADC group injected sequencer discontinuous mode enable     \
	...
	#define LL_ADC_SAMPLINGTIME_1CYCLE_5                                                       \
		(0x00000000UL) /*!< Sampling time 1.5 ADC clock cycles */
	#define LL_ADC_SAMPLINGTIME_2CYCLES_5                                                      \
		(ADC_SMPR2_SMP10_0) /*!< Sampling time 2.5 ADC clock cycles */
	#define LL_ADC_SAMPLINGTIME_8CYCLES_5                                                      \
		(ADC_SMPR2_SMP10_1) /*!< Sampling time 8.5 ADC clock cycles */
	#define LL_ADC_SAMPLINGTIME_16CYCLES_5                                                     \
		(ADC_SMPR2_SMP10_1 | ADC_SMPR2_SMP10_0) /*!< Sampling time 16.5 ADC clock cycles   \
							 */
	#define LL_ADC_SAMPLINGTIME_32CYCLES_5                                                     \
		(ADC_SMPR2_SMP10_2) /*!< Sampling time 32.5 ADC clock cycles */
	#define LL_ADC_SAMPLINGTIME_64CYCLES_5                                                     \
		(ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_0) /*!< Sampling time 64.5 ADC clock cycles   \
							 */
	#define LL_ADC_SAMPLINGTIME_387CYCLES_5                                                    \
		(ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1) /*!< Sampling time 387.5 ADC clock cycles  \
							 */
	#define LL_ADC_SAMPLINGTIME_810CYCLES_5                                                    \
		(ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1 |                                           \
		 ADC_SMPR2_SMP10_0) /*!< Sampling time 810.5 ADC clock cycles */
	/**
	 * @}
	 */
	...
	#define LL_ADC_SINGLE_ENDED                                                                \
		(ADC_CALFACT_CALFACT_S) /*!< ADC channel ending set to single ended (literal also  \
					   used to set calibration mode) */
	#define LL_ADC_DIFFERENTIAL_ENDED                                                          \
		(ADC_CR_ADCALDIF |                                                                 \
		 ADC_CALFACT_CALFACT_D) /*!< ADC channel ending set to differential (literal also  \
					   used to set calibration mode) */
	...
	#define LL_ADC_AWD_ALL_CHANNELS_REG                                                        \
		(ADC_AWD_CR23_CHANNEL_MASK |                                                       \
		 ADC_CFGR_AWD1EN) /*!< ADC analog watchdog monitoring of all channels, converted   \
				     by group regular only */
	#define LL_ADC_AWD_ALL_CHANNELS_INJ                                                        \
		(ADC_AWD_CR23_CHANNEL_MASK |                                                       \
		 ADC_CFGR_JAWD1EN) /*!< ADC analog watchdog monitoring of all channels, converted  \
				      by group injected only */
	...
	#define LL_ADC_AWD_CHANNEL_19_REG                                                          \
		((LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                     \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel     \
				      (channel connected to GPIO pin) ADCx_IN19, converted by      \
				      group regular only */
	#define LL_ADC_AWD_CHANNEL_19_INJ                                                          \
		((LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                    \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel     \
				      (channel connected to GPIO pin) ADCx_IN19, converted by      \
				      group injected only */
	#define LL_ADC_AWD_CHANNEL_19_REG_INJ                                                      \
		((LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |  \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel     \
				      (channel connected to GPIO pin) ADCx_IN19, converted by      \
				      either group regular or injected */
	#define LL_ADC_AWD_CH_VREFINT_REG                                                          \
		((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel     \
				      connected to VrefInt: Internal voltage reference, converted  \
				      by group regular only */
	...
	#define LL_ADC_AWD_CH_VCORE_REG                                                            \
		((LL_ADC_CHANNEL_VCORE & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                  \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel     \
				      connected to VddCore, converted by group regular only */
	#define LL_ADC_AWD_CH_VCORE_INJ                                                            \
		((LL_ADC_CHANNEL_VCORE & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                 \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel     \
				      connected to VddCore, converted by group injected only */
	#define LL_ADC_AWD_CH_VCORE_REG_INJ                                                        \
		((LL_ADC_CHANNEL_VCORE & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                 \
		 ADC_CFGR_AWD1EN |                                                                 \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel     \
				      connected to VddCore, converted by either group regular or   \
				      injected */
	...
	#define LL_ADC_AWD_CH_VBAT_REG                                                             \
		((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                   \
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel     \
				      connected to Vbat/4: Vbat voltage through a divider ladder   \
				      of factor 1/4 to have Vbat always below Vdda, converted by   \
				      group regular only */
	...
	#define LL_ADC_AWD_CH_VBAT_REG_INJ                                                         \
		((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                  \
		 ...
		 ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel     \
				      connected to Vbat/4: Vbat voltage through a divider ladder   \
				      of factor 1/4 to have Vbat always below Vdda */
	...
	#define LL_ADC_OVS_GRP_REGULAR_CONTINUED                                                   \
		(ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of ADC group regular. If    \
				     group injected interrupts group regular: when ADC group       \
				     injected is triggered, the oversampling on ADC group regular  \
	...
	#define LL_ADC_OVS_GRP_INJ_REG_RESUMED                                                     \
		(ADC_CFGR2_JOVSE |                                                                 \
		 ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of both ADC groups regular  \
				     and injected. If group injected interrupting group regular:   \
				     when ADC group injected is triggered, the oversampling on ADC \
	...
	#define LL_ADC_OVS_REG_CONT                                                                \
		(0x00000000UL) /*!< ADC oversampling discontinuous mode: continuous mode (all      \
				  conversions of oversampling ratio are done from 1 trigger) */
	#define LL_ADC_OVS_REG_DISCONT                                                             \
		(ADC_CFGR2_TROVS) /*!< ADC oversampling discontinuous mode: discontinuous mode     \
	...
	#define LL_ADC_OVS_SHIFT_NONE                                                              \
		(0x00000000UL) /*!< ADC oversampling no shift (sum of the ADC conversions data is  \
				  not divided to result as the ADC oversampling conversion data)   \
				*/
	#define LL_ADC_OVS_SHIFT_RIGHT_1                                                           \
		(ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 1 (sum of the ADC conversions    \
				      data is divided by 2 to result as the ADC oversampling       \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_2                                                           \
		(ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 2 (sum of the ADC conversions    \
				      data is divided by 4 to result as the ADC oversampling       \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_3                                                           \
		(ADC_CFGR2_OVSS_1 |                                                                \
		 ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 3 (sum of the ADC conversions    \
				      data is divided by 8 to result as the ADC oversampling       \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_4                                                           \
		(ADC_CFGR2_OVSS_2) /*!< ADC oversampling shift of 4 (sum of the ADC conversions    \
				      data is divided by 16 to result as the ADC oversampling      \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_5                                                           \
		(ADC_CFGR2_OVSS_2 |                                                                \
		 ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 5 (sum of the ADC conversions    \
				      data is divided by 32 to result as the ADC oversampling      \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_6                                                           \
		(ADC_CFGR2_OVSS_2 |                                                                \
		 ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 6 (sum of the ADC conversions    \
				      data is divided by 64 to result as the ADC oversampling      \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_7                                                           \
		(ADC_CFGR2_OVSS_2 | ADC_CFGR2_OVSS_1 |                                             \
		 ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 7 (sum of the ADC conversions    \
				      data is divided by 128 to result as the ADC oversampling     \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_8                                                           \
		(ADC_CFGR2_OVSS_3) /*!< ADC oversampling shift of 8 (sum of the ADC conversions    \
				      data is divided by 256 to result as the ADC oversampling     \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_9                                                           \
		(ADC_CFGR2_OVSS_3 |                                                                \
		 ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 9 (sum of the ADC conversions    \
				      data is divided by 512 to result as the ADC oversampling     \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_10                                                          \
		(ADC_CFGR2_OVSS_3 |                                                                \
		 ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 10 (sum of the ADC conversions   \
				      data is divided by 1024 to result as the ADC oversampling    \
				      conversion data) */
	#define LL_ADC_OVS_SHIFT_RIGHT_11                                                          \
		(ADC_CFGR2_OVSS_3 | ADC_CFGR2_OVSS_1 |                                             \
		 ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 11 (sum of the ADC conversions   \
				      data is divided by 2048 to result as the ADC oversampling    \
				      conversion data) */
	/**
	 * @}
	 */
		...
		#define LL_ADC_MULTI_REG_DMA_EACH_ADC                                              \
			(0x00000000UL) /*!< ADC multimode group regular conversions are            \
					  transferred by DMA: each ADC uses its own DMA channel,   \
		...
		#define LL_ADC_MULTI_REG_DMA_RES_32_10B                                            \
			(ADC_CCR_DAMDF_1) /*!< ADC multimode group regular conversions are         \
					     transferred by DMA, one DMA channel for both ADC (DMA \
					     of ADC master). Setting for ADC resolution of 32      \
					     (16x2) down to 10 bits */
		#define LL_ADC_MULTI_REG_DMA_RES_8B                                                \
			(ADC_CCR_DAMDF_1 |                                                         \
			 ADC_CCR_DAMDF_0) /*!< ADC multimode group regular conversions are         \
					     transferred by DMA, one DMA channel for both ADC (DMA \
					     of ADC master). Setting for ADC resolution of 8 bits  \
					   */
		/**
		 * @}
		 */

		/** @defgroup ADC_LL_EC_MULTI_TWOSMP_DELAY  Multimode - Delay between two sampling
		 * phases
		 * @{
		 */
		#define LL_ADC_MULTI_TWOSMP_DELAY_1CYCLE_5                                         \
			(0x00000000UL) /*!< ADC multimode delay between two sampling phases: 1.5   \
					  ADC clock cycle for all resolution                    */
		#define LL_ADC_MULTI_TWOSMP_DELAY_2CYCLES_5                                        \
			(ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling            \
					     phases: 2.5 ADC clock cycles for all resolution */
		#define LL_ADC_MULTI_TWOSMP_DELAY_3CYCLES_5                                        \
			(ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling            \
					     phases: 3.5 ADC clock cycles for all resolution */
		#define LL_ADC_MULTI_TWOSMP_DELAY_4CYCLES_5                                        \
			(ADC_CCR_DELAY_1 |                                                         \
			 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling            \
					     phases: 4.5 ADC clock cycles for 16, 14, 12 or 10     \
					     bits resolution */
		#define LL_ADC_MULTI_TWOSMP_DELAY_4CYCLES_5_8_BITS                                 \
			(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                       \
			 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling            \
					     phases: 4.5 ADC clock cycles  for 8 bits resolution   \
					   */
		#define LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES_5                                        \
			(ADC_CCR_DELAY_2) /*!< ADC multimode delay between two sampling            \
					     phases: 5.5 ADC clock cycles for 16, 14, 12 bits      \
					     resolution       */
		#define LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES_5_10_BITS                                \
			(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                       \
			 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling            \
					     phases: 5.5 ADC clock cycles for 10 bits resolution   \
					   */
		#define LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES_5                                        \
			(ADC_CCR_DELAY_2 |                                                         \
			 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling            \
					     phases: 6.5 ADC clock cycles for 16 or 14 bits        \
					     resolution         */
		#define LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES_5_12_BITS                                \
			(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                       \
			 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling            \
					     phases: 6.5 ADC clock cycles for 12 bits resolution   \
					   */
		#define LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES_5                                        \
			(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1) /*!< ADC multimode delay between two   \
							       sampling phases: 7.5 ADC clock      \
							       cycles for 16 bits resolution */
		#define LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES_5_14_BITS                                \
			(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                       \
			 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling            \
					     phases: 7.5 ADC clock cycles for 14 bits resolution   \
					   */
		#define LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES_5                                        \
			(ADC_CCR_DELAY_3) /*!< ADC multimode delay between two sampling            \
					     phases: 8.5 ADC clock cycles for 16 bits resolution   \
					   */
		/**
		 * @}
		 */
	...
	#define LL_ADC_DELAY_INTERNAL_REGUL_STAB_US                                                \
		(10UL) /*!< Delay for ADC stabilization time (ADC voltage regulator start-up time) \
			*/
	...
	#define LL_ADC_DELAY_VREFINT_STAB_US                                                       \
		(5UL) /*!< Delay for internal voltage reference stabilization time */
	...
	#define LL_ADC_DELAY_TEMPSENSOR_STAB_US                                                    \
		(26UL) /*!< Delay for temperature sensor stabilization time */
	...
	/*           6 / 15625 = 0,384ms */
	/* At CPU speed example of 650 MHz, this means */
	/*    3.58 * 650 MHz = 524400 CPU cycles */
	#define ADC_LINEARITY_BIT_TOGGLE_TIMEOUT                                                   \
		(524400UL) /*!< ADC linearity set/clear bit delay */
	 ...
	 *         (3) On STM32MP1, fast channel (0.125 us for 14-bit resolution (ADC conversion
	 * rate up to 8 Ms/s)). Other channels are slow channels (conversion rate: refer to
	 * reference manual).
	 ...
	 *         (3) On STM32MP1, fast channel (0.125 us for 14-bit resolution (ADC conversion
	 * rate up to 8 Ms/s)). Other channels are slow channels (conversion rate: refer to
	 * reference manual).\n (1) For ADC channel read back from ADC register, comparison with
	 ...
	 * channel (channel connected to a GPIO pin). Value "1" if the channel corresponds to a
	...
	#define __LL_ADC_ANALOGWD_CHANNEL_GROUP(__CHANNEL__, __GROUP__)                            \
		(((__GROUP__) == LL_ADC_GROUP_REGULAR) ? (((__CHANNEL__)&ADC_CHANNEL_ID_MASK) |    \
	 ...
	 *         @arg @ref LL_ADC_RESOLUTION_10B
	 *         @arg @ref LL_ADC_RESOLUTION_8B
	 * @retval ADC conversion data full-scale digital value (unit: digital value of ADC
	 * conversion data)
	 */
	 ...
	 * typical value (unit: uV/DegCelsius). On STM32MP1, refer to device datasheet parameter
	 * "Avg_Slope".
	 ...
	 * STM32MP1, refer to device datasheet parameter "V30" (corresponding to TS_CAL1).
	 ...
	 * voltage has been measured. This parameter can be one of the following values:
	 *         @arg @ref LL_ADC_RESOLUTION_16B
	 *         @arg @ref LL_ADC_RESOLUTION_14B
	 *         @arg @ref LL_ADC_RESOLUTION_12B
	 *         @arg @ref LL_ADC_RESOLUTION_10B
						    ...
						    uint32_t PathInternal)
{
	if (PathInternal == LL_ADC_PATH_INTERNAL_VDDCORE) {
		...
		MODIFY_REG(ADCxy_COMMON->CCR, ADC_CCR_VREFEN | ADC_CCR_VSENSEEN | ADC_CCR_VBATEN,
			   PathInternal);
	}
}
...
__STATIC_INLINE uint32_t LL_ADC_GetCommonPathInternalCh(ADC_Common_TypeDef *ADCxy_COMMON)
{
	return (uint32_t)(READ_BIT(ADCxy_COMMON->CCR,
				   ADC_CCR_VREFEN | ADC_CCR_VSENSEEN | ADC_CCR_VBATEN));
}
 ...
 *
 *         (1) On STM32MP1, parameter available only on ADC instance: ADC2.\n
 *         (3) On STM32MP1, fast channel (0.125 us for 14-bit resolution (ADC conversion rate up to
 * 8 Ms/s)). Other channels are slow channels (conversion rate: refer to reference manual).
 ...
 */
__STATIC_INLINE void LL_ADC_SetDataRightShift(ADC_TypeDef *ADCx, uint32_t Offsety,
					      uint32_t RigthShift)
{
...
{
	return (uint32_t)((READ_BIT(ADCx->CFGR2, (ADC_CFGR2_RSHIFT1 << (Offsety & 0x1FUL)))) >>
			  (Offsety & 0x1FUL));
}
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerSource(ADC_TypeDef *ADCx)
{
	...
	uint32_t shift_exten =
		((trigger_source & ADC_CFGR_EXTEN) >> (ADC_REG_TRIG_EXTEN_BITOFFSET_POS - 2UL));

	/* Set bitfield corresponding to ADC_CFGR_EXTEN and ADC_CFGR_EXTSEL         */
	/* to match with triggers literals definition.                              */
	return ((trigger_source & (ADC_REG_TRIG_SOURCE_MASK >> shift_exten) & ADC_CFGR_EXTSEL) |
...
__STATIC_INLINE uint32_t LL_ADC_INJ_GetTriggerSource(ADC_TypeDef *ADCx)
{
	...
	uint32_t shift_jexten =
		((trigger_source & ADC_JSQR_JEXTEN) >> (ADC_INJ_TRIG_EXTEN_BITOFFSET_POS - 2UL));
...
{
	return (uint32_t)((READ_BIT(ADCx->JSQR, (ADC_CHANNEL_ID_NUMBER_MASK >>
						 ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS)
							<< (Rank & ADC_INJ_RANK_ID_JSQR_MASK)) >>
			   (Rank & ADC_INJ_RANK_ID_JSQR_MASK))
			  << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS);
						   ...
						   uint32_t Rank3_Channel, uint32_t Rank4_Channel)
{
	...
	MODIFY_REG(ADCx->JSQR,
		   ADC_JSQR_JEXTSEL | ADC_JSQR_JEXTEN | ADC_JSQR_JSQ4 | ADC_JSQR_JSQ3 |
			   ADC_JSQR_JSQ2 | ADC_JSQR_JSQ1 | ADC_JSQR_JL,
						   ...
						   uint32_t SamplingTime)
{
	...
	/* other bits reserved for other purpose.                                   */
	__IO uint32_t *preg =
		__ADC_PTR_REG_OFFSET(ADCx->SMPR1, ((Channel & ADC_CHANNEL_SMPRX_REGOFFSET_MASK) >>
...
__STATIC_INLINE void LL_ADC_ConfigOverSamplingRatioShift(ADC_TypeDef *ADCx, uint32_t Ratio,
							 uint32_t Shift)
{
	MODIFY_REG(ADCx->CFGR2, (ADC_CFGR2_OVSS | ADC_CFGR2_OSR),
		   (Shift | (((Ratio - 1UL) << ADC_CFGR2_OSR_Pos))));
}
...
{
	return (((uint32_t)(READ_BIT(ADCx->CFGR2, ADC_CFGR2_OSR)) + (1UL << ADC_CFGR2_OSR_Pos)) >>
		ADC_CFGR2_OSR_Pos);
}
					     ...
					     uint32_t SingleDiff)
{
	...
	/*       instead of modifying only the selected bit for this function,      */
	/*       to not interfere with bits with HW property "rs".                  */
	MODIFY_REG(ADCx->CR, ADC_CR_ADCALLIN | ADC_CR_ADCALDIF | ADC_CR_BITS_PROPERTY_RS,
		   ADC_CR_ADCAL | (CalibrationMode & ADC_CALIB_MODE_MASK) |
			   (SingleDiff & ADC_SINGLEDIFF_CALIB_START_MASK));
}
...
{
	return ((READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_EOC_SLV) == (LL_ADC_FLAG_EOC_SLV)) ? 1UL
											    : 0UL);
}
...
{
	return ((READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_EOS_MST) == (LL_ADC_FLAG_EOS_MST)) ? 1UL
											    : 0UL);
}
...
{
	return ((READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_EOS_SLV) == (LL_ADC_FLAG_EOS_SLV)) ? 1UL
											    : 0UL);
}
...
{
	return ((READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_OVR_MST) == (LL_ADC_FLAG_OVR_MST)) ? 1UL
											    : 0UL);
}
...
{
	return ((READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_OVR_SLV) == (LL_ADC_FLAG_OVR_SLV)) ? 1UL
											    : 0UL);
}
