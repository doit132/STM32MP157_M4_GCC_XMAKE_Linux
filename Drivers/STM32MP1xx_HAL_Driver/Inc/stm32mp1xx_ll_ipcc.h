 ...
 */
	...
	#define LL_IPCC_C1TOC2SR_CH1F                                                              \
		IPCC_C1TOC2SR_CH1F_Msk /*!< C1 transmit to C2 receive Channel1 status flag before  \
					  masking */
	#define LL_IPCC_C1TOC2SR_CH2F                                                              \
		IPCC_C1TOC2SR_CH2F_Msk /*!< C1 transmit to C2 receive Channel2 status flag before  \
					  masking */
	#define LL_IPCC_C1TOC2SR_CH3F                                                              \
		IPCC_C1TOC2SR_CH3F_Msk /*!< C1 transmit to C2 receive Channel3 status flag before  \
					  masking */
	#define LL_IPCC_C1TOC2SR_CH4F                                                              \
		IPCC_C1TOC2SR_CH4F_Msk /*!< C1 transmit to C2 receive Channel4 status flag before  \
					  masking */
	#define LL_IPCC_C1TOC2SR_CH5F                                                              \
		IPCC_C1TOC2SR_CH5F_Msk /*!< C1 transmit to C2 receive Channel5 status flag before  \
					  masking */
	#define LL_IPCC_C1TOC2SR_CH6F                                                              \
		IPCC_C1TOC2SR_CH6F_Msk /*!< C1 transmit to C2 receive Channel6 status flag before  \
					  masking */
	#define LL_IPCC_C2TOC1SR_CH1F                                                              \
		IPCC_C2TOC1SR_CH1F_Msk /*!< C2 transmit to C1 receive Channel1 status flag before  \
					  masking */
	#define LL_IPCC_C2TOC1SR_CH2F                                                              \
		IPCC_C2TOC1SR_CH2F_Msk /*!< C2 transmit to C1 receive Channel2 status flag before  \
					  masking */
	#define LL_IPCC_C2TOC1SR_CH3F                                                              \
		IPCC_C2TOC1SR_CH3F_Msk /*!< C2 transmit to C1 receive Channel3 status flag before  \
					  masking */
	#define LL_IPCC_C2TOC1SR_CH4F                                                              \
		IPCC_C2TOC1SR_CH4F_Msk /*!< C2 transmit to C1 receive Channel4 status flag before  \
					  masking */
	#define LL_IPCC_C2TOC1SR_CH5F                                                              \
		IPCC_C2TOC1SR_CH5F_Msk /*!< C2 transmit to C1 receive Channel5 status flag before  \
					  masking */
	#define LL_IPCC_C2TOC1SR_CH6F                                                              \
		IPCC_C2TOC1SR_CH6F_Msk /*!< C2 transmit to C1 receive Channel6 status flag before  \
					  masking */
...
__STATIC_INLINE uint32_t LL_C1_IPCC_IsEnabledTransmitChannel(IPCC_TypeDef const *const IPCCx,
							     uint32_t Channel)
{
	return ((READ_BIT(IPCCx->C1MR, Channel << IPCC_C1MR_CH1FM_Pos) !=
		 (Channel << IPCC_C1MR_CH1FM_Pos))
			? 1UL
			: 0UL);
}
...
__STATIC_INLINE uint32_t LL_C2_IPCC_IsEnabledTransmitChannel(IPCC_TypeDef const *const IPCCx,
							     uint32_t Channel)
{
	return ((READ_BIT(IPCCx->C2MR, Channel << IPCC_C2MR_CH1FM_Pos) !=
		 (Channel << IPCC_C2MR_CH1FM_Pos))
			? 1UL
			: 0UL);
}
