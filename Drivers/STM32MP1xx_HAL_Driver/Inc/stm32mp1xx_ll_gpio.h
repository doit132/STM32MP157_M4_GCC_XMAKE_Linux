...
typedef struct {
	...
	uint32_t Alternate; /*!< Specifies the Peripheral to be connected to the selected pins.
				 ...
				 GPIO HW configuration can be modified afterwards using unitary
			       function @ref LL_GPIO_SetAFPin_0_7() and LL_GPIO_SetAFPin_8_15().*/
} LL_GPIO_InitTypeDef;
	...
	#define LL_GPIO_PIN_ALL                                                                    \
		(GPIO_BSRR_BS0 | GPIO_BSRR_BS1 | GPIO_BSRR_BS2 | GPIO_BSRR_BS3 | GPIO_BSRR_BS4 |   \
		 ...
		 GPIO_BSRR_BS10 | GPIO_BSRR_BS11 | GPIO_BSRR_BS12 | GPIO_BSRR_BS13 |               \
		 GPIO_BSRR_BS14 | GPIO_BSRR_BS15) /*!< Select all pins */
	/**
	 * @}
	 */
	...
	#define LL_GPIO_SPEED_FREQ_HIGH                                                            \
		GPIO_OSPEEDR_OSPEEDR0_1 /*!< Select I/O fast output speed   */
...
{
	return (uint32_t)(READ_BIT(GPIOx->OSPEEDR, ((Pin * Pin) * GPIO_OSPEEDR_OSPEEDR0)) /
			  (Pin * Pin));
}
...
{
	return (uint32_t)(READ_BIT(GPIOx->AFR[0], ((((Pin * Pin) * Pin) * Pin) * GPIO_AFRL_AFR0)) /
			  (((Pin * Pin) * Pin) * Pin));
}
...
__STATIC_INLINE void LL_GPIO_SetAFPin_8_15(GPIO_TypeDef *GPIOx, uint32_t Pin, uint32_t Alternate)
{
	MODIFY_REG(GPIOx->AFR[1],
		   (((((Pin >> 8U) * (Pin >> 8U)) * (Pin >> 8U)) * (Pin >> 8U)) * GPIO_AFRH_AFR8),
