 ...
 */
	...
	#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C1                                                    \
		SYSCFG_PMCSETR_I2C1_FMP /*!< Enable Fast Mode Plus for I2C1      */
	#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C2                                                    \
		SYSCFG_PMCSETR_I2C2_FMP /*!< Enable Fast Mode Plus for I2C2      */
	#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C3                                                    \
		SYSCFG_PMCSETR_I2C3_FMP /*!< Enable Fast Mode Plus for I2C3      */
	#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C4                                                    \
		SYSCFG_PMCSETR_I2C4_FMP /*!< Enable Fast Mode Plus for I2C4      */
	#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C5                                                    \
		SYSCFG_PMCSETR_I2C5_FMP /*!< Enable Fast Mode Plus for I2C5      */
	#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C6                                                    \
		SYSCFG_PMCSETR_I2C6_FMP /*!< Enable Fast Mode Plus for I2C6      */
	/**
	 * @}
	 */
	...
	#define LL_SYSCFG_ETH_REF_CLK                                                              \
		SYSCFG_PMCSETR_ETH_REF_CLK_SEL /*!< Enable ETH REF clock selection */
	/**
	 * @}
	 */
	...
	#define LL_SYSCFG_TIMBREAK_PVD                                                             \
		SYSCFG_CBR_PVDL /*!< Enables and locks the PVD connection                          \
				     with TIM1/8/15/16/17 Break Input                              \
				     and also the PVDE and PLS bits of the Power Control Interface \
				 */
	#define LL_SYSCFG_TIMBREAK_CM4_LOCKUP                                                      \
		SYSCFG_CBR_CLL /*!< Enables and locks the Cortex-M4 LOCKUP signal                  \
	...
	#define LL_SYSCFG_REGISTER_CODE                                                            \
		SYSCFG_CMPCR_SW_CTRL /*!< Enable Compensation Software Control */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_SYSCFG_AXI_MASTER0_S1                                                           \
		SYSCFG_ICNR_AXI_M0 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER1_S1                                                           \
		SYSCFG_ICNR_AXI_M1 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER2_S1                                                           \
		SYSCFG_ICNR_AXI_M2 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER3_S1                                                           \
		SYSCFG_ICNR_AXI_M3 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER5_S1                                                           \
		SYSCFG_ICNR_AXI_M5 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER6_S1                                                           \
		SYSCFG_ICNR_AXI_M6 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER7_S1                                                           \
		SYSCFG_ICNR_AXI_M7 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER8_S1                                                           \
		SYSCFG_ICNR_AXI_M8 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER9_S1                                                           \
		SYSCFG_ICNR_AXI_M9 /*!< Enable AXI Master access DDR through Slave S1 */
	#define LL_SYSCFG_AXI_MASTER10_S1                                                          \
		SYSCFG_ICNR_AXI_M10 /*!< Enable AXI Master access DDR through Slave S1 */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_DBGMCU_IWDG_FREEZE_1CA7_HALT                                                    \
		0U /*!< Freeze Watchdog timer when either CA7 core halt in debug mode */
	#define LL_DBGMCU_IWDG_FREEZE_2CA7_HALT                                                    \
		DBGMCU_CR_DBG_WDFZCTL /*!< Freeze Watchdog timer when both CA7 cores halt in debug \
					 mode */
	/**
	 * @}
	 */
	...
	#define LL_DBGMCU_APB1_GRP1_LPTIM1_STOP                                                    \
		DBGMCU_APB1_FZ_DBG_LPTIM1_STOP /*!< LPTIM1 counter stopped when core is halted */
	#define LL_DBGMCU_APB1_GRP1_WWDG1_STOP                                                     \
		DBGMCU_APB1_FZ_DBG_WWDG1_STOP /*!< WWDG1 counter stopped when core is halted */
	#define LL_DBGMCU_APB1_GRP1_I2C1_STOP                                                      \
		DBGMCU_APB1_FZ_DBG_I2C1_STOP /*!< I2C1 SMBUS timeout mode stopped when Core is     \
						halted */
	#define LL_DBGMCU_APB1_GRP1_I2C2_STOP                                                      \
		DBGMCU_APB1_FZ_DBG_I2C2_STOP /*!< I2C2 SMBUS timeout mode stopped when Core is     \
						halted */
	#define LL_DBGMCU_APB1_GRP1_I2C3_STOP                                                      \
		DBGMCU_APB1_FZ_DBG_I2C3_STOP /*!< I2C3 SMBUS timeout mode stopped when Core is     \
						halted */
	#define LL_DBGMCU_APB1_GRP1_I2C5_STOP                                                      \
		DBGMCU_APB1_FZ_DBG_I2C5_STOP /*!< I2C5 SMBUS timeout mode stopped when Core is     \
						halted */
	/**
	 * @}
	 */
	...
	#define LL_DBGMCU_APB2_GRP1_TIM1_STOP                                                      \
		DBGMCU_APB2_FZ_DBG_TIM1_STOP /*!< TIM1 is frozen while the core is in debug mode   \
					      */
	#define LL_DBGMCU_APB2_GRP1_TIM8_STOP                                                      \
		DBGMCU_APB2_FZ_DBG_TIM8_STOP /*!< TIM8 is frozen while the core is in debug mode   \
					      */
	#define LL_DBGMCU_APB2_GRP1_TIM15_STOP                                                     \
		DBGMCU_APB2_FZ_DBG_TIM15_STOP /*!< TIM15 is frozen while the core is in debug mode \
					       */
	#define LL_DBGMCU_APB2_GRP1_TIM16_STOP                                                     \
		DBGMCU_APB2_FZ_DBG_TIM16_STOP /*!< TIM16 is frozen while the core is in debug mode \
					       */
	#define LL_DBGMCU_APB2_GRP1_TIM17_STOP                                                     \
		DBGMCU_APB2_FZ_DBG_TIM17_STOP /*!< TIM17 is frozen while the core is in debug mode \
					       */
	#define LL_DBGMCU_APB2_GRP1_FDCAN_STOP                                                     \
		DBGMCU_APB2_FZ_DBG_FDCAN_STOP /*!< FDCAN is frozen while the core is in debug mode \
					       */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_DBGMCU_APB3_GRP1_LPTIM2_STOP                                                    \
		DBGMCU_APB3_FZ_DBG_LPTIM2_STOP /*!< LPTIM2 counter stopped when core is halted */
	#define LL_DBGMCU_APB3_GRP1_LPTIM3_STOP                                                    \
		DBGMCU_APB3_FZ_DBG_LPTIM3_STOP /*!< LPTIM3 counter stopped when core is halted */
	#define LL_DBGMCU_APB3_GRP1_LPTIM4_STOP                                                    \
		DBGMCU_APB3_FZ_DBG_LPTIM4_STOP /*!< LPTIM4 counter stopped when core is halted */
	#define LL_DBGMCU_APB3_GRP1_LPTIM5_STOP                                                    \
		DBGMCU_APB3_FZ_DBG_LPTIM5_STOP /*!< LPTIM5 counter stopped when core is halted */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_DBGMCU_APB5_GRP1_I2C4_STOP                                                      \
		DBGMCU_APB5_FZ_DBG_I2C4_STOP /*!< I2C4 is frozen while the core is in debug mode   \
					      */
	#define LL_DBGMCU_APB5_GRP1_RTC_STOP                                                       \
		DBGMCU_APB5_FZ_DBG_RTC_STOP /*!< RTC is frozen while the core is in debug mode */
	#define LL_DBGMCU_APB5_GRP1_I2C6_STOP                                                      \
		DBGMCU_APB5_FZ_DBG_I2C6_STOP /*!< I2C6 is frozen while the core is in debug mode   \
					      */
/**
 * @}
 */
...
{
	MODIFY_REG(SYSCFG->PMCSETR, (SYSCFG_PMCSETR_ETH_CLK_SEL | SYSCFG_PMCSETR_ETH_REF_CLK_SEL),
		   Clock);
}
...
{
	MODIFY_REG(SYSCFG->PMCCLRR, (SYSCFG_PMCCLRR_ETH_CLK_SEL | SYSCFG_PMCCLRR_ETH_REF_CLK_SEL),
		   Clock);
}
...
{
	MODIFY_REG(SYSCFG->PMCCLRR, (SYSCFG_PMCCLRR_ANA0_SEL_SEL | SYSCFG_PMCCLRR_ANA1_SEL_SEL),
		   AnalogSwitch);
}
...
__STATIC_INLINE void LL_SYSCFG_DisableFastModePlus(uint32_t ConfigFastModePlus)
{
	MODIFY_REG(SYSCFG->PMCCLRR,
		   (SYSCFG_PMCCLRR_I2C1_FMP | SYSCFG_PMCCLRR_I2C2_FMP | SYSCFG_PMCCLRR_I2C3_FMP |
		    SYSCFG_PMCCLRR_I2C4_FMP | SYSCFG_PMCCLRR_I2C5_FMP | SYSCFG_PMCCLRR_I2C6_FMP),
		   ConfigFastModePlus);
}
...
{
	return (uint32_t)(READ_BIT(SYSCFG->CMPENSETR, SYSCFG_CMPENSETR_MCU_EN) ==
			  SYSCFG_CMPENSETR_MCU_EN);
}
...
{
	return (uint32_t)(READ_BIT(SYSCFG->IOCTRLSETR, SYSCFG_IOCTRLSETR_HSLVEN_SPI) ==
...
{
	MODIFY_REG(SYSCFG->IOCTRLCLRR, SYSCFG_IOCTRLCLRR_HSLVEN_SDMMC,
		   SYSCFG_IOCTRLCLRR_HSLVEN_SDMMC);
}
...
{
	return (uint32_t)(READ_BIT(SYSCFG->IOCTRLSETR, SYSCFG_IOCTRLSETR_HSLVEN_SDMMC) ==
...
{
	return (uint32_t)(READ_BIT(SYSCFG->IOCTRLSETR, SYSCFG_IOCTRLSETR_HSLVEN_ETH) ==
...
{
	MODIFY_REG(SYSCFG->IOCTRLCLRR, SYSCFG_IOCTRLCLRR_HSLVEN_QUADSPI,
		   SYSCFG_IOCTRLCLRR_HSLVEN_QUADSPI);
}
...
{
	return (uint32_t)(READ_BIT(SYSCFG->IOCTRLSETR, SYSCFG_IOCTRLSETR_HSLVEN_QUADSPI) ==
...
{
	MODIFY_REG(SYSCFG->IOCTRLCLRR, SYSCFG_IOCTRLCLRR_HSLVEN_TRACE,
		   SYSCFG_IOCTRLCLRR_HSLVEN_TRACE);
}
...
{
	return (uint32_t)(READ_BIT(SYSCFG->IOCTRLSETR, SYSCFG_IOCTRLSETR_HSLVEN_TRACE) ==
