...
#define EXTI_LINE_17                                                                               \
	(EXTI_CONFIG | EXTI_EVENT | EXTI_REG1 | 0x11u) /* RTC timestamp and SecureError wakeup */
#define EXTI_LINE_18                                                                               \
	(EXTI_CONFIG | EXTI_EVENT | EXTI_REG1 | 0x12u) /* TAMP tamper and SecureError wakeup */
#define EXTI_LINE_19                                                                               \
	(EXTI_CONFIG | EXTI_EVENT | EXTI_REG1 |                                                    \
	 0x13u) /* RTC Wakeup timer and Alarms (A and B) and SecureError wakeup */
...
#define IS_EXTI_LINE(__LINE__)                                                                     \
	((((__LINE__) & ~(EXTI_PROPERTY_MASK | EXTI_EVENT_PRESENCE_MASK | EXTI_REG_MASK |          \
			  EXTI_PIN_MASK)) == 0x00u) &&                                             \
...
#define IS_EXTI_PENDING_EDGE(__LINE__)                                                             \
	(((__LINE__) == EXTI_TRIGGER_RISING) || ((__LINE__) == EXTI_TRIGGER_FALLING))
...
#define IS_EXTI_GPIO_PORT(__PORT__)                                                                \
	(((__PORT__) == EXTI_GPIOA) || ((__PORT__) == EXTI_GPIOB) || ((__PORT__) == EXTI_GPIOC) || \
	 ...
	 ((__PORT__) == EXTI_GPIOK) || ((__PORT__) == EXTI_GPIOZ))
