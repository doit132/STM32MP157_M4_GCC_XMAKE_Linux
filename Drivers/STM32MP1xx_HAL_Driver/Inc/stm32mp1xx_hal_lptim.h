...
typedef struct {
	uint32_t Polarity; /*!< Selects the polarity of the active edge for the counter unit
			    ...
			    Note: This parameter is used only when Ultra low power clock source is
			    used. Note: If the polarity is configured on 'both edges', an auxiliary
			    clock (one of the Low power oscillator) must be active. This parameter
			    can be a value of @ref LPTIM_Clock_Polarity */

	uint32_t SampleTime; /*!< Selects the clock sampling time to configure the clock glitch
			     filter. Note: This parameter is used only when Ultra low power clock
			     source is used. This parameter can be a value of @ref
...
typedef struct {
	...
	uint32_t
		ActiveEdge; /*!< Selects the Trigger active edge.
			    Note: This parameter is used only when an external trigger is used.
			    This parameter can be a value of @ref LPTIM_External_Trigger_Polarity */

	uint32_t
		SampleTime; /*!< Selects the trigger sampling time to configure the clock glitch
			    filter. Note: This parameter is used only when an external trigger is
			    used. This parameter can be a value of @ref LPTIM_Trigger_Sample_Time */
...
typedef struct {
	...
	uint32_t
		CounterSource; /*!< Specifies whether the counter is incremented each internal event
			       or each external event.
			       This parameter can be a value of @ref LPTIM_Counter_Source */

	uint32_t Input1Source; /*!< Specifies source selected for input1 (GPIO or comparator
			       output). This parameter can be a value of @ref LPTIM_Input1_Source */

	uint32_t
		Input2Source; /*!< Specifies source selected for input2 (GPIO or comparator output).
	...
	#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
{
	...
	void (*MspInitCallback)(
		struct __LPTIM_HandleTypeDef *hlptim); /*!< LPTIM Base Msp Init Callback */
	void (*MspDeInitCallback)(
		struct __LPTIM_HandleTypeDef *hlptim); /*!< LPTIM Base Msp DeInit Callback */
	void (*CompareMatchCallback)(
		struct __LPTIM_HandleTypeDef *hlptim); /*!< Compare match Callback */
	void (*AutoReloadMatchCallback)(
		struct __LPTIM_HandleTypeDef *hlptim); /*!< Auto-reload match Callback */
	void (*TriggerCallback)(struct __LPTIM_HandleTypeDef
					*hlptim); /*!< External trigger event detection Callback */
	void (*CompareWriteCallback)(
		struct __LPTIM_HandleTypeDef
			*hlptim); /*!< Compare register write complete Callback     */
	void (*AutoReloadWriteCallback)(
		struct __LPTIM_HandleTypeDef
			*hlptim); /*!< Auto-reload register write complete Callback */
	...
	void (*DirectionDownCallback)(
		struct __LPTIM_HandleTypeDef
			*hlptim); /*!< Down-counting direction change Callback      */
	#endif			  /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
} LPTIM_HandleTypeDef;
...
typedef enum {
	...
	HAL_LPTIM_AUTORELOAD_WRITE_CB_ID =
		0x06U, /*!< Auto-reload register write complete Callback ID  */
...
typedef void (*pLPTIM_CallbackTypeDef)(
	 ...
	 * @retval None
	 */
	#define __HAL_LPTIM_RESET_COUNTER(__HANDLE__)                                              \
		((__HANDLE__)->Instance->CR |= LPTIM_CR_COUNTRST)
	 ...
	 * @retval None
	 */
	#define __HAL_LPTIM_RESET_COUNTER_AFTERREAD(__HANDLE__)                                    \
		((__HANDLE__)->Instance->CR |= LPTIM_CR_RSTARE)
...
HAL_LPTIM_StateTypeDef HAL_LPTIM_GetState(LPTIM_HandleTypeDef *hlptim);
	...
	#define IS_LPTIM_TRG_SOURCE(__TRIG__)                                                      \
		(((__TRIG__) == LPTIM_TRIGSOURCE_SOFTWARE) ||                                      \
		 ((__TRIG__) == LPTIM_TRIGSOURCE_0) || ((__TRIG__) == LPTIM_TRIGSOURCE_1) ||       \
		 ((__TRIG__) == LPTIM_TRIGSOURCE_2) || ((__TRIG__) == LPTIM_TRIGSOURCE_3) ||       \
		 ((__TRIG__) == LPTIM_TRIGSOURCE_4) || ((__TRIG__) == LPTIM_TRIGSOURCE_5) ||       \
	...
	#define IS_LPTIM_INPUT1_SOURCE(__INSTANCE__, __SOURCE__)                                   \
		((((__INSTANCE__) == LPTIM1) && (((__SOURCE__) == LPTIM_INPUT1SOURCE_GPIO))) ||    \
		 (((__INSTANCE__) == LPTIM2) && (((__SOURCE__) == LPTIM_INPUT1SOURCE_GPIO))) ||    \
		 (((__INSTANCE__) == LPTIM3) && (((__SOURCE__) == LPTIM_INPUT1SOURCE_SAI4_FSA) ||  \
						 ((__SOURCE__) == LPTIM_INPUT1SOURCE_SAI4_FSB))))

	#define IS_LPTIM_INPUT2_SOURCE(__INSTANCE__, __SOURCE__)                                   \
		((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2)) &&                     \
