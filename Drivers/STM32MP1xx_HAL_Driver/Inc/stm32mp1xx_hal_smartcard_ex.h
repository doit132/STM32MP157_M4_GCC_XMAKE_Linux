...
/** @defgroup SMARTCARDEx_Transmission_Completion_Indication SMARTCARD Transmission Completion
 * Indication
 * @{
 */
#define SMARTCARD_TCBGT SMARTCARD_IT_TCBGT /*!< SMARTCARD transmission complete before guard time  \
					    */
#define SMARTCARD_TC                                                                               \
	SMARTCARD_IT_TC /*!< SMARTCARD transmission complete (flag raised when guard time has      \
			   elapsed) */
/**
 * @}
 */

/** @defgroup SMARTCARDEx_Advanced_Features_Initialization_Type SMARTCARD advanced feature
 * initialization type
 * @{
 */
...
#define SMARTCARD_FLAG_TCBGT                                                                       \
	USART_ISR_TCBGT /*!< SMARTCARD transmission complete before guard time completion */
...
#define SMARTCARD_IT_TCBGT                                                                         \
	0x1978U /*!< SMARTCARD transmission complete before guard time completion interruption */
...
#define SMARTCARD_CLEAR_TCBGTF                                                                     \
	USART_ICR_TCBGTCF /*!< SMARTCARD transmission complete before guard time completion clear  \
			     flag */
...
#define SMARTCARD_TRANSMISSION_COMPLETION_SETTING(__HANDLE__)                                      \
	do {                                                                                       \
		if (HAL_IS_BIT_CLR((__HANDLE__)->AdvancedInit.AdvFeatureInit,                      \
			...
			assert_param(IS_SMARTCARD_TRANSMISSION_COMPLETION(                         \
