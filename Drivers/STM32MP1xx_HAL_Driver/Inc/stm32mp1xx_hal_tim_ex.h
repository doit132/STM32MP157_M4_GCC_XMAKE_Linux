...
typedef struct {
	...
	uint32_t Polarity; /*!< Specifies the break input source polarity.
				This parameter can be a value of @ref
			      TIMEx_Break_Input_Source_Polarity Not relevant when analog watchdog
			      output of the DFSDM1 used as break input source */
...
#define TIM_TIM1_ETR_ADC1_AWD1                                                                     \
	(TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0)	   /* !< TIM1_ETR is connected to ADC1 AWD1 */
#define TIM_TIM1_ETR_ADC1_AWD2 (TIM1_AF1_ETRSEL_2) /* !< TIM1_ETR is connected to ADC1 AWD2 */
#define TIM_TIM1_ETR_ADC1_AWD3                                                                     \
	(TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0) /* !< TIM1_ETR is connected to ADC1 AWD3 */
#define TIM_TIM1_ETR_ADC2_AWD1                                                                     \
	(TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1) /* !< TIM1_ETR is connected to ADC3 AWD1 */
#define TIM_TIM1_ETR_ADC2_AWD2                                                                     \
	(TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 |                                                   \
	 TIM1_AF1_ETRSEL_0)			 /* !< TIM1_ETR is connected to ADC3 AWD2 */
#define TIM_TIM1_ETR_ADC2_AWD3 TIM1_AF1_ETRSEL_3 /* !< TIM1_ETR is connected to ADC3 AWD3 */
	...
	#define TIM_TIM8_ETR_ADC1_AWD1                                                             \
		(TIM8_AF1_ETRSEL_1 | TIM8_AF1_ETRSEL_0) /* !< TIM8_ETR is connected to ADC1 AWD1   \
							 */
	#define TIM_TIM8_ETR_ADC1_AWD2                                                             \
		(TIM8_AF1_ETRSEL_2) /* !< TIM8_ETR is connected to ADC1 AWD2 */
	#define TIM_TIM8_ETR_ADC1_AWD3                                                             \
		(TIM8_AF1_ETRSEL_2 | TIM8_AF1_ETRSEL_0) /* !< TIM8_ETR is connected to ADC1 AWD3   \
							 */
	#define TIM_TIM8_ETR_ADC2_AWD1                                                             \
		(TIM8_AF1_ETRSEL_2 | TIM8_AF1_ETRSEL_1) /* !< TIM8_ETR is connected to ADC3 AWD1   \
							 */
	#define TIM_TIM8_ETR_ADC2_AWD2                                                             \
		(TIM8_AF1_ETRSEL_2 | TIM8_AF1_ETRSEL_1 |                                           \
		 TIM8_AF1_ETRSEL_0)			 /* !< TIM8_ETR is connected to ADC3 AWD2 */
	#define TIM_TIM8_ETR_ADC2_AWD3 TIM8_AF1_ETRSEL_3 /* !< TIM8_ETR is connected to ADC3 AWD3  \
							  */
#endif
#if defined(TIM2)
	#define TIM_TIM2_ETR_GPIO 0x00000000U /* !< TIM2_ETR is connected to GPIO */
	#define TIM_TIM2_ETR_RCC_LSE                                                               \
		(TIM2_AF1_ETRSEL_1 | TIM2_AF1_ETRSEL_0) /* !< TIM2_ETR is connected to RCC LSE */
	#define TIM_TIM2_ETR_SAI1_FSA                                                              \
		(TIM2_AF1_ETRSEL_2) /* !< TIM2_ETR is connected to SAI1 FS_A */
	#define TIM_TIM2_ETR_SAI1_FSB                                                              \
		(TIM2_AF1_ETRSEL_2 | TIM2_AF1_ETRSEL_0) /* !< TIM2_ETR is connected to SAI1 FS_B   \
							 */
	#define TIM_TIM2_ETR_ETH_PPS                                                               \
		(TIM2_AF1_ETRSEL_2 | TIM2_AF1_ETRSEL_1) /* !< TIM2_ETR is connected to ETH PPS */
#endif
#if defined(TIM3)
	#define TIM_TIM3_ETR_GPIO 0x00000000U /* !< TIM3_ETR is connected to GPIO */
	#define TIM_TIM3_ETR_ETH_PPS                                                               \
		(TIM3_AF1_ETRSEL_2 | TIM3_AF1_ETRSEL_1) /* !< TIM3_ETR is connected to ETH PPS */
#endif
#if defined(TIM4)
	...
	#define TIM_TIM5_ETR_SAI2_FSB TIM5_AF1_ETRSEL_1 /* !< TIM5_ETR is connected to SAI2 FS_B   \
							 */
	#define TIM_TIM5_ETR_OTG_SOF                                                               \
		(TIM5_AF1_ETRSEL_1 | TIM5_AF1_ETRSEL_0) /* !< TIM5_ETR is connected to OTG SOF */
#endif
/**
 * @}
 */
...
#define TIM_BREAKINPUTSOURCE_DFSDM1                                                                \
	0x00000008U /* !< The analog watchdog output of the DFSDM1 peripheral is connected to the  \
		       break input */
/**
 * @}
 */
...
#define TIM_TIM15_TI1_TIM4_CH1                                                                     \
	(TIM_TISEL_TI1SEL_0 | TIM_TISEL_TI1SEL_1)  /* !< TIM15_TI1 is connected to TIM4 CH1 */
#define TIM_TIM15_TI1_RCC_LSE (TIM_TISEL_TI1SEL_2) /* !< TIM15_TI1 is connected to RCC LSE  */
#define TIM_TIM15_TI1_RCC_CSI                                                                      \
	(TIM_TISEL_TI1SEL_2 | TIM_TISEL_TI1SEL_0) /* !< TIM15_TI1 is connected to RCC CSI  */
#define TIM_TIM15_TI1_RCC_MCO2                                                                     \
	(TIM_TISEL_TI1SEL_2 | TIM_TISEL_TI1SEL_1) /* !< TIM15_TI1 is connected to RCC MCO2 */
#define TIM_TIM15_TI1_HSI_CAL_CK                                                                   \
	(TIM_TISEL_TI1SEL_2 | TIM_TISEL_TI1SEL_1 |                                                 \
	 TIM_TISEL_TI1SEL_0)			    /* !< TIM15_TI1 is connected to HSI CAL CK */
...
#define TIM_TIM15_TI2_TIM4_CH2                                                                     \
	(TIM_TISEL_TI2SEL_0 | TIM_TISEL_TI2SEL_1) /* !< TIM15_TI2 is connected to TIM4 CH2 */
...
#define TIM_TIM16_TI1_WKUP_IT                                                                      \
	(TIM_TISEL_TI1SEL_0 | TIM_TISEL_TI1SEL_1) /* !< TIM16 TI1 is connected to WKUP_IT */
...
#define TIM_TIM17_TI1_RCC_HSE_RTC TIM_TISEL_TI1SEL_1 /* !< TIM17 TI1 is connected to RCC HSE RTC   \
						      */
#define TIM_TIM17_TI1_RCC_MCO1                                                                     \
	(TIM_TISEL_TI1SEL_0 | TIM_TISEL_TI1SEL_1) /* !< TIM17 TI1 is connected to RCC MCO1 */
/**
 * @}
 */
...
HAL_StatusTypeDef HAL_TIMEx_TISelection(TIM_HandleTypeDef *htim, uint32_t TISelection,
					uint32_t Channel);
