...
#define PWR_PVDLEVEL_7                                                                             \
	PWR_CR1_PLS_LEV7 /* External voltage level on PVD_IN                                       \
			    (compared to internal VREFINT) */

#define IS_PWR_PVD_LEVEL(__LEVEL__)                                                                \
	(((__LEVEL__) == PWR_PVDLEVEL_0) || ((__LEVEL__) == PWR_PVDLEVEL_1) ||                     \
...
#define IS_PWR_PVD_MODE(__MODE__)                                                                  \
	(((__MODE__) == PWR_PVD_MODE_NORMAL) || ((__MODE__) == PWR_PVD_MODE_IT_RISING) ||          \
...
#define IS_PWR_REGULATOR(__REGULATOR__)                                                            \
	(((__REGULATOR__) == PWR_MAINREGULATOR_ON) || ((__REGULATOR__) == PWR_LOWPOWERREGULATOR_ON))
/**
 * @}
 */
...
#define IS_PWR_SLEEP_ENTRY(__ENTRY__)                                                              \
	(((__ENTRY__) == PWR_SLEEPENTRY_WFI) || ((__ENTRY__) == PWR_SLEEPENTRY_WFE))
/**
 * @}
 */
...
#define IS_PWR_STOP_ENTRY(__ENTRY__)                                                               \
	(((__ENTRY__) == PWR_STOPENTRY_WFI) || ((__ENTRY__) == PWR_STOPENTRY_WFE))
/**
 * @}
 */
 ...
 */
	...
	#define __HAL_PWR_GET_FLAG(__FLAG__)                                                       \
		(((__FLAG__) == PWR_FLAG_PVDO)	  ? ((PWR->CSR1 & PWR_CSR1_PVDO) == PWR_CSR1_PVDO) \
		 ...
		 : ((__FLAG__) == PWR_FLAG_11R)                                                    \
			 ? ((PWR->CR3 & PWR_CR3_REG11RDY) == PWR_CR3_REG11RDY)                     \
		 : ((__FLAG__) == PWR_FLAG_18R)                                                    \
			 ? ((PWR->CR3 & PWR_CR3_REG18RDY) == PWR_CR3_REG18RDY)                     \
		 : ((__FLAG__) == PWR_FLAG_USB)                                                    \
			 ? ((PWR->CR3 & PWR_CR3_USB33RDY) == PWR_CR3_USB33RDY)                     \
		 : ((__FLAG__) == PWR_FLAG_SB) ? ((PWR->MCUCR & PWR_MCUCR_SBF) == PWR_MCUCR_SBF)   \
		 : ((__FLAG__) == PWR_FLAG_STOP)                                                   \
			 ? ((PWR->MCUCR & PWR_MCUCR_STOPF) == PWR_MCUCR_STOPF)                     \
	...
	#define __HAL_PWR_GET_FLAG(__FLAG__)                                                       \
		(((__FLAG__) == PWR_FLAG_PVDO)	  ? ((PWR->CSR1 & PWR_CSR1_PVDO) == PWR_CSR1_PVDO) \
		 ...
		 : ((__FLAG__) == PWR_FLAG_STOP)                                                   \
			 ? ((PWR->MPUCR & PWR_MPUCR_STOPF) == PWR_MPUCR_STOPF)                     \
			 : ((PWR->MPUCR & PWR_MPUCR_SBF_MPU) == PWR_MPUCR_SBF_MPU))
#endif /*CORE_CA7*/
 ...
 * @{
 */
#define PWR_EXTI_LINE_PVD_AVD                                                                      \
	EXTI_IMR1_IM16 /*!< External interrupt line 16                                             \
