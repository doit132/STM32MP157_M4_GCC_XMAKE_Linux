...
#define GPIO_MODE_IT_RISING                                                                        \
	((uint32_t)0x10110000U) /*!< External Interrupt Mode with Rising edge trigger detection */
#define GPIO_MODE_IT_FALLING                                                                       \
	((uint32_t)0x10210000U) /*!< External Interrupt Mode with Falling edge trigger detection   \
				 */
#define GPIO_MODE_IT_RISING_FALLING                                                                \
	((uint32_t)0x10310000U) /*!< External Interrupt Mode with Rising/Falling edge trigger      \
				   detection  */

#define GPIO_MODE_EVT_RISING                                                                       \
	((uint32_t)0x10120000U) /*!< External Event Mode with Rising edge trigger detection */
#define GPIO_MODE_EVT_FALLING                                                                      \
	((uint32_t)0x10220000U) /*!< External Event Mode with Falling edge trigger detection */
#define GPIO_MODE_EVT_RISING_FALLING                                                               \
	((uint32_t)0x10320000U) /*!< External Event Mode with Rising/Falling edge trigger          \
				   detection       */
/**
 * @}
 */
...
#define __HAL_GPIO_EXTI_GET_IT(__EXTI_LINE__)                                                      \
	((EXTI->RPR1 & (__EXTI_LINE__)) | (EXTI->FPR1 & (__EXTI_LINE__)))
