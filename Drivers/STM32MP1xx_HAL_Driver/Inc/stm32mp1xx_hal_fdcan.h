...
typedef struct {
	...
	FunctionalState
		AutoRetransmission; /*!< Enable or disable the automatic retransmission mode.
	...
	uint32_t NominalSyncJumpWidth; /*!< Specifies the maximum number of time quanta the FDCAN
					  ...
					  perform resynchronization. This parameter must be a number
					  between 1 and 128            */
	...
	uint32_t
		RxFifo0ElmtSize; /*!< Specifies the Data Field Size in an Rx FIFO 0 element.
	...
	uint32_t
		RxFifo1ElmtSize; /*!< Specifies the Data Field Size in an Rx FIFO 1 element.
				      This parameter can be a value of @ref FDCAN_data_field_size */
	...
	uint32_t
		TxFifoQueueElmtsNbr; /*!< Specifies the number of Tx Buffers used for Tx FIFO/Queue.
					  This parameter must be a number between 0 and 32 */
...
typedef struct {
	...
	uint32_t ClockDivider; /*!< Specifies the FDCAN kernel clock divider when the clock
				  calibration is bypassed. This parameter can be a value of @ref
				  FDCAN_clock_divider            */

	uint32_t MinOscClkPeriods; /*!< Configures the minimum number of periods in two CAN bit
				      times. The actual configured number of periods is
				      MinOscClkPeriods x 32. This parameter must be a number between
				      0x00 and 0xFF                */

	uint32_t CalFieldLength; /*!< Specifies the calibration field length.
				      This parameter can be a value of @ref
				    FDCAN_calibration_field_length */
...
typedef struct {
	...
	uint32_t BitRateSwitch; /*!< Specifies whether the Tx frame will be transmitted with or
				   without bit rate switching. This parameter can be a value of @ref
...
typedef struct {
	...
	uint32_t IsFilterMatchingFrame; /*!< Specifies whether the accepted frame did not match any
					   Rx filter. Acceptance of non-matching frames may be
					   enabled via HAL_FDCAN_ConfigGlobalFilter(). This
...
typedef struct {
	...
	uint32_t BitRateSwitch; /*!< Specifies whether the Tx frame is transmitted with or without
				   bit rate switching. This parameter can be a value of @ref
				   FDCAN_bit_rate_switching    */
 ...
 */
typedef struct {
	uint32_t LastErrorCode; /*!< Specifies the type of the last error that occurred on the FDCAN
				   bus. This parameter can be a value of @ref
				   FDCAN_protocol_error_code                           */

	uint32_t DataLastErrorCode; /*!< Specifies the type of the last error that occurred in the
				       data phase of a CAN FD format frame with its BRS flag set.
					 This parameter can be a value of @ref
				       FDCAN_protocol_error_code                           */
	...
	uint32_t RxFDFflag; /*!< Specifies if CAN FD message (FDF flag set) has been received since
			       last protocol status. This parameter can be:
...
typedef struct {
	...
	uint32_t
		ErrorLogging; /*!< Specifies the Transmit/Receive error logging counter value.
				   This parameter can be a number between 0 and 255.
				   This counter is incremented each time when a FDCAN protocol error
				 causes the TxErrorCnt or the RxErrorCnt to be incremented. The
				 counter stops at 255; the next increment of TxErrorCnt or
				 RxErrorCnt sets interrupt flag FDCAN_FLAG_ERROR_LOGGING_OVERFLOW */
...
typedef struct {
	...
	uint32_t ExternalClkSync; /*!< Enable or disable External Clock Synchronization.
				       This parameter can be a value of @ref
				     FDCAN_TT_external_clk_sync. This parameter is ignored if
				     OperationMode is set to FDCAN_TT_COMMUNICATION_LEVEL1 */
	...
	uint32_t AppWdgLimit; /*!< Specifies the Application Watchdog Limit : maximum time after
				   ...
				   The application watchdog can be disabled by setting AppWdgLimit
				 to 0. This parameter must be a number between 0 and 255. This
				 parameter is ignored if OperationMode is set to
				   FDCAN_TT_COMMUNICATION_LEVEL0 */

	uint32_t GlobalTimeFilter; /*!< Enable or disable Global Time Filtering.
					This parameter can be a value of @ref
				      FDCAN_TT_global_time_filtering. This parameter is ignored if
				      OperationMode is set to FDCAN_TT_COMMUNICATION_LEVEL1 */

	uint32_t ClockCalibration; /*!< Enable or disable Automatic Clock Calibration.
					This parameter can be a value of @ref
				      FDCAN_TT_auto_clk_calibration. This parameter is ignored if
				      OperationMode is set to FDCAN_TT_COMMUNICATION_LEVEL1 */

	uint32_t EvtTrigPolarity; /*!< Specifies the Event Trigger Polarity.
				       This parameter can be a value of @ref
				     FDCAN_TT_event_trig_polarity. This parameter is ignored if
				     OperationMode is set to FDCAN_TT_COMMUNICATION_LEVEL0 */

	uint32_t BasicCyclesNbr; /*!< Specifies the nubmer of basic cycles in the system matrix.
				      This parameter can be a value of @ref
				    FDCAN_TT_basic_cycle_number        */

	uint32_t CycleStartSync; /*!< Enable or disable synchronization pulse output at pin
				    fdcan1_soc. This parameter can be a value of @ref
				    FDCAN_TT_cycle_start_sync          */

	uint32_t TxEnableWindow; /*!< Specifies the length of Tx enable window in NTUs.
				      This parameter must be a number between 1 and 16 */

	uint32_t ExpTxTrigNbr; /*!< Specifies the number of expected Tx_Triggers in the system
				  matrix. This is the sum of Tx_Triggers for exclusive, single
				  arbitrating and merged arbitrating windows. This parameter must be
				  a number between 0 and 4095                       */

	uint32_t TURNumerator; /*!< Specifies the TUR (Time Unit Ratio) numerator.
				    It is adviced to set this parameter to the largest applicable
				  value. This parameter must be a number between 0x10000 and 0x1FFFF
				*/
...
typedef struct {
	...
	uint32_t StartCycle; /*!< Specifies the index of the first cycle in which the trigger
				becomes active. This parameter is ignored if RepeatFactor is set to
				FDCAN_TT_REPEAT_EVERY_CYCLE. This parameter must be a number between
				0 and RepeatFactor                       */

	uint32_t TmEventInt; /*!< Enable or disable the internal time mark event.
				  If enabled, FDCAN_TT_FLAG_TRIG_TIME_MARK flag is set when trigger
				memory element becomes active. This parameter can be a value of @ref
				FDCAN_TT_Time_Mark_Event_Internal          */

	uint32_t
		TmEventExt; /*!< Enable or disable the external time mark event.
				 If enabled, and if TTOCN.TTIE is set, a pulse is generated at
			       fdcan1_tmp when trigger memory element becomes active. This parameter
			       can be a value of @ref FDCAN_TT_Time_Mark_Event_External          */
	...
	uint32_t TxBufferIndex; /*!< Specifies the index of the Tx buffer for which the trigger is
				   valid. This parameter can be a value of @ref FDCAN_Tx_location.
				     This parameter is taken in consideration only if the trigger is
				   configured for transmission. */

	uint32_t FilterIndex; /*!< Specifies the filter for which the trigger is valid.
				   This parameter is taken in consideration only if the trigger is
				 configured for reception. This parameter must be a number between:
...
typedef struct {
	...
	uint32_t GTimeQuality; /*!< Specifies the Quality of Global Time Phase.
				  ...
				  otherwise fixed to 0. This parameter can be:
				     - 0 : Global time not valid
				     - 1 : Global time in phase with Time Master */

	uint32_t ClockQuality; /*!< Specifies the Quality of Clock Speed.
				    This parameter is only relevant in Level 0 and Level 2,
				  otherwise fixed to 1. This parameter can be:
				     - 0 : Local clock speed not synchronized to Time Master clock
				  speed
	...
	uint32_t WaitForEvt; /*!< Specifies whether a Gap is annouced.
				  This parameter can be:
				   - 0 : No Gap announced, reset by a reference message with
				Next_is_Gap = 0
	...
	uint32_t ECSPending; /*!< Specifies the External Clock Synchronization State.
				  This parameter can be:
				   ...
				   - 1 : Node waits for external clock synchronization to take
				effect           */
...
typedef struct {
	...
	#define HAL_FDCAN_ERROR_PROTOCOL_ARBT                                                      \
		FDCAN_IR_PEA /*!< Protocol Error in Arbitration Phase (Nominal Bit Time is used)   \
			      */
	...
	#define HAL_FDCAN_ERROR_TT_GLOBAL_TIME                                                     \
		FDCAN_TTIR_GTE /*!< Global Time Error : Synchronization deviation exceeded limit   \
				*/
	#define HAL_FDCAN_ERROR_TT_TX_UNDERFLOW                                                    \
		FDCAN_TTIR_TXU /*!< Tx Count Underflow : Less Tx trigger than expected in one      \
				  matrix cycle */
	#define HAL_FDCAN_ERROR_TT_TX_OVERFLOW                                                     \
		FDCAN_TTIR_TXO /*!< Tx Count Overflow : More Tx trigger than expected in one       \
				  matrix cycle  */
	#define HAL_FDCAN_ERROR_TT_SCHEDULE1                                                       \
		FDCAN_TTIR_SE1 /*!< Scheduling error 1 */
	#define HAL_FDCAN_ERROR_TT_SCHEDULE2                                                       \
		FDCAN_TTIR_SE2 /*!< Scheduling error 2 */
	#define HAL_FDCAN_ERROR_TT_NO_INIT_REF                                                     \
		FDCAN_TTIR_IWT /*!< No system startup due to missing reference message */
	#define HAL_FDCAN_ERROR_TT_NO_REF                                                          \
		FDCAN_TTIR_WT /*!< Missing reference message */
	#define HAL_FDCAN_ERROR_TT_APPL_WDG                                                        \
		FDCAN_TTIR_AW /*!< Application watchdog not served in time */
	#define HAL_FDCAN_ERROR_TT_CONFIG                                                          \
		FDCAN_TTIR_CER /*!< Error found in trigger list */
	 ...
	 * @{
	 */
	#define FDCAN_CLOCK_CALIBRATION_DISABLE                                                    \
		((uint32_t)0x00000000U) /*!< Disable Clock Calibration */
	#define FDCAN_CLOCK_CALIBRATION_ENABLE                                                     \
		((uint32_t)0x00000001U) /*!< Enable Clock Calibration  */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_CALIB_FIELD_LENGTH_32                                                        \
		((uint32_t)0x00000000U) /*!< Calibration field length is 32 bits */
	#define FDCAN_CALIB_FIELD_LENGTH_64                                                        \
		((uint32_t)FDCANCCU_CCFG_CFL) /*!< Calibration field length is 64 bits */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_CLOCK_NOT_CALIBRATED                                                         \
		((uint32_t)0x00000000U) /*!< Clock not calibrated       */
	#define FDCAN_CLOCK_BASIC_CALIBRATED                                                       \
		((uint32_t)0x40000000U) /*!< Clock basic calibrated     */
	#define FDCAN_CLOCK_PRECISION_CALIBRATED                                                   \
		((uint32_t)0x80000000U) /*!< Clock precision calibrated */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_CALIB_TIME_QUANTA_COUNTER                                                    \
		((uint32_t)0x00000000U) /*!< Time Quanta Counter             */
	#define FDCAN_CALIB_CLOCK_PERIOD_COUNTER                                                   \
		((uint32_t)0x00000001U) /*!< Oscillator Clock Period Counter */
	#define FDCAN_CALIB_WATCHDOG_COUNTER                                                       \
		((uint32_t)0x00000002U) /*!< Calibration Watchdog Counter    */
	/**
	 * @}
	 */
	...
	#define FDCAN_BRS_OFF                                                                      \
		((uint32_t)0x00000000U) /*!< FDCAN frames transmitted/received without bit rate    \
					   switching */
	#define FDCAN_BRS_ON                                                                       \
	...
	#define FDCAN_CLASSIC_CAN                                                                  \
		((uint32_t)0x00000000U) /*!< Frame transmitted/received in Classic CAN format */
	#define FDCAN_FD_CAN                                                                       \
	...
	#define FDCAN_FILTER_MASK                                                                  \
		((uint32_t)0x00000002U) /*!< Classic filter: FilterID1 = filter, FilterID2 = mask  \
					 */
	#define FDCAN_FILTER_RANGE_NO_EIDM                                                         \
		((uint32_t)0x00000003U) /*!< Range filter from FilterID1 to FilterID2, EIDM mask   \
					   not applied */
	/**
	 * @}
	 */
	...
	#define FDCAN_FILTER_TO_RXBUFFER                                                           \
		((uint32_t)0x00000007U) /*!< Store into Rx Buffer, configuration of FilterType     \
					   ignored */
	/**
	 * @}
	 */
	...
	#define FDCAN_RX_BUFFER0                                                                   \
		((uint32_t)0x00000000U) /*!< Get received message from Rx Buffer 0  */
	#define FDCAN_RX_BUFFER1                                                                   \
		((uint32_t)0x00000001U) /*!< Get received message from Rx Buffer 1  */
	#define FDCAN_RX_BUFFER2                                                                   \
		((uint32_t)0x00000002U) /*!< Get received message from Rx Buffer 2  */
	#define FDCAN_RX_BUFFER3                                                                   \
		((uint32_t)0x00000003U) /*!< Get received message from Rx Buffer 3  */
	#define FDCAN_RX_BUFFER4                                                                   \
		((uint32_t)0x00000004U) /*!< Get received message from Rx Buffer 4  */
	#define FDCAN_RX_BUFFER5                                                                   \
		((uint32_t)0x00000005U) /*!< Get received message from Rx Buffer 5  */
	#define FDCAN_RX_BUFFER6                                                                   \
		((uint32_t)0x00000006U) /*!< Get received message from Rx Buffer 6  */
	#define FDCAN_RX_BUFFER7                                                                   \
		((uint32_t)0x00000007U) /*!< Get received message from Rx Buffer 7  */
	#define FDCAN_RX_BUFFER8                                                                   \
		((uint32_t)0x00000008U) /*!< Get received message from Rx Buffer 8  */
	#define FDCAN_RX_BUFFER9                                                                   \
		((uint32_t)0x00000009U) /*!< Get received message from Rx Buffer 9  */
	#define FDCAN_RX_BUFFER10                                                                  \
		((uint32_t)0x0000000AU) /*!< Get received message from Rx Buffer 10 */
	#define FDCAN_RX_BUFFER11                                                                  \
		((uint32_t)0x0000000BU) /*!< Get received message from Rx Buffer 11 */
	#define FDCAN_RX_BUFFER12                                                                  \
		((uint32_t)0x0000000CU) /*!< Get received message from Rx Buffer 12 */
	#define FDCAN_RX_BUFFER13                                                                  \
		((uint32_t)0x0000000DU) /*!< Get received message from Rx Buffer 13 */
	#define FDCAN_RX_BUFFER14                                                                  \
		((uint32_t)0x0000000EU) /*!< Get received message from Rx Buffer 14 */
	#define FDCAN_RX_BUFFER15                                                                  \
		((uint32_t)0x0000000FU) /*!< Get received message from Rx Buffer 15 */
	#define FDCAN_RX_BUFFER16                                                                  \
		((uint32_t)0x00000010U) /*!< Get received message from Rx Buffer 16 */
	#define FDCAN_RX_BUFFER17                                                                  \
		((uint32_t)0x00000011U) /*!< Get received message from Rx Buffer 17 */
	#define FDCAN_RX_BUFFER18                                                                  \
		((uint32_t)0x00000012U) /*!< Get received message from Rx Buffer 18 */
	#define FDCAN_RX_BUFFER19                                                                  \
		((uint32_t)0x00000013U) /*!< Get received message from Rx Buffer 19 */
	#define FDCAN_RX_BUFFER20                                                                  \
		((uint32_t)0x00000014U) /*!< Get received message from Rx Buffer 20 */
	#define FDCAN_RX_BUFFER21                                                                  \
		((uint32_t)0x00000015U) /*!< Get received message from Rx Buffer 21 */
	#define FDCAN_RX_BUFFER22                                                                  \
		((uint32_t)0x00000016U) /*!< Get received message from Rx Buffer 22 */
	#define FDCAN_RX_BUFFER23                                                                  \
		((uint32_t)0x00000017U) /*!< Get received message from Rx Buffer 23 */
	#define FDCAN_RX_BUFFER24                                                                  \
		((uint32_t)0x00000018U) /*!< Get received message from Rx Buffer 24 */
	#define FDCAN_RX_BUFFER25                                                                  \
		((uint32_t)0x00000019U) /*!< Get received message from Rx Buffer 25 */
	#define FDCAN_RX_BUFFER26                                                                  \
		((uint32_t)0x0000001AU) /*!< Get received message from Rx Buffer 26 */
	#define FDCAN_RX_BUFFER27                                                                  \
		((uint32_t)0x0000001BU) /*!< Get received message from Rx Buffer 27 */
	#define FDCAN_RX_BUFFER28                                                                  \
		((uint32_t)0x0000001CU) /*!< Get received message from Rx Buffer 28 */
	#define FDCAN_RX_BUFFER29                                                                  \
		((uint32_t)0x0000001DU) /*!< Get received message from Rx Buffer 29 */
	#define FDCAN_RX_BUFFER30                                                                  \
		((uint32_t)0x0000001EU) /*!< Get received message from Rx Buffer 30 */
	#define FDCAN_RX_BUFFER31                                                                  \
		((uint32_t)0x0000001FU) /*!< Get received message from Rx Buffer 31 */
	#define FDCAN_RX_BUFFER32                                                                  \
		((uint32_t)0x00000020U) /*!< Get received message from Rx Buffer 32 */
	#define FDCAN_RX_BUFFER33                                                                  \
		((uint32_t)0x00000021U) /*!< Get received message from Rx Buffer 33 */
	#define FDCAN_RX_BUFFER34                                                                  \
		((uint32_t)0x00000022U) /*!< Get received message from Rx Buffer 34 */
	#define FDCAN_RX_BUFFER35                                                                  \
		((uint32_t)0x00000023U) /*!< Get received message from Rx Buffer 35 */
	#define FDCAN_RX_BUFFER36                                                                  \
		((uint32_t)0x00000024U) /*!< Get received message from Rx Buffer 36 */
	#define FDCAN_RX_BUFFER37                                                                  \
		((uint32_t)0x00000025U) /*!< Get received message from Rx Buffer 37 */
	#define FDCAN_RX_BUFFER38                                                                  \
		((uint32_t)0x00000026U) /*!< Get received message from Rx Buffer 38 */
	#define FDCAN_RX_BUFFER39                                                                  \
		((uint32_t)0x00000027U) /*!< Get received message from Rx Buffer 39 */
	#define FDCAN_RX_BUFFER40                                                                  \
		((uint32_t)0x00000028U) /*!< Get received message from Rx Buffer 40 */
	#define FDCAN_RX_BUFFER41                                                                  \
		((uint32_t)0x00000029U) /*!< Get received message from Rx Buffer 41 */
	#define FDCAN_RX_BUFFER42                                                                  \
		((uint32_t)0x0000002AU) /*!< Get received message from Rx Buffer 42 */
	#define FDCAN_RX_BUFFER43                                                                  \
		((uint32_t)0x0000002BU) /*!< Get received message from Rx Buffer 43 */
	#define FDCAN_RX_BUFFER44                                                                  \
		((uint32_t)0x0000002CU) /*!< Get received message from Rx Buffer 44 */
	#define FDCAN_RX_BUFFER45                                                                  \
		((uint32_t)0x0000002DU) /*!< Get received message from Rx Buffer 45 */
	#define FDCAN_RX_BUFFER46                                                                  \
		((uint32_t)0x0000002EU) /*!< Get received message from Rx Buffer 46 */
	#define FDCAN_RX_BUFFER47                                                                  \
		((uint32_t)0x0000002FU) /*!< Get received message from Rx Buffer 47 */
	#define FDCAN_RX_BUFFER48                                                                  \
		((uint32_t)0x00000030U) /*!< Get received message from Rx Buffer 48 */
	#define FDCAN_RX_BUFFER49                                                                  \
		((uint32_t)0x00000031U) /*!< Get received message from Rx Buffer 49 */
	#define FDCAN_RX_BUFFER50                                                                  \
		((uint32_t)0x00000032U) /*!< Get received message from Rx Buffer 50 */
	#define FDCAN_RX_BUFFER51                                                                  \
		((uint32_t)0x00000033U) /*!< Get received message from Rx Buffer 51 */
	#define FDCAN_RX_BUFFER52                                                                  \
		((uint32_t)0x00000034U) /*!< Get received message from Rx Buffer 52 */
	#define FDCAN_RX_BUFFER53                                                                  \
		((uint32_t)0x00000035U) /*!< Get received message from Rx Buffer 53 */
	#define FDCAN_RX_BUFFER54                                                                  \
		((uint32_t)0x00000036U) /*!< Get received message from Rx Buffer 54 */
	#define FDCAN_RX_BUFFER55                                                                  \
		((uint32_t)0x00000037U) /*!< Get received message from Rx Buffer 55 */
	#define FDCAN_RX_BUFFER56                                                                  \
		((uint32_t)0x00000038U) /*!< Get received message from Rx Buffer 56 */
	#define FDCAN_RX_BUFFER57                                                                  \
		((uint32_t)0x00000039U) /*!< Get received message from Rx Buffer 57 */
	#define FDCAN_RX_BUFFER58                                                                  \
		((uint32_t)0x0000003AU) /*!< Get received message from Rx Buffer 58 */
	#define FDCAN_RX_BUFFER59                                                                  \
		((uint32_t)0x0000003BU) /*!< Get received message from Rx Buffer 59 */
	#define FDCAN_RX_BUFFER60                                                                  \
		((uint32_t)0x0000003CU) /*!< Get received message from Rx Buffer 60 */
	#define FDCAN_RX_BUFFER61                                                                  \
		((uint32_t)0x0000003DU) /*!< Get received message from Rx Buffer 61 */
	#define FDCAN_RX_BUFFER62                                                                  \
		((uint32_t)0x0000003EU) /*!< Get received message from Rx Buffer 62 */
	#define FDCAN_RX_BUFFER63                                                                  \
		((uint32_t)0x0000003FU) /*!< Get received message from Rx Buffer 63 */
	/**
	 * @}
	 */
	...
	#define FDCAN_TIMESTAMP_INTERNAL                                                           \
		((uint32_t)0x00000001U) /*!< Timestamp counter value incremented according to TCP  \
					 */
	...
	#define FDCAN_TIMESTAMP_PRESC_1                                                            \
		((uint32_t)0x00000000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					 */
	#define FDCAN_TIMESTAMP_PRESC_2                                                            \
		((uint32_t)0x00010000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 2  */
	#define FDCAN_TIMESTAMP_PRESC_3                                                            \
		((uint32_t)0x00020000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 3  */
	#define FDCAN_TIMESTAMP_PRESC_4                                                            \
		((uint32_t)0x00030000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 4  */
	#define FDCAN_TIMESTAMP_PRESC_5                                                            \
		((uint32_t)0x00040000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 5  */
	#define FDCAN_TIMESTAMP_PRESC_6                                                            \
		((uint32_t)0x00050000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 6  */
	#define FDCAN_TIMESTAMP_PRESC_7                                                            \
		((uint32_t)0x00060000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 7  */
	#define FDCAN_TIMESTAMP_PRESC_8                                                            \
		((uint32_t)0x00070000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 8  */
	#define FDCAN_TIMESTAMP_PRESC_9                                                            \
		((uint32_t)0x00080000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 9  */
	#define FDCAN_TIMESTAMP_PRESC_10                                                           \
		((uint32_t)0x00090000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 10 */
	#define FDCAN_TIMESTAMP_PRESC_11                                                           \
		((uint32_t)0x000A0000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 11 */
	#define FDCAN_TIMESTAMP_PRESC_12                                                           \
		((uint32_t)0x000B0000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 12 */
	#define FDCAN_TIMESTAMP_PRESC_13                                                           \
		((uint32_t)0x000C0000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 13 */
	#define FDCAN_TIMESTAMP_PRESC_14                                                           \
		((uint32_t)0x000D0000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 14 */
	#define FDCAN_TIMESTAMP_PRESC_15                                                           \
		((uint32_t)0x000E0000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 15 */
	#define FDCAN_TIMESTAMP_PRESC_16                                                           \
		((uint32_t)0x000F0000U) /*!< Timestamp counter time unit in equal to CAN bit time  \
					   multipled by 16 */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_REF_MESSAGE_NO_PAYLOAD                                                    \
		((uint32_t)0x00000000U) /*!< Reference message has no additional payload  */
	#define FDCAN_TT_REF_MESSAGE_ADD_PAYLOAD                                                   \
		((uint32_t)FDCAN_TTRMC_RMPS) /*!< Additional payload is taken from Tx Buffer 0 */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_REPEAT_EVERY_CYCLE                                                        \
		((uint32_t)0x00000000U) /*!< Trigger valid for all cycles   */
	#define FDCAN_TT_REPEAT_EVERY_2ND_CYCLE                                                    \
		((uint32_t)0x00000002U) /*!< Trigger valid every 2dn cycle  */
	#define FDCAN_TT_REPEAT_EVERY_4TH_CYCLE                                                    \
		((uint32_t)0x00000004U) /*!< Trigger valid every 4th cycle  */
	#define FDCAN_TT_REPEAT_EVERY_8TH_CYCLE                                                    \
		((uint32_t)0x00000008U) /*!< Trigger valid every 8th cycle  */
	#define FDCAN_TT_REPEAT_EVERY_16TH_CYCLE                                                   \
		((uint32_t)0x00000010U) /*!< Trigger valid every 16th cycle */
	#define FDCAN_TT_REPEAT_EVERY_32ND_CYCLE                                                   \
		((uint32_t)0x00000020U) /*!< Trigger valid every 32nd cycle */
	#define FDCAN_TT_REPEAT_EVERY_64TH_CYCLE                                                   \
		((uint32_t)0x00000040U) /*!< Trigger valid every 64th cycle */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_TX_REF_TRIGGER                                                            \
		((uint32_t)0x00000000U) /*!< Transmit reference message in strictly time-triggered \
					   operation */
	#define FDCAN_TT_TX_REF_TRIGGER_GAP                                                        \
		((uint32_t)0x00000001U) /*!< Transmit reference message in external                \
					   event-synchronized time-triggered operation */
	#define FDCAN_TT_TX_TRIGGER_SINGLE                                                         \
		((uint32_t)0x00000002U) /*!< Start a single transmission in an exclusive time      \
					   window */
	#define FDCAN_TT_TX_TRIGGER_CONTINUOUS                                                     \
		((uint32_t)0x00000003U) /*!< Start a continuous transmission in an exclusive time  \
					   window */
	#define FDCAN_TT_TX_TRIGGER_ARBITRATION                                                    \
		((uint32_t)0x00000004U) /*!< Start a transmission in an arbitration time window */
	#define FDCAN_TT_TX_TRIGGER_MERGED                                                         \
		((uint32_t)0x00000005U) /*!< Start a merged arbitration window */
	#define FDCAN_TT_WATCH_TRIGGER                                                             \
		((uint32_t)0x00000006U) /*!< Check for missing reference messages in strictly      \
					   time-triggered operation */
	#define FDCAN_TT_WATCH_TRIGGER_GAP                                                         \
		((uint32_t)0x00000007U) /*!< Check for missing reference messages in external      \
					   event-synchronized time-triggered operation */
	#define FDCAN_TT_RX_TRIGGER                                                                \
		((uint32_t)0x00000008U) /*!< Check for the reception of periodic messages in       \
					   exclusive time windows */
	#define FDCAN_TT_TIME_BASE_TRIGGER                                                         \
		((uint32_t)0x00000009U) /*!< Generate internal/external events depending on        \
					   TmEventInt/TmEventExt configuration */
	#define FDCAN_TT_END_OF_LIST                                                               \
		((uint32_t)0x0000000AU) /*!< Illegal trigger, to be assigned to the unused         \
					   triggers after a FDCAN_TT_WATCH_TRIGGER or              \
	 ...
	 * @{
	 */
	#define FDCAN_TT_TM_NO_INTERNAL_EVENT                                                      \
		((uint32_t)0x00000000U) /*!< No action */
	#define FDCAN_TT_TM_GEN_INTERNAL_EVENT                                                     \
		((uint32_t)0x00000020U) /*!< Internal event is generated when trigger becomes      \
					   active */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_TM_NO_EXTERNAL_EVENT                                                      \
		((uint32_t)0x00000000U) /*!< No action */
	#define FDCAN_TT_TM_GEN_EXTERNAL_EVENT                                                     \
		((uint32_t)0x00000010U) /*!< External event (pulse) is generated when trigger      \
					   becomes active */
	/**
	 * @}
	 */
	...
	#define FDCAN_TT_COMMUNICATION_LEVEL1                                                      \
		((uint32_t)0x00000001U) /*!< Time triggered communication, level 1 */
	#define FDCAN_TT_COMMUNICATION_LEVEL2                                                      \
		((uint32_t)0x00000002U) /*!< Time triggered communication, level 2 */
	#define FDCAN_TT_COMMUNICATION_LEVEL0                                                      \
		((uint32_t)0x00000003U) /*!< Time triggered communication, level 0 */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_STRICTLY_TT_OPERATION                                                        \
		((uint32_t)0x00000000U) /*!< Strictly time-triggered operation */
	#define FDCAN_EXT_EVT_SYNC_TT_OPERATION                                                    \
		((uint32_t)FDCAN_TTOCF_GEN) /*!< External event-synchronized time-triggered        \
					       operation */
	/**
	 * @}
	 */
	...
	#define FDCAN_TT_EXT_CLK_SYNC_DISABLE                                                      \
		((uint32_t)0x00000000U) /*!< External clock synchronization in Level 0,2 disabled  \
					 */
	#define FDCAN_TT_EXT_CLK_SYNC_ENABLE                                                       \
		((uint32_t)FDCAN_TTOCF_EECS) /*!< External clock synchronization in Level 0,2      \
						enabled  */
	/**
	 * @}
	 */
	...
	#define FDCAN_TT_GLOB_TIME_FILT_DISABLE                                                    \
		((uint32_t)0x00000000U) /*!< Global time filtering in Level 0,2 disabled */
	#define FDCAN_TT_GLOB_TIME_FILT_ENABLE                                                     \
		((uint32_t)FDCAN_TTOCF_EGTF) /*!< Global time filtering in Level 0,2 enabled  */
	/**
	 * @}
	 */
	...
	#define FDCAN_TT_AUTO_CLK_CALIB_DISABLE                                                    \
		((uint32_t)0x00000000U) /*!< Automatic clock calibration in Level 0,2 disabled */
	#define FDCAN_TT_AUTO_CLK_CALIB_ENABLE                                                     \
		((uint32_t)                                                                        \
			 FDCAN_TTOCF_ECC) /*!< Automatic clock calibration in Level 0,2 enabled */
	/**
	 * @}
	 */
	...
	#define FDCAN_TT_EVT_TRIG_POL_FALLING                                                      \
		((uint32_t)FDCAN_TTOCF_EVTP) /*!< Falling edge trigger */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_CYCLES_PER_MATRIX_1                                                       \
		((uint32_t)0x00000000U) /*!< 1 Basic Cycle per Matrix   */
	#define FDCAN_TT_CYCLES_PER_MATRIX_2                                                       \
		((uint32_t)0x00000001U) /*!< 2 Basic Cycles per Matrix  */
	#define FDCAN_TT_CYCLES_PER_MATRIX_4                                                       \
		((uint32_t)0x00000003U) /*!< 4 Basic Cycles per Matrix  */
	#define FDCAN_TT_CYCLES_PER_MATRIX_8                                                       \
		((uint32_t)0x00000007U) /*!< 8 Basic Cycles per Matrix  */
	#define FDCAN_TT_CYCLES_PER_MATRIX_16                                                      \
		((uint32_t)0x0000000FU) /*!< 16 Basic Cycles per Matrix */
	#define FDCAN_TT_CYCLES_PER_MATRIX_32                                                      \
		((uint32_t)0x0000001FU) /*!< 32 Basic Cycles per Matrix */
	#define FDCAN_TT_CYCLES_PER_MATRIX_64                                                      \
		((uint32_t)0x0000003FU) /*!< 64 Basic Cycles per Matrix */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_NO_SYNC_PULSE                                                             \
		((uint32_t)0x00000000U) /*!< No sync pulse                      */
	#define FDCAN_TT_SYNC_BASIC_CYCLE_START                                                    \
		((uint32_t)0x00000040U) /*!< Sync pulse at start of basic cycle */
	#define FDCAN_TT_SYNC_MATRIX_START                                                         \
		((uint32_t)0x00000080U) /*!< Sync pulse at start of matrix      */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_STOP_WATCH_TRIGGER_0                                                      \
		((uint32_t)0x00000000U) /*!< TIM2 selected as stop watch trigger  */
	#define FDCAN_TT_STOP_WATCH_TRIGGER_1                                                      \
		((uint32_t)0x00000001U) /*!< TIM3 selected as stop watch trigger  */
	#define FDCAN_TT_STOP_WATCH_TRIGGER_2                                                      \
		((uint32_t)0x00000002U) /*!< ETH selected as stop watch trigger   */
	#define FDCAN_TT_STOP_WATCH_TRIGGER_3                                                      \
		((uint32_t)0x00000003U) /*!< HRTIM selected as stop watch trigger */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_EVENT_TRIGGER_0                                                           \
		((uint32_t)0x00000000U) /*!< TIM2 selected as event trigger  */
	#define FDCAN_TT_EVENT_TRIGGER_1                                                           \
		((uint32_t)0x00000010U) /*!< TIM3 selected as event trigger  */
	#define FDCAN_TT_EVENT_TRIGGER_2                                                           \
		((uint32_t)0x00000020U) /*!< ETH selected as event trigger   */
	#define FDCAN_TT_EVENT_TRIGGER_3                                                           \
		((uint32_t)0x00000030U) /*!< HRTIM selected as event trigger */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_STOP_WATCH_DISABLED                                                       \
		((uint32_t)0x00000000U) /*!< Stop Watch disabled */
	#define FDCAN_TT_STOP_WATCH_CYCLE_TIME                                                     \
		((uint32_t)0x00000008U) /*!< Actual value of cycle time is copied to Capture Time  \
					   register (TTCPT.SWV)  */
	#define FDCAN_TT_STOP_WATCH_LOCAL_TIME                                                     \
		((uint32_t)0x00000010U) /*!< Actual value of local time is copied to Capture Time  \
					   register (TTCPT.SWV)  */
	#define FDCAN_TT_STOP_WATCH_GLOBAL_TIME                                                    \
		((uint32_t)0x00000018U) /*!< Actual value of global time is copied to Capture Time \
					   register (TTCPT.SWV) */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_STOP_WATCH_RISING                                                         \
		((uint32_t)0x00000000U) /*!< Selected stop watch source is captured at rising edge \
					   of fdcan1_swt  */
	#define FDCAN_TT_STOP_WATCH_FALLING                                                        \
		((uint32_t)0x00000004U) /*!< Selected stop watch source is captured at falling     \
					   edge of fdcan1_swt */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_TT_REG_TIMEMARK_DIABLED                                                      \
		((uint32_t)0x00000000U) /*!< No Register Time Mark Interrupt generated */
	#define FDCAN_TT_REG_TIMEMARK_CYC_TIME                                                     \
		((uint32_t)0x00000040U) /*!< Register Time Mark Interrupt if Time Mark = cycle     \
					   time  */
	#define FDCAN_TT_REG_TIMEMARK_LOC_TIME                                                     \
		((uint32_t)0x00000080U) /*!< Register Time Mark Interrupt if Time Mark = local     \
					   time  */
	#define FDCAN_TT_REG_TIMEMARK_GLO_TIME                                                     \
		((uint32_t)0x000000C0U) /*!< Register Time Mark Interrupt if Time Mark = global    \
					   time */
	/**
	 * @}
	 */
	...
	#define FDCAN_TT_MASTER_OFF                                                                \
		((uint32_t)0x00000000U) /*!< Master_Off, no master properties relevant */
	#define FDCAN_TT_TIME_SLAVE                                                                \
		((uint32_t)0x00000004U) /*!< Operating as Time Slave                   */
	#define FDCAN_TT_BACKUP_TIME_MASTER                                                        \
		((uint32_t)0x00000008U) /*!< Operating as Backup Time Master           */
	#define FDCAN_TT_CURRENT_TIME_MASTER                                                       \
		((uint32_t)0x0000000CU) /*!< Operating as current Time Master          */
	/**
	 * @}
	 */
	...
	#define FDCAN_TT_SYNCHRONIZING                                                             \
		((uint32_t)0x00000010U)			     /*!< Synchronizing to communication */
	...
	#define FDCAN_FLAG_RX_BUFFER_NEW_MESSAGE                                                   \
		FDCAN_IR_DRX /*!< At least one received message stored into a Rx Buffer */
	...
	#define FDCAN_FLAG_RX_FIFO0_WATERMARK                                                      \
		FDCAN_IR_RF0W /*!< Rx FIFO 0 fill level reached watermark                */
	...
	#define FDCAN_FLAG_RX_FIFO1_WATERMARK                                                      \
		FDCAN_IR_RF1W /*!< Rx FIFO 1 fill level reached watermark                */
	...
	#define FDCAN_FLAG_CALIB_STATE_CHANGED                                                     \
		(FDCANCCU_IR_CSC << 30) /*!< Clock calibration state changed */
	#define FDCAN_FLAG_CALIB_WATCHDOG_EVENT                                                    \
		(FDCANCCU_IR_CWE << 30) /*!< Clock calibration watchdog event occurred */
	/**
	 * @}
	 */
	...
	#define FDCAN_IT_RX_BUFFER_NEW_MESSAGE                                                     \
		FDCAN_IE_DRXE /*!< At least one received message stored into a Rx Buffer */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define FDCAN_IT_CALIB_STATE_CHANGED                                                       \
		(FDCANCCU_IE_CSCE << 30) /*!< Clock calibration state changed           */
	#define FDCAN_IT_CALIB_WATCHDOG_EVENT                                                      \
		(FDCANCCU_IE_CWEE << 30) /*!< Clock calibration watchdog event occurred */
	/**
	 * @}
	 */
	...
	#define FDCAN_IT_TX_EVT_FIFO_WATERMARK                                                     \
		FDCAN_IE_TEFWE /*!< Tx Event FIFO fill level reached watermark */
	...
	#define FDCAN_IT_RX_FIFO0_WATERMARK                                                        \
		FDCAN_IE_RF0WE /*!< Rx FIFO 0 fill level reached watermark */
	...
	#define FDCAN_IT_RX_FIFO1_WATERMARK                                                        \
		FDCAN_IE_RF1WE /*!< Rx FIFO 1 fill level reached watermark */
	 ...
	 * @{
	 */
	#define FDCAN_TT_FLAG_BASIC_CYCLE_START                                                    \
		FDCAN_TTIR_SBC /*!< Start of Basic Cycle             */
	#define FDCAN_TT_FLAG_MATRIX_CYCLE_START                                                   \
		FDCAN_TTIR_SMC /*!< Start of Matrix Cycle            */
	#define FDCAN_TT_FLAG_SYNC_MODE_CHANGE                                                     \
		FDCAN_TTIR_CSM				    /*!< Change of Synchronization Mode   */
	...
	#define FDCAN_TT_FLAG_TRIG_TIME_MARK                                                       \
		FDCAN_TTIR_TTMI				/*!< Trigger Time Mark Event Internal */
	#define FDCAN_TT_FLAG_STOP_WATCH FDCAN_TTIR_SWE /*!< Stop Watch Event                 */
	#define FDCAN_TT_FLAG_GLOBAL_TIME_WRAP                                                     \
		FDCAN_TTIR_GTW /*!< Global Time Wrap                 */
	#define FDCAN_TT_FLAG_GLOBAL_TIME_DISC                                                     \
		FDCAN_TTIR_GTD /*!< Global Time Discontinuity        */
	#define FDCAN_TT_FLAG_GLOBAL_TIME_ERROR                                                    \
		FDCAN_TTIR_GTE /*!< Global Time Error                */
	#define FDCAN_TT_FLAG_TX_COUNT_UNDERFLOW                                                   \
		FDCAN_TTIR_TXU /*!< Tx Count Underflow               */
	#define FDCAN_TT_FLAG_TX_COUNT_OVERFLOW                                                    \
		FDCAN_TTIR_TXO /*!< Tx Count Overflow                */
	#define FDCAN_TT_FLAG_SCHEDULING_ERROR_1                                                   \
		FDCAN_TTIR_SE1 /*!< Scheduling Error 1               */
	#define FDCAN_TT_FLAG_SCHEDULING_ERROR_2                                                   \
		FDCAN_TTIR_SE2 /*!< Scheduling Error 2               */
	#define FDCAN_TT_FLAG_ERROR_LEVEL_CHANGE                                                   \
		FDCAN_TTIR_ELC /*!< Error Level Changed              */
	#define FDCAN_TT_FLAG_INIT_WATCH_TRIGGER                                                   \
		FDCAN_TTIR_IWT				  /*!< Initialization Watch Trigger     */
	#define FDCAN_TT_FLAG_WATCH_TRIGGER FDCAN_TTIR_WT /*!< Watch Trigger                    */
	#define FDCAN_TT_FLAG_APPLICATION_WATCHDOG                                                 \
		FDCAN_TTIR_AW /*!< Application Watchdog             */
	...
	/** @defgroup FDCAN_TTScheduleSynchronization_Interrupts FDCAN TT Schedule Synchronization
	 * Interrupts
	 * @{
	 */
	#define FDCAN_TT_IT_BASIC_CYCLE_START FDCAN_TTIE_SBCE /*!< Start of Basic Cycle */
	#define FDCAN_TT_IT_MATRIX_CYCLE_START                                                     \
		FDCAN_TTIE_SMCE /*!< Start of Matrix Cycle          */
	...
	#define __HAL_FDCAN_GET_IT(__HANDLE__, __INTERRUPT__)                                      \
		(((__INTERRUPT__) < FDCAN_IT_CALIB_WATCHDOG_EVENT)                                 \
			 ? ((__HANDLE__)->Instance->IR & (__INTERRUPT__))                          \
			 : ((FDCAN_CCU->IR << 30) & (__INTERRUPT__)))
	...
	#define __HAL_FDCAN_GET_FLAG(__HANDLE__, __FLAG__)                                         \
		(((__FLAG__) < FDCAN_FLAG_CALIB_WATCHDOG_EVENT)                                    \
			 ? ((__HANDLE__)->Instance->IR & (__FLAG__))                               \
			 : ((FDCAN_CCU->IR << 30) & (__FLAG__)))
	 ...
	 * @retval None
	 */
	#define __HAL_FDCAN_TT_ENABLE_IT(__HANDLE__, __INTERRUPT__)                                \
	 ...
	 * @retval None
	 */
	#define __HAL_FDCAN_TT_DISABLE_IT(__HANDLE__, __INTERRUPT__)                               \
		(((__HANDLE__)->ttcan->TTIE) &= ~(__INTERRUPT__))
	 ...
	 * @retval ITStatus
	 */
	#define __HAL_FDCAN_TT_GET_IT(__HANDLE__, __INTERRUPT__)                                   \
	 ...
	 * @retval None
	 */
	#define __HAL_FDCAN_TT_CLEAR_IT(__HANDLE__, __INTERRUPT__)                                 \
		(((__HANDLE__)->ttcan->TTIR) = (__INTERRUPT__))
	 ...
	 * @retval FlagStatus
	 */
	#define __HAL_FDCAN_TT_GET_FLAG(__HANDLE__, __FLAG__)                                      \
	 ...
	 * @retval None
	 */
	#define __HAL_FDCAN_TT_CLEAR_FLAG(__HANDLE__, __FLAG__)                                    \
		(((__HANDLE__)->ttcan->TTIR) = (__FLAG__))
	 ...
	 * @retval ITStatus
	 */
	#define __HAL_FDCAN_TT_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                            \
		(((__HANDLE__)->ttcan->TTIE) & (__INTERRUPT__))
...
HAL_StatusTypeDef HAL_FDCAN_ConfigRxFifoOverwrite(FDCAN_HandleTypeDef *hfdcan, uint32_t RxFifo,
...
HAL_StatusTypeDef HAL_FDCAN_TT_ConfigStopWatch(FDCAN_HandleTypeDef *hfdcan, uint32_t Source,
					       uint32_t Polarity);
...
HAL_StatusTypeDef HAL_FDCAN_ConfigInterruptLines(FDCAN_HandleTypeDef *hfdcan, uint32_t ITList,
...
void HAL_FDCAN_TT_StopWatchCallback(FDCAN_HandleTypeDef *hfdcan, uint32_t SWTime,
...
HAL_FDCAN_StateTypeDef HAL_FDCAN_GetState(FDCAN_HandleTypeDef *hfdcan);
	...
	#define IS_FDCAN_MODE(MODE)                                                                \
		(((MODE) == FDCAN_MODE_NORMAL) || ((MODE) == FDCAN_MODE_RESTRICTED_OPERATION) ||   \
	...
	#define IS_FDCAN_DATA_SIZE(SIZE)                                                           \
		(((SIZE) == FDCAN_DATA_BYTES_8) || ((SIZE) == FDCAN_DATA_BYTES_12) ||              \
		 ((SIZE) == FDCAN_DATA_BYTES_16) || ((SIZE) == FDCAN_DATA_BYTES_20) ||             \
		 ((SIZE) == FDCAN_DATA_BYTES_24) || ((SIZE) == FDCAN_DATA_BYTES_32) ||             \
		 ((SIZE) == FDCAN_DATA_BYTES_48) || ((SIZE) == FDCAN_DATA_BYTES_64))
	...
	#define IS_FDCAN_FILTER_CFG(CONFIG)                                                        \
		(((CONFIG) == FDCAN_FILTER_DISABLE) || ((CONFIG) == FDCAN_FILTER_TO_RXFIFO0) ||    \
		 ((CONFIG) == FDCAN_FILTER_TO_RXFIFO1) || ((CONFIG) == FDCAN_FILTER_REJECT) ||     \
		 ((CONFIG) == FDCAN_FILTER_HP) || ((CONFIG) == FDCAN_FILTER_TO_RXFIFO0_HP) ||      \
	...
	#define IS_FDCAN_FIFO_WATERMARK(FIFO)                                                      \
		(((FIFO) == FDCAN_CFG_TX_EVENT_FIFO) || ((FIFO) == FDCAN_CFG_RX_FIFO0) ||          \
		 ((FIFO) == FDCAN_CFG_RX_FIFO1))
	#define IS_FDCAN_NON_MATCHING(DESTINATION)                                                 \
		(((DESTINATION) == FDCAN_ACCEPT_IN_RX_FIFO0) ||                                    \
		 ((DESTINATION) == FDCAN_ACCEPT_IN_RX_FIFO1) || ((DESTINATION) == FDCAN_REJECT))
	...
	#define IS_FDCAN_TT_TRIGGER_TYPE(TYPE)                                                     \
		(((TYPE) == FDCAN_TT_TX_REF_TRIGGER) || ((TYPE) == FDCAN_TT_TX_REF_TRIGGER_GAP) || \
		 ((TYPE) == FDCAN_TT_TX_TRIGGER_SINGLE) ||                                         \
		 ((TYPE) == FDCAN_TT_TX_TRIGGER_CONTINUOUS) ||                                     \
		 ((TYPE) == FDCAN_TT_TX_TRIGGER_ARBITRATION) ||                                    \
		 ((TYPE) == FDCAN_TT_TX_TRIGGER_MERGED) || ((TYPE) == FDCAN_TT_WATCH_TRIGGER) ||   \
		 ((TYPE) == FDCAN_TT_WATCH_TRIGGER_GAP) || ((TYPE) == FDCAN_TT_RX_TRIGGER) ||      \
		 ((TYPE) == FDCAN_TT_TIME_BASE_TRIGGER) || ((TYPE) == FDCAN_TT_END_OF_LIST))
	...
	#define IS_FDCAN_TT_TUR_NUMERATOR(NUMERATOR)                                               \
		(((NUMERATOR) >= 0x10000U) && ((NUMERATOR) <= 0x1FFFFU))
	#define IS_FDCAN_TT_TUR_DENOMINATOR(DENOMINATOR)                                           \
		(((DENOMINATOR) >= 0x0001U) && ((DENOMINATOR) <= 0x3FFFU))
