...
typedef struct {
	...
	uint32_t Line_32_63; /*!< Specifies the EXTI lines to be enabled or disabled for Lines in
				range 32 to 63 This parameter can be any combination of @ref
				EXTI_LL_EC_LINE */

	uint32_t Line_64_95; /*!< Specifies the EXTI lines to be enabled or disabled for Lines in
				range 64 to 95 This parameter can be any combination of @ref
				EXTI_LL_EC_LINE */
	...
	#define LL_EXTI_CONFIG_LINE0                                                               \
		((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_0  | EXTICR[0] */
	#define LL_EXTI_CONFIG_LINE1                                                               \
		((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_8  | EXTICR[0] */
	#define LL_EXTI_CONFIG_LINE2                                                               \
		((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_16 | EXTICR[0] */
	#define LL_EXTI_CONFIG_LINE3                                                               \
		((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_24 | EXTICR[0] */
	#define LL_EXTI_CONFIG_LINE4                                                               \
		((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_0  | EXTICR[1] */
	#define LL_EXTI_CONFIG_LINE5                                                               \
		((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_8  | EXTICR[1] */
	#define LL_EXTI_CONFIG_LINE6                                                               \
		((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_16 | EXTICR[1] */
	#define LL_EXTI_CONFIG_LINE7                                                               \
		((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_24 | EXTICR[1] */
	#define LL_EXTI_CONFIG_LINE8                                                               \
		((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_0  | EXTICR[2] */
	#define LL_EXTI_CONFIG_LINE9                                                               \
		((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_8  | EXTICR[2] */
	#define LL_EXTI_CONFIG_LINE10                                                              \
		((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_16 | EXTICR[2] */
	#define LL_EXTI_CONFIG_LINE11                                                              \
		((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_24 | EXTICR[2] */
	#define LL_EXTI_CONFIG_LINE12                                                              \
		((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_0  | EXTICR[3] */
	#define LL_EXTI_CONFIG_LINE13                                                              \
		((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_8  | EXTICR[3] */
	#define LL_EXTI_CONFIG_LINE14                                                              \
		((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_16 | EXTICR[3] */
	#define LL_EXTI_CONFIG_LINE15                                                              \
		((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_24 | EXTICR[3] */
	/**
	 * @}
	 */
