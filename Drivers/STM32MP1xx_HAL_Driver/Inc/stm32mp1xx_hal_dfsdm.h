...
typedef struct {
	uint32_t Type; /*!< SPI or Manchester modes.
			...
			*/
	uint32_t
		SpiClock; /*!< SPI clock select (external or internal with different sampling
			     point). This parameter can be a value of @ref DFSDM_Channel_SpiClock */
...
typedef enum {
	HAL_DFSDM_CHANNEL_CKAB_CB_ID =
		0x00U, /*!< DFSDM channel clock absence detection callback ID */
	HAL_DFSDM_CHANNEL_SCD_CB_ID =
		0x01U, /*!< DFSDM channel short circuit detection callback ID */
...
typedef struct {
	uint32_t Trigger; /*!< Trigger used to start injected conversion: software, external or
			     synchronous. This parameter can be a value of @ref DFSDM_Filter_Trigger
			   */
...
typedef struct {
	...
	DFSDM_Filter_InjectedParamTypeDef
		InjectedParam;			     /*!< DFSDM injected conversion parameters */
...
#endif /* USE_HAL_DFSDM_REGISTER_CALLBACKS */
{
	...
	void (*RegConvHalfCpltCallback)(struct __DFSDM_Filter_HandleTypeDef
						*hdfsdm_filter); /*!< DFSDM filter half regular
								    conversion complete callback */
	void (*InjConvCpltCallback)(
		struct __DFSDM_Filter_HandleTypeDef
			*hdfsdm_filter); /*!< DFSDM filter injected conversion complete callback */
	void (*InjConvHalfCpltCallback)(struct __DFSDM_Filter_HandleTypeDef
						*hdfsdm_filter); /*!< DFSDM filter half injected
								    conversion complete callback */
	void (*ErrorCallback)(struct __DFSDM_Filter_HandleTypeDef
				      *hdfsdm_filter); /*!< DFSDM filter error callback */
	void (*MspInitCallback)(struct __DFSDM_Filter_HandleTypeDef
					*hdfsdm_filter); /*!< DFSDM filter MSP init callback */
...
typedef struct {
	uint32_t
		DataSource;	  /*!< Values from digital filter or from channel watchdog filter.
	...
	int32_t LowThreshold;	  /*!< Low threshold for the analog watchdog.
				       This parameter must be a number between Min_Data = -8388608 and
				     Max_Data = 8388607 */
	uint32_t HighBreakSignal; /*!< Break signal assigned to analog watchdog high threshold
				     event. This parameter can be a values combination of @ref
				     DFSDM_BreakSignals */
...
#define DFSDM_CHANNEL_OUTPUT_CLOCK_AUDIO                                                           \
	DFSDM_CHCFGR1_CKOUTSRC /*!< Source for ouput clock is audio clock */
/**
 * @}
 */
...
#define DFSDM_FILTER_EXT_TRIG_LPTIM2_OUT                                                           \
	(DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_1 | DFSDM_FLTCR1_JEXTSEL_3 |                \
	 DFSDM_FLTCR1_JEXTSEL_4) /*!< For all DFSDM filters */
#define DFSDM_FILTER_EXT_TRIG_LPTIM3_OUT                                                           \
	(DFSDM_FLTCR1_JEXTSEL_2 | DFSDM_FLTCR1_JEXTSEL_3 |                                         \
	 DFSDM_FLTCR1_JEXTSEL_4) /*!< For all DFSDM filters */
/**
 * @}
 */
...
#define DFSDM_FILTER_ERROR_DMA 0x00000003U /*!< DMA error occurs */
	...
	#define DFSDM_FILTER_ERROR_INVALID_CALLBACK                                                \
		0x00000004U /*!< Invalid callback error occurs */
#endif
/**
 * @}
 */
...
#define IS_DFSDM_FILTER_EXT_TRIG(TRIG)                                                             \
	(((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO) ||                                            \
	 ...
	 ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI11) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI15) ||   \
