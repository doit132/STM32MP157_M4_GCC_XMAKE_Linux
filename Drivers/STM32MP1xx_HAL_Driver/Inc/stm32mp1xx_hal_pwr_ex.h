...
/* Low level + Pull-up */
#define PWR_WAKEUP_PIN6_LOW_PULLUP                                                                 \
	(uint32_t)(PWR_WKUPCR_WKUPP_6 | PWR_MPUWKUPENR_WKUPEN_6 | PWR_WKUPCR_WKUPPUPD6_0)
#define PWR_WAKEUP_PIN5_LOW_PULLUP                                                                 \
	(uint32_t)(PWR_WKUPCR_WKUPP_5 | PWR_MPUWKUPENR_WKUPEN_5 | PWR_WKUPCR_WKUPPUPD5_0)
#define PWR_WAKEUP_PIN4_LOW_PULLUP                                                                 \
	(uint32_t)(PWR_WKUPCR_WKUPP_4 | PWR_MPUWKUPENR_WKUPEN_4 | PWR_WKUPCR_WKUPPUPD4_0)
#define PWR_WAKEUP_PIN3_LOW_PULLUP                                                                 \
	(uint32_t)(PWR_WKUPCR_WKUPP_3 | PWR_MPUWKUPENR_WKUPEN_3 | PWR_WKUPCR_WKUPPUPD3_0)
#define PWR_WAKEUP_PIN2_LOW_PULLUP                                                                 \
	(uint32_t)(PWR_WKUPCR_WKUPP_2 | PWR_MPUWKUPENR_WKUPEN_2 | PWR_WKUPCR_WKUPPUPD2_0)
#define PWR_WAKEUP_PIN1_LOW_PULLUP                                                                 \
	(uint32_t)(PWR_WKUPCR_WKUPP_1 | PWR_MPUWKUPENR_WKUPEN_1 | PWR_WKUPCR_WKUPPUPD1_0)
...
/* Low level + Pull-down */
#define PWR_WAKEUP_PIN6_LOW_PULLDOWN                                                               \
	(uint32_t)(PWR_WKUPCR_WKUPP_6 | PWR_MPUWKUPENR_WKUPEN_6 | PWR_WKUPCR_WKUPPUPD6_1)
#define PWR_WAKEUP_PIN5_LOW_PULLDOWN                                                               \
	(uint32_t)(PWR_WKUPCR_WKUPP_5 | PWR_MPUWKUPENR_WKUPEN_5 | PWR_WKUPCR_WKUPPUPD5_1)
#define PWR_WAKEUP_PIN4_LOW_PULLDOWN                                                               \
	(uint32_t)(PWR_WKUPCR_WKUPP_4 | PWR_MPUWKUPENR_WKUPEN_4 | PWR_WKUPCR_WKUPPUPD4_1)
#define PWR_WAKEUP_PIN3_LOW_PULLDOWN                                                               \
	(uint32_t)(PWR_WKUPCR_WKUPP_3 | PWR_MPUWKUPENR_WKUPEN_3 | PWR_WKUPCR_WKUPPUPD3_1)
#define PWR_WAKEUP_PIN2_LOW_PULLDOWN                                                               \
	(uint32_t)(PWR_WKUPCR_WKUPP_2 | PWR_MPUWKUPENR_WKUPEN_2 | PWR_WKUPCR_WKUPPUPD2_1)
#define PWR_WAKEUP_PIN1_LOW_PULLDOWN                                                               \
	(uint32_t)(PWR_WKUPCR_WKUPP_1 | PWR_MPUWKUPENR_WKUPEN_1 | PWR_WKUPCR_WKUPPUPD1_1)
/**
 * @}
 */
...
#define PWR_AVD_MODE_IT_RISING                                                                     \
	((uint32_t)0x00010001U) /*!< External Interrupt Mode with Rising edge trigger detection */
#define PWR_AVD_MODE_IT_FALLING                                                                    \
	((uint32_t)0x00010002U) /*!< External Interrupt Mode with Falling edge trigger detection   \
				 */
#define PWR_AVD_MODE_IT_RISING_FALLING                                                             \
	((uint32_t)0x00010003U) /*!< External Interrupt Mode with Rising/Falling edge trigger      \
				   detection */
/**
 * @}
 */
...
#define PWR_BATTERY_CHARGING_RESISTOR_5                                                            \
	((uint32_t)0x00000000U) /*!< VBAT charging through a 5 kOhm resistor   */
#define PWR_BATTERY_CHARGING_RESISTOR_1_5                                                          \
	PWR_CR3_VBRS /*!< VBAT charging through a 1.5 kOhm resistor */
/**
 * @}
 */
...
#define IS_PWR_WAKEUP_PIN(__PIN__)                                                                 \
	(((__PIN__) == PWR_WAKEUP_PIN1) || ((__PIN__) == PWR_WAKEUP_PIN2) ||                       \
	 ((__PIN__) == PWR_WAKEUP_PIN3) || ((__PIN__) == PWR_WAKEUP_PIN4) ||                       \
	 ((__PIN__) == PWR_WAKEUP_PIN5) || ((__PIN__) == PWR_WAKEUP_PIN6) ||                       \
	 ((__PIN__) == PWR_WAKEUP_PIN1_HIGH) || ((__PIN__) == PWR_WAKEUP_PIN2_HIGH) ||             \
	 ((__PIN__) == PWR_WAKEUP_PIN3_HIGH) || ((__PIN__) == PWR_WAKEUP_PIN4_HIGH) ||             \
	 ((__PIN__) == PWR_WAKEUP_PIN5_HIGH) || ((__PIN__) == PWR_WAKEUP_PIN6_HIGH) ||             \
	 ((__PIN__) == PWR_WAKEUP_PIN1_LOW) || ((__PIN__) == PWR_WAKEUP_PIN2_LOW) ||               \
	 ((__PIN__) == PWR_WAKEUP_PIN3_LOW) || ((__PIN__) == PWR_WAKEUP_PIN4_LOW) ||               \
	 ((__PIN__) == PWR_WAKEUP_PIN5_LOW) || ((__PIN__) == PWR_WAKEUP_PIN6_LOW) ||               \
	 ...
	 ((__PIN__) == PWR_WAKEUP_PIN6_LOW_PULLUP) || ((__PIN__) == PWR_WAKEUP_PIN5_LOW_PULLUP) || \
	 ((__PIN__) == PWR_WAKEUP_PIN4_LOW_PULLUP) || ((__PIN__) == PWR_WAKEUP_PIN3_LOW_PULLUP) || \
	 ((__PIN__) == PWR_WAKEUP_PIN2_LOW_PULLUP) || ((__PIN__) == PWR_WAKEUP_PIN1_LOW_PULLUP) || \
