...
typedef struct __DMA_HandleTypeDef {
	...
	DMAMUX_RequestGenStatus_TypeDef
		*DMAmuxRequestGenStatus; /*!< DMAMUX request generator Status Address       */
...
#define DMA_FIFO_THRESHOLD_1QUARTERFULL                                                            \
	((uint32_t)0x00000000U) /*!< FIFO threshold 1 quart full configuration  */
...
#define __HAL_DMA_GET_FS(__HANDLE__)                                                               \
	((IS_DMA_INSTANCE(__HANDLE__))                                                             \
		 ? (((DMA_Stream_TypeDef *)(__HANDLE__)->Instance)->FCR & (DMA_SxFCR_FS))          \
		 : 0)
...
#define __HAL_DMA_ENABLE(__HANDLE__)                                                               \
	(((DMA_Stream_TypeDef *)(__HANDLE__)->Instance)->CR |= DMA_SxCR_EN)
