...
#ifndef STM32MP1xx_HAL_RTC_EX_H
#define STM32MP1xx_HAL_RTC_EX_H
...
typedef struct {
	...
	uint32_t
		Interrupt; /*!< Specifies the interrupt mode
...
typedef struct {
	...
	uint32_t ActiveAsyncPrescaler; /*!< Specifies the Active Tamper asynchronous Prescaler
...
typedef struct {
	...
	uint32_t rtcNonSecureFeatures; /*!< Specifies the non-secure features.
					    This parameter is only relevant if RTC is not fully
					  secure (rtcSecureFull == RTC_SECURE_FULL_NO). This
					  parameter can be a combination of @ref
					  RTCEx_RTC_NonSecure_Features. */

	uint32_t
		tampSecureFull; /*!< Specifies If the TAMP is fully secure or not
	...
	uint32_t backupRegisterStartZone2; /*!< Specifies the backup register start zone 2
						...
						This parameter can be RTC_BKP_DRx where x can be
					      from 0 to 31 to specify the register. Warning : this
					      parameter is shared with RTC_PrivilegeStateTypeDef. */
...
typedef struct {
	...
	uint32_t backupRegisterStartZone2; /*!< Specifies the backup register start zone 2.
						...
						This parameter can be RTC_BKP_DRx where x can be
					      from 0 to 31 to specify the register . Warning : this
					      parameter is writable in secure mode or if trustzone
					      is disabled. Warning : this parameter is shared with
					      RTC_SecureStateTypeDef */
...
#define RTC_SMOOTHCALIB_PERIOD_32SEC                                                               \
	0x00000000u /*!< If RTCCLK = 32768 Hz, Smooth calibration                                  \
			 period is 32s,  else 2exp20 RTCCLK pulses */
#define RTC_SMOOTHCALIB_PERIOD_16SEC                                                               \
	RTC_CALR_CALW16 /*!< If RTCCLK = 32768 Hz, Smooth calibration                              \
			     period is 16s, else 2exp19 RTCCLK pulses */
#define RTC_SMOOTHCALIB_PERIOD_8SEC                                                                \
	RTC_CALR_CALW8 /*!< If RTCCLK = 32768 Hz, Smooth calibration                               \
...
#define RTC_INT_TAMPER_ALL                                                                         \
	(RTC_INT_TAMPER_1 | RTC_INT_TAMPER_2 | RTC_INT_TAMPER_3 | RTC_INT_TAMPER_5 |               \
	 RTC_INT_TAMPER_4 | RTC_INT_TAMPER_8)
/**
 * @}
 */
...
#define RTC_TAMPERTRIGGER_FALLINGEDGE                                                              \
	0x01u /*!< Warning : Filter must be RTC_TAMPERFILTER_DISABLE */
#define RTC_TAMPERTRIGGER_LOWLEVEL                                                                 \
	0x02u /*!< Warning : Filter must not be RTC_TAMPERFILTER_DISABLE */
#define RTC_TAMPERTRIGGER_HIGHLEVEL                                                                \
	0x03u /*!< Warning : Filter must not be RTC_TAMPERFILTER_DISABLE */
/**
 * @}
 */
...
#define RTC_TAMPERFILTER_2SAMPLE                                                                   \
	TAMP_FLTCR_TAMPFLT_0 /*!< Tamper is activated after 2                                      \
				   consecutive samples at the active level */
#define RTC_TAMPERFILTER_4SAMPLE                                                                   \
	TAMP_FLTCR_TAMPFLT_1 /*!< Tamper is activated after 4                                      \
				   consecutive samples at the active level */
#define RTC_TAMPERFILTER_8SAMPLE                                                                   \
	TAMP_FLTCR_TAMPFLT /*!< Tamper is activated after 8                                        \
				 consecutive samples at the active level */
/**
 * @}
 */
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV32768                                                     \
	0x00000000U /*!< Each of the tamper inputs are sampled                                     \
			  with a frequency =  RTCCLK / 32768 */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV16384                                                     \
	TAMP_FLTCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled                           \
				    with a frequency =  RTCCLK / 16384 */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV8192                                                      \
	TAMP_FLTCR_TAMPFREQ_1 /*!< Each of the tamper inputs are sampled                           \
				    with a frequency =  RTCCLK / 8192  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096                                                      \
	(TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024                                                      \
	(TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled \
							      with a frequency =  RTCCLK / 1024 */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512                                                       \
	(TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled \
...
#define RTC_TAMPERPRECHARGEDURATION_1RTCCLK                                                        \
	0x00000000U /*!< Tamper pins are pre-charged before                                        \
			  sampling during 1 RTCCLK cycle  */
#define RTC_TAMPERPRECHARGEDURATION_2RTCCLK                                                        \
	TAMP_FLTCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before                              \
				    sampling during 2 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_4RTCCLK                                                        \
	TAMP_FLTCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before                              \
				    sampling during 4 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK                                                        \
	(TAMP_FLTCR_TAMPPRCH_0 | TAMP_FLTCR_TAMPPRCH_1) /*!< Tamper pins are pre-charged before    \
...
#define RTC_TAMPER_PULLUP_DISABLE                                                                  \
	TAMP_FLTCR_TAMPPUDIS /*!< Tamper pins pre-charge is disabled          */
/**
 * @}
 */
...
#define RTC_TIMESTAMPONTAMPERDETECTION_DISABLE                                                     \
	0x00000000u /*!< TimeStamp on Tamper Detection event is not saved */
#define RTC_TIMESTAMPONTAMPERDETECTION_ENABLE                                                      \
	RTC_CR_TAMPTS /*!< TimeStamp on Tamper Detection event saved        */
/**
 * @}
 */
...
#define RTC_IT_INT_TAMP_ALL                                                                        \
	(RTC_IT_INT_TAMP_1 | RTC_IT_INT_TAMP_2 | RTC_IT_INT_TAMP_3 | RTC_IT_INT_TAMP_4 |           \
	 RTC_IT_INT_TAMP_5 | RTC_IT_INT_TAMP_8)
/**
 * @}
 */
...
#define RTC_FLAG_INT_TAMP_ALL                                                                      \
	(RTC_FLAG_INT_TAMP_1 | RTC_FLAG_INT_TAMP_2 | RTC_FLAG_INT_TAMP_3 | RTC_FLAG_INT_TAMP_4 |   \
	 RTC_FLAG_INT_TAMP_5 | RTC_FLAG_INT_TAMP_8)
/**
 * @}
 */
...
/** @defgroup RTCEx_ActiveTamper_Async_prescaler RTCEx Active_Tamper_Asynchronous_Prescaler clock
 * Definitions
 * @{
 */
...
#define RTC_ATAMP_ASYNCPRES_RTCCLK_32                                                              \
	(TAMP_ATCR1_ATCKSEL_2 | TAMP_ATCR1_ATCKSEL_0) /*!< RTCCLK/32 */
#define RTC_ATAMP_ASYNCPRES_RTCCLK_64                                                              \
	(TAMP_ATCR1_ATCKSEL_2 | TAMP_ATCR1_ATCKSEL_1) /*!< RTCCLK/64 */
#define RTC_ATAMP_ASYNCPRES_RTCCLK_128                                                             \
	(TAMP_ATCR1_ATCKSEL_2 | TAMP_ATCR1_ATCKSEL_1 | TAMP_ATCR1_ATCKSEL_0) /*!< RTCCLK/128 */
/**
 * @}
 */
...
#define RTC_SECURE_FULL_NO                                                                         \
	RTC_SMCR_DECPROT /*!< RTC is not full secure, features can be non-secure. See              \
			    RTC_LL_EC_NONSECURE_RTC_FEATURE */
/**
 * @}
 */
...
#define RTC_NONSECURE_FEATURE_ALL                                                                  \
	(RTC_SMCR_INITDPROT | RTC_SMCR_CALDPROT | RTC_SMCR_TSDPROT | RTC_SMCR_WUTDPROT |           \
...
#define RTC_PRIVILEGE_FEATURE_ALL                                                                  \
	(RTC_PRIVCR_INITPRIV | RTC_PRIVCR_CALPRIV | RTC_PRIVCR_TSPRIV | RTC_PRIVCR_WUTPRIV |       \
...
/** @defgroup RTCEx_Backup_Reg_Privilege_zone  RTCEx Privilege Backup register privilege zone
 * Definition
 * @{
 */
...
#define __HAL_RTC_WAKEUPTIMER_GET_IT(__HANDLE__, __INTERRUPT__)                                    \
	((((RTC->MISR) & ((__INTERRUPT__) >> 12U)) != 0UL) ? 1UL : 0UL)
/**
...
#define __HAL_RTC_WAKEUPTIMER_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                             \
	((((RTC->CR) & (__INTERRUPT__)) != 0UL) ? 1UL : 0UL)
...
#define __HAL_RTC_WAKEUPTIMER_CLEAR_FLAG(__HANDLE__, __FLAG__)                                     \
	...
	#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_IT()                                             \
		(EXTI_C2->IMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
	...
	#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_EVENT()                                          \
		(EXTI_C2->EMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
 ...
 */
	 ...
	 */
	#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_IT()                                             \
		(EXTI_C1->IMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
	 ...
	 */
	#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_EVENT()                                          \
		(EXTI_C1->EMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
...
#define __HAL_RTC_TIMESTAMP_GET_IT(__HANDLE__, __INTERRUPT__)                                      \
	((((RTC->MISR) & ((__INTERRUPT__) >> 12U)) != 0U) ? 1UL : 0UL)
/**
...
#define __HAL_RTC_TIMESTAMP_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                               \
	((((RTC->CR) & (__INTERRUPT__)) != 0U) ? 1UL : 0UL)
...
#define __HAL_RTC_TIMESTAMP_CLEAR_FLAG(__HANDLE__, __FLAG__)                                       \
	(__HAL_RTC_CLEAR_FLAG((__HANDLE__), (__FLAG__)))
	 ...
	 * @retval None
	 */
	#define __HAL_RTC_TIMESTAMP_EXTI_ENABLE_IT()                                               \
		(EXTI_C2->IMR1 |= RTC_EXTI_LINE_TIMESTAMP_EVENT)

	/**
	 * @brief  Disable interrupt on the RTC Timestamp associated Exti line.
	 * @retval None
	 */
	#define __HAL_RTC_TIMESTAMP_EXTI_DISABLE_IT()                                              \
		(EXTI_C2->IMR1 &= ~(RTC_EXTI_LINE_TIMESTAMP_EVENT))
	...
	#define __HAL_RTC_TIMESTAMP_EXTI_ENABLE_EVENT()                                            \
		(EXTI_C2->EMR1 |= RTC_EXTI_LINE_TIMESTAMP_EVENT)

	/**
	 * @brief  Disable event on the RTC Timestamp associated Exti line.
	 * @retval None
	 */
	#define __HAL_RTC_TIMESTAMP_EXTI_DISABLE_EVENT()                                           \
		(EXTI_C2->EMR1 &= ~(RTC_EXTI_LINE_TIMESTAMP_EVENT))
	 ...
	 */
	#define __HAL_RTC_TIMESTAMP_EXTI_ENABLE_IT()                                               \
		(EXTI_C1->IMR1 |= RTC_EXTI_LINE_TIMESTAMP_EVENT)
	 ...
	 */
	#define __HAL_RTC_TIMESTAMP_EXTI_ENABLE_EVENT()                                            \
		(EXTI_C1->EMR1 |= RTC_EXTI_LINE_TIMESTAMP_EVENT)
...
#define __HAL_RTC_TAMPER_GET_IT(__HANDLE__, __INTERRUPT__)                                         \
	((((TAMP->MISR) & (__INTERRUPT__)) != 0U) ? 1UL : 0UL)
...
#define __HAL_RTC_TAMPER_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                                  \
	((((TAMP->IER) & (__INTERRUPT__)) != 0U) ? 1UL : 0UL)
...
#define __HAL_RTC_TAMPER_CLEAR_FLAG(__HANDLE__, __FLAG__) ((TAMP->SCR) = (__FLAG__))
	 ...
	 * @retval None
	 */
	#define __HAL_RTC_TAMPER_EXTI_ENABLE_IT()    (EXTI_C2->IMR1 |= RTC_EXTI_LINE_TAMPER_EVENT)

	/**
	 * @brief  Disable interrupt on the RTC tamper associated Exti line.
	 * @retval None
	 */
	#define __HAL_RTC_TAMPER_EXTI_DISABLE_IT()   (EXTI_C2->IMR1 &= ~(RTC_EXTI_LINE_TAMPER_EVENT))
	 ...
	 * @retval None
	 */
	#define __HAL_RTC_TAMPER_EXTI_ENABLE_IT()    (EXTI_C1->IMR1 |= RTC_EXTI_LINE_TAMPER_EVENT)

	/**
	 * @brief  Disable interrupt on the RTC tamper associated Exti line.
	 * @retval None
	 */
	#define __HAL_RTC_TAMPER_EXTI_DISABLE_IT()   (EXTI_C1->IMR1 &= ~(RTC_EXTI_LINE_TAMPER_EVENT))

	/**
	 * @brief  Enable event on the RTC tamper associated Exti line.
	 * @retval None
	 */
	#define __HAL_RTC_TAMPER_EXTI_ENABLE_EVENT() (EXTI_C1->EMR1 |= RTC_EXTI_LINE_TAMPER_EVENT)
	 ...
	 */
	#define __HAL_RTC_TAMPER_EXTI_DISABLE_EVENT()                                              \
		(EXTI_C1->EMR1 &= ~(RTC_EXTI_LINE_TAMPER_EVENT))
...
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer_IT(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter,
					      uint32_t WakeUpClock, uint32_t WakeUpAutoClr);
...
HAL_StatusTypeDef HAL_RTCEx_MonotonicCounterGet(RTC_HandleTypeDef *hrtc, uint32_t Instance,
						uint32_t *Value);
/**
 * @}
 */
...
HAL_StatusTypeDef HAL_RTCEx_PollForTamperEvent(RTC_HandleTypeDef *hrtc, uint32_t Tamper,
					       uint32_t Timeout);
...
HAL_StatusTypeDef HAL_RTCEx_PollForInternalTamperEvent(RTC_HandleTypeDef *hrtc, uint32_t IntTamper,
						       uint32_t Timeout);
 ...
 */
	...
	#define RTC_EXTI_LINE_TIMESTAMP_EVENT                                                      \
		EXTI_IMR1_IM18 /*!< External interrupt line 18 Connected to the RTC Time Stamp     \
				  events */
	#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT                                                    \
		EXTI_IMR1_IM18 /*!< External interrupt line 18 Connected to the RTC Wakeup event   \
				*/
	#define RTC_EXTI_LINE_TAMPER_EVENT                                                         \
		EXTI_IMR1_IM20 /*!< External interrupt line 20 Connected to the RTC tamper events  \
				*/
#else			       /* #if defined (CORTEX_IN_SECURE_STATE) */
	#define RTC_EXTI_LINE_ALARM_EVENT                                                          \
		EXTI_IMR1_IM17 /*!< External interrupt line 17 Connected to the RTC Alarm event */
	#define RTC_EXTI_LINE_TIMESTAMP_EVENT                                                      \
		EXTI_IMR1_IM17 /*!< External interrupt line 17 Connected to the RTC Time Stamp     \
				  events */
	#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT                                                    \
		EXTI_IMR1_IM17 /*!< External interrupt line 17 Connected to the RTC Wakeup event   \
				*/
	#define RTC_EXTI_LINE_TAMPER_EVENT                                                         \
		EXTI_IMR1_IM19 /*!< External interrupt line 19 Connected to the RTC tamper events  \
				*/
#endif			       /* #if defined (CORTEX_IN_SECURE_STATE) */
/**
 * @}
...
#define IS_RTC_TAMPER_TAMPERDETECTIONOUTPUT(MODE)                                                  \
	(((MODE) == RTC_TAMPERDETECTIONOUTPUT_ENABLE) ||                                           \
...
#define IS_RTC_SMOOTH_CALIB_PERIOD(PERIOD)                                                         \
	(((PERIOD) == RTC_SMOOTHCALIB_PERIOD_32SEC) ||                                             \
	 ((PERIOD) == RTC_SMOOTHCALIB_PERIOD_16SEC) || ((PERIOD) == RTC_SMOOTHCALIB_PERIOD_8SEC))
...
#define IS_RTC_LOW_POWER_CALIB(LPCAL)	 (((LPCAL) == RTC_LPCAL_SET) || ((LPCAL) == RTC_LPCAL_RESET))

#define IS_RTC_TAMPER(__TAMPER__)                                                                  \
	((((__TAMPER__)&RTC_TAMPER_ALL) != 0x00U) && (((__TAMPER__) & ~RTC_TAMPER_ALL) == 0x00U))
...
#define IS_RTC_TAMPER_FILTER(__FILTER__)                                                           \
	(((__FILTER__) == RTC_TAMPERFILTER_DISABLE) ||                                             \
	 ...
	 ((__FILTER__) == RTC_TAMPERFILTER_4SAMPLE) || ((__FILTER__) == RTC_TAMPERFILTER_8SAMPLE))
...
#define IS_RTC_TAMPER_PULLUP_STATE(__STATE__)                                                      \
	(((__STATE__) == RTC_TAMPER_PULLUP_ENABLE) || ((__STATE__) == RTC_TAMPER_PULLUP_DISABLE))
...
#define IS_RTC_SECURE_FULL(__STATE__)                                                              \
	(((__STATE__) == RTC_SECURE_FULL_YES) || ((__STATE__) == RTC_SECURE_FULL_NO))

#define IS_RTC_NONSECURE_FEATURES(__FEATURES__)                                                    \
	(((__FEATURES__) & ~RTC_NONSECURE_FEATURE_ALL) == 0u)

#define IS_TAMP_SECURE_FULL(__STATE__)                                                             \
	(((__STATE__) == TAMP_SECURE_FULL_YES) || ((__STATE__) == TAMP_SECURE_FULL_NO))

#define IS_RTC_PRIVILEGE_FULL(__STATE__)                                                           \
	(((__STATE__) == RTC_PRIVILEGE_FULL_YES) || ((__STATE__) == RTC_PRIVILEGE_FULL_NO))

#define IS_RTC_PRIVILEGE_FEATURES(__FEATURES__)                                                    \
	(((__FEATURES__) & ~RTC_PRIVILEGE_FEATURE_ALL) == 0u)

#define IS_TAMP_PRIVILEGE_FULL(__STATE__)                                                          \
	(((__STATE__) == TAMP_PRIVILEGE_FULL_YES) || ((__STATE__) == TAMP_PRIVILEGE_FULL_NO))
