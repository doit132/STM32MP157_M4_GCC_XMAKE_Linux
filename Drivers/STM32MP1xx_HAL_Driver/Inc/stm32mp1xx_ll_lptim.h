...
#ifndef STM32MP1xx_LL_LPTIM_H
#define STM32MP1xx_LL_LPTIM_H
...
typedef struct {
	 ...
	 * @brief    IT defines which can be used with LL_LPTIM_ReadReg and  LL_LPTIM_WriteReg
	 * functions
	 * @{
	 */
	...
	#define LL_LPTIM_OPERATING_MODE_CONTINUOUS                                                 \
		LPTIM_CR_CNTSTRT /*!<LP Timer starts in continuous mode*/
	#define LL_LPTIM_OPERATING_MODE_ONESHOT                                                    \
		LPTIM_CR_SNGSTRT /*!<LP Tilmer starts in single mode*/
	/**
	 * @}
	 */
	...
	#define LL_LPTIM_UPDATE_MODE_IMMEDIATE                                                     \
		0x00000000U /*!<Preload is disabled: registers are updated after each APB bus      \
			       write access*/
	#define LL_LPTIM_UPDATE_MODE_ENDOFPERIOD                                                   \
		LPTIM_CFGR_PRELOAD /*!<preload is enabled: registers are updated at the end of the \
				      current LPTIM period*/
	/**
	 * @}
	 */
	...
	#define LL_LPTIM_COUNTER_MODE_INTERNAL                                                     \
		0x00000000U /*!<The counter is incremented following each internal clock pulse*/
	#define LL_LPTIM_COUNTER_MODE_EXTERNAL                                                     \
		LPTIM_CFGR_COUNTMODE /*!<The counter is incremented following each valid clock     \
	...
	#define LL_LPTIM_OUTPUT_WAVEFORM_PWM                                                       \
		0x00000000U /*!<LPTIM  generates either a PWM waveform or a One pulse waveform     \
			       depending on chosen operating mode CONTINUOUS or SINGLE*/
	#define LL_LPTIM_OUTPUT_WAVEFORM_SETONCE                                                   \
		LPTIM_CFGR_WAVE /*!<LPTIM  generates a Set Once waveform*/
	/**
	 * @}
	 */
	...
	#define LL_LPTIM_OUTPUT_POLARITY_REGULAR                                                   \
		0x00000000U /*!<The LPTIM output reflects the compare results between LPTIMx_ARR   \
			       and LPTIMx_CMP registers*/
	#define LL_LPTIM_OUTPUT_POLARITY_INVERSE                                                   \
		LPTIM_CFGR_WAVPOL /*!<The LPTIM output reflects the inverse of the compare results \
	...
	#define LL_LPTIM_PRESCALER_DIV2                                                            \
		LPTIM_CFGR_PRESC_0 /*!<Prescaler division factor is set to 2*/
	#define LL_LPTIM_PRESCALER_DIV4                                                            \
		LPTIM_CFGR_PRESC_1 /*!<Prescaler division factor is set to 4*/
	#define LL_LPTIM_PRESCALER_DIV8                                                            \
		(LPTIM_CFGR_PRESC_1 |                                                              \
		 LPTIM_CFGR_PRESC_0) /*!<Prescaler division factor is set to 8*/
	#define LL_LPTIM_PRESCALER_DIV16                                                           \
		LPTIM_CFGR_PRESC_2 /*!<Prescaler division factor is set to 16*/
	#define LL_LPTIM_PRESCALER_DIV32                                                           \
		(LPTIM_CFGR_PRESC_2 |                                                              \
		 LPTIM_CFGR_PRESC_0) /*!<Prescaler division factor is set to 32*/
	#define LL_LPTIM_PRESCALER_DIV64                                                           \
		(LPTIM_CFGR_PRESC_2 |                                                              \
		 LPTIM_CFGR_PRESC_1) /*!<Prescaler division factor is set to 64*/
	#define LL_LPTIM_PRESCALER_DIV128                                                          \
		LPTIM_CFGR_PRESC /*!<Prescaler division factor is set to 128*/
	/**
	 * @}
	 */
	...
	#define LL_LPTIM_TRIG_SOURCE_GPIO                                                          \
		0x00000000U /*!<External input trigger is connected to TIMx_ETR input*/
	#define LL_LPTIM_TRIG_SOURCE_RTCALARMA                                                     \
		LPTIM_CFGR_TRIGSEL_0 /*!<External input trigger is connected to RTC Alarm A*/
	#define LL_LPTIM_TRIG_SOURCE_RTCALARMB                                                     \
		LPTIM_CFGR_TRIGSEL_1 /*!<External input trigger is connected to RTC Alarm B*/
	#define LL_LPTIM_TRIG_SOURCE_RTCTAMP1                                                      \
		(LPTIM_CFGR_TRIGSEL_1 |                                                            \
		 LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to RTC Tamper 1*/
	#define LL_LPTIM_TRIG_SOURCE_RTCTAMP2                                                      \
		LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to RTC Tamper 2*/
	#define LL_LPTIM_TRIG_SOURCE_RTCTAMP3                                                      \
		(LPTIM_CFGR_TRIGSEL_2 |                                                            \
		 LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to RTC Tamper 3*/
	#define LL_LPTIM_TRIG_SOURCE_LPTIM2                                                        \
		0x00000000U /*!<External input trigger is connected to LPTIM2 output*/
	#define LL_LPTIM_TRIG_SOURCE_LPTIM3                                                        \
		LPTIM_CFGR_TRIGSEL_0 /*!<External input trigger is connected to LPTIM3 output*/
	#define LL_LPTIM_TRIG_SOURCE_LPTIM4                                                        \
		LPTIM_CFGR_TRIGSEL_1 /*!<External input trigger is connected to LPTIM4 output*/
	#define LL_LPTIM_TRIG_SOURCE_LPTIM5                                                        \
		(LPTIM_CFGR_TRIGSEL_1 |                                                            \
		 LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to LPTIM5 output*/
	#define LL_LPTIM_TRIG_SOURCE_SAI1A                                                         \
		LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to SAI1A output*/
	#define LL_LPTIM_TRIG_SOURCE_SAI1B                                                         \
		(LPTIM_CFGR_TRIGSEL_2 |                                                            \
		 LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to SAI1B output*/
	#define LL_LPTIM_TRIG_SOURCE_SAI2A                                                         \
		LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to SAI2A output*/
	#define LL_LPTIM_TRIG_SOURCE_SAI2B                                                         \
		(LPTIM_CFGR_TRIGSEL_2 |                                                            \
		 LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to SAI2B output*/
	#define LL_LPTIM_TRIG_SOURCE_SAI4A                                                         \
		(LPTIM_CFGR_TRIGSEL_1 |                                                            \
		 LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to SAI4A output*/
	#define LL_LPTIM_TRIG_SOURCE_SAI4B                                                         \
		LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to SAI4B output*/
	/**
	 * @}
	 */
	...
	#define LL_LPTIM_TRIG_FILTER_NONE                                                          \
		0x00000000U /*!<Any trigger active level change is considered as a valid trigger*/
	#define LL_LPTIM_TRIG_FILTER_2                                                             \
		LPTIM_CFGR_TRGFLT_0 /*!<Trigger active level change must be stable for at least 2  \
				       clock periods before it is considered as valid trigger*/
	#define LL_LPTIM_TRIG_FILTER_4                                                             \
		LPTIM_CFGR_TRGFLT_1 /*!<Trigger active level change must be stable for at least 4  \
				       clock periods before it is considered as valid trigger*/
	#define LL_LPTIM_TRIG_FILTER_8                                                             \
		LPTIM_CFGR_TRGFLT /*!<Trigger active level change must be stable for at least 8    \
				     clock periods before it is considered as valid trigger*/
	/**
	 * @}
	 */
	...
	#define LL_LPTIM_TRIG_POLARITY_RISING                                                      \
		LPTIM_CFGR_TRIGEN_0 /*!<LPTIM counter starts when a rising edge is detected*/
	#define LL_LPTIM_TRIG_POLARITY_FALLING                                                     \
		LPTIM_CFGR_TRIGEN_1 /*!<LPTIM counter starts when a falling edge is detected*/
	#define LL_LPTIM_TRIG_POLARITY_RISING_FALLING                                              \
		LPTIM_CFGR_TRIGEN /*!<LPTIM counter starts when a rising or a falling edge is      \
				     detected*/
	/**
	 * @}
	 */
	...
	#define LL_LPTIM_CLK_SOURCE_INTERNAL                                                       \
		0x00000000U /*!<LPTIM is clocked by internal clock source (APB clock or any of the \
			       embedded oscillators)*/
	#define LL_LPTIM_CLK_SOURCE_EXTERNAL                                                       \
		LPTIM_CFGR_CKSEL /*!<LPTIM is clocked by an external clock source through the      \
	...
	#define LL_LPTIM_CLK_FILTER_NONE                                                           \
		0x00000000U /*!<Any external clock signal level change is considered as a valid    \
			       transition*/
	#define LL_LPTIM_CLK_FILTER_2                                                              \
		LPTIM_CFGR_CKFLT_0 /*!<External clock signal level change must be stable for at    \
				      least 2 clock periods before it is considered as valid       \
				      transition*/
	#define LL_LPTIM_CLK_FILTER_4                                                              \
		LPTIM_CFGR_CKFLT_1 /*!<External clock signal level change must be stable for at    \
				      least 4 clock periods before it is considered as valid       \
				      transition*/
	#define LL_LPTIM_CLK_FILTER_8                                                              \
		LPTIM_CFGR_CKFLT /*!<External clock signal level change must be stable for at      \
	...
	#define LL_LPTIM_CLK_POLARITY_RISING                                                       \
		0x00000000U /*!< The rising edge is the active edge used for counting*/
	#define LL_LPTIM_CLK_POLARITY_FALLING                                                      \
		LPTIM_CFGR_CKPOL_0 /*!< The falling edge is the active edge used for counting*/
	#define LL_LPTIM_CLK_POLARITY_RISING_FALLING                                               \
		LPTIM_CFGR_CKPOL_1 /*!< Both edges are active edges*/
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_LPTIM_INPUT2_SRC_GPIO      0x00000000U /*!< For LPTIM1 and LPTIM2 */
	/**
	 * @}
	 */
	 ...
	 * @retval None
	 */
	#define LL_LPTIM_WriteReg(__INSTANCE__, __REG__, __VALUE__)                                \
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_ConfigOutput(LPTIM_TypeDef *LPTIMx, uint32_t Waveform,
					   uint32_t Polarity)
{
 ...
 *         @arg @ref LL_LPTIM_TRIG_SOURCE_SAI1A  (*)
 *         @arg @ref LL_LPTIM_TRIG_SOURCE_SAI1B  (*)
 *         @arg @ref LL_LPTIM_TRIG_SOURCE_SAI2A  (*)
 *         @arg @ref LL_LPTIM_TRIG_SOURCE_SAI2B  (*)
 *         @arg @ref LL_LPTIM_TRIG_SOURCE_SAI4A  (*)
 *         @arg @ref LL_LPTIM_TRIG_SOURCE_SAI4B  (*)
 *
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_ConfigTrigger(LPTIM_TypeDef *LPTIMx, uint32_t Source, uint32_t Filter,
					    uint32_t Polarity)
{
	MODIFY_REG(LPTIMx->CFGR, LPTIM_CFGR_TRIGSEL | LPTIM_CFGR_TRGFLT | LPTIM_CFGR_TRIGEN,
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ConfigClock(LPTIM_TypeDef *LPTIMx, uint32_t ClockFilter,
...
/**
 * @brief  Inform application whether a valid edge on the selected external trigger input has
 * occurred.
...
/**
  * @brief  Informs application whether the APB bus write operation to the LPTIMx_CMP register has
  been successfully completed. If so, a new one can be initiated.
...
/**
  * @brief  Informs application whether the APB bus write operation to the LPTIMx_ARR register has
  been successfully completed. If so, a new one can be initiated.
...
/**
  * @brief  Informs the application whether the counter direction has changed from down to up (when
...
/**
  * @brief  Informs the application whether the counter direction has changed from up to down (when
  the LPTIM instance operates in encoder mode).
