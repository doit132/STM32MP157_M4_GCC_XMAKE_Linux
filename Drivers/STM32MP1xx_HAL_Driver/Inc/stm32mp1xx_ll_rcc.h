...
typedef struct {
	 ...
	 */
		...
		#define USBO_48M_VALUE                                                             \
			48000000U /*!< Value of the rcc_ck_usbo_48m oscillator in Hz */
	...
	#define LL_RCC_CIFR_LSECSSC                                                                \
		RCC_MC_CIFR_LSECSSF /*!< LSE Clock Security System Interrupt Clear */
	...
	#define LL_RCC_CIFR_LSECSSF                                                                \
		RCC_MC_CIFR_LSECSSF /*!< LSE Clock Security System Interrupt flag */
	...
	#define LL_RCC_CIER_LSECSSIE                                                               \
		RCC_MC_CIER_LSECSSIE /*!< LSE Clock Security System Interrupt Enable */
	...
	#define LL_RCC_MCO1SOURCE_HSE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO1CFGR, RCC_MCO1CFGR_MCO1SEL, RCC_MCO1CFGR_MCO1SEL_0)
	#define LL_RCC_MCO1SOURCE_CSI                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO1CFGR, RCC_MCO1CFGR_MCO1SEL, RCC_MCO1CFGR_MCO1SEL_1)
	#define LL_RCC_MCO1SOURCE_LSI                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO1CFGR, RCC_MCO1CFGR_MCO1SEL,                            \
			     (RCC_MCO1CFGR_MCO1SEL_0 | RCC_MCO1CFGR_MCO1SEL_1))
	#define LL_RCC_MCO1SOURCE_LSE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO1CFGR, RCC_MCO1CFGR_MCO1SEL, RCC_MCO1CFGR_MCO1SEL_2)

	#define LL_RCC_MCO2SOURCE_MPU LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, 0)
	#define LL_RCC_MCO2SOURCE_AXI                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, RCC_MCO2CFGR_MCO2SEL_0)
	#define LL_RCC_MCO2SOURCE_MCU                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, RCC_MCO2CFGR_MCO2SEL_1)
	#define LL_RCC_MCO2SOURCE_PLL4                                                             \
		LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL,                            \
			     (RCC_MCO2CFGR_MCO2SEL_1 | RCC_MCO2CFGR_MCO2SEL_0))
	#define LL_RCC_MCO2SOURCE_HSE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, RCC_MCO2CFGR_MCO2SEL_2)
	#define LL_RCC_MCO2SOURCE_HSI                                                              \
		LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL,                            \
			     (RCC_MCO2CFGR_MCO2SEL_2 | RCC_MCO2CFGR_MCO2SEL_0))
	/**
	 * @}
	 */
	...
	#define LL_RCC_MCO1_DIV_4                                                                  \
		(RCC_MCO1CFGR_MCO1DIV_1 | RCC_MCO1CFGR_MCO1DIV_0) /*!< MCO divided by 4 */
	#define LL_RCC_MCO1_DIV_5 RCC_MCO1CFGR_MCO1DIV_2	  /*!< MCO divided by 5 */
	#define LL_RCC_MCO1_DIV_6                                                                  \
		(RCC_MCO1CFGR_MCO1DIV_2 | RCC_MCO1CFGR_MCO1DIV_0) /*!< MCO divided by 6 */
	#define LL_RCC_MCO1_DIV_7                                                                  \
		(RCC_MCO1CFGR_MCO1DIV_2 | RCC_MCO1CFGR_MCO1DIV_1) /*!< MCO divided by 7 */
	#define LL_RCC_MCO1_DIV_8                                                                  \
		(RCC_MCO1CFGR_MCO1DIV_2 | RCC_MCO1CFGR_MCO1DIV_1 |                                 \
		 RCC_MCO1CFGR_MCO1DIV_0)		 /*!< MCO divided by 8 */
	#define LL_RCC_MCO1_DIV_9 RCC_MCO1CFGR_MCO1DIV_3 /*!< MCO divided by 9 */
	#define LL_RCC_MCO1_DIV_10                                                                 \
		(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_0) /*!< MCO divided by 10 */
	#define LL_RCC_MCO1_DIV_11                                                                 \
		(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_1) /*!< MCO divided by 11 */
	#define LL_RCC_MCO1_DIV_12                                                                 \
		(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_1 |                                 \
		 RCC_MCO1CFGR_MCO1DIV_0) /*!< MCO divided by 12 */
	#define LL_RCC_MCO1_DIV_13                                                                 \
		(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_2) /*!< MCO divided by 13 */
	#define LL_RCC_MCO1_DIV_14                                                                 \
		(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_2 |                                 \
		 RCC_MCO1CFGR_MCO1DIV_0) /*!< MCO divided by 14 */
	#define LL_RCC_MCO1_DIV_15                                                                 \
		(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_2 |                                 \
		 RCC_MCO1CFGR_MCO1DIV_1) /*!< MCO divided by 15 */
	#define LL_RCC_MCO1_DIV_16                                                                 \
		(RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_2 | RCC_MCO1CFGR_MCO1DIV_1 |        \
		 RCC_MCO1CFGR_MCO1DIV_0) /*!< MCO divided by 16 */
	/**
	 * @}
	 */
	...
	#define LL_RCC_MCO2_DIV_4                                                                  \
		(RCC_MCO2CFGR_MCO2DIV_1 | RCC_MCO2CFGR_MCO2DIV_0) /*!< MCO divided by 4 */
	#define LL_RCC_MCO2_DIV_5 RCC_MCO2CFGR_MCO2DIV_2	  /*!< MCO divided by 5 */
	#define LL_RCC_MCO2_DIV_6                                                                  \
		(RCC_MCO2CFGR_MCO2DIV_2 | RCC_MCO2CFGR_MCO2DIV_0) /*!< MCO divided by 6 */
	#define LL_RCC_MCO2_DIV_7                                                                  \
		(RCC_MCO2CFGR_MCO2DIV_2 | RCC_MCO2CFGR_MCO2DIV_1) /*!< MCO divided by 7 */
	#define LL_RCC_MCO2_DIV_8                                                                  \
		(RCC_MCO2CFGR_MCO2DIV_2 | RCC_MCO2CFGR_MCO2DIV_1 |                                 \
		 RCC_MCO2CFGR_MCO2DIV_0)		 /*!< MCO divided by 8 */
	#define LL_RCC_MCO2_DIV_9 RCC_MCO2CFGR_MCO2DIV_3 /*!< MCO divided by 9 */
	#define LL_RCC_MCO2_DIV_10                                                                 \
		(RCC_MCO2CFGR_MCO2DIV_3 | RCC_MCO2CFGR_MCO2DIV_0) /*!< MCO divided by 10 */
	#define LL_RCC_MCO2_DIV_11                                                                 \
		(RCC_MCO2CFGR_MCO2DIV_3 | RCC_MCO2CFGR_MCO2DIV_1) /*!< MCO divided by 11 */
	#define LL_RCC_MCO2_DIV_12                                                                 \
		(RCC_MCO2CFGR_MCO2DIV_3 | RCC_MCO2CFGR_MCO2DIV_1 |                                 \
		 RCC_MCO2CFGR_MCO2DIV_0) /*!< MCO divided by 12 */
	#define LL_RCC_MCO2_DIV_13                                                                 \
		(RCC_MCO2CFGR_MCO2DIV_3 | RCC_MCO2CFGR_MCO2DIV_2) /*!< MCO divided by 13 */
	#define LL_RCC_MCO2_DIV_14                                                                 \
		(RCC_MCO2CFGR_MCO2DIV_3 | RCC_MCO2CFGR_MCO2DIV_2 |                                 \
		 RCC_MCO2CFGR_MCO2DIV_0) /*!< MCO divided by 14 */
	#define LL_RCC_MCO2_DIV_15                                                                 \
		(RCC_MCO2CFGR_MCO2DIV_3 | RCC_MCO2CFGR_MCO2DIV_2 |                                 \
		 RCC_MCO2CFGR_MCO2DIV_1) /*!< MCO divided by 15 */
	#define LL_RCC_MCO2_DIV_16                                                                 \
		(RCC_MCO2CFGR_MCO2DIV_3 | RCC_MCO2CFGR_MCO2DIV_2 | RCC_MCO2CFGR_MCO2DIV_1 |        \
		 RCC_MCO2CFGR_MCO2DIV_0) /*!< MCO divided by 16 */
	/**
	 * @}
	 */
	...
	#define LL_RCC_RTC_HSE_DIV_8                                                               \
		(RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
	...
	#define LL_RCC_RTC_HSE_DIV_12                                                              \
		(RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_13 (RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2)
	#define LL_RCC_RTC_HSE_DIV_14                                                              \
		(RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_15                                                              \
		(RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
	#define LL_RCC_RTC_HSE_DIV_16                                                              \
		(RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 |              \
		 RCC_RTCDIVR_RTCDIV_0)
	...
	#define LL_RCC_RTC_HSE_DIV_20                                                              \
		(RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_21 (RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2)
	#define LL_RCC_RTC_HSE_DIV_22                                                              \
		(RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_23                                                              \
		(RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
	...
	#define LL_RCC_RTC_HSE_DIV_26                                                              \
		(RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_27                                                              \
		(RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_1)
	...
	#define LL_RCC_RTC_HSE_DIV_31                                                              \
		(RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 |              \
		 RCC_RTCDIVR_RTCDIV_1)
	#define LL_RCC_RTC_HSE_DIV_32                                                              \
		(RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 |              \
		 RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
	...
	#define LL_RCC_RTC_HSE_DIV_36                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_37 (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_2)
	#define LL_RCC_RTC_HSE_DIV_38                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_39                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
	#define LL_RCC_RTC_HSE_DIV_40                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 |              \
		 RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_41 (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3)
	#define LL_RCC_RTC_HSE_DIV_42                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_43                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_1)
	#define LL_RCC_RTC_HSE_DIV_44                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_1 |              \
		 RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_45                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2)
	...
	#define LL_RCC_RTC_HSE_DIV_47                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 |              \
		 RCC_RTCDIVR_RTCDIV_1)
	#define LL_RCC_RTC_HSE_DIV_48                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 |              \
		 RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_49 (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4)
	#define LL_RCC_RTC_HSE_DIV_50                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_51                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_1)
	#define LL_RCC_RTC_HSE_DIV_52                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_1 |              \
		 RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_53                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2)
	...
	#define LL_RCC_RTC_HSE_DIV_57                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3)
	...
	#define LL_RCC_RTC_HSE_DIV_61                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 |              \
		 RCC_RTCDIVR_RTCDIV_2)
	#define LL_RCC_RTC_HSE_DIV_62                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 |              \
		 RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
	#define LL_RCC_RTC_HSE_DIV_63                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 |              \
		 RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
	#define LL_RCC_RTC_HSE_DIV_64                                                              \
		(RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_3 |              \
		 RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
	/**
	 * @}
	...
	#define LL_RCC_MPU_CLKSOURCE_PLL1                                                          \
		RCC_MPCKSELR_MPUSRC_1 /*!< PLL1 selection as MPU clock                             \
				       */
	#define LL_RCC_MPU_CLKSOURCE_MPUDIV                                                        \
		(RCC_MPCKSELR_MPUSRC_1 |                                                           \
		 RCC_MPCKSELR_MPUSRC_0) /*!< MPUDIV selection as MPU clock */
	/**
	 * @}
	 */
	...
	#define LL_RCC_MPU_CLKSOURCE_STATUS_HSE                                                    \
		RCC_MPCKSELR_MPUSRC_0 /*!< HSE used as MPU clock                                   \
				       */
	...
	#define LL_RCC_MPU_CLKSOURCE_STATUS_MPUDIV                                                 \
		(RCC_MPCKSELR_MPUSRC_1 | RCC_MPCKSELR_MPUSRC_0) /*!< MPUDIV used as MPU clock */
	/**
	 * @}
	 */
	...
	#define LL_RCC_MPU_DIV_2                                                                   \
		RCC_MPCKDIVR_MPUDIV_0 /*!< MPUSS is equal to pll1_p_ck divided by 2 */
	#define LL_RCC_MPU_DIV_4                                                                   \
		RCC_MPCKDIVR_MPUDIV_1 /*!< MPUSS is equal to pll1_p_ck divided by 4 */
	#define LL_RCC_MPU_DIV_8                                                                   \
		(RCC_MPCKDIVR_MPUDIV_1 |                                                           \
		 RCC_MPCKDIVR_MPUDIV_0) /*!< MPUSS is equal to pll1_p_ck divided by 8 */
	#define LL_RCC_MPU_DIV_16                                                                  \
		RCC_MPCKDIVR_MPUDIV_2 /*!< MPUSS is equal to pll1_p_ck divided by 16 */
	/**
	 * @}
	 */
	...
	#define LL_RCC_AXISS_CLKSOURCE_HSE                                                         \
		RCC_ASSCKSELR_AXISSRC_0 /*!< HSE selection as AXISS clock */
	#define LL_RCC_AXISS_CLKSOURCE_PLL2                                                        \
		RCC_ASSCKSELR_AXISSRC_1 /*!< PLL2 selection as AXISS clock */
	#define LL_RCC_AXISS_CLKSOURCE_OFF                                                         \
		(RCC_ASSCKSELR_AXISSRC_1 | RCC_ASSCKSELR_AXISSRC_0) /*!< AXISS is gated */
	/**
	 * @}
	 */
	...
	#define LL_RCC_AXISS_CLKSOURCE_STATUS_HSE                                                  \
		RCC_ASSCKSELR_AXISSRC_0 /*!< HSE used as AXISS clock */
	#define LL_RCC_AXISS_CLKSOURCE_STATUS_PLL2                                                 \
		RCC_ASSCKSELR_AXISSRC_1 /*!< PLL2 used as AXISS clock */
	#define LL_RCC_AXISS_CLKSOURCE_STATUS_OFF                                                  \
		(RCC_ASSCKSELR_AXISSRC_1 | RCC_ASSCKSELR_AXISSRC_0) /*!< AXISS is gated */
	/**
	 * @}
	 */
	...
	#define LL_RCC_MCUSS_CLKSOURCE_HSE                                                         \
		RCC_MSSCKSELR_MCUSSRC_0 /*!< HSE selection as MCUSS clock */
	#define LL_RCC_MCUSS_CLKSOURCE_CSI                                                         \
		RCC_MSSCKSELR_MCUSSRC_1 /*!< CSI selection as MCUSS clock */
	#define LL_RCC_MCUSS_CLKSOURCE_PLL3                                                        \
		(RCC_MSSCKSELR_MCUSSRC_1 |                                                         \
		 RCC_MSSCKSELR_MCUSSRC_0) /*!< PLL3 selection as MCUSS clock */
	/**
	 * @}
	 */
	...
	#define LL_RCC_MCUSS_CLKSOURCE_STATUS_HSE                                                  \
		RCC_MSSCKSELR_MCUSSRC_0 /*!< HSE used as MCUSS clock */
	#define LL_RCC_MCUSS_CLKSOURCE_STATUS_CSI                                                  \
		RCC_MSSCKSELR_MCUSSRC_1 /*!< CSI used as MCUSS clock */
	#define LL_RCC_MCUSS_CLKSOURCE_STATUS_PLL3                                                 \
		(RCC_MSSCKSELR_MCUSSRC_1 | RCC_MSSCKSELR_MCUSSRC_0) /*!< PLL3 used as MCUSS clock  \
								     */
	/**
	 * @}
	 */
	...
	#define LL_RCC_MCU_DIV_8                                                                   \
		(RCC_MCUDIVR_MCUDIV_1 | RCC_MCUDIVR_MCUDIV_0) /*!< MCUSS divided by 8 */
	#define LL_RCC_MCU_DIV_16 RCC_MCUDIVR_MCUDIV_2	      /*!< MCUSS divided by 16 */
	#define LL_RCC_MCU_DIV_32                                                                  \
		(RCC_MCUDIVR_MCUDIV_2 | RCC_MCUDIVR_MCUDIV_0) /*!< MCUSS divided by 32 */
	#define LL_RCC_MCU_DIV_64                                                                  \
		(RCC_MCUDIVR_MCUDIV_2 | RCC_MCUDIVR_MCUDIV_1) /*!< MCUSS divided by 64 */
	#define LL_RCC_MCU_DIV_128                                                                 \
		(RCC_MCUDIVR_MCUDIV_2 | RCC_MCUDIVR_MCUDIV_1 |                                     \
		 RCC_MCUDIVR_MCUDIV_0)			/*!< MCUSS divided by 128 */
	#define LL_RCC_MCU_DIV_256 RCC_MCUDIVR_MCUDIV_3 /*!< MCUSS divided by 256 */
	#define LL_RCC_MCU_DIV_512                                                                 \
		(RCC_MCUDIVR_MCUDIV_3 | RCC_MCUDIVR_MCUDIV_0) /*!< MCUSS divided by 512 */
	/**
	 * @}
	 */
	...
	#define LL_RCC_APB1_DIV_8                                                                  \
		(RCC_APB1DIVR_APB1DIV_1 | RCC_APB1DIVR_APB1DIV_0) /*!< mlhclk divided by 8 */
	...
	#define LL_RCC_APB2_DIV_8                                                                  \
		(RCC_APB2DIVR_APB2DIV_1 | RCC_APB2DIVR_APB2DIV_0) /*!< mlhclk divided by 8 */
	...
	#define LL_RCC_APB3_DIV_8                                                                  \
		(RCC_APB3DIVR_APB3DIV_1 | RCC_APB3DIVR_APB3DIV_0) /*!< mlhclk divided by 8 */
	...
	#define LL_RCC_APB4_DIV_8                                                                  \
		(RCC_APB4DIVR_APB4DIV_1 | RCC_APB4DIVR_APB4DIV_0) /*!< aclk divided by 8 */
	...
	#define LL_RCC_APB5_DIV_8                                                                  \
		(RCC_APB5DIVR_APB5DIV_1 | RCC_APB5DIVR_APB5DIV_0) /*!< aclk divided by 8 */
	...
	#define LL_RCC_LSEDRIVE_HIGH                                                               \
		(RCC_BDCR_LSEDRV_1 | RCC_BDCR_LSEDRV_0) /*!< Xtal mode higher driving capability   \
							 */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_I2C12_CLKSOURCE_PCLK1                                                       \
		LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC, 0)
	#define LL_RCC_I2C12_CLKSOURCE_PLL4R                                                       \
		LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC,                     \
			     RCC_I2C12CKSELR_I2C12SRC_0)
	#define LL_RCC_I2C12_CLKSOURCE_HSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC,                     \
			     RCC_I2C12CKSELR_I2C12SRC_1)
	#define LL_RCC_I2C12_CLKSOURCE_CSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC,                     \
			     (RCC_I2C12CKSELR_I2C12SRC_1 | RCC_I2C12CKSELR_I2C12SRC_0))

	#define LL_RCC_I2C35_CLKSOURCE_PCLK1                                                       \
		LL_CLKSOURCE(RCC_OFFSET_I2C35CKSELR, RCC_I2C35CKSELR_I2C35SRC, 0)
	#define LL_RCC_I2C35_CLKSOURCE_PLL4R                                                       \
		LL_CLKSOURCE(RCC_OFFSET_I2C35CKSELR, RCC_I2C35CKSELR_I2C35SRC,                     \
			     RCC_I2C35CKSELR_I2C35SRC_0)
	#define LL_RCC_I2C35_CLKSOURCE_HSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_I2C35CKSELR, RCC_I2C35CKSELR_I2C35SRC,                     \
			     RCC_I2C35CKSELR_I2C35SRC_1)
	#define LL_RCC_I2C35_CLKSOURCE_CSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_I2C35CKSELR, RCC_I2C35CKSELR_I2C35SRC,                     \
			     (RCC_I2C35CKSELR_I2C35SRC_1 | RCC_I2C35CKSELR_I2C35SRC_0))

	#define LL_RCC_I2C46_CLKSOURCE_PCLK5                                                       \
		LL_CLKSOURCE(RCC_OFFSET_I2C46CKSELR, RCC_I2C46CKSELR_I2C46SRC, 0)
	#define LL_RCC_I2C46_CLKSOURCE_PLL3Q                                                       \
		LL_CLKSOURCE(RCC_OFFSET_I2C46CKSELR, RCC_I2C46CKSELR_I2C46SRC,                     \
			     RCC_I2C46CKSELR_I2C46SRC_0)
	#define LL_RCC_I2C46_CLKSOURCE_HSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_I2C46CKSELR, RCC_I2C46CKSELR_I2C46SRC,                     \
			     RCC_I2C46CKSELR_I2C46SRC_1)
	#define LL_RCC_I2C46_CLKSOURCE_CSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_I2C46CKSELR, RCC_I2C46CKSELR_I2C46SRC,                     \
			     (RCC_I2C46CKSELR_I2C46SRC_1 | RCC_I2C46CKSELR_I2C46SRC_0))
	/**
	 * @}
	 */
	...
	#define LL_RCC_SAI1_CLKSOURCE_PLL4Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC, 0)
	#define LL_RCC_SAI1_CLKSOURCE_PLL3Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC,                        \
			     RCC_SAI1CKSELR_SAI1SRC_0)
	#define LL_RCC_SAI1_CLKSOURCE_I2SCKIN                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC,                        \
			     RCC_SAI1CKSELR_SAI1SRC_1)
	#define LL_RCC_SAI1_CLKSOURCE_PER                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC,                        \
			     (RCC_SAI1CKSELR_SAI1SRC_1 | RCC_SAI1CKSELR_SAI1SRC_0))
	#define LL_RCC_SAI1_CLKSOURCE_PLL3R                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC,                        \
			     RCC_SAI1CKSELR_SAI1SRC_2)

	#define LL_RCC_SAI2_CLKSOURCE_PLL4Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, 0)
	#define LL_RCC_SAI2_CLKSOURCE_PLL3Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC,                        \
			     RCC_SAI2CKSELR_SAI2SRC_0)
	#define LL_RCC_SAI2_CLKSOURCE_I2SCKIN                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC,                        \
			     RCC_SAI2CKSELR_SAI2SRC_1)
	#define LL_RCC_SAI2_CLKSOURCE_PER                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC,                        \
			     (RCC_SAI2CKSELR_SAI2SRC_1 | RCC_SAI2CKSELR_SAI2SRC_0))
	#define LL_RCC_SAI2_CLKSOURCE_SPDIF                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC,                        \
			     RCC_SAI2CKSELR_SAI2SRC_2)
	#define LL_RCC_SAI2_CLKSOURCE_PLL3R                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC,                        \
			     (RCC_SAI2CKSELR_SAI2SRC_2 | RCC_SAI2CKSELR_SAI2SRC_0))

	#define LL_RCC_SAI3_CLKSOURCE_PLL4Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI3CKSELR, RCC_SAI3CKSELR_SAI3SRC, 0)
	#define LL_RCC_SAI3_CLKSOURCE_PLL3Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI3CKSELR, RCC_SAI3CKSELR_SAI3SRC,                        \
			     RCC_SAI3CKSELR_SAI3SRC_0)
	#define LL_RCC_SAI3_CLKSOURCE_I2SCKIN                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SAI3CKSELR, RCC_SAI3CKSELR_SAI3SRC,                        \
			     RCC_SAI3CKSELR_SAI3SRC_1)
	#define LL_RCC_SAI3_CLKSOURCE_PER                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SAI3CKSELR, RCC_SAI3CKSELR_SAI3SRC,                        \
			     (RCC_SAI3CKSELR_SAI3SRC_1 | RCC_SAI3CKSELR_SAI3SRC_0))
	#define LL_RCC_SAI3_CLKSOURCE_PLL3R                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI3CKSELR, RCC_SAI3CKSELR_SAI3SRC,                        \
			     RCC_SAI3CKSELR_SAI3SRC_2)

	#define LL_RCC_SAI4_CLKSOURCE_PLL4Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI4CKSELR, RCC_SAI4CKSELR_SAI4SRC, 0)
	#define LL_RCC_SAI4_CLKSOURCE_PLL3Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI4CKSELR, RCC_SAI4CKSELR_SAI4SRC,                        \
			     RCC_SAI4CKSELR_SAI4SRC_0)
	#define LL_RCC_SAI4_CLKSOURCE_I2SCKIN                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SAI4CKSELR, RCC_SAI4CKSELR_SAI4SRC,                        \
			     RCC_SAI4CKSELR_SAI4SRC_1)
	#define LL_RCC_SAI4_CLKSOURCE_PER                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SAI4CKSELR, RCC_SAI4CKSELR_SAI4SRC,                        \
			     (RCC_SAI4CKSELR_SAI4SRC_1 | RCC_SAI4CKSELR_SAI4SRC_0))
	#define LL_RCC_SAI4_CLKSOURCE_PLL3R                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SAI4CKSELR, RCC_SAI4CKSELR_SAI4SRC,                        \
			     RCC_SAI4CKSELR_SAI4SRC_2)
	/**
	 * @}
	 */
	...
	#define LL_RCC_SPI1_CLKSOURCE_PLL4P                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC, 0)
	#define LL_RCC_SPI1_CLKSOURCE_PLL3Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC,                    \
			     RCC_SPI2S1CKSELR_SPI1SRC_0)
	#define LL_RCC_SPI1_CLKSOURCE_I2SCKIN                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC,                    \
			     RCC_SPI2S1CKSELR_SPI1SRC_1)
	#define LL_RCC_SPI1_CLKSOURCE_PER                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC,                    \
			     (RCC_SPI2S1CKSELR_SPI1SRC_1 | RCC_SPI2S1CKSELR_SPI1SRC_0))
	#define LL_RCC_SPI1_CLKSOURCE_PLL3R                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC,                    \
			     RCC_SPI2S1CKSELR_SPI1SRC_2)

	#define LL_RCC_SPI23_CLKSOURCE_PLL4P                                                       \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC, 0)
	#define LL_RCC_SPI23_CLKSOURCE_PLL3Q                                                       \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC,                 \
			     RCC_SPI2S23CKSELR_SPI23SRC_0)
	#define LL_RCC_SPI23_CLKSOURCE_I2SCKIN                                                     \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC,                 \
			     RCC_SPI2S23CKSELR_SPI23SRC_1)
	#define LL_RCC_SPI23_CLKSOURCE_PER                                                         \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC,                 \
			     (RCC_SPI2S23CKSELR_SPI23SRC_1 | RCC_SPI2S23CKSELR_SPI23SRC_0))
	#define LL_RCC_SPI23_CLKSOURCE_PLL3R                                                       \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC,                 \
			     RCC_SPI2S23CKSELR_SPI23SRC_2)

	#define LL_RCC_SPI45_CLKSOURCE_PCLK2                                                       \
		LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI45SRC, 0)
	#define LL_RCC_SPI45_CLKSOURCE_PLL4Q                                                       \
		LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI45SRC,                     \
			     RCC_SPI45CKSELR_SPI45SRC_0)
	#define LL_RCC_SPI45_CLKSOURCE_HSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI45SRC,                     \
			     RCC_SPI45CKSELR_SPI45SRC_1)
	#define LL_RCC_SPI45_CLKSOURCE_CSI                                                         \
		LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI45SRC,                     \
			     (RCC_SPI45CKSELR_SPI45SRC_1 | RCC_SPI45CKSELR_SPI45SRC_0))
	#define LL_RCC_SPI45_CLKSOURCE_HSE                                                         \
		LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI45SRC,                     \
			     RCC_SPI45CKSELR_SPI45SRC_2)

	#define LL_RCC_SPI6_CLKSOURCE_PCLK5                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SPI6CKSELR, RCC_SPI6CKSELR_SPI6SRC, 0)
	#define LL_RCC_SPI6_CLKSOURCE_PLL4Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SPI6CKSELR, RCC_SPI6CKSELR_SPI6SRC,                        \
			     RCC_SPI6CKSELR_SPI6SRC_0)
	#define LL_RCC_SPI6_CLKSOURCE_HSI                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SPI6CKSELR, RCC_SPI6CKSELR_SPI6SRC,                        \
			     RCC_SPI6CKSELR_SPI6SRC_1)
	#define LL_RCC_SPI6_CLKSOURCE_CSI                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SPI6CKSELR, RCC_SPI6CKSELR_SPI6SRC,                        \
			     (RCC_SPI6CKSELR_SPI6SRC_1 | RCC_SPI6CKSELR_SPI6SRC_0))
	#define LL_RCC_SPI6_CLKSOURCE_HSE                                                          \
		LL_CLKSOURCE(RCC_OFFSET_SPI6CKSELR, RCC_SPI6CKSELR_SPI6SRC,                        \
			     RCC_SPI6CKSELR_SPI6SRC_2)
	#define LL_RCC_SPI6_CLKSOURCE_PLL3Q                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SPI6CKSELR, RCC_SPI6CKSELR_SPI6SRC,                        \
			     (RCC_SPI6CKSELR_SPI6SRC_2 | RCC_SPI6CKSELR_SPI6SRC_0))
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_USART1_CLKSOURCE_PCLK5                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART1CKSELR, RCC_UART1CKSELR_UART1SRC, 0)
	#define LL_RCC_USART1_CLKSOURCE_PLL3Q                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART1CKSELR, RCC_UART1CKSELR_UART1SRC,                     \
			     RCC_UART1CKSELR_UART1SRC_0)
	#define LL_RCC_USART1_CLKSOURCE_HSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART1CKSELR, RCC_UART1CKSELR_UART1SRC,                     \
			     RCC_UART1CKSELR_UART1SRC_1)
	#define LL_RCC_USART1_CLKSOURCE_CSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART1CKSELR, RCC_UART1CKSELR_UART1SRC,                     \
			     (RCC_UART1CKSELR_UART1SRC_1 | RCC_UART1CKSELR_UART1SRC_0))
	#define LL_RCC_USART1_CLKSOURCE_PLL4Q                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART1CKSELR, RCC_UART1CKSELR_UART1SRC,                     \
			     RCC_UART1CKSELR_UART1SRC_2)
	#define LL_RCC_USART1_CLKSOURCE_HSE                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART1CKSELR, RCC_UART1CKSELR_UART1SRC,                     \
			     (RCC_UART1CKSELR_UART1SRC_2 | RCC_UART1CKSELR_UART1SRC_0))

	#define LL_RCC_UART24_CLKSOURCE_PCLK1                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART24CKSELR, RCC_UART24CKSELR_UART24SRC, 0)
	#define LL_RCC_UART24_CLKSOURCE_PLL4Q                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART24CKSELR, RCC_UART24CKSELR_UART24SRC,                  \
			     RCC_UART24CKSELR_UART24SRC_0)
	#define LL_RCC_UART24_CLKSOURCE_HSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART24CKSELR, RCC_UART24CKSELR_UART24SRC,                  \
			     RCC_UART24CKSELR_UART24SRC_1)
	#define LL_RCC_UART24_CLKSOURCE_CSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART24CKSELR, RCC_UART24CKSELR_UART24SRC,                  \
			     (RCC_UART24CKSELR_UART24SRC_1 | RCC_UART24CKSELR_UART24SRC_0))
	#define LL_RCC_UART24_CLKSOURCE_HSE                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART24CKSELR, RCC_UART24CKSELR_UART24SRC,                  \
			     RCC_UART24CKSELR_UART24SRC_2)

	#define LL_RCC_UART35_CLKSOURCE_PCLK1                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, 0)
	#define LL_RCC_UART35_CLKSOURCE_PLL4Q                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC,                  \
			     RCC_UART35CKSELR_UART35SRC_0)
	#define LL_RCC_UART35_CLKSOURCE_HSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC,                  \
			     RCC_UART35CKSELR_UART35SRC_1)
	#define LL_RCC_UART35_CLKSOURCE_CSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC,                  \
			     (RCC_UART35CKSELR_UART35SRC_1 | RCC_UART35CKSELR_UART35SRC_0))
	#define LL_RCC_UART35_CLKSOURCE_HSE                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC,                  \
			     RCC_UART35CKSELR_UART35SRC_2)

	#define LL_RCC_USART6_CLKSOURCE_PCLK2                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC, 0)
	#define LL_RCC_USART6_CLKSOURCE_PLL4Q                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC,                     \
			     RCC_UART6CKSELR_UART6SRC_0)
	#define LL_RCC_USART6_CLKSOURCE_HSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC,                     \
			     RCC_UART6CKSELR_UART6SRC_1)
	#define LL_RCC_USART6_CLKSOURCE_CSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC,                     \
			     (RCC_UART6CKSELR_UART6SRC_1 | RCC_UART6CKSELR_UART6SRC_0))
	#define LL_RCC_USART6_CLKSOURCE_HSE                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC,                     \
			     RCC_UART6CKSELR_UART6SRC_2)

	#define LL_RCC_UART78_CLKSOURCE_PCLK1                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC, 0)
	#define LL_RCC_UART78_CLKSOURCE_PLL4Q                                                      \
		LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC,                  \
			     RCC_UART78CKSELR_UART78SRC_0)
	#define LL_RCC_UART78_CLKSOURCE_HSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC,                  \
			     RCC_UART78CKSELR_UART78SRC_1)
	#define LL_RCC_UART78_CLKSOURCE_CSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC,                  \
			     (RCC_UART78CKSELR_UART78SRC_1 | RCC_UART78CKSELR_UART78SRC_0))
	#define LL_RCC_UART78_CLKSOURCE_HSE                                                        \
		LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC,                  \
			     RCC_UART78CKSELR_UART78SRC_2)
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_SDMMC12_CLKSOURCE_HCLK6                                                     \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC12SRC, 0)
	#define LL_RCC_SDMMC12_CLKSOURCE_PLL3R                                                     \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC12SRC,               \
			     RCC_SDMMC12CKSELR_SDMMC12SRC_0)
	#define LL_RCC_SDMMC12_CLKSOURCE_PLL4P                                                     \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC12SRC,               \
			     RCC_SDMMC12CKSELR_SDMMC12SRC_1)
	#define LL_RCC_SDMMC12_CLKSOURCE_HSI                                                       \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC12SRC,               \
			     (RCC_SDMMC12CKSELR_SDMMC12SRC_1 | RCC_SDMMC12CKSELR_SDMMC12SRC_0))

	#define LL_RCC_SDMMC3_CLKSOURCE_HCLK2                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC3CKSELR, RCC_SDMMC3CKSELR_SDMMC3SRC, 0)
	#define LL_RCC_SDMMC3_CLKSOURCE_PLL3R                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC3CKSELR, RCC_SDMMC3CKSELR_SDMMC3SRC,                  \
			     RCC_SDMMC3CKSELR_SDMMC3SRC_0)
	#define LL_RCC_SDMMC3_CLKSOURCE_PLL4P                                                      \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC3CKSELR, RCC_SDMMC3CKSELR_SDMMC3SRC,                  \
			     RCC_SDMMC3CKSELR_SDMMC3SRC_1)
	#define LL_RCC_SDMMC3_CLKSOURCE_HSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC3CKSELR, RCC_SDMMC3CKSELR_SDMMC3SRC,                  \
	 ...
	 */
		...
		#define LL_RCC_FDCAN_CLKSOURCE_PLL4R                                               \
			(RCC_FDCANCKSELR_FDCANSRC_1 | RCC_FDCANCKSELR_FDCANSRC_0)
	/**
	 * @}
	 */
	#endif /*FDCAN1*/
	 ...
	 * @{
	 */
	#define LL_RCC_RNG1_CLKSOURCE_CSI                                                          \
		LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC, 0)
	#define LL_RCC_RNG1_CLKSOURCE_PLL4R                                                        \
		LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC,                        \
			     RCC_RNG1CKSELR_RNG1SRC_0)
	#define LL_RCC_RNG1_CLKSOURCE_LSE                                                          \
		LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC,                        \
			     RCC_RNG1CKSELR_RNG1SRC_1)
	#define LL_RCC_RNG1_CLKSOURCE_LSI                                                          \
		LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC,                        \
			     (RCC_RNG1CKSELR_RNG1SRC_1 | RCC_RNG1CKSELR_RNG1SRC_0))

	#define LL_RCC_RNG2_CLKSOURCE_CSI                                                          \
		LL_CLKSOURCE(RCC_OFFSET_RNG2CKSELR, RCC_RNG2CKSELR_RNG2SRC, 0)
	#define LL_RCC_RNG2_CLKSOURCE_PLL4R                                                        \
		LL_CLKSOURCE(RCC_OFFSET_RNG2CKSELR, RCC_RNG2CKSELR_RNG2SRC,                        \
			     RCC_RNG2CKSELR_RNG2SRC_0)
	#define LL_RCC_RNG2_CLKSOURCE_LSE                                                          \
		LL_CLKSOURCE(RCC_OFFSET_RNG2CKSELR, RCC_RNG2CKSELR_RNG2SRC,                        \
			     RCC_RNG2CKSELR_RNG2SRC_1)
	#define LL_RCC_RNG2_CLKSOURCE_LSI                                                          \
		LL_CLKSOURCE(RCC_OFFSET_RNG2CKSELR, RCC_RNG2CKSELR_RNG2SRC,                        \
			     (RCC_RNG2CKSELR_RNG2SRC_1 | RCC_RNG2CKSELR_RNG2SRC_0))
	/**
	 * @}
	 */
	...
	#define LL_RCC_CKPER_CLKSOURCE_OFF                                                         \
		(RCC_CPERCKSELR_CKPERSRC_1 | RCC_CPERCKSELR_CKPERSRC_0) /*Clock disabled*/
	/**
	 * @}
	 */
	...
	#define LL_RCC_LPTIM1_CLKSOURCE_PCLK1                                                      \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, 0)
	#define LL_RCC_LPTIM1_CLKSOURCE_PLL4P                                                      \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC,                  \
			     RCC_LPTIM1CKSELR_LPTIM1SRC_0)
	#define LL_RCC_LPTIM1_CLKSOURCE_PLL3Q                                                      \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC,                  \
			     RCC_LPTIM1CKSELR_LPTIM1SRC_1)
	#define LL_RCC_LPTIM1_CLKSOURCE_LSE                                                        \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC,                  \
			     (RCC_LPTIM1CKSELR_LPTIM1SRC_1 | RCC_LPTIM1CKSELR_LPTIM1SRC_0))
	#define LL_RCC_LPTIM1_CLKSOURCE_LSI                                                        \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC,                  \
			     RCC_LPTIM1CKSELR_LPTIM1SRC_2)
	#define LL_RCC_LPTIM1_CLKSOURCE_PER                                                        \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC,                  \
			     (RCC_LPTIM1CKSELR_LPTIM1SRC_2 | RCC_LPTIM1CKSELR_LPTIM1SRC_0))
	#define LL_RCC_LPTIM1_CLKSOURCE_OFF                                                        \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC,                  \
			     (RCC_LPTIM1CKSELR_LPTIM1SRC_2 | RCC_LPTIM1CKSELR_LPTIM1SRC_1))

	#define LL_RCC_LPTIM23_CLKSOURCE_PCLK3                                                     \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM23SRC, 0)
	#define LL_RCC_LPTIM23_CLKSOURCE_PLL4Q                                                     \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM23SRC,               \
			     RCC_LPTIM23CKSELR_LPTIM23SRC_0)
	#define LL_RCC_LPTIM23_CLKSOURCE_PER                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM23SRC,               \
			     RCC_LPTIM23CKSELR_LPTIM23SRC_1)
	#define LL_RCC_LPTIM23_CLKSOURCE_LSE                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM23SRC,               \
			     (RCC_LPTIM23CKSELR_LPTIM23SRC_1 | RCC_LPTIM23CKSELR_LPTIM23SRC_0))
	#define LL_RCC_LPTIM23_CLKSOURCE_LSI                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM23SRC,               \
			     RCC_LPTIM23CKSELR_LPTIM23SRC_2)
	#define LL_RCC_LPTIM23_CLKSOURCE_OFF                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM23SRC,               \
			     (RCC_LPTIM23CKSELR_LPTIM23SRC_2 | RCC_LPTIM23CKSELR_LPTIM23SRC_0))

	#define LL_RCC_LPTIM45_CLKSOURCE_PCLK3                                                     \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, 0)
	#define LL_RCC_LPTIM45_CLKSOURCE_PLL4P                                                     \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC,               \
			     RCC_LPTIM45CKSELR_LPTIM45SRC_0)
	#define LL_RCC_LPTIM45_CLKSOURCE_PLL3Q                                                     \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC,               \
			     RCC_LPTIM45CKSELR_LPTIM45SRC_1)
	#define LL_RCC_LPTIM45_CLKSOURCE_LSE                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC,               \
			     (RCC_LPTIM45CKSELR_LPTIM45SRC_1 | RCC_LPTIM45CKSELR_LPTIM45SRC_0))
	#define LL_RCC_LPTIM45_CLKSOURCE_LSI                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC,               \
			     RCC_LPTIM45CKSELR_LPTIM45SRC_2)
	#define LL_RCC_LPTIM45_CLKSOURCE_PER                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC,               \
			     (RCC_LPTIM45CKSELR_LPTIM45SRC_2 | RCC_LPTIM45CKSELR_LPTIM45SRC_0))
	#define LL_RCC_LPTIM45_CLKSOURCE_OFF                                                       \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC,               \
			     (RCC_LPTIM45CKSELR_LPTIM45SRC_2 | RCC_LPTIM45CKSELR_LPTIM45SRC_1))
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_TIMG1PRES_DEACTIVATED                                                       \
		LL_CLKSOURCE(RCC_OFFSET_TIMG1PRER, RCC_TIMG1PRER_TIMG1PRE, 0)
	#define LL_RCC_TIMG1PRES_ACTIVATED                                                         \
		LL_CLKSOURCE(RCC_OFFSET_TIMG1PRER, RCC_TIMG1PRER_TIMG1PRE, RCC_TIMG1PRER_TIMG1PRE)

	#define LL_RCC_TIMG2PRES_DEACTIVATED                                                       \
		LL_CLKSOURCE(RCC_OFFSET_TIMG2PRER, RCC_TIMG2PRER_TIMG2PRE, 0)
	#define LL_RCC_TIMG2PRES_ACTIVATED                                                         \
		LL_CLKSOURCE(RCC_OFFSET_TIMG2PRER, RCC_TIMG2PRER_TIMG2PRE, RCC_TIMG2PRER_TIMG2PRE)
	/**
	 * @}
	 */
	...
	#define LL_RCC_RTC_CLKSOURCE_LSE                                                           \
		RCC_BDCR_RTCSRC_0 /*!< LSE oscillator clock used as RTC clock */
	#define LL_RCC_RTC_CLKSOURCE_LSI                                                           \
		RCC_BDCR_RTCSRC_1 /*!< LSI oscillator clock used as RTC clock */
	#define LL_RCC_RTC_CLKSOURCE_HSE_DIV                                                       \
		(RCC_BDCR_RTCSRC_1 | RCC_BDCR_RTCSRC_0) /*!< HSE oscillator clock divided by       \
							   RTCDIV used as RTC clock */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_I2C12_CLKSOURCE                                                             \
		LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC, 0x00000000U)
	#define LL_RCC_I2C35_CLKSOURCE                                                             \
		LL_CLKSOURCE(RCC_OFFSET_I2C35CKSELR, RCC_I2C35CKSELR_I2C35SRC, 0x00000000U)
	#define LL_RCC_I2C46_CLKSOURCE                                                             \
		LL_CLKSOURCE(RCC_OFFSET_I2C46CKSELR, RCC_I2C46CKSELR_I2C46SRC, 0x00000000U)
	/**
	 * @}
	 */
	...
	#define LL_RCC_SAI1_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC, 0x00000000U)
	#define LL_RCC_SAI2_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, 0x00000000U)
	#define LL_RCC_SAI3_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_SAI3CKSELR, RCC_SAI3CKSELR_SAI3SRC, 0x00000000U)
	#define LL_RCC_SAI4_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_SAI4CKSELR, RCC_SAI4CKSELR_SAI4SRC, 0x00000000U)
	/**
	 * @}
	 */
	...
	#define LL_RCC_SPI1_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC, 0x00000000U)
	#define LL_RCC_SPI23_CLKSOURCE                                                             \
		LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC, 0x00000000U)
	#define LL_RCC_SPI45_CLKSOURCE                                                             \
		LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI45SRC, 0x00000000U)
	#define LL_RCC_SPI6_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_SPI6CKSELR, RCC_SPI6CKSELR_SPI6SRC, 0x00000000U)
	/**
	 * @}
	 */
	...
	#define LL_RCC_USART1_CLKSOURCE                                                            \
		LL_CLKSOURCE(RCC_OFFSET_UART1CKSELR, RCC_UART1CKSELR_UART1SRC, 0x00000000U)
	#define LL_RCC_UART24_CLKSOURCE                                                            \
		LL_CLKSOURCE(RCC_OFFSET_UART24CKSELR, RCC_UART24CKSELR_UART24SRC, 0x00000000U)
	#define LL_RCC_UART35_CLKSOURCE                                                            \
		LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, 0x00000000U)
	#define LL_RCC_USART6_CLKSOURCE                                                            \
		LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC, 0x00000000U)
	#define LL_RCC_UART78_CLKSOURCE                                                            \
		LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC, 0x00000000U)
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_SDMMC12_CLKSOURCE                                                           \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC12SRC, 0x00000000U)
	#define LL_RCC_SDMMC3_CLKSOURCE                                                            \
		LL_CLKSOURCE(RCC_OFFSET_SDMMC3CKSELR, RCC_SDMMC3CKSELR_SDMMC3SRC, 0x00000000U)
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_RNG1_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC, 0x00000000U)
	#define LL_RCC_RNG2_CLKSOURCE                                                              \
		LL_CLKSOURCE(RCC_OFFSET_RNG2CKSELR, RCC_RNG2CKSELR_RNG2SRC, 0x00000000U)
	/**
	 * @}
	 */
	...
	#define LL_RCC_LPTIM1_CLKSOURCE                                                            \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, 0x00000000U)
	#define LL_RCC_LPTIM23_CLKSOURCE                                                           \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM23SRC, 0x00000000U)
	#define LL_RCC_LPTIM45_CLKSOURCE                                                           \
		LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, 0x00000000U)
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_TIMG1PRES                                                                   \
		LL_CLKSOURCE(RCC_OFFSET_TIMG1PRER, RCC_TIMG1PRER_TIMG1PRE, 0x00000000U)
	#define LL_RCC_TIMG2PRES                                                                   \
		LL_CLKSOURCE(RCC_OFFSET_TIMG2PRER, RCC_TIMG2PRER_TIMG2PRE, 0x00000000U)
	/**
	 * @}
	 */
	...
	#define LL_RCC_PLL12SOURCE_HSE                                                             \
		RCC_RCK12SELR_PLL12SRC_0 /*!< HSE clock selected as PLL12 entry clock source */
	...
	#define LL_RCC_PLL3SOURCE_HSE                                                              \
		RCC_RCK3SELR_PLL3SRC_0 /*!< HSE clock selected as PLL3 entry clock source */
	#define LL_RCC_PLL3SOURCE_CSI                                                              \
		RCC_RCK3SELR_PLL3SRC_1 /*!< CSI clock selected as PLL3 entry clock source */
	#define LL_RCC_PLL3SOURCE_NONE                                                             \
		(RCC_RCK3SELR_PLL3SRC_1 | RCC_RCK3SELR_PLL3SRC_0) /*!< No clock */
	/**
	 * @}
	 */
	...
	#define LL_RCC_PLL4SOURCE_HSE                                                              \
		RCC_RCK4SELR_PLL4SRC_0 /*!< HSE clock selected as PLL4 entry clock source */
	#define LL_RCC_PLL4SOURCE_CSI                                                              \
		RCC_RCK4SELR_PLL4SRC_1 /*!< CSI clock selected as PLL4 entry clock source */
	#define LL_RCC_PLL4SOURCE_I2SCKIN                                                          \
		(RCC_RCK4SELR_PLL4SRC_1 | RCC_RCK4SELR_PLL4SRC_0) /*!< Signal I2S_CKIN selected as \
								     PLL4 entry clock source */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL3IFRANGE_0                                                               \
		RCC_PLL3CFGR1_IFRGE_0 /*!< The PLL3 input (ref3_ck) clock range frequency          \
					   is between 4 and 8 MHz (default after reset) */
	#define LL_RCC_PLL3IFRANGE_1                                                               \
		RCC_PLL3CFGR1_IFRGE_1 /*!< The PLL3 input (ref3_ck) clock range frequency          \
	 ...
	 * @{
	 */
	#define LL_RCC_PLL4IFRANGE_0                                                               \
		RCC_PLL4CFGR1_IFRGE_0 /*!< The PLL4 input (ref4_ck) clock range frequency          \
					   is between 4 and 8 MHz (default after reset) */
	#define LL_RCC_PLL4IFRANGE_1                                                               \
		RCC_PLL4CFGR1_IFRGE_1 /*!< The PLL4 input (ref4_ck) clock range frequency          \
					   is between 8 and 16 MHz */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL1SSCG_CENTER_SPREAD                                                      \
		0x00000000U /*!< Center-spread modulation selected (default after reset) */
	#define LL_RCC_PLL1SSCG_DOWN_SPREAD                                                        \
		RCC_PLL1CSGR_SSCG_MODE /*!< Down-spread modulation selected */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL1RPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL1RPDFN_DIS_DISABLED                                                      \
		RCC_PLL1CSGR_RPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL1TPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL1TPDFN_DIS_DISABLED                                                      \
		RCC_PLL1CSGR_TPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL2SSCG_CENTER_SPREAD                                                      \
		0x00000000U /*!< Center-spread modulation selected (default after reset) */
	#define LL_RCC_PLL2SSCG_DOWN_SPREAD                                                        \
		RCC_PLL2CSGR_SSCG_MODE /*!< Down-spread modulation selected */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL2RPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL2RPDFN_DIS_DISABLED                                                      \
		RCC_PLL2CSGR_RPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL2TPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL2TPDFN_DIS_DISABLED                                                      \
		RCC_PLL2CSGR_TPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL3SSCG_CENTER_SPREAD                                                      \
		0x00000000U /*!< Center-spread modulation selected (default after reset) */
	#define LL_RCC_PLL3SSCG_DOWN_SPREAD                                                        \
		RCC_PLL3CSGR_SSCG_MODE /*!< Down-spread modulation selected */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL3RPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL3RPDFN_DIS_DISABLED                                                      \
		RCC_PLL3CSGR_RPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL3TPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL3TPDFN_DIS_DISABLED                                                      \
		RCC_PLL3CSGR_TPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL4SSCG_CENTER_SPREAD                                                      \
		0x00000000U /*!< Center-spread modulation selected (default after reset) */
	#define LL_RCC_PLL4SSCG_DOWN_SPREAD                                                        \
		RCC_PLL4CSGR_SSCG_MODE /*!< Down-spread modulation selected */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL4RPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL4RPDFN_DIS_DISABLED                                                      \
		RCC_PLL4CSGR_RPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define LL_RCC_PLL4TPDFN_DIS_ENABLED                                                       \
		0x00000000U /*!< Dithering noise injection enabled (default after reset) */
	#define LL_RCC_PLL4TPDFN_DIS_DISABLED                                                      \
		RCC_PLL4CSGR_TPDFN_DIS /*!< Dithering noise injection disabled */
	/**
	 * @}
	 */
	 ...
	 */
	#define LL_RCC_CALC_MPUDIV_FREQ(__PLL1PINPUTCLKFREQ__, __MPUDIVPRESCALER__)                \
		((__PLL1PINPUTCLKFREQ__) >> (__MPUDIVPRESCALER__))
	 ...
	 */
	#define LL_RCC_CALC_ACLK_FREQ(__ACLKINPUTCLKFREQ__, __AXIPRESCALER__)                      \
		((__ACLKINPUTCLKFREQ__) / ((__AXIPRESCALER__) + 1U))
	 ...
	 */
	#define LL_RCC_CALC_PCLK4_FREQ(__ACLKFREQ__, __APB4PRESCALER__)                            \
		((__ACLKFREQ__) >> (__APB4PRESCALER__))
	 ...
	 */
	#define LL_RCC_CALC_PCLK5_FREQ(__ACLKFREQ__, __APB5PRESCALER__)                            \
		((__ACLKFREQ__) >> (__APB5PRESCALER__))

	/**
	 * @brief  Helper macro to calculate the MLHCLK, MCU, FCLK, HCLK4, HCLK3, HCLK2 and HCLK1
	 * frequencies
	 * @param  __MLHCLKINPUTCLKFREQ__ Frequency of the input of mlhclk_ck (based on
	 * HSI/HSE/CSI/PLL3P)
	 ...
	 */
	#define LL_RCC_CALC_MLHCLK_FREQ(__MLHCLKINPUTCLKFREQ__, __MCUPRESCALER__)                  \
		((__MLHCLKINPUTCLKFREQ__) >> (__MCUPRESCALER__))
	 ...
	 */
	#define LL_RCC_CALC_PCLK1_FREQ(__MLHCLKFREQ__, __APB1PRESCALER__)                          \
		((__MLHCLKFREQ__) >> (__APB1PRESCALER__))
	 ...
	 */
	#define LL_RCC_CALC_PCLK2_FREQ(__MLHCLKFREQ__, __APB2PRESCALER__)                          \
		((__MLHCLKFREQ__) >> (__APB2PRESCALER__))
	 ...
	 */
	#define LL_RCC_CALC_PCLK3_FREQ(__MLHCLKFREQ__, __APB3PRESCALER__)                          \
		((__MLHCLKFREQ__) >> (__APB3PRESCALER__))
...
{
	__IO uint32_t *pReg =
		(__IO uint32_t *)((uint32_t)&RCC->I2C46CKSELR + LL_CLKSOURCE_REG(ClkSource));
...
__STATIC_INLINE uint32_t LL_RCC_GetClockSource(uint32_t Periph)
{
	__IO const uint32_t *pReg =
		(uint32_t *)((uint32_t)((uint32_t)(&RCC->I2C46CKSELR) + LL_CLKSOURCE_REG(Periph)));

	return (uint32_t)(Periph |
			  ((READ_BIT(*pReg, LL_CLKSOURCE_MASK(Periph))) << RCC_CONFIG_SHIFT));
}
...
__STATIC_INLINE void LL_RCC_ConfigMCO(uint32_t MCOxSource, uint32_t MCOxPrescaler)
{
	...
	/* Set MCOx prescaler */
	__IO uint32_t *pReg =
		(__IO uint32_t *)((uint32_t)&RCC->I2C46CKSELR + LL_CLKSOURCE_REG(MCOxSource));
...
{
	return (uint32_t)((READ_BIT(RCC->PLL1CR, RCC_PLL1CR_DIVPEN) == RCC_PLL1CR_DIVPEN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL1FRACR, RCC_PLL1FRACR_FRACLE) == RCC_PLL1FRACR_FRACLE)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL1CR, RCC_PLL1CR_SSCG_CTRL) == RCC_PLL1CR_SSCG_CTRL)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL1CFGR1, RCC_PLL1CFGR1_DIVN) >> RCC_PLL1CFGR1_DIVN_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL1CFGR1, RCC_PLL1CFGR1_DIVM1) >>
...
{
	return (uint32_t)((READ_BIT(RCC->PLL1CFGR2, RCC_PLL1CFGR2_DIVP) >> RCC_PLL1CFGR2_DIVP_Pos) +
			  1U);
}
...
/** @brief  Configure the PLL1 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL1_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN,
					   uint32_t SSCGMode, uint32_t IncStep)
{
	MODIFY_REG(RCC->PLL1CSGR,
		   (RCC_PLL1CSGR_MOD_PER | RCC_PLL1CSGR_TPDFN_DIS | RCC_PLL1CSGR_RPDFN_DIS |
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CR, RCC_PLL2CR_DIVPEN) == RCC_PLL2CR_DIVPEN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CR, RCC_PLL2CR_DIVQEN) == RCC_PLL2CR_DIVQEN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CR, RCC_PLL2CR_DIVREN) == RCC_PLL2CR_DIVREN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2FRACR, RCC_PLL2FRACR_FRACLE) == RCC_PLL2FRACR_FRACLE)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CR, RCC_PLL2CR_SSCG_CTRL) == RCC_PLL2CR_SSCG_CTRL)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CFGR1, RCC_PLL2CFGR1_DIVN) >> RCC_PLL2CFGR1_DIVN_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CFGR1, RCC_PLL2CFGR1_DIVM2) >>
			   RCC_PLL2CFGR1_DIVM2_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CFGR2, RCC_PLL2CFGR2_DIVP) >> RCC_PLL2CFGR2_DIVP_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CFGR2, RCC_PLL2CFGR2_DIVQ) >> RCC_PLL2CFGR2_DIVQ_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL2CFGR2, RCC_PLL2CFGR2_DIVR) >> RCC_PLL2CFGR2_DIVR_Pos) +
			  1U);
}
...
/** @brief  Configure the PLL2 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL2_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN,
					   uint32_t SSCGMode, uint32_t IncStep)
{
	MODIFY_REG(RCC->PLL2CSGR,
		   (RCC_PLL2CSGR_MOD_PER | RCC_PLL2CSGR_TPDFN_DIS | RCC_PLL2CSGR_RPDFN_DIS |
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CR, RCC_PLL3CR_DIVPEN) == RCC_PLL3CR_DIVPEN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CR, RCC_PLL3CR_DIVQEN) == RCC_PLL3CR_DIVQEN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CR, RCC_PLL3CR_DIVREN) == RCC_PLL3CR_DIVREN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3FRACR, RCC_PLL3FRACR_FRACLE) == RCC_PLL3FRACR_FRACLE)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CR, RCC_PLL3CR_SSCG_CTRL) == RCC_PLL3CR_SSCG_CTRL)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CFGR1, RCC_PLL3CFGR1_DIVN) >> RCC_PLL3CFGR1_DIVN_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CFGR1, RCC_PLL3CFGR1_DIVM3) >>
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CFGR2, RCC_PLL3CFGR2_DIVP) >> RCC_PLL3CFGR2_DIVP_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CFGR2, RCC_PLL3CFGR2_DIVQ) >> RCC_PLL3CFGR2_DIVQ_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL3CFGR2, RCC_PLL3CFGR2_DIVR) >> RCC_PLL3CFGR2_DIVR_Pos) +
			  1U);
}
...
/** @brief  Configure the PLL3 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL3_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN,
					   uint32_t SSCGMode, uint32_t IncStep)
{
	MODIFY_REG(RCC->PLL3CSGR,
		   (RCC_PLL3CSGR_MOD_PER | RCC_PLL3CSGR_TPDFN_DIS | RCC_PLL3CSGR_RPDFN_DIS |
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CR, RCC_PLL4CR_DIVPEN) == RCC_PLL4CR_DIVPEN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CR, RCC_PLL4CR_DIVQEN) == RCC_PLL4CR_DIVQEN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CR, RCC_PLL4CR_DIVREN) == RCC_PLL4CR_DIVREN) ? 1UL
											  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4FRACR, RCC_PLL4FRACR_FRACLE) == RCC_PLL4FRACR_FRACLE)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CR, RCC_PLL4CR_SSCG_CTRL) == RCC_PLL4CR_SSCG_CTRL)
				  ? 1UL
				  : 0UL);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CFGR1, RCC_PLL4CFGR1_DIVN) >> RCC_PLL4CFGR1_DIVN_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CFGR1, RCC_PLL4CFGR1_DIVM4) >>
			   RCC_PLL4CFGR1_DIVM4_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CFGR2, RCC_PLL4CFGR2_DIVP) >> RCC_PLL4CFGR2_DIVP_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CFGR2, RCC_PLL4CFGR2_DIVQ) >> RCC_PLL4CFGR2_DIVQ_Pos) +
			  1U);
}
...
{
	return (uint32_t)((READ_BIT(RCC->PLL4CFGR2, RCC_PLL4CFGR2_DIVR) >> RCC_PLL4CFGR2_DIVR_Pos) +
			  1U);
}
...
/** @brief  Configure the PLL4 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL4_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN,
					   uint32_t SSCGMode, uint32_t IncStep)
{
	MODIFY_REG(RCC->PLL4CSGR,
		   (RCC_PLL4CSGR_MOD_PER | RCC_PLL4CSGR_TPDFN_DIS | RCC_PLL4CSGR_RPDFN_DIS |
...
{
	return (READ_BIT(RCC->MC_RSTSCLRR, RCC_MC_RSTSCLRR_WWDG1RSTF) ==
		(RCC_MC_RSTSCLRR_WWDG1RSTF));
}
...
{
	return (READ_BIT(RCC->MC_RSTSCLRR, RCC_MC_RSTSCLRR_IWDG2RSTF) ==
		(RCC_MC_RSTSCLRR_IWDG2RSTF));
}
...
{
	return (READ_BIT(RCC->MC_RSTSCLRR, RCC_MC_RSTSCLRR_IWDG1RSTF) ==
		(RCC_MC_RSTSCLRR_IWDG1RSTF));
}
...
{
	return (READ_BIT(RCC->MC_RSTSCLRR, RCC_MC_RSTSCLRR_MCSYSRSTF) ==
		(RCC_MC_RSTSCLRR_MCSYSRSTF));
}
...
{
	return (READ_BIT(RCC->MC_RSTSCLRR, RCC_MC_RSTSCLRR_MPSYSRSTF) ==
		(RCC_MC_RSTSCLRR_MPSYSRSTF));
}
...
{
	return (READ_BIT(RCC->MC_RSTSCLRR, RCC_MC_RSTSCLRR_VCORERSTF) ==
		(RCC_MC_RSTSCLRR_VCORERSTF));
}
 ...
 * @{
 */
uint32_t LL_RCC_CalcPLLClockFreq(uint32_t PLLInputFreq, uint32_t M, uint32_t N, uint32_t FRACV,
				 uint32_t PQR);
