...
#ifndef STM32MP1xx_HAL_ADC_EX_H
...
typedef struct {
	...
	uint32_t InjectedSamplingTime; /*!< Sampling time value to be set for the selected channel.
					  ...
					  12 bits, 10.5 cycles at 10 bits, 8.5 cycles at 8 bits, 6.5
					  cycles at 6 bits). This parameter can be a value of @ref
					  ADC_HAL_EC_CHANNEL_SAMPLINGTIME. Caution: This parameter
					  applies to a channel that can be used in a regular and/or
					  injected group. It overwrites the last setting. Note: In
					  case of usage of internal measurement channels
					  (VrefInt/Vbat/TempSensor), sampling time constraints must
					  be respected (sampling time can be adjusted in function of
					  ADC clock frequency and sampling time setting) Refer to
					  device datasheet for timings values. */

	uint32_t InjectedSingleDiff; /*!< Selection of single-ended or differential input.
					  In differential mode: Differential measurement is between
					the selected channel 'i' (positive input) and channel 'i+1'
					(negative input). Only channel 'i' has to be configured,
					channel 'i+1' is configured automatically. This parameter
					must be a value of @ref
					ADC_HAL_EC_CHANNEL_SINGLE_DIFF_ENDING. Caution: This
					parameter applies to a channel that can be used in a regular
					and/or injected group. It overwrites the last setting. Note:
					Refer to Reference Manual to ensure the selected channel is
					available in differential mode. Note: When configuring a
					channel 'i' in differential mode, the channel 'i+1' is not
					usable separately. Note: This parameter must be modified
					when ADC is disabled (before ADC start conversion or after
					ADC stop conversion). If ADC is enabled, this parameter
					setting is bypassed without error reporting (as it can be
					the expected behavior in case of another parameter update on
					the fly) */

	uint32_t
		InjectedOffsetNumber; /*!< Selects the offset number.
					   This parameter can be a value of @ref
					 ADC_HAL_EC_OFFSET_NB. Caution: Only one offset is allowed
					 per channel. This parameter overwrites the last setting. */

	uint32_t InjectedOffset; /*!< Defines the offset to be subtracted from the raw converted
				    data. Offset value must be a positive number. Depending of ADC
				    resolution selected (12, 10, 8 or 6 bits), this parameter must
				    be a number between Min_Data = 0x000 and Max_Data = 0xFFF,
				    0x3FF, 0xFF or 0x3F respectively. Note: This parameter must be
				    modified when no conversion is on going on both regular and
				    injected groups (ADC disabled, or ADC enabled without continuous
				    mode or external trigger that could launch a conversion). */

	uint32_t InjectedOffsetRightShift; /*!< Specifies whether the 1 bit Right-shift feature is
					      used or not. This parameter is applied only for 16-bit
					      or 8-bit resolution. This parameter can be set to
					      ENABLE or DISABLE. */

	FunctionalState InjectedOffsetSignedSaturation; /*!< Specifies whether the Signed saturation
						feature is used or not. This parameter is applied
						only for 16-bit or 8-bit resolution. This parameter
						can be set to ENABLE or DISABLE. */
	uint32_t InjectedLeftBitShift; /*!< Configures the left shifting applied to the final result
					  with or without oversampling. This parameter can be a
					  value of @ref ADCEx_Left_Bit_Shift */
	...
	uint32_t InjectedNbrOfConversion; /*!< Specifies the number of ranks that will be converted
					     ...
					     parameter 'ScanConvMode' must be enabled. This
					     parameter must be a number between Min_Data = 1 and
					     Max_Data = 4. Caution: this setting impacts the entire
					     injected group. Therefore, call of
					     HAL_ADCEx_InjectedConfigChannel() to configure a
					     channel on injected group can impact the configuration
					     of other channels previously set. */

	FunctionalState
		InjectedDiscontinuousConvMode; /*!< Specifies whether the conversions sequence of
					     ADC group injected is performed in
					     ...
					     enabled only if continuous mode is disabled. This
					     parameter can be set to ENABLE or DISABLE. Note: This
					     parameter must be modified when ADC is disabled (before
					     ADC start conversion or after ADC stop conversion).
					     Note: For injected group, discontinuous mode converts
					     the sequence channel by channel (discontinuous length
					     fixed to 1 rank). Caution: this setting impacts the
	...
	FunctionalState
		AutoInjectedConv; /*!< Enables or disables the selected ADC group injected automatic
				     conversion after regular one This parameter can be set to
				     ENABLE or DISABLE. Note: To use Automatic injected conversion,
				     discontinuous mode must be disabled ('DiscontinuousConvMode'
				     and 'InjectedDiscontinuousConvMode' set to DISABLE) Note: To
				     use Automatic injected conversion, injected group external
				     triggers must be disabled ('ExternalTrigInjecConv' set to
				     ADC_INJECTED_SOFTWARE_START) Note: In case of DMA used with
				     regular group: if DMA configured in normal mode (single shot)
				     JAUTO will be stopped upon DMA transfer complete. To maintain
				     JAUTO always enabled, DMA must be configured in circular mode.
	...
	FunctionalState
		QueueInjectedContext; /*!< Specifies whether the context queue feature is enabled.
					 ...
					 configurations are queued on up to 2 contexts. If a new
					 injected context is set when queue is full, error is
					 triggered by interruption and through function
					   'HAL_ADCEx_InjectedQueueOverflowCallback'.
					   Caution: This feature request that the sequence is fully
					 configured before injected conversion start. Therefore,
					 configure channels with as many calls to
					 HAL_ADCEx_InjectedConfigChannel() as the
					 'InjectedNbrOfConversion' parameter. Caution: this setting
					 impacts the entire injected group. Therefore, call of
					 HAL_ADCEx_InjectedConfigChannel() to configure a channel on
					 injected group can impact the configuration of other
					 channels previously set. Note: This parameter must be
					 modified when ADC is disabled (before ADC start conversion
					 or after ADC stop conversion). */

	uint32_t ExternalTrigInjecConv; /*!< Selects the external event used to trigger the
					   conversion start of injected group. If set to
					   ADC_INJECTED_SOFTWARE_START, external triggers are
					   disabled and software trigger is used instead. This
					   parameter can be a value of @ref
					   ADC_injected_external_trigger_source. Caution: this
					   setting impacts the entire injected group. Therefore,
	...
	uint32_t ExternalTrigInjecConvEdge; /*!< Selects the external trigger edge of injected
					       group. This parameter can be a value of @ref
					       ADC_injected_external_trigger_edge. If trigger source
					       is set to ADC_INJECTED_SOFTWARE_START, this parameter
					       is discarded. Caution: this setting impacts the
					       entire injected group. Therefore, call of
					       HAL_ADCEx_InjectedConfigChannel() to configure a
	...
	ADC_InjOversamplingTypeDef
		InjecOversampling; /*!< Specifies the Oversampling parameters.
					Caution: this setting overwrites the previous oversampling
				      configuration if oversampling already enabled. Note: This
				      parameter can be modified only if there is no conversion is
...
typedef struct {
	...
	uint32_t TwoSamplingDelay; /*!< Configures the Delay between 2 sampling phases.
					This parameter can be a value of @ref
				      ...
				      resolution: from 1 to 9 clock cycles for 16 bits, from 1 to 9
				      clock cycles for 14 bits from 1 to 8 clock cycles for 12 bits
...
#define ADC_EXTERNALTRIGINJEC_T3_CC4                                                               \
	(LL_ADC_INJ_TRIG_EXT_TIM3_CH4) /*!< ADC group injected conversion trigger from external    \
					  peripheral: TIM3 channel 4 event (capture compare: input \
					  capture or output capture). Trigger edge set to rising   \
					  edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T4_TRGO                                                              \
	(LL_ADC_INJ_TRIG_EXT_TIM4_TRGO) /*!< ADC group injected conversion trigger from external   \
...
#define ADC_EXTERNALTRIGINJEC_T8_CC4                                                               \
	(LL_ADC_INJ_TRIG_EXT_TIM8_CH4) /*!< ADC group injected conversion trigger from external    \
					  peripheral: TIM8 channel 4 event (capture compare: input \
					  capture or output capture). Trigger edge set to rising   \
					  edge (default setting). */
...
#define ADC_EXTERNALTRIGINJEC_T8_TRGO                                                              \
	(LL_ADC_INJ_TRIG_EXT_TIM8_TRGO) /*!< ADC group injected conversion trigger from external   \
					   peripheral: TIM8 TRGO event. Trigger edge set to rising \
					   edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T8_TRGO2                                                             \
	(LL_ADC_INJ_TRIG_EXT_TIM8_TRGO2) /*!< ADC group injected conversion trigger from external  \
					    peripheral: TIM8 TRGO2 event. Trigger edge set to      \
					    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_CC3                                                               \
	(LL_ADC_INJ_TRIG_EXT_TIM3_CH3) /*!< ADC group injected conversion trigger from external    \
					  peripheral: TIM3 channel 3 event (capture compare: input \
					  capture or output capture). Trigger edge set to rising   \
					  edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_TRGO                                                              \
	(LL_ADC_INJ_TRIG_EXT_TIM3_TRGO) /*!< ADC group injected conversion trigger from external   \
					   peripheral: TIM3 TRGO event. Trigger edge set to rising \
					   edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_CC1                                                               \
	(LL_ADC_INJ_TRIG_EXT_TIM3_CH1) /*!< ADC group injected conversion trigger from external    \
					  peripheral: TIM3 channel 1 event (capture compare: input \
					  capture or output capture). Trigger edge set to rising   \
					  edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T6_TRGO                                                              \
	(LL_ADC_INJ_TRIG_EXT_TIM6_TRGO) /*!< ADC group injected conversion trigger from external   \
					   peripheral: TIM6 TRGO event. Trigger edge set to rising \
					   edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T15_TRGO                                                             \
	(LL_ADC_INJ_TRIG_EXT_TIM15_TRGO) /*!< ADC group injected conversion trigger from external  \
					    peripheral: TIM15 TRGO event. Trigger edge set to      \
					    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_LPTIM1_OUT                                                           \
	(LL_ADC_INJ_TRIG_EXT_LPTIM1_OUT) /*!< ADC group injected conversion trigger from external  \
					    peripheral: LPTIM1 OUT event. Trigger edge set to      \
					    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_LPTIM2_OUT                                                           \
	(LL_ADC_INJ_TRIG_EXT_LPTIM2_OUT) /*!< ADC group injected conversion trigger from external  \
					    peripheral: LPTIM2 OUT event. Trigger edge set to      \
					    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_LPTIM3_OUT                                                           \
	(LL_ADC_INJ_TRIG_EXT_LPTIM3_OUT) /*!< ADC group injected conversion trigger from external  \
					    peripheral: LPTIM3 OUT event. Trigger edge set to      \
					    rising edge (default setting). */
/**
 * @}
 */

/** @defgroup ADC_injected_external_trigger_edge ADC group injected trigger edge (when external
 * trigger is selected)
 * @{
 */
...
#define ADC_SINGLE_ENDED                                                                           \
	(LL_ADC_SINGLE_ENDED) /*!< ADC channel ending set to single ended (literal also used to    \
...
#define ADC_OFFSET_1                                                                               \
	(LL_ADC_OFFSET_1) /*!< ADC offset number 1: ADC channel and offset level to which the      \
			     offset programmed will be applied (independently of channel mapped on \
			     ADC group regular or group injected) */
#define ADC_OFFSET_2                                                                               \
	(LL_ADC_OFFSET_2) /*!< ADC offset number 2: ADC channel and offset level to which the      \
			     offset programmed will be applied (independently of channel mapped on \
			     ADC group regular or group injected) */
#define ADC_OFFSET_3                                                                               \
	(LL_ADC_OFFSET_3) /*!< ADC offset number 3: ADC channel and offset level to which the      \
			     offset programmed will be applied (independently of channel mapped on \
			     ADC group regular or group injected) */
#define ADC_OFFSET_4                                                                               \
	(LL_ADC_OFFSET_4) /*!< ADC offset number 4: ADC channel and offset level to which the      \
			     offset programmed will be applied (independently of channel mapped on \
			     ADC group regular or group injected) */
/**
 * @}
 ...
 */
	...
	#define ADC_DUALMODE_INTERL                                                                \
		(LL_ADC_MULTI_DUAL_REG_INTERL) /*!< ADC dual mode enabled: Combined group regular  \
						  interleaved */
	...
	#define ADC_DUALMODE_REGSIMULT_INJECSIMULT                                                 \
		(LL_ADC_MULTI_DUAL_REG_SIM_INJ_SIM) /*!< ADC dual mode enabled: Combined group     \
						       regular simultaneous + group injected       \
						       simultaneous */
	#define ADC_DUALMODE_REGSIMULT_ALTERTRIG                                                   \
		(LL_ADC_MULTI_DUAL_REG_SIM_INJ_ALT) /*!< ADC dual mode enabled: Combined group     \
						       regular simultaneous + group injected       \
						       alternate trigger */
	#define ADC_DUALMODE_REGINTERL_INJECSIMULT                                                 \
		(LL_ADC_MULTI_DUAL_REG_INT_INJ_SIM) /*!< ADC dual mode enabled: Combined group     \
						       regular interleaved + group injected        \
						       simultaneous */
	...
	#define ADC_DUALMODEDATAFORMAT_DISABLED                                                    \
		(0x00000000UL) /*!< Dual ADC mode without data packing: ADCx_CDR and ADCx_CDR2     \
				  registers not used */
	#define ADC_DUALMODEDATAFORMAT_32_10_BITS                                                  \
		(ADC_CCR_DAMDF_1) /*!< Data formatting mode for 32 down to 10-bit resolution */
	#define ADC_DUALMODEDATAFORMAT_8_BITS                                                      \
		((ADC_CCR_DAMDF_0 |                                                                \
		  ADC_CCR_DAMDF_1)) /*!< Data formatting mode for 8-bit resolution */
	/**
	 * @}
	 */
	...
	#define ADC_TWOSAMPLINGDELAY_1CYCLE                                                        \
		(LL_ADC_MULTI_TWOSMP_DELAY_1CYCLE_5) /*!< ADC multimode delay between two sampling \
							phases: 1 ADC clock cycle */
	#define ADC_TWOSAMPLINGDELAY_2CYCLES                                                       \
		(LL_ADC_MULTI_TWOSMP_DELAY_2CYCLES_5) /*!< ADC multimode delay between two         \
							 sampling phases: 2 ADC clock cycles */
	#define ADC_TWOSAMPLINGDELAY_3CYCLES                                                       \
		(LL_ADC_MULTI_TWOSMP_DELAY_3CYCLES_5) /*!< ADC multimode delay between two         \
							 sampling phases: 3 ADC clock cycles */
	#define ADC_TWOSAMPLINGDELAY_4CYCLES                                                       \
		(LL_ADC_MULTI_TWOSMP_DELAY_4CYCLES_5) /*!< ADC multimode delay between two         \
							 sampling phases: 4 ADC clock cycles */
	#define ADC_TWOSAMPLINGDELAY_5CYCLES                                                       \
		(LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES_5) /*!< ADC multimode delay between two         \
							 sampling phases: 5 ADC clock cycles */
	#define ADC_TWOSAMPLINGDELAY_6CYCLES                                                       \
		(LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES_5) /*!< ADC multimode delay between two         \
							 sampling phases: 6 ADC clock cycles */
	#define ADC_TWOSAMPLINGDELAY_7CYCLES                                                       \
		(LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES_5) /*!< ADC multimode delay between two         \
							 sampling phases: 7 ADC clock cycles */
	#define ADC_TWOSAMPLINGDELAY_8CYCLES                                                       \
		(LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES_5) /*!< ADC multimode delay between two         \
...
#define ADC_CFGR_FIELDS                                                                            \
	(ADC_CFGR_AWD1CH | ADC_CFGR_JAUTO | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                   \
	 ADC_CFGR_AWD1SGL | ADC_CFGR_JQM | ADC_CFGR_JDISCEN | ADC_CFGR_DISCNUM | ADC_CFGR_DISCEN | \
	 ADC_CFGR_AUTDLY | ADC_CFGR_CONT | ADC_CFGR_OVRMOD | ADC_CFGR_EXTEN | ADC_CFGR_EXTSEL | |  \
 ...
 * @retval None
 */
#define ADC_CALFACT_DIFF_GET(__CALIBRATION_FACTOR__)                                               \
...
#define ADC_OFFSET_SHIFT_RESOLUTION(__HANDLE__, __OFFSET__)                                        \
	(((((__HANDLE__)->Instance->CFGR) & ADC_CFGR_RES_2) == 0UL)                                \
		 ? ((__OFFSET__) << (((((__HANDLE__)->Instance->CFGR) & ADC_CFGR_RES) >> 2UL) *    \
				     2UL))                                                         \
		 : ((__OFFSET__) << (((((__HANDLE__)->Instance->CFGR) &                            \
				       (ADC_CFGR_RES & 0xFFFFFFF3UL)) >>                           \
				      2UL) *                                                       \
				     2UL)))
...
#define ADC_AWD1THRESHOLD_SHIFT_RESOLUTION(__HANDLE__, __THRESHOLD__)                              \
	(((((__HANDLE__)->Instance->CFGR) & ADC_CFGR_RES_2) == 0UL)                                \
		 ? ((__THRESHOLD__)                                                                \
		    << (((((__HANDLE__)->Instance->CFGR) & ADC_CFGR_RES) >> 2UL) * 2UL))           \
		 : ((__THRESHOLD__)                                                                \
		    << (((((__HANDLE__)->Instance->CFGR) & (ADC_CFGR_RES & 0xFFFFFFF3UL)) >>       \
			 2UL) *                                                                    \
			2UL)))
...
#define ADC_MASTER_REGISTER(__HANDLE__)                                                            \
	(((((__HANDLE__)->Instance) == ADC1)) ? ((__HANDLE__)->Instance) : (ADC1))

/**
 * @brief Check whether or not dual regular conversions are enabled
 * @param __HANDLE__: ADC handle
 * @retval SET (dual regular conversions are enabled) or RESET (ADC is independent or no dual
 * regular conversions are enabled)
 */
...
/**
 * @brief Ensure ADC Instance is Independent or Master, or is not Slave ADC with dual regular
 * conversions enabled
 * @param __HANDLE__: ADC handle
 * @retval SET (Independent or Master, or Slave without dual regular conversions enabled) or RESET
 * (Slave ADC with dual regular conversions enabled)
 */
...
/**
 * @brief Ensure ADC Instance is Independent or Master, or is not Slave ADC with dual injected
 * conversions enabled
 * @param __HANDLE__: ADC handle
...
#define ADC_INDEPENDENT_OR_NONMULTIMODEINJECTED_SLAVE(__HANDLE__)                                  \
	...
	#define ADC_CLEAR_COMMON_CONTROL_REGISTER(__HANDLE__)                                      \
		CLEAR_BIT(__LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance)->CCR,                   \
			  ADC_CCR_CKMODE | ADC_CCR_PRESC | ADC_CCR_VBATEN | ADC_CCR_VSENSEEN |     \
				  ADC_CCR_VREFEN | ADC_CCR_DAMDF | ADC_CCR_DELAY | ADC_CCR_DUAL)
#endif /* ADC_MULTIMODE_SUPPORT */
 ...
 * @note if __HANDLE_MASTER__ is the handle of a slave ADC or an independent ADC, __HANDLE_SLAVE__
...
#define IS_ADC_CHANNEL(__CHANNEL__)                                                                \
	(((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) ||                   \
	 ...
	 ((__CHANNEL__) == ADC_CHANNEL_DAC1CH2_ADC2) || ((__CHANNEL__) == ADC_CHANNEL_VCORE) ||    \
...
#define IS_ADC1_DIFF_CHANNEL(__CHANNEL__)                                                          \
	(((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) ||                   \
	 ...
	 ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_10) ||                  \
	 ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) ||                 \
	 ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_18))
...
#define IS_ADC_EXTTRIGINJEC_EDGE(__EDGE__)                                                         \
	...
	#define IS_ADC_MULTIMODE(__MODE__)                                                         \
		(((__MODE__) == ADC_MODE_INDEPENDENT) ||                                           \
		 ...
		 ((__MODE__) == ADC_DUALMODE_REGSIMULT) || ((__MODE__) == ADC_DUALMODE_INTERL) ||  \
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef *hadc,
						   ADC_MultiModeTypeDef *pmultimode);
#endif /* ADC_MULTIMODE_SUPPORT */
