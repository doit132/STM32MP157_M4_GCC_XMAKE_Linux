...
typedef struct {
	...
	uint32_t
		MemoryOrM2MDstDataSize; /*!< Specifies the Memory data size alignment or Destination
					   data size alignment (byte, half word, word) in case of
					   memory to memory transfer direction. This parameter can
					   be a value of @ref DMA_LL_EC_MDATAALIGN
	...
	uint32_t
		FIFOMode; /*!< Specifies if the FIFO mode or Direct mode will be used for the
			     specified stream. This parameter can be a value of @ref DMA_LL_FIFOMODE
...
__STATIC_INLINE void LL_DMA_EnableStream(DMA_TypeDef *DMAx, uint32_t Stream)
{
	...
	SET_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
		DMA_SxCR_EN);
}
...
__STATIC_INLINE void LL_DMA_DisableStream(DMA_TypeDef *DMAx, uint32_t Stream)
{
	...
	CLEAR_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
		  DMA_SxCR_EN);
}
...
__STATIC_INLINE uint32_t LL_DMA_IsEnabledStream(DMA_TypeDef *DMAx, uint32_t Stream)
{
	...
	return ((READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))
				  ->CR,
...
__STATIC_INLINE void LL_DMA_SetDataLength(DMA_TypeDef *DMAx, uint32_t Stream, uint32_t NbData)
{
	...
	MODIFY_REG(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->NDTR,
		   DMA_SxNDT, NbData);
}
...
__STATIC_INLINE uint32_t LL_DMA_GetDataLength(DMA_TypeDef *DMAx, uint32_t Stream)
{
	...
	return (READ_BIT(
		((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->NDTR,
		DMA_SxNDT));
}
...
__STATIC_INLINE void LL_DMA_SetPeriphRequest(DMA_TypeDef *DMAx, uint32_t Stream, uint32_t Request)
{
	MODIFY_REG(
		((DMAMUX_Channel_TypeDef *)(uint32_t)((uint32_t)DMAMUX1_Channel0 +
						      (DMAMUX_CCR_SIZE * (Stream)) +
						      (uint32_t)(DMAMUX_CCR_SIZE *
								 LL_DMA_INSTANCE_TO_DMAMUX_CHANNEL(
									 DMAx))))
			->CCR,
...
__STATIC_INLINE uint32_t LL_DMA_GetPeriphRequest(DMA_TypeDef *DMAx, uint32_t Stream)
{
	return (READ_BIT(
		((DMAMUX_Channel_TypeDef *)((
			 uint32_t)((uint32_t)DMAMUX1_Channel0 + (DMAMUX_CCR_SIZE * (Stream)) +
				   (uint32_t)(DMAMUX_CCR_SIZE *
...
__STATIC_INLINE uint32_t LL_DMA_GetFIFOStatus(DMA_TypeDef *DMAx, uint32_t Stream)
{
	...
	return (READ_BIT(
		((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->FCR,
		DMA_SxFCR_FS));
}
...
__STATIC_INLINE void LL_DMA_DisableFifoMode(DMA_TypeDef *DMAx, uint32_t Stream)
{
	...
	CLEAR_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->FCR,
		  DMA_SxFCR_DMDIS);
}
...
__STATIC_INLINE void LL_DMA_EnableFifoMode(DMA_TypeDef *DMAx, uint32_t Stream)
{
	...
	SET_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->FCR,
		DMA_SxFCR_DMDIS);
}
...
__STATIC_INLINE void LL_DMA_SetFIFOThreshold(DMA_TypeDef *DMAx, uint32_t Stream, uint32_t Threshold)
{
	...
	MODIFY_REG(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->FCR,
					    ...
					    uint32_t DstAddress, uint32_t Direction)
{
	...
	if (Direction == LL_DMA_DIRECTION_MEMORY_TO_PERIPH) {
		WRITE_REG(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))
				  ->M0AR,
			  SrcAddress);
		WRITE_REG(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))
				  ->PAR,
					     ...
					     uint32_t MemoryAddress)
{
	...
	WRITE_REG(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->M0AR,
		  MemoryAddress);
}
					     ...
					     uint32_t PeriphAddress)
{
	...
	WRITE_REG(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->PAR,
		  PeriphAddress);
}
...
__STATIC_INLINE void LL_DMA_SetMemory1Address(DMA_TypeDef *DMAx, uint32_t Stream, uint32_t Address)
{
	...
	MODIFY_REG(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->M1AR,
